...
public class TradeVO {
	...
	public int getLDTM_DDS() {
		return LDTM_DDS;
	}

	public void setLDTM_DDS(int lDTM_DDS) {
		LDTM_DDS = lDTM_DDS;
	}
	...
	public int getSSDYRT() {
		return SSDYRT;
	}

	public void setSSDYRT(int sSDYRT) {
		SSDYRT = sSDYRT;
	}

	public int getSSDY_BAS_AM() {
		return SSDY_BAS_AM;
	}

	public void setSSDY_BAS_AM(int sSDY_BAS_AM) {
		SSDY_BAS_AM = sSDY_BAS_AM;
	}

	public int getDDLY_SSDYRT() {
		return DDLY_SSDYRT;
	}

	public void setDDLY_SSDYRT(int dDLY_SSDYRT) {
