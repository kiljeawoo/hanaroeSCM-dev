package com.nh.escm.pds.partner.vo;

public class TradeTrnrelReqVO {
	private String RQR_NA_TRPL_C;
	private String RQR_NA_TEAM_C;
	private String RQR_DT;
	private String TR_RQR_SQNO;
	private String CSER_NA_TRPL_C;
	private String CSER_CLNTNM;
	private String CSER_NA_TEAM_C;
	private String CSER_NA_TEAM_N;
	private String SPLR_NA_TRPL_C;
	private String SPLR_CLNTNM;
	private String SPLR_NA_TEAM_N;
	private String MNGT_NA_TRPL_C;
	private String MNGT_CLNTNM;
	private String MNGT_NA_TEAM_C;
	private String MNGT_NA_TEAM_N;
	...
	private String BKG_CHG_DT;
	private String TR_REL_RG_RQR_DSC;
	private String FSRG_DTM;
	private String LSCHG_DTM;
	private String LS_CMENO;
	private String APVMN_ENO;
	private String APV_NA_BZPLC;
	private String APV_NA_TEAM_C;
	private String APV_DT;
	private String REJ_RSNCTT;
	private String TR_REL_PRG_STSC;
	...
	public TradeTrnrelReqVO(){
		
	}


	public String getRQR_NA_TRPL_C() {
		return RQR_NA_TRPL_C;
	}


	public void setRQR_NA_TRPL_C(String rQR_NA_TRPL_C) {
		RQR_NA_TRPL_C = rQR_NA_TRPL_C;
	}


	public String getRQR_NA_TEAM_C() {
		return RQR_NA_TEAM_C;
	}


	public void setRQR_NA_TEAM_C(String rQR_NA_TEAM_C) {
		RQR_NA_TEAM_C = rQR_NA_TEAM_C;
	}


	public String getRQR_DT() {
		return RQR_DT;
	}


	public void setRQR_DT(String rQR_DT) {
		RQR_DT = rQR_DT;
	}


	public String getTR_RQR_SQNO() {
		return TR_RQR_SQNO;
	}


	public void setTR_RQR_SQNO(String tR_RQR_SQNO) {
		TR_RQR_SQNO = tR_RQR_SQNO;
	}
	...
	public String getBKG_CHG_DT() {
		return BKG_CHG_DT;
	}


	public void setBKG_CHG_DT(String bKG_CHG_DT) {
		BKG_CHG_DT = bKG_CHG_DT;
	}


	public String getTR_REL_RG_RQR_DSC() {
		return TR_REL_RG_RQR_DSC;
	}


	public void setTR_REL_RG_RQR_DSC(String tR_REL_RG_RQR_DSC) {
	...
	public String getAPVMN_ENO() {
		return APVMN_ENO;
	}


	public void setAPVMN_ENO(String aPVMN_ENO) {
		APVMN_ENO = aPVMN_ENO;
	}


	public String getAPV_NA_BZPLC() {
		return APV_NA_BZPLC;
	}


	public void setAPV_NA_BZPLC(String aPV_NA_BZPLC) {
		APV_NA_BZPLC = aPV_NA_BZPLC;
	}


	public String getAPV_NA_TEAM_C() {
		return APV_NA_TEAM_C;
	}


	public void setAPV_NA_TEAM_C(String aPV_NA_TEAM_C) {
	...
	public String getREJ_RSNCTT() {
		return REJ_RSNCTT;
	}


	public void setREJ_RSNCTT(String rEJ_RSNCTT) {
		REJ_RSNCTT = rEJ_RSNCTT;
	}


	public String getTR_REL_PRG_STSC() {
		return TR_REL_PRG_STSC;
	}


	public void setTR_REL_PRG_STSC(String tR_REL_PRG_STSC) {
	...
	public String getSPLR_NA_TEAM_N() {
		return SPLR_NA_TEAM_N;
	}


	public void setSPLR_NA_TEAM_N(String sPLR_NA_TEAM_N) {
		SPLR_NA_TEAM_N = sPLR_NA_TEAM_N;
	}


	public String getCSER_CLNTNM() {
		return CSER_CLNTNM;
	}


	public void setCSER_CLNTNM(String cSER_CLNTNM) {
		CSER_CLNTNM = cSER_CLNTNM;
	}

	public String getSPLR_CLNTNM() {
		return SPLR_CLNTNM;
	}

	public void setSPLR_CLNTNM(String sPLR_CLNTNM) {
		SPLR_CLNTNM = sPLR_CLNTNM;
	}
	...
	public String getMNGT_CLNTNM() {
		return MNGT_CLNTNM;
	}

	public void setMNGT_CLNTNM(String mNGT_CLNTNM) {
		MNGT_CLNTNM = mNGT_CLNTNM;
	}
	...
	public String getMNGT_NA_TEAM_N() {
		return MNGT_NA_TEAM_N;
	}

	public void setMNGT_NA_TEAM_N(String mNGT_NA_TEAM_N) {
		MNGT_NA_TEAM_N = mNGT_NA_TEAM_N;
	}
