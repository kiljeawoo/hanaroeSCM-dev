 ...
 *
 */
public class DeliveryTradingPatnersExcelVO  implements Serializable {
	...
	public String getOGN_NA_DVY_PLASH_SLPNO() {
		return OGN_NA_DVY_PLASH_SLPNO;
	}
	...
	public void setOGN_NA_DVY_PLASH_SLPNO(String oGN_NA_DVY_PLASH_SLPNO) {
		OGN_NA_DVY_PLASH_SLPNO = oGN_NA_DVY_PLASH_SLPNO;
	}
	...
	public void setBYNT_WT(String bYNT_WT) {
		BYNT_WT = bYNT_WT;
	}
	...
	public void setBYNG_VAT(String bYNG_VAT) {
		BYNG_VAT = bYNG_VAT;
	}
	...
	public void setBYNG_SSDY(String bYNG_SSDY) {
		BYNG_SSDY = bYNG_SSDY;
	}
