...
public class DeliveryTradingPatnersSrhVO  implements Serializable {
	...
	private String dvyaa_na_trpl_rdo;//배송지구분
	...
	public void setDvyaa_na_trpl_c(String dvyaa_na_trpl_c) {
		this.dvyaa_na_trpl_c = dvyaa_na_trpl_c;
	}

	public String getDvyaa_na_trpl_rdo() {
		return dvyaa_na_trpl_rdo;
	}

	public void setDvyaa_na_trpl_rdo(String dvyaa_na_trpl_rdo) {
		this.dvyaa_na_trpl_rdo = dvyaa_na_trpl_rdo;
	}
}