package com.nh.escm.mds.delivery.helper;
...
public class VOConvertHelper {
	...
	private DeliveryNoticeMdsService deliveryNoticeService;
	...
	public static VOConvertHelper newInstance(PlatFormRequestHelper requestHelper, DataSet dsM, DataSet dsD, DeliveryNoticeMdsService deliveryNoticeService, SequenceKeyService seqKeyService, String rogoInfCrtDsc, String editType){
	...
	//배송예정서 일반등록
	public VOConvertHelper(PlatFormRequestHelper requestHelper, DataSet dsM, DataSet dsD, DeliveryNoticeMdsService deliveryNoticeEquipService, SequenceKeyService seqKeyService, String rogoInfCrtDsc, String editType) {
		this.requestHelper = requestHelper;
		this.dsM = dsM;
		this.dsD = dsD;
		this.seqKeyService = seqKeyService;
		this.deliveryNoticeService = deliveryNoticeEquipService;
