...
public class RecadvMaster_NA_TRPL_C_VO implements Serializable{
...
private static final long serialVersionUID = 20151130L;
	 ...
	 * 경제통합전표번호
	 */
	private String NA_SLPNO;
	/**
	 * 정정취소구분
	 */
	private String NA_CRC_CAN_DSC;
	/**
	 * 본/지사명
	 */
	private String BCLNTNM;
	/**
	 * 배송예정서번호
	 */
	 ...
	 * 실매입처명
	 */
	private String CCLNTNM;
	/**
	 * 검수일자
	 */
	private String CNR_DT;
	/**
	 * 매출일자-전표번호
	 */
	private String TRSLPNO;
	/**
	 * 지급예정일
	 */
	private String RPY_PLA_DT;
	/**
	 * 공급금액 A
	 */
	private long GAM_AM;
	 ...
	 * 부가세 B
	 */
	private long BYNG_VAT;
	/**
	 * 총공급금액 C=A+B+E+F
	 */
	private long TOT_GAM;
	/**
	 * 총공제금액 D=P~Y
	 */
	private long CHRG_TOT;
	/**
	 * 공병금액 E
	 */
	 ...
	 * 거래구분
	 */
	private String NA_TR_DSC;
	/**
	 * 계통구분
	 */
	private String ROTS_CTR_DSC;
	/**
	 * 본/지사코드
	 */
	 ...
	 * 실매입처(농협)
	 */
	private String ACTL_BUYPL_NA_TRPL_C;
	/**
	 * 업체수수료 O=P+Q+R+S
	 */
	private long COMP_FEE;
	/**
	 * 매입장려금 P
	 */
	private long BYNG_SSDY;
	/**
	 * 관리수수료(R2) Q
	 */
	private long ETR_AMN_FEE;
	/**
	 * 관리부가세(R2) R
	 */
	private long ETR_AMN_VAT;
	/**
	 * 관리수수료(R1) S
	 */
	private long SLGT_AMN_FEE;
	/**
	 * 물류수수료 T
	 */
	private long PHD_FEE;
	/**
	 * 물류부가세 U
	 */
	private long PHD_FEE_VAT;
	/**
	 * 운송용역비 V
	 */
	private long TRP_SVC_CST;
	/**
	 * 운송부가세 W
	 */
	private long TRP_SVCOS_VAT;
	/**
	 * 기타수수료 X
	 */
	private long ETC_FEE;
	/**
	 * 기타부가세 Y
	 */
	private long ETC_FEE_VAT;
	/**
	 * 정산사업장코드
	 */
	private String ADJ_NA_BZPLC;
	/**
	 * 정산처코드
	 */
	private String ADJ_NA_TRPL_C;
	/**
	 * 최초등록자개인번호, 배송예정서 작성자
	 */
	...
	private String APPLICATION_ID;	//XML문서번호
	
	private long GWA_AM; //과세공급
	private long GWA_VAT; //과세부가세
	private long LIQ_GAM; //주류공급
	private long LIQ_VAT; //주류부가세
	private long EXTX_AM; //면세금액
	private long SMA_AM; //영세금액
	...
	public long getGWA_AM() {
		return GWA_AM;
	}
	public void setGWA_AM(long gWA_AM) {
		GWA_AM = gWA_AM;
	}
	public long getGWA_VAT() {
		return GWA_VAT;
	}
	public void setGWA_VAT(long gWA_VAT) {
		GWA_VAT = gWA_VAT;
	}
	public long getLIQ_GAM() {
		return LIQ_GAM;
	}
	public void setLIQ_GAM(long lIQ_GAM) {
		LIQ_GAM = lIQ_GAM;
	}
	public long getLIQ_VAT() {
		return LIQ_VAT;
	}
	public void setLIQ_VAT(long lIQ_VAT) {
		LIQ_VAT = lIQ_VAT;
	}
	...
	public String getADJ_NA_BZPLC() {
		return ADJ_NA_BZPLC;
	}
	public void setADJ_NA_BZPLC(String aDJ_NA_BZPLC) {
		ADJ_NA_BZPLC = aDJ_NA_BZPLC;
	}
	public String getADJ_NA_TRPL_C() {
		return ADJ_NA_TRPL_C;
	}
	public void setADJ_NA_TRPL_C(String aDJ_NA_TRPL_C) {
		ADJ_NA_TRPL_C = aDJ_NA_TRPL_C;
	}
	...
	public String toString() {
		return "RecadvMaster_NA_TRPL_C_VO [RN=" + RN + ", NA_BZPLC=" + NA_BZPLC
				+ ", NA_TEAM_C=" + NA_TEAM_C + ", SLP_DT=" + SLP_DT
				+ ", NA_SLPNO=" + NA_SLPNO + ", NA_CRC_CAN_DSC="
				+ NA_CRC_CAN_DSC + ", BCLNTNM=" + BCLNTNM
				+ ", NA_DVY_PLASH_SLPNO=" + NA_DVY_PLASH_SLPNO + ", CCLNTNM="
				+ CCLNTNM + ", CNR_DT=" + CNR_DT + ", TRSLPNO=" + TRSLPNO
				+ ", RPY_PLA_DT=" + RPY_PLA_DT + ", GAM_AM=" + GAM_AM
				+ ", BYNG_VAT=" + BYNG_VAT + ", TOT_GAM=" + TOT_GAM
				+ ", CHRG_TOT=" + CHRG_TOT + ", VCBT_AM=" + VCBT_AM
				+ ", VCBX_AM=" + VCBX_AM + ", CBAM=" + CBAM + ", NA_TR_DSC="
				+ NA_TR_DSC + ", ROTS_CTR_DSC=" + ROTS_CTR_DSC
				+ ", MNGT_NA_TRPL_C=" + MNGT_NA_TRPL_C
				+ ", ACTL_BUYPL_NA_TRPL_C=" + ACTL_BUYPL_NA_TRPL_C
				...
				+ ", ADJ_NA_BZPLC=" + ADJ_NA_BZPLC + ", ADJ_NA_TRPL_C="
				+ ADJ_NA_TRPL_C + ", FSRGMN_ENO=" + FSRGMN_ENO + ", EDIRG_DTM="
				+ EDIRG_DTM + ", FS_RMS_DT=" + FS_RMS_DT + ", GWA_AM=" + GWA_AM
				+ ", GWA_VAT=" + GWA_VAT + ", LIQ_GAM=" + LIQ_GAM
				+ ", LIQ_VAT=" + LIQ_VAT + ", EXTX_AM=" + EXTX_AM + ", SMA_AM="
				+ SMA_AM + ", TOTAL_GAM_AM=" + TOTAL_GAM_AM
				+ ", TOTAL_BYNG_VAT=" + TOTAL_BYNG_VAT + ", TOTAL_TOT_GAM="
				+ TOTAL_TOT_GAM + ", TOTAL_CHRG_TOT=" + TOTAL_CHRG_TOT
				+ ", TOTAL_VCBT_AM=" + TOTAL_VCBT_AM + ", TOTAL_VCBX_AM="
				+ TOTAL_VCBX_AM + ", TOTAL_CBAM=" + TOTAL_CBAM
				+ ", TOTAL_COMP_FEE=" + TOTAL_COMP_FEE + ", TOTAL_BYNG_SSDY="
				+ TOTAL_BYNG_SSDY + ", TOTAL_ETR_AMN_FEE=" + TOTAL_ETR_AMN_FEE
				+ ", TOTAL_ETR_AMN_VAT=" + TOTAL_ETR_AMN_VAT
				+ ", TOTAL_SLGT_AMN_FEE=" + TOTAL_SLGT_AMN_FEE
				+ ", TOTAL_PHD_FEE=" + TOTAL_PHD_FEE + ", TOTAL_PHD_FEE_VAT="
				+ TOTAL_PHD_FEE_VAT + ", TOTAL_TRP_SVC_CST="
				+ TOTAL_TRP_SVC_CST + ", TOTAL_TRP_SVCOS_VAT="
				+ TOTAL_TRP_SVCOS_VAT + ", TOTAL_ETC_FEE=" + TOTAL_ETC_FEE
				+ ", TOTAL_ETC_FEE_VAT=" + TOTAL_ETC_FEE_VAT + "]";
	}
