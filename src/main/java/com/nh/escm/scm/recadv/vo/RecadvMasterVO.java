 ...
 *
 */
public class RecadvMasterVO implements Serializable{
	...
	private String PBDDLY_YN; // PB직송여부
	private String DVY_PLASH_CRT_DSC; // 배송예정서생성구분코드
	private String CNFM_YN; //확인여부
	...
	public String getPBDDLY_YN() {
		return PBDDLY_YN;
	}
	public void setPBDDLY_YN(String pBDDLY_YN) {
		PBDDLY_YN = pBDDLY_YN;
	}
	public String getDVY_PLASH_CRT_DSC() {
		return DVY_PLASH_CRT_DSC;
	}
	public void setDVY_PLASH_CRT_DSC(String dVY_PLASH_CRT_DSC) {
		DVY_PLASH_CRT_DSC = dVY_PLASH_CRT_DSC;
	}
