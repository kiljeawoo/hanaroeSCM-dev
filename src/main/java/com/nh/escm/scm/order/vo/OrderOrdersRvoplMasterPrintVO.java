 ...
 *
 */
public class OrderOrdersRvoplMasterPrintVO  implements Serializable{
	...
	private List<OrderOrdersRvoplDetailPrintVO> list;
	...
	public List<OrderOrdersRvoplDetailPrintVO> getList() {
		return list;
	}
	...
	public void setList(List<OrderOrdersRvoplDetailPrintVO> list) {
		this.list = list;
	}
