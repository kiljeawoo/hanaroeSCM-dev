 ...
 *
 */
public class OrderOrdersDailyMasterPrintVO  implements Serializable{
	...
	private String ODRPL_NA_TRPL_C;//발주처팀
	...
	private List<OrderOrdersDailyDetailPrintVO> list;
	...
	public List<OrderOrdersDailyDetailPrintVO> getList() {
		return list;
	}



	public void setList(List<OrderOrdersDailyDetailPrintVO> list) {
		this.list = list;
	}
