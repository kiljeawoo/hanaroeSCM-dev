...
public class DeliveryNoticeOrderVO  implements Serializable {
	...
	private String SRA_WRS_DSC;//축산상품구분
	private String NA_PAK_DSC;//축산포장구분
	private String SFP_BOX_DSC;//박스구분
	private String SRA_WK_DSC;//축산작업구분
	private Double DVY_WT;//배송중량
	private List<DeliveryNoticeOrderDetailVO> dnodVoList; /* 배송예정서 상세 */
	private String BYNG_UPR_MOD_YN;//매입단가수정여부
	...
	public void setNA_PAK_DSC(String nA_PAK_DSC) {
		NA_PAK_DSC = nA_PAK_DSC;
	}
	...
	public void setSFP_BOX_DSC(String sFP_BOX_DSC) {
		SFP_BOX_DSC = sFP_BOX_DSC;
	}
	...
	public void setSRA_WK_DSC(String sRA_WK_DSC) {
		SRA_WK_DSC = sRA_WK_DSC;
	}
	...
	public void setDVY_WT(Double dVY_WT) {
		DVY_WT = dVY_WT;
	}
