...
public class DeliveryNoticeOrderPrintVO implements Serializable {
	...
	private String SPYPL_BZTPNM;//공급처 업태
	private String SPYPL_BZCCNM;//공급처 종목
	private String DVYAA_BZTPNM;//배송처 업태
	private String DVYAA_BZCCNM;//배송처 종목
	private String BKG_EVT_DSC;
	private String DVYAA_ADDRESS;//배송처주소
	private String RMK_CNTN;//배송처
	private String DVY_WT;//총중량
	private String INDV_ID_NO;//개체식별번호
	private String NA_TRPL_SEAL_FLNM;//직인파일
	...
	public String getDVY_WT() {
		return DVY_WT;
	}
	public void setDVY_WT(String dVY_WT) {
		DVY_WT = dVY_WT;
	}
	...
	public String getDVYAA_ADDRESS() {
		return DVYAA_ADDRESS;
	}
	public void setDVYAA_ADDRESS(String dVYAA_ADDRESS) {
		DVYAA_ADDRESS = dVYAA_ADDRESS;
	}
	...
	public String getSPYPL_BZTPNM() {
		return SPYPL_BZTPNM;
	}
	public void setSPYPL_BZTPNM(String sPYPL_BZTPNM) {
		SPYPL_BZTPNM = sPYPL_BZTPNM;
	}
	public String getSPYPL_BZCCNM() {
		return SPYPL_BZCCNM;
	}
	public void setSPYPL_BZCCNM(String sPYPL_BZCCNM) {
		SPYPL_BZCCNM = sPYPL_BZCCNM;
	}
	public String getDVYAA_BZTPNM() {
		return DVYAA_BZTPNM;
	}
	public void setDVYAA_BZTPNM(String dVYAA_BZTPNM) {
		DVYAA_BZTPNM = dVYAA_BZTPNM;
	}
	public String getDVYAA_BZCCNM() {
		return DVYAA_BZCCNM;
	}
	public void setDVYAA_BZCCNM(String dVYAA_BZCCNM) {
		DVYAA_BZCCNM = dVYAA_BZCCNM;
	}
