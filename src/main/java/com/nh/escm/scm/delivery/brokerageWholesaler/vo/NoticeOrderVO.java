...
public class NoticeOrderVO implements Serializable {
	...
	private String DQPD_RSN_CNTN; /* 결품사유 */
	...
	public String getDQPD_RSN_CNTN() {
		return DQPD_RSN_CNTN;
	}




	public void setDQPD_RSN_CNTN(String dQPD_RSN_CNTN) {
		DQPD_RSN_CNTN = dQPD_RSN_CNTN;
	}
