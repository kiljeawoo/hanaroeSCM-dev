...
<title>Namo CrossEditor : Admin</title>
	<script type="text/javascript">var pe_xr="pe_QN"; </script>
...
<form method="post" id="adminSetForm" name="adminSetForm" action="manager_proc.jsp" onsubmit="return pe_ax();">
			...
			<td class="pe_hX">
				...
				<table id="Info">
					<tr>
						...
						<font style="font-size:14pt;color:#3e77c1;font-weight:bold;text-decoration:none;"><span id="pe_Fx"></span></font></td>
				...
				<table class="pe_nz">
					<tr>
						<td class="pe_aDK">				
							<ul>
								<li class="pe_mD pe_OK"><input type="button" id="setting_base" value="" style="width:110px;height:28px;" class="pe_wM pe_ht" /></li>
								<li class="pe_mD"><input type="button" id="setting_edit" value="" style="width:110px;height:28px;" class="pe_wM pe_ht" /></li>
								<li class="pe_mD"><input type="button" id="setting_view" value="" style="width:110px;height:28px;" class="pe_wM pe_ht" /></li>
								<li class="pe_mD"><input type="button" id="setting_ab" value="" style="width:110px;height:28px;" class="pe_wM pe_ht" /></li>
							</ul>
						
						</td>
					</tr>
					<tr>
						<td class="pe_oI pe_jm"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_LX"></span></font></td>
					</tr>
				</table>
			...
			<td class="pe_hX">
				<div id="pe_aho">
					<table class="pe_ws">
						<tr>
							<td>
								<table class="pe_eF"><tr><td class="pe_iC" colspan="3"></td></tr>
								</table>
							 
								<table class="pe_eF">
								
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Gs"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_FH"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Gd"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_EL"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
											<input type="text" id="ImageSavePath" class="pe_ma" name="ImageSavePath" value="<%=settingValue.get("ImageSavePath")%>" /> ex) http:// www.mysite.com/image
										</td>
									</tr>
									...
									<div id="pe_aqv">
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Fo"></span></b></td>
										<td class="pe_dX"></td>
										<td >
											<table class="pe_eF">
												<tr>
													<td class="pe_ek"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_Ud" value="real" /><span id="pe_FY"></span>
												...
												<tr>
													<td class="pe_ek"> &nbsp;&nbsp;
													<input type="radio" name="encodingStyle" id="pe_ahQ" value="trans" /><span id="pe_Gu"></span>
													</td>
												</tr>
												<tr>
													<td class = "pe_dU" colspan="3"></td>
												...
												<tr>
													<td class="pe_ek"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_aia" value="random" /><span id="pe_Mu"></span>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_JR"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek"> &nbsp;
											<input type="hidden" id="UploadFileSubDir" name ="UploadFileSubDir" value="<%=settingValue.get("UploadFileSubDir")%>" />
											<input type="radio" id="pe_Kq" name="pe_ajj" value="true" /><label for="pe_Kq"><span id="pe_Ji"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_JK" name="pe_ajj" value="false" /><label for="pe_JK"><span id="pe_Kd"></span></label>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_DO"></span></b></td>
										<td class="pe_dX"></td>
										<td >
											<table class="pe_eF">
												<tr>
													<td >&nbsp;&nbsp;<span id="pe_DV"></span></td>
													<td class="pe_dX"></td>
													<td class="pe_ek"><input type="text" id="Width" name="Width" class="pe_oj" maxlength="10" value="<%=settingValue.get("Width")%>" />
													px</td>
												</tr>
												<tr>
													<td class = "pe_dU" colspan="3"></td>
												...
												<tr>
													<td >&nbsp;&nbsp;<span id="pe_CU"></span></td>
													<td class="pe_dX"></td>
													<td class="pe_ek"><input type="text" id="Height" name="Height" class="pe_oj" maxlength="10" value="<%=settingValue.get("Height")%>" /> px
													</td>
												</tr>	
											</table>
										</td>
						...
						<tr>
							<td class="pe_oI pe_jm"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_KC"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_eF">
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ll"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_KT"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Jl"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_LU"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Mr"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_KS"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Jz"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_IZ"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Mk"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_EX"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
											<input type="text" id="DocBaseURL" name="DocBaseURL" class="pe_ma" value="<%=settingValue.get("DocBaseURL")%>" /> ex) http://www.mysite.com/doc.html 
										</td>
									</tr>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_OP"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_PX"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Pb"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_zE"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Qm"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Pc"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
											<input type="number" min="0" max="60" style="ime-mode:disabled;" id="AutoSavePeriod" name="AutoSavePeriod" class="pe_ma" value="<%=settingValue.get("AutoSavePeriod")%>" /><b><span id="pe_Ln"></span></b>&nbsp;&nbsp;<span id="pe_OT"></span>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_IH"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_QS"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr id="pe_aCu">
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_QU"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Rn"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
						...
						<tr>
							<td class="pe_oI pe_jm"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_IO"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_eF">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="AdminPageUploadFileExtBlockList"><span id="pe_Bj"></span></b></td>
										<td class="pe_dX"></td>
										<td>
											<table class="pe_eF">
												<input type="hidden" name="UploadImageFileExtBlockList" value="<%=settingValue.get("UploadImageFileExtBlockList")%>" />
												<tr>
													<td class="pe_ek"><input type="checkbox" id="UploadImageFileExtBlockListChecked" <%=settingValue.get("UploadImageFileExtBlockListChecked")%>/><span id="pe_pI"></span></td>
												</tr>
												<tr>
													<td class="pe_ek"><textarea id="UploadImageFileExtBlockListTextarea" cols="70" rows="2"><%=settingValue.get("UploadImageFileExtBlockListTextarea")%></textarea><br /><span id="pe_CW"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="AdminPageUploadFileExtBlockList"></span></b></td>
										<td class="pe_dX"></td>
										<td>
											<table class="pe_eF">
												<input type="hidden" name="UploadFileExtBlockList" value="<%=settingValue.get("UploadFileExtBlockList")%>" />
												<tr>
													<td class="pe_ek"><input type="checkbox" id="UploadFileExtBlockListChecked" <%=settingValue.get("UploadFileExtBlockListChecked")%>/><span id="pe_pI"></span></td>
												</tr>
												<tr>
													<td class="pe_ek"><textarea id="UploadFileExtBlockListTextarea" cols="70" rows="2"><%=settingValue.get("UploadFileExtBlockListTextarea")%></textarea><br /><span id="pe_CW"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_IY"></span></b></td>
										<td class="pe_dX"></td>
										<td >
											<table class="pe_eF">
												<input type="hidden" name="AttributeBlockList" value="<%=settingValue.get("AttributeBlockList")%>" />
												<tr>
													<td class="pe_ek"><input type="checkbox" id="AttributeBlockListChecked" <%=settingValue.get("AttributeBlockListChecked")%>/><span id="pe_pI"></span></td>
												</tr>
												<tr>
													<td class="pe_ek"><textarea id="AttributeBlockListTextarea" cols="70" rows="2"><%=settingValue.get("AttributeBlockListTextarea") %></textarea><br /><span id="pe_yt"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_MM"></span></b></td>
										<td class="pe_dX"></td>
										<td >
											<table class="pe_eF">
												<input type="hidden" name="TagBlockList" value="<%=settingValue.get("TagBlockList")%>" />
												<tr>
													<td class="pe_ek"><input type="checkbox" id="TagBlockListChecked" <%=settingValue.get("TagBlockListChecked")%>/><span id="pe_pI"></span></td>
												</tr>
												<tr>
													<td class="pe_ek"><textarea id="TagBlockListTextarea" cols="70" rows="2"><%=settingValue.get("TagBlockListTextarea") %></textarea><br /><span id="pe_yt"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
						...
						<tr>
							<td class="pe_oI pe_jm"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Or"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_eF" >
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Is"></span></b></td>
										<td class="pe_dX"></td>
										<td>
											<table class="pe_eF">
												<input type="hidden" name="Template" id="Template" value="<%=settingValue.get("Template")%>" />
												<tr>
													<td class="pe_ek"><input type="button" id="pe_aXd" value="+" onClick="pe_aM(this)"/></td>
													<td class="pe_ek">&nbsp;</td>
													<td class="pe_ek">&nbsp;</td>
												</tr>
											...
											for(int i=0; i<TemplateListArr.length ; i++){
												...
												if(TemplateListArr[i] == null || TemplateListArr[i] == ""){
													...
													%>
														<tr>
															<td><input type="text"  name="pe_adc"  value="<%=templateName %>" style="width:100px"/></td>
															<td><input type="text"  name="pe_anu"  value="<%=templateUrl %>" style="width:320px"/></td>
															<td><input type="text"  name="pe_ant"  value="<%=templateEncoding %>" style="width:90px"/><input type="button" value="-" onclick="pe_a(this)"/></td>
					...
					<table class="pe_ws">
						<tr>
							<td>
								...
								<table class="pe_eF">
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_LO"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_ZI" class="color{hash:true,valueElement:'FontColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="FontColor" name="FontColor" value="<%=settingValue.get("FontColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_hR">
											<input type="button" class="pe_jo pe_ht" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_ZI').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Li"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_LM"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_KX"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										...
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_My"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek"><input type="checkbox" id="ReturnKeyActionBRChecked" <%=settingValue.get("ReturnKeyActionBRChecked")%>/><label for="ReturnKeyActionBR"><span id="pe_Mx"></span></label></td>
									</tr>
									<tr>
										<td class="pe_dU" colspan="3"></td>
									</tr>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Pj"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Rg"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Rc"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
								...
								<table class="pe_eF">
									<tr>
										<td class="pe_oI pe_jm"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Bj"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ms"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_acy" class="color{hash:true,valueElement:'ImgLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="ImgLineColor" name="ImgLineColor" value="<%=settingValue.get("ImgLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_hR">
											<input type="button" class="pe_jo pe_ht" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_acy').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
								...
								<table class="pe_eF">				
									<tr>
										<td class="pe_oI pe_jm"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_KL"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Nk"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_aeX" class="color{hash:true,valueElement:'TableLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="TableLineColor" name="TableLineColor" value="<%=settingValue.get("TableLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_hR">
											<input type="button" class="pe_jo pe_ht" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_aeX').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_LH"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_afn" class="color{hash:true,valueElement:'TableBGColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="TableBGColor" name="TableBGColor" value="<%=settingValue.get("TableBGColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_hR">
											<input type="button" class="pe_jo pe_ht" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_afn').color.fromString('#FFFFFF');">
											</li>
											</ul></td>
											</tr>
											</table>
					...
					<table class="pe_ws">
						<tr>
							<td>
								...
								<table class="pe_eF">
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_KV"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_OY"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ff"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
											<input type="text" id="Css" name="Css" class="pe_ma" value="<%=settingValue.get("Css")%>" />  ex) http://www.mysite.com/common.css 
										</td>
									</tr>
									<tr>
										<td class="pe_dU" colspan="3"></td>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Hq"></span></b>
										...
										<td >
											<table class="pe_eF">
												<tr>
													<td class="pe_vQ">&nbsp;&nbsp;<span id="pe_Ku"></span></td>
													<td class="pe_dX"></td>
													<td class="pe_ek">
														<input type="text" id="outlinecolor" name="outlinecolor" class="pe_vG" value="" />  ex) #000000 or black 
													</td>
												</tr>
												<tr>
													<td class="pe_dU" colspan="3"></td>
												...
												<tr>
													<td class="pe_vQ">&nbsp;&nbsp;<span id="pe_Lz"></span></td>
													<td class="pe_dX"></td>
													<td class="pe_ek">
														<input type="text" id="innerlineColor" name="innerlineColor" class="pe_vG" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_dU" colspan="3"></td>
												...
												<tr>
													<td class="pe_vQ">&nbsp;&nbsp;<span id="pe_KK"></span></td>
													<td class="pe_dX"></td>
													<td class="pe_ek">
														<input type="text" id="skinfontColor" name="skinfontColor" class="pe_vG" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_dU" colspan="3"></td>
												...
												<tr>
													<td class="pe_vQ">&nbsp;&nbsp;<span id="pe_Hk"></span></td>
													<td class="pe_dX"></td>
													<td class="pe_ek">
														<input type="text" id="toolbarBackgroundColor" name="toolbarBackgroundColor" class="pe_vG" value="" />
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Lw"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
											<input type="hidden" id="CreateTab" name ="CreateTab" value="<%=settingValue.get("CreateTab")%>" />
											<input type="checkbox" id="pe_GE" name="pe_yU" value="0" /><label for="pe_GE"><span id="wysiwyg"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_IE" name="pe_yU" value="1" /><label for="pe_IE"><span id="html"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_Fm" name="pe_yU" value="2" /><label for="pe_Fm"><span id="preview"></span></label>
										</td>
									</tr>
								</table>
						...
						<tr>
							<td class="pe_oI pe_jm"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Hj"></span></font></td>
						</tr>
						<tr>
							<td>
								<table class="pe_eF"><tr><td class="pe_iC" colspan="3"></td></tr>
								...
								<table class="pe_eF">
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Jp"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
							...
							<tr>
								<td>
									<table class="pe_eF">
										...
										<tr>
											<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Jn"></span></b></td>
											<td class="pe_dX"></td>
											<td>
												<table class="pe_eF">
													<tr>
														<td class="pe_wc" >&nbsp;&nbsp;<span id="pe_Ka"></span></td>
														<td class="pe_dX"></td>
														<td class="pe_ek">
															<input type="text" id="AdminPageUserMenuIdInput" name="AdminPageUserMenuIdInput" class="pe_ma" value="" /> 
														</td>
													</tr>
													<tr>
														<td class="pe_dU" colspan="3"></td>
													...
													<tr>
														<td class="pe_wc">&nbsp;&nbsp;<span id="pe_Jw"></span></td>
														<td class="pe_dX"></td>
														<td class="pe_ek">
															<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_QI" value="function" /><label for="pe_QI"><span id="pe_KB"></span></label>&nbsp;&nbsp;<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_Sa" value="plugin" /><label for="pe_Sa"><span id="pe_Hi"></span></label>
														</td>
													</tr>
													<tr>
														<td class="pe_dU" colspan="3"></td>
													...
													<tr>
														<td class="pe_wc">&nbsp;&nbsp;<span id="pe_JF"></span></td>
														<td class="pe_dX"></td>
														<td class="pe_ek" height="50px">
															<input type="text" id="AdminPageUserMenuButtonImgPathInput" name="AdminPageUserMenuButtonImgPathInput" class="pe_ma" value="" />
													...
													<tr>
														<td class="pe_wc">&nbsp;&nbsp;<span id="pe_GZ"></span></td>
														<td class="pe_dX"></td>
														<td class="pe_ek">	
															<input type="text" id="AdminPageUserMenuTitleInput" name="AdminPageUserMenuTitleInput" class="pe_ma" value="" />
														</td>
													</tr>
												</table>
											</td>
											<td class="pe_dX"></td>
											<td style="text-align:center;vertical-align:middle;"><input type="button" id="pe_BH" value="" class="" style="width:60px;height:60px;"/>
											</td>
										</tr>
										<tr>
											<td class="pe_dU" colspan="5"></td>
										...
										<tr>
											<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ik"></span></b></td>
											<td class="pe_dX"></td>
									...
									<table>
										<tr>
											<td id="pe_aFB">
												...
												<div id="pe_apU" >
													<span id="pe_AL"></span> <br> 
													<span id="pe_Dc"></span><br>
													<span id="pe_BO"></span><br>
												</div>
											</td>
											<td id="pe_aDT">
											...
											<td valign="bottom">
												<ul style="margin:0 auto;width:340px;">
													<li class="pe_hR">
														<input type="button" id="spacebar" value="" class="pe_jo pe_ht" style="width:80px;height:26px;" />
													</li>
													<li class="pe_hR"><input type="button" id="space" value="" class="pe_jo pe_ht" style="width:68px;height:26px;"></li>
													<li class="pe_hR"><input type="button" id="enter" value="" class="pe_jo pe_ht" style="width:66px;height:26px;"></li>
												</ul>
											</td>
										</tr>
										<tr>
					...
					<table class="pe_ws">
						<tr>
							<td>
								...
								<table class="pe_eF">
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_KO"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
											<input type="text" id="DocTitle" name="DocTitle" class="pe_ma" value="<%=settingValue.get("DocTitle")%>" />
										</td>
									</tr>
									<tr>
										<td class="pe_dU" colspan="3"></td>
									...
									<tr>
										<td class="pe_ei">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_JY"></span></b></td>
										<td class="pe_dX"></td>
										<td class="pe_ek">
											<input type="hidden" id="AccessibilityOption" name ="AccessibilityOption" value="<%=settingValue.get("AccessibilityOption")%>" />
											<input type="radio" id="pe_Qw" name="pe_Fw" value="0" /><label for="pe_Qw"><span id="pe_JE"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_Rp" name="pe_Fw" value="1" /><label for="pe_Rp"><span id="pe_IM"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_RS" name="pe_Fw" value="2" /><label for="pe_RS"><span id="pe_JQ"></span></label>
										</td>
									</tr>
									<tr>
										<td class="pe_dU" colspan="3"></td>
