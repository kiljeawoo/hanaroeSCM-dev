...
<%
	...
	{	
			...
			{
				session.invalidate(); 
				result_sc = "<script>alert(NamoSELang.pe_xT);window.document.location.href='../index.html';</script>";
			}
			else
			{
		...
		result_sc = "<script>alert(NamoSELang.pe_Cj);location.href='account_setting.jsp';</script>";
	}
