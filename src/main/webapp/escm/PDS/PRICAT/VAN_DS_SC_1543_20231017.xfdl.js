    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,893,3358);
            }
            ...
            obj = new Static("Static22", "absolute", "793", "3245", null, "24", "15", null, this);
            ...
            obj = new Button("btn_save01", "absolute", null, "3299", "92", "21", "15", null, this);
            obj.set_text("신청");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_enable("false");
            obj.set_tabstop("false");
            ...
            obj = new Static("stc_no_b01", "absolute", "109", "2222", null, "29", "15", null, this);
            obj.set_cssclass("sta_WF_Labelbg");
            obj.set_taborder("91");
            this.addChild(obj.name, obj);

            obj = new Static("stc_namo_msg", "absolute", "8", "2602", "685", "21", null, null, this);
            obj.set_text("※ 툴바(도구모음)의 그림 버튼을 선택하여 업로드 할 수 있습니다. 상세내용 이미지는 최대 5개까지 업로드 가능합니다.");
            obj.style.set_color("darkblue");
            obj.set_taborder("99");
            this.addChild(obj.name, obj);

            obj = new Static("stc_no_info_01", "absolute", "0", "2222", "110", "29", null, null, this);
            obj.set_text("품목");
            obj.set_cssclass("sta_WF_Label");
            ...
            obj = new Combo("cbo_wrs_ntfy", "absolute", "115", "2226", "365", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stc_namo_msg01", "absolute", "495", "2226", "258", "21", null, null, this);
            obj.set_text("※ 취급 상품에 해당하는 고시 품목을 선택");
            obj.style.set_color("blue");
            obj.set_taborder("190");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_wrs_nfty_hdng", "absolute", "0", "2250", null, "196", "15", null, this);
            ...
            obj = new Static("stc_namo_msg04", "absolute", "205", "2485", "650", "42", null, null, this);
            ...
            obj = new Static("stc_img_b04", "absolute", "136", "2526", null, "29", "15", null, this);
            obj.set_cssclass("sta_WF_Labelbg");
            obj.set_taborder("96");
            this.addChild(obj.name, obj);

            obj = new Static("Static24", "absolute", "0", "2500", "180", "21", null, null, this);
            obj.set_text("라벨(상품표시사항) 이미지");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.set_taborder("93");
            this.addChild(obj.name, obj);

            obj = new Static("stc_namo_msg02", "absolute", "153", "2581", "232", "21", null, null, this);
            obj.set_text("※ 이미지 사이즈 : 900~1000*무제한");
            obj.style.set_color("blue");
            obj.set_taborder("98");
            this.addChild(obj.name, obj);

            obj = new Button("btn_atch_del12", "absolute", "395", "2530", "56", "21", null, null, this);
            obj.set_text("삭제");
            obj.set_taborder("191");
            obj.set_tabstop("false");
            this.addChild(obj.name, obj);

            obj = new FileUpload("FileUpload12", "absolute", "139", "2530", "253", "21", null, null, this);
            ...
            obj = new Static("stc_wrs_img_04", "absolute", "0", "2526", "137", "29", null, null, this);
            ...
            obj = new Static("Static37", "absolute", "0", "2581", "248", "21", null, null, this);
            ...
            obj = new Static("Static23", "absolute", "0", "2197", "150", "21", null, null, this);
            ...
            obj = new Static("sta_file_data12", "absolute", "505", "2530", "88", "21", null, null, this);
            obj.set_visible("false");
            ...
            obj = new WebBrowser("wb_namo", "absolute", "9", "2620", null, "650", "6", null, this);
            ...
            //-- Default Layout
            obj = new Layout("default", "", 893, 3358, this,
            	//-- Layout function
            	function(p) {
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1543_20231017.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1543_20231017.xfdl", function() {
        ...
        this.loadIncludeScript("VAN_DS_SC_1543_20231017.xfdl");
