(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("stc_namo_msg", "absolute", "8", "2922", "685", "21", null, null, this);
            ...
            obj = new WebBrowser("wb_namo", "absolute", "9", "2940", null, "650", "6", null, this);
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1543_20230926_copy.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1543_20230926_copy.xfdl", function() {
        ...
        this.loadIncludeScript("VAN_DS_SC_1543_20230926_copy.xfdl");
