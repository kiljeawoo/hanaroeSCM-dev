(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("cbo_div_list01", "absolute", "548", "564", "104", "21", null, null, this);
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1543_20231103.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1543_20231103.xfdl", function() {
        ...
        // 			},
        	...
        	this.cbo_div_list01.set_value(""); // 포장
        ...
        this.fn_makeWrsName = function()
        {
        	...
        	// 포장
        	if (!this.gfn_isNull(this.cbo_div_list01.value)) {
        		name += "/" + this.cbo_div_list01.text;
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.cbo_div_list01.addEventHandler("onitemchanged", this.fn_makeWrsName, this);

        };

        this.loadIncludeScript("VAN_DS_SC_1543_20231103.xfdl");
