(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static25", "absolute", "0", "2136", "160", "29", null, null, this);
            ...
            obj = new Static("Static26", "absolute", "159", "2136", null, "29", "15", null, this);
            obj.set_cssclass("sta_WF_Labelbg");
            obj.set_taborder("84");
            this.addChild(obj.name, obj);

            obj = new FileUpload("FileUpload14", "absolute", "163", "2140", "431", "21", null, null, this);
            obj.getSetter("retry").set("0");
            obj.set_tabstop("true");
            ...
            obj = new Button("btn_atch_del14", "absolute", "598", "2140", "51", "21", null, null, this);
            obj.set_text("삭제");
            obj.style.set_imagealign("center middle");
            ...
            obj = new Static("sta_file_data14", "absolute", "677", "2140", "88", "21", null, null, this);
            obj.set_visible("false");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1543_before_editer_patch.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1543_before_editer_patch.xfdl", function() {
        ...
        this.loadIncludeScript("VAN_DS_SC_1543_before_editer_patch.xfdl");
