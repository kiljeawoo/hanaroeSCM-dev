(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_list", "absolute", "0", "105", null, null, "15", "42", this);
            obj.set_taborder("5");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"198\"/><Column size=\"139\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell/><Cell col=\"1\" text=\"순번\"/><Cell col=\"2\" text=\"첨부서류\"/><Cell col=\"3\" text=\"제출여부\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:SYSTEMFILENAME == null ? &quot;none&quot; : &quot;checkbox&quot;\" edittype=\"expr:SYSTEMFILENAME == null ? &quot;none&quot; : &quot;checkbox&quot;\"/><Cell col=\"1\" text=\"expr:currow+1\"/><Cell col=\"2\" text=\"bind:ATCHNAME\"/><Cell col=\"3\" displaytype=\"expr:SYSTEMFILENAME == null ? &quot;normal&quot; : SYSTEMFILENAME == '2daysOver'?'normal':&quot;button&quot;\" text=\"expr:SYSTEMFILENAME == null ? &quot;미첨부&quot; : SYSTEMFILENAME == '2daysOver'?'삭제':&quot;다운로드&quot;\" autosizerow=\"limitmin\"/></Band></Format></Formats>");
            this.div_list.addChild(obj.name, obj);
            ...
            this.div_list.addChild(obj.name, obj);
            obj = new Static("Static02", "absolute", "125", "294", "609", "21", null, null, this.div_list);
            obj.set_taborder("11");
            obj.set_text("업로드된 파일들은 업로드일 기준 2일후 삭제됩니다.");
            ...
            this.div_list.addChild(obj.name, obj);
            obj = new Button("btn_toggle00", "absolute", "46.07%", "-20", "62", "12", null, null, this.div_list);
            obj.set_taborder("9");
            obj.set_cssclass("btn_WFSA_SearchClose");
            this.div_list.addChild(obj.name, obj);
            obj = new Button("btn_toggle01", "absolute", "46.07%", "0", "62", "12", null, null, this.div_list);
            obj.set_taborder("12");
            obj.set_cssclass("btn_WFSA_SearchClose");
            this.div_list.addChild(obj.name, obj);

            obj = new Div("div_search", "absolute", "0", "29", null, "76", "15", null, this);
            obj.set_taborder("8");
            ...
            cbo_resDsc_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">all</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">신청중</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">신청완료</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">승인</Col></Row><Row><Col id=\"codecolumn\">4</Col><Col id=\"datacolumn\">반려</Col></Row></Rows>");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1561.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1561.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_list.btn_toggle01.addEventHandler("onclick", this.div_list_btn_toggle00_onclick, this);
        ...
        this.loadIncludeScript("VAN_DS_SC_1561.xfdl");
