(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_atch_old", "absolute", "0", "2268", null, "177", "15", null, this);
            ...
            obj = new Div("div_menu", "absolute", "0", "0", null, "65", "2", null, this);
            obj.set_text("Div01");
            obj.set_taborder("0");
            ...
            obj = new Static("sta_pagename07", "absolute", "0", "2213", "129", "21", null, null, this);
            obj.set_text("첨부서류");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.set_taborder("85");
            this.addChild(obj.name, obj);

            obj = new Static("sta_result01", "absolute", "0", "2234", "842", "21", null, null, this);
            ...
            obj = new Static("Static11", "absolute", "0", "2108", "160", "29", null, null, this);
            ...
            obj = new Static("Static13", "absolute", "159", "2108", null, "29", "15", null, this);
            obj.set_cssclass("sta_WF_Labelbg");
            obj.set_taborder("80");
            this.addChild(obj.name, obj);
            ...
            obj = new FileUpload("FileUpload03", "absolute", "163", "2112", "431", "21", null, null, this);
            obj.getSetter("retry").set("0");
            obj.set_tabstop("true");
            ...
            obj = new Button("btn_atch_del03", "absolute", "598", "2112", "51", "21", null, null, this);
            obj.set_text("삭제");
            obj.style.set_imagealign("center middle");
            ...
            obj = new Static("sta_file_data3", "absolute", "677", "2112", "88", "21", null, null, this);
            obj.set_visible("false");
            ...
            obj = new Static("Static22", "absolute", "793", "3565", null, "24", "15", null, this);
            ...
            obj = new Button("btn_save01", "absolute", null, "3619", "92", "21", "15", null, this);
            obj.set_text("신청");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_enable("false");
            obj.set_tabstop("false");
            ...
            obj = new Static("stc_no_b01", "absolute", "109", "2542", null, "29", "15", null, this);
            obj.set_cssclass("sta_WF_Labelbg");
            obj.set_taborder("91");
            this.addChild(obj.name, obj);

            obj = new Static("stc_namo_msg", "absolute", "0", "2922", "685", "21", null, null, this);
            obj.set_text("※ 툴바(도구모음)의 그림 버튼을 선택하여 업로드 할 수 있습니다. 상세내용 이미지는 최대 5개까지 업로드 가능합니다.");
            obj.style.set_color("darkblue");
            obj.set_taborder("99");
            this.addChild(obj.name, obj);

            obj = new Static("stc_no_info_01", "absolute", "0", "2542", "110", "29", null, null, this);
            obj.set_text("품목");
            obj.set_cssclass("sta_WF_Label");
            ...
            obj = new Combo("cbo_wrs_ntfy", "absolute", "115", "2546", "365", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stc_namo_msg01", "absolute", "495", "2546", "258", "21", null, null, this);
            obj.set_text("※ 취급 상품에 해당하는 고시 품목을 선택");
            obj.style.set_color("blue");
            obj.set_taborder("190");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_wrs_nfty_hdng", "absolute", "0", "2570", null, "196", "15", null, this);
            ...
            obj = new Static("stc_namo_msg04", "absolute", "205", "2805", "650", "42", null, null, this);
            ...
            obj = new Static("stc_img_b04", "absolute", "136", "2846", null, "29", "15", null, this);
            obj.set_cssclass("sta_WF_Labelbg");
            obj.set_taborder("96");
            this.addChild(obj.name, obj);

            obj = new WebBrowser("wb_namo", "absolute", "3", "2940", null, "650", "12", null, this);
            obj.set_enable("false");
            obj.set_taborder("100");
            this.addChild(obj.name, obj);

            obj = new Static("Static24", "absolute", "0", "2820", "180", "21", null, null, this);
            obj.set_text("라벨(상품표시사항) 이미지");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.set_taborder("93");
            this.addChild(obj.name, obj);

            obj = new Static("stc_namo_msg02", "absolute", "153", "2901", "232", "21", null, null, this);
            obj.set_text("※ 이미지 사이즈 : 900~1000*무제한");
            obj.style.set_color("blue");
            obj.set_taborder("98");
            this.addChild(obj.name, obj);

            obj = new Button("btn_atch_del12", "absolute", "395", "2850", "56", "21", null, null, this);
            obj.set_text("삭제");
            obj.set_taborder("191");
            obj.set_tabstop("false");
            this.addChild(obj.name, obj);

            obj = new FileUpload("FileUpload12", "absolute", "139", "2850", "253", "21", null, null, this);
            ...
            obj = new Static("stc_wrs_img_04", "absolute", "0", "2846", "137", "29", null, null, this);
            ...
            obj = new Static("Static37", "absolute", "0", "2901", "248", "21", null, null, this);
            ...
            obj = new Static("Static23", "absolute", "0", "2517", "150", "21", null, null, this);
            ...
            obj = new Static("sta_file_data12", "absolute", "505", "2850", "88", "21", null, null, this);
            obj.set_visible("false");
            ...
            obj = new Static("Static12", "absolute", "0", "2136", "160", "29", null, null, this);
            obj.set_text("상세 이미지");
            obj.set_cssclass("sta_WF_Label");
            obj.style.set_padding("2 7 0 7");
            obj.set_taborder("81");
            ...
            obj = new Static("Static17", "absolute", "159", "2136", null, "29", "15", null, this);
            obj.set_cssclass("sta_WF_Labelbg");
            obj.set_taborder("82");
            this.addChild(obj.name, obj);

            obj = new Static("Static25", "absolute", "0", "2164", "160", "29", null, null, this);
            ...
            obj = new Static("Static26", "absolute", "159", "2164", null, "29", "15", null, this);
            obj.set_cssclass("sta_WF_Labelbg");
            obj.set_taborder("84");
            this.addChild(obj.name, obj);

            obj = new FileUpload("FileUpload13", "absolute", "163", "2140", "431", "21", null, null, this);
            obj.getSetter("retry").set("0");
            obj.set_tabstop("true");
            ...
            obj = new FileUpload("FileUpload14", "absolute", "163", "2168", "431", "21", null, null, this);
            obj.getSetter("retry").set("0");
            obj.set_tabstop("true");
            ...
            obj = new Button("btn_atch_del13", "absolute", "598", "2140", "51", "21", null, null, this);
            obj.set_text("삭제");
            obj.style.set_imagealign("center middle");
            ...
            obj = new Button("btn_atch_del14", "absolute", "598", "2168", "51", "21", null, null, this);
            obj.set_text("삭제");
            obj.style.set_imagealign("center middle");
            ...
            obj = new Static("sta_file_data13", "absolute", "677", "2140", "88", "21", null, null, this);
            obj.set_visible("false");
            obj.set_taborder("199");
            this.addChild(obj.name, obj);

            obj = new Static("sta_file_data14", "absolute", "677", "2168", "88", "21", null, null, this);
            obj.set_visible("false");
            ...
            obj = new Div("div_atch_new", "absolute", "0", "2268", null, "212", "15", null, this);
            obj.set_visible("true");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1543_20230718.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1543_20230718.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//this.make_gds_alcoholic_drink_biz_place();
        	
        	// Remove common event from the hide button and attach the private event.
        	document.getElementById(application.mainframe.VFrameSet0.HFrameSet0.VFrameSet1.FrameSet0['02009005'].form.btn_LFOpen._unique_id)
        		.addEventListener('click',function (){increase_header_marginLeft(obj)});
        	document.getElementById(application.mainframe.VFrameSet0.HFrameSet0.VFrameSet1.FrameSet0['02009005'].form.btn_LFClose._unique_id)
        		.addEventListener('click',function (){decrease_header_marginLeft(obj)});
        	...
        	//상단 버튼 고정
        	//신규상품등록
        	document.getElementById(obj.div_menu._unique_id).style.position='fixed';
        	document.getElementById(obj.div_menu._unique_id).style.marginTop = '110px';
        	document.getElementById(obj.div_menu._unique_id).style.zIndex = '3';
        	document.getElementById(obj.div_menu._unique_id).style.marginLeft = '200px';
        	
        	//코리안넷 상품정보 불러오기 버튼
        	document.getElementById(obj.btn_load_kornet._unique_id).style.position='fixed';
        	document.getElementById(obj.btn_load_kornet._unique_id).style.marginTop = '110px';
        	document.getElementById(obj.btn_load_kornet._unique_id).style.zIndex = '3';
        	document.getElementById(obj.btn_load_kornet._unique_id).style.marginLeft = '200px';
        	
        	//초기화 버튼
        	document.getElementById(obj.btn_clear02._unique_id).style.position='fixed';
        	document.getElementById(obj.btn_clear02._unique_id).style.marginTop = '110px';
        	document.getElementById(obj.btn_clear02._unique_id).style.zIndex = '3';
        	document.getElementById(obj.btn_clear02._unique_id).style.marginLeft = '200px';
        	
        	//신청 버튼
        	document.getElementById(obj.btn_save00._unique_id).style.position='fixed';
        	document.getElementById(obj.btn_save00._unique_id).style.marginTop = '110px';
        	document.getElementById(obj.btn_save00._unique_id).style.zIndex = '3';
        	document.getElementById(obj.btn_save00._unique_id).style.marginLeft = '200px';
        	
        	// 안내표시
        	document.getElementById(obj.stc_namo_msg03._unique_id).style.position='fixed';
        	document.getElementById(obj.stc_namo_msg03._unique_id).style.marginTop = '110px';
        	document.getElementById(obj.stc_namo_msg03._unique_id).style.zIndex = '3';
        	document.getElementById(obj.stc_namo_msg03._unique_id).style.marginLeft = '200px';
        }
        ...
        this.edt_gtin_onkeydown = function(obj,e)
        {
         ...
         //decrease header marginLeft when click menu-hide button
        function decrease_header_marginLeft (obj,e){
        	console.log('decrease_header_marginLeft')
        	document.getElementById(obj.div_menu._unique_id).style.marginLeft = '0px';
        	document.getElementById(obj.btn_load_kornet._unique_id).style.marginLeft = '0px';
        	document.getElementById(obj.btn_clear02._unique_id).style.marginLeft = '0px';
        	document.getElementById(obj.btn_save00._unique_id).style.marginLeft = '0px';
        	document.getElementById(obj.stc_namo_msg03._unique_id).style.marginLeft = '0px';
        }

        //increase header marginLeft when click menu-hide button
        function increase_header_marginLeft (obj,e){
        	console.log('increase_header_marginLeft')
        	document.getElementById(obj.div_menu._unique_id).style.marginLeft = '200px';
        	document.getElementById(obj.btn_load_kornet._unique_id).style.marginLeft = '200px';
        	document.getElementById(obj.btn_clear02._unique_id).style.marginLeft = '200px';
        	document.getElementById(obj.btn_save00._unique_id).style.marginLeft = '200px';
        ...
        this.loadIncludeScript("VAN_DS_SC_1543_20230718.xfdl");
