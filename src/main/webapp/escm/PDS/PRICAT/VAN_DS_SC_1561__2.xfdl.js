(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.addChild(obj.name, obj);
            obj = new Grid("grd_main", "absolute", "0", "12", null, "220", "0", null, this.div_list);
            obj.set_taborder("4");
            ...
            obj.set_taborder("11");
            obj.set_text("2일이 경과되어 파일의 다운로드가 불가합니다.");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1561__2.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1561__2.xfdl", function() {
        ...
        {
        	trace('form_onload');
        	console.log(application.gv_glnCode);//gln 값 그냥 얘 찍어주면 됨.
        ...
        {
        	trace('btn_search00_onclick');
        	console.log(application.gv_glnCode);
        ...
        {
            /*
            console.log(this.ds_main_req.rowcount);
            console.log(this.ds_main_req.getColumn(this.ds_main_req.rowcount-1,"REQ_DT")); 
            */
        ...
        //      console.log(colDate);
        //      console.log(nowDate);
        //      console.log(colDate<nowDate);
             
                        	
        //      if(colDate<nowDate){
        //         trace('이틀 지났다!!!!');
        //         alert('등록요청 후 2일이 지난 파일은 확인 및 다운로드가 불가 합니다.');
        //         this.div_list.grd_detail.set_nodatatext('등록요청 후 2일이 지난 파일은 확인 및 다운로드가 불가 합니다.');
        //         return;
        //       }
        ...
        this.loadIncludeScript("VAN_DS_SC_1561__2.xfdl");
