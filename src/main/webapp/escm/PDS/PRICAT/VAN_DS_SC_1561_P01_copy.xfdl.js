(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_cssclass("WF_Essential");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_NA_SPYPL_NM", "absolute", "230", "745", "77", "21", null, null, this.div_search);
            obj.set_enable("true");
            obj.set_taborder("290");
            obj.set_cssclass("WF_Essential");
            this.div_search.addChild(obj.name, obj);
            obj = new Button("btn_search_SPYPL", "absolute", "312", "745", "36", "21", null, null, this.div_search);
            ...
            obj.style.set_font("9 Gulim");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_NA_SPYPL_TEAM_NM", "absolute", "356", "745", "70", "21", null, null, this.div_search);
            obj.set_taborder("297");
            obj.set_enable("false");
            obj.set_visible("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_NA_SPYPL_TEAM_C", "absolute", "356", "745", "70", "21", null, null, this.div_search);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","div_search.edt_search_wrs03","value","ds_wrs_rg_req_lg","PLTPE_SGNO");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item58","div_search.edt_search_wrs04","value","ds_wrs_rg_req_lg","PLTPE_LYNO");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item59","div_search.edt_search_wrs05","value","ds_wrs_rg_req_lg","SEL_UPR");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item153","div_search.edt_search_wrs06","value","ds_wrs_rg_req_lg","BYNG_UPR");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item162","div_search.edt_search_wrs08","value","ds_wrs_rg_req_lg","WRS_HGHT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item163","div_search.edt_search_wrs09","value","ds_wrs_rg_req_lg","LEN_LEN");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item164","div_search.edt_search_wrs10","value","ds_wrs_rg_req_lg","WDTH_LEN");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item171","div_search.edt_search_wrs11","value","ds_wrs_rg_req_lg","BOX_BULK");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item173","div_search.edt_search_wrs12","value","ds_wrs_rg_req_lg","BOX_WT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item5","div_search.edt_NA_SPYPL_C","value","ds_wrs_rg_req_lg","NA_SPYPL_C");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item99","div_search.BOX_WRS_YN","value","ds_wrs_rg_req_lg","BOX_WRS_YN");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item6","div_search.edt_search_wrs02","value","ds_wrs_rg_req_lg","PLTPE_BOX_CN");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item179","div_search.edt_NA_SPYPL_TEAM_C","value","ds_wrs_rg_req_lg","NA_SPYPL_TEAM_C");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1561_P01_copy.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1561_P01_copy.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.edt_NA_SPYPL_C.addEventHandler("onkeydown", this.edt_NA_SPYPL_C_onkeydown, this);
            this.div_search.edt_NA_SPYPL_NM.addEventHandler("onkeydown", this.edt_NA_SPYPL_NM_onkeydown, this);
            this.div_search.edt_NA_SPYPL_NM.addEventHandler("oneditclick", this.div_search_edt_NA_SPYPL_NM_oneditclick, this);
            this.div_search.btn_search_SPYPL.addEventHandler("onclick", this.btn_search_SPYPL_onclick, this);
        ...
        this.loadIncludeScript("VAN_DS_SC_1561_P01_copy.xfdl");
