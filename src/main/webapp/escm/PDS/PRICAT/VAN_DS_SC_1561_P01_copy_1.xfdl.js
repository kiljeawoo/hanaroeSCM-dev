    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,880,1354);
            }
            ...
            obj.style.set_padding("2 7 0 7");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_data15", "absolute", "113", "196", "122", "21", null, null, this.div_search);
            ...
            obj.set_readonly("true");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_data16", "absolute", "240", "196", "137", "21", null, null, this.div_search);
            ...
            obj = new Edit("Edit00", "absolute", "148", "1044", "373", "21", null, null, this);
            ...
            //-- Default Layout
            obj = new Layout("default", "", 880, 1354, this,
            	//-- Layout function
            	function(p) {
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item29","div_search.edt_search_wrs02","value","ds_detail","파렛트당박스수");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item33","div_search.edt_search_wrs03","value","ds_detail","파렛트당단수");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1561_P01_copy_1.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1561_P01_copy_1.xfdl", function() {
        ...
        this.loadIncludeScript("VAN_DS_SC_1561_P01_copy_1.xfdl");
