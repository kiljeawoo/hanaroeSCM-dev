(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_readonly("true");
            obj.set_direction("vertical");
            obj = new Grid("grd_wrs_nfty_hdng", "absolute", "0", "1000", null, "196", "0", null, this.div_search);
            ...
            this.div_search.addChild(obj.name, obj);
            obj = new Static("stc_no_b01", "absolute", "109", "972", null, "29", "0", null, this.div_search);
            obj.set_taborder("273");
            obj.set_cssclass("sta_WF_Labelbg");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("stc_no_info_01", "absolute", "0", "972", "110", "29", null, null, this.div_search);
            obj.set_taborder("274");
            obj.set_text("품목");
            obj.set_cssclass("sta_WF_Label");
            obj.style.set_color("#222222ff");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static17", "absolute", "0", "945", "150", "21", null, null, this.div_search);
            ...
            obj.set_visible("true");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_day02", "absolute", "113", "976", "365", "21", null, null, this.div_search);
