(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"REPMNM\" type=\"STRING\" size=\"256\"/><Column id=\"MB_ID\" type=\"STRING\" size=\"256\"/><Column id=\"BIRTH\" type=\"STRING\" size=\"256\"/><Column id=\"SEX_DSC\" type=\"STRING\" size=\"256\"/><Column id=\"HP1\" type=\"STRING\" size=\"256\"/><Column id=\"HP2\" type=\"STRING\" size=\"256\"/><Column id=\"HP3\" type=\"STRING\" size=\"256\"/><Column id=\"USR_EMAIL01\" type=\"STRING\" size=\"256\"/><Column id=\"USR_EMAIL02\" type=\"STRING\" size=\"256\"/><Column id=\"MB_PW1\" type=\"STRING\" size=\"256\"/><Column id=\"MB_PW2\" type=\"STRING\" size=\"256\"/><Column id=\"USR_TPC\" type=\"STRING\" size=\"256\"/><Column id=\"CHRG_BSNNM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static120", "absolute", "0", "409", "711", "58", null, null, this.Div05);
            obj.set_taborder("34");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div05.addChild(obj.name, obj);
            ...
            obj.set_text("-");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static119", "absolute", "0", "409", "120", "58", null, null, this.Div05);
            obj.set_taborder("51");
            obj.set_text("회원권한");
            obj.set_cssclass("sta_WF_Label");
            this.Div05.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chk_WEBHARD_AUTH", "absolute", "125", "414", "173", "21", null, null, this.Div05);
            obj.set_taborder("60");
            ...
            obj.set_visible("false");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static17", "absolute", "0", "466", "711", "29", null, null, this.Div05);
            obj.set_taborder("74");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "0", "466", "120", "29", null, null, this.Div05);
            obj.set_taborder("72");
            obj.set_text("담당업무");
            obj.set_cssclass("sta_WF_Label");
            this.Div05.addChild(obj.name, obj);
            obj = new Edit("edt_CHRG_BSNNM", "absolute", "123", "470", "583", "21", null, null, this.Div05);
            obj.set_taborder("73");
            ...
            obj.style.set_border("0 solid #ccd3d5ff");
            this.Div05.addChild(obj.name, obj);
            obj = new CheckBox("chk_PDA_AUTH", "absolute", "590", "414", "90", "21", null, null, this.Div05);
            obj.set_taborder("77");
            obj.set_text("PDA 검수");
            obj.set_truevalue("Y");
            obj.set_falsevalue("N");
            ...
            obj.set_enable("false");
            this.Div05.addChild(obj.name, obj);
            obj = new CheckBox("chk_PRICE", "absolute", "125", "441", "90", "21", null, null, this.Div05);
            obj.set_taborder("78");
            obj.set_text("모바일앱");
            obj.set_value("N");
            obj.set_truevalue("Y");
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item13","Div05.edt_USR_NM","value","ds_userInfo","REPMNM");
            this.addChild(obj.name, obj);
            obj.bind();
