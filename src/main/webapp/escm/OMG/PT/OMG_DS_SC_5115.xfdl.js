(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div05", "absolute", "17", "16", "711", "607", null, null, this);
            obj.set_taborder("10");
            ...
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static02", "absolute", "336", "353", "135", "29", null, null, this.Div05);
            ...
            obj.set_maxlength("4");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static13", "absolute", "530", "357", "9", "21", null, null, this.Div05);
            ...
            obj.set_maxlength("4");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static14", "absolute", "591", "357", "9", "21", null, null, this.Div05);
        ...
        this.registerScript("OMG_DS_SC_5115.xfdl", function() {
        ...
        ********************************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_5115.xfdl");
