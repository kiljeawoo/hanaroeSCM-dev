(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Radio("radio_auth", "absolute", "155", "623", "301", "23", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static29", "absolute", "301", "210", "139", "21", null, null, this);
            obj.set_taborder("48");
            obj.set_text("(※200KB 이하만 가능)");
            this.addChild(obj.name, obj);

            obj = new Button("btn_comname", "absolute", "362", "295", "22", "21", null, null, this);
            obj.set_taborder("49");
