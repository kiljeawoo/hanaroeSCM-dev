    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_8511");
                this.set_classname("OMG_DS_SC_7022");
                this.set_titletext("사업장/상품별 재고현황상세");
            ...
            obj = new Grid("Grid04", "absolute", "0", "223", "540", "353", null, null, this);
            obj.set_taborder("51");
            obj.set_binddataset("grd01");
            obj.set_autofittype("col");
            obj.set_summarytype("top");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"150\"/><Column size=\"390\"/></Columns><Rows><Row size=\"50\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"63\"/><Row size=\"63\"/></Rows><Band id=\"head\"><Cell text=\"상품코드\"/><Cell col=\"1\" text=\"상품명\"/><Cell row=\"1\" text=\"재고수량\"/><Cell row=\"1\" col=\"1\" text=\"재고금액(만원)\"/></Band><Band id=\"body\"><Cell style=\"align: ;\" text=\"bind:Column0\"/><Cell col=\"1\" style=\"align:left middle;\" text=\"bind:Column1\"/><Cell row=\"1\" style=\"align:right middle;\"/><Cell row=\"1\" col=\"1\" style=\"align:right middle;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid01", "absolute", "0", "128", "540", "95", null, null, this);
            ...
            obj = new Static("Static00", "absolute", "0%", "64", null, "64", "71.67%", null, this);
            obj.getSetter("taborder").set("56");
            obj.set_text("마트정보");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static01", "absolute", "153", "64", "387", "64", null, null, this);
            obj.getSetter("taborder").set("57");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit00", "absolute", "29.07%", "69", null, "54", "2.78%", null, this);
            obj.set_taborder("58");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 540, 512, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("사업장/상품별 재고현황상세");
        ...
        this.loadIncludeScript("OMG_DS_SC_8511.xfdl");
