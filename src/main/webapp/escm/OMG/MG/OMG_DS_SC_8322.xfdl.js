(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"BSN_DSC\" type=\"STRING\" size=\"256\"/><Column id=\"SRV_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"SRV_Q_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"SRV_A_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"SRV_A_NUM\" type=\"STRING\" size=\"256\"/><Column id=\"ANSWER\" type=\"STRING\" size=\"256\"/><Column id=\"INPUT_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"TXT_COL_CNT\" type=\"STRING\" size=\"256\"/><Column id=\"TXT_ROW_CNT\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"FSRG_DTM\" type=\"STRING\" size=\"256\"/><Column id=\"FSRGMN_ENO\" type=\"STRING\" size=\"256\"/><Column id=\"LSCHG_DTM\" type=\"STRING\" size=\"256\"/><Column id=\"LS_CMENO\" type=\"STRING\" size=\"256\"/><Column id=\"CHECK_YN\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("Edit00", "absolute", "145", "17", "73", "23", null, null, this);
            obj.set_taborder("10");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit01", "absolute", "229", "15", "73", "23", null, null, this);
            obj.set_taborder("11");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit02", "absolute", "307", "14", "73", "23", null, null, this);
            obj.set_taborder("12");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit03", "absolute", "457", "12", "73", "23", null, null, this);
            obj.set_taborder("15");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Button("btn_insert", "absolute", null, "322", "44", "22", "79", null, this);
            obj.set_taborder("13");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"45\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"130\" band=\"left\"/><Column size=\"450\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"none\"/><Cell col=\"1\"/><Cell col=\"2\" text=\"번호\"/><Cell col=\"3\" text=\"행수\"/><Cell col=\"4\" text=\"열수\"/><Cell col=\"5\" text=\"답변 형식\"/><Cell col=\"6\" text=\"답변\"/></Band><Band id=\"body\"><Cell displaytype=\"button\" edittype=\"none\" text=\"삭제\" editdisplay=\"edit\"/><Cell col=\"1\" displaytype=\"button\" text=\"수정\"/><Cell col=\"2\" text=\"bind:SRV_A_NUM\"/><Cell col=\"3\" edittype=\"text\" editfilter=\"number\" text=\"bind:TXT_COL_CNT\" editdisplay=\"display\" combodisplay=\"edit\"/><Cell col=\"4\" edittype=\"text\" editfilter=\"number\" text=\"bind:TXT_ROW_CNT\" editdisplay=\"display\" combodisplay=\"edit\"/><Cell col=\"5\" displaytype=\"combo\" edittype=\"combo\" text=\"bind:INPUT_TYPE\" combodataset=\"ds_ans\" combocodecol=\"code\" combodatacol=\"value\" combodisplay=\"display\" tooltiptext=\"bind:INPUT_TYPE\"/><Cell col=\"6\" displaytype=\"normal\" edittype=\"text\" style=\"controlbackground:#edf4faff;\" cssclass=\"bodyEssential\" text=\"bind:ANSWER\" editdisplay=\"display\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_quplus", "absolute", null, "322", "51", "22", "22", null, this);
            obj.set_taborder("7");
            obj.set_text("행추가");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("btn_select", "absolute", null, "322", "44", "22", "129", null, this);
            obj.set_taborder("16");
            obj.set_text("조회");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("btn_update", "absolute", null, "324", "44", "22", "181", null, this);
            obj.set_taborder("17");
            obj.set_text("수정");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Edit("Edit04", "absolute", "549", "12", "73", "23", null, null, this);
            obj.set_taborder("19");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit05", "absolute", "634", "15", "73", "23", null, null, this);
            obj.set_taborder("20");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
        ...
        this.registerScript("OMG_DS_SC_8322.xfdl", function() {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_8322.xfdl");
