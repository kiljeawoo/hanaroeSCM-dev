    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,486,321);
            }
            ...
            obj = new Grid("grd_mbInfo", "absolute", "17", "102", null, "163", "17", null, this);
            obj.set_taborder("5");
            ...
            obj = new Button("btn_ok", "absolute", "359", "275", "54", "29", null, null, this);
            obj.set_taborder("6");
            obj.set_text("확인");
            obj.set_cssclass("btn_WF_Popup");
            this.addChild(obj.name, obj);

            obj = new Button("btn_cancel", "absolute", "415", "275", "54", "29", null, null, this);
            obj.set_taborder("7");
            obj.set_text("취소");
            obj.set_cssclass("btn_WF_Popup");
            this.addChild(obj.name, obj);
            ...
            //-- Default Layout
            obj = new Layout("default", "", 486, 321, this,
            	//-- Layout function
            	function(p) {
