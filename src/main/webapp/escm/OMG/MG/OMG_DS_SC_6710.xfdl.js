(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div02", "absolute", "0%", "7", null, "475", "15", null, this);
            obj.set_taborder("21");
            obj.set_text("Div02");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("Grid00", "absolute", "8", "46", "240", "427", null, null, this.Div02);
            obj.set_taborder("58");
            ...
            this.Div02.addChild(obj.name, obj);
            obj = new Tab("Tab00", "absolute", "263", "46", null, "427", "0", null, this.Div02);
            obj.set_taborder("59");
            obj.set_tabindex("0");
            ...
            obj = new Grid("grid_user", "absolute", "0.2%", "1", null, null, "0%", "0", this.Div02.Tab00.tabpage1);
            obj.set_taborder("0");
            obj.set_autofittype("col");
