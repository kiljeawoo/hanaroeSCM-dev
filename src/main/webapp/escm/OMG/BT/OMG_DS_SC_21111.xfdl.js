    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_21111");
                this.set_titletext("신규계약 (수산 선어/활어 평가표)");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"level\" type=\"STRING\" size=\"256\"/><Column id=\"point\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"level\">5</Col><Col id=\"point\"/></Row><Row><Col id=\"level\">10</Col><Col id=\"point\"/></Row><Row><Col id=\"level\">15</Col><Col id=\"point\"/></Row><Row><Col id=\"level\">20</Col><Col id=\"point\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"level\" type=\"STRING\" size=\"256\"/><Column id=\"point\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"level\">10</Col><Col id=\"point\"/></Row><Row><Col id=\"level\">20</Col><Col id=\"point\"/></Row><Row><Col id=\"level\">30</Col><Col id=\"point\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"level\" type=\"STRING\" size=\"256\"/><Column id=\"point\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"level\">20</Col><Col id=\"point\"/></Row><Row><Col id=\"level\">25</Col><Col id=\"point\"/></Row><Row><Col id=\"level\">30</Col><Col id=\"point\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            
            // UI Components Initialize
            obj = new Static("Static28", "absolute", "380", "294", null, "29", "15", null, this);
            obj.set_taborder("57");
            ...
            obj = new Static("Static03", "absolute", "135", "182", "246", "29", null, null, this);
            obj.set_taborder("48");
            obj.set_text("중매인 · 매참인");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static08", "absolute", "380", "210", null, "29", "15", null, this);
            obj.set_taborder("50");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new FileUpload("FileUpload01", "absolute", null, "214", "72", "21", "19", null, this);
            obj.set_taborder("4");
            ...
            obj = new Static("Static26", "absolute", "380", "238", null, "29", "133", null, this);
            obj.set_taborder("51");
            obj.set_text("수입 면장 기재");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static20", "absolute", null, "238", "60", "29", "15", null, this);
            obj.set_taborder("52");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static19", "absolute", null, "266", "60", "29", "15", null, this);
            obj.set_taborder("53");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_a03", "absolute", null, "238", "20", "57", "31", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("6");
            ...
            obj = new Static("Static22", "absolute", null, "266", "60", "29", "74", null, this);
            obj.set_taborder("54");
            obj.set_text("10");
            obj.set_cssclass("sta_WF_Labelbg_R");
            this.addChild(obj.name, obj);

            obj = new Static("Static25", "absolute", "380", "266", null, "29", "133", null, this);
            obj.set_taborder("55");
            obj.set_text("신용장 약정서, 수입 면장 기재");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_down02", "absolute", "384", "298", null, "21", "89", null, this);
            obj.set_taborder("56");
            obj.set_readonly("true");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static21", "absolute", null, "238", "60", "29", "74", null, this);
            obj.set_taborder("58");
            obj.set_text("5");
            obj.set_cssclass("sta_WF_Labelbg_R");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static186", "absolute", "526", "686", null, "29", "133", null, this);
            obj.set_taborder("79");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static184", "absolute", "16", "686", "512", "29", null, null, this);
            obj.set_taborder("81");
            obj.set_text("소 계");
            obj.set_cssclass("sta_WF_Label_c");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("84");
            obj.set_text("- 운송차량 (법인 또는 대표자 명의) 운영 3년 이상 업체 : 활어(활어차), 선어(냉장·냉동탑차)");
            obj.set_cssclass("sta_WF_DescriptionB01");
            obj.style.set_background("left middle");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("85");
            obj.set_text("- 유통 전 단계 원산지 증명서 증빙 가능업체 (수입수산물 포함)");
            obj.set_cssclass("sta_WF_DescriptionB01");
            obj.style.set_background("left middle");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("86");
            obj.set_text("- 생산물책임보험(1사고당 1억원 이상 보장) 가입업체");
            obj.set_cssclass("sta_WF_DescriptionB01");
            obj.style.set_background("left middle");
            this.addChild(obj.name, obj);

            obj = new Static("Static193", "absolute", "15", "832", "398", "28", null, null, this);
            obj.set_taborder("88");
            obj.set_text("농협 경제사업 참여");
            obj.set_cssclass("sta_WF_DescriptionB01");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("90");
            obj.set_text("70점 이상 득점시 계약상담 가능");
            obj.set_cssclass("sta_WF_DescriptionB01");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_down01", "absolute", "384", "214", null, "21", "89", null, this);
            obj.set_taborder("95");
            obj.set_readonly("true");
            obj.set_enable("false");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static29", "absolute", "135", "294", "246", "29", null, null, this);
            obj.set_taborder("103");
            obj.set_text("관련서류 첨부");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static27", "absolute", "135", "238", "246", "57", null, null, this);
            obj.set_taborder("104");
            obj.set_text("직수입");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static07", "absolute", "135", "210", "246", "29", null, null, this);
            ...
            obj = new FileUpload("FileUpload02", "absolute", null, "298", "72", "21", "19", null, this);
            obj.set_taborder("7");
            obj.getSetter("retry").set("0");
            obj.set_enable("false");
            obj.set_index("0");
            ...
            obj = new CheckBox("chk_a02", "absolute", null, "186", "25", "21", "26", null, this);
            obj.set_taborder("23");
            obj.set_value("0");
            ...
            obj = new Static("Static09", "absolute", "135", "322", "246", "85", null, null, this);
            obj.set_taborder("106");
            obj.set_text("운송차량 직접(본인) 운영 기간");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static10", "absolute", "380", "322", null, "29", "133", null, this);
            obj.set_taborder("107");
            obj.set_text("3년 이상 ~ 5년 미만");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static11", "absolute", "380", "350", null, "29", "133", null, this);
            obj.set_taborder("108");
            obj.set_text("5년 이상 ~ 10년 미만");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static24", "absolute", "380", "378", null, "29", "133", null, this);
            obj.set_taborder("109");
            obj.set_text("10년 이상");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static12", "absolute", null, "322", "60", "29", "74", null, this);
            obj.set_taborder("110");
            obj.set_text("10");
            obj.set_cssclass("sta_WF_Labelbg_R");
            this.addChild(obj.name, obj);

            obj = new Static("Static13", "absolute", null, "350", "60", "29", "74", null, this);
            obj.set_taborder("111");
            obj.set_text("20");
            obj.set_cssclass("sta_WF_Labelbg_R");
            this.addChild(obj.name, obj);

            obj = new Static("Static23", "absolute", null, "378", "60", "29", "74", null, this);
            obj.set_taborder("112");
            obj.set_text("30");
            obj.set_cssclass("sta_WF_Labelbg_R");
            this.addChild(obj.name, obj);

            obj = new Static("Static14", "absolute", null, "322", "60", "29", "15", null, this);
            obj.set_taborder("113");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static15", "absolute", null, "350", "60", "29", "15", null, this);
            obj.set_taborder("114");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static18", "absolute", null, "378", "60", "29", "15", null, this);
            obj.set_taborder("115");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_a04", "absolute", null, "322", "20", "85", "31", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("9");
            ...
            obj = new Static("Static16", "absolute", "135", "406", "246", "29", null, null, this);
            obj.set_taborder("116");
            obj.set_text("차량등록증 첨부");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static17", "absolute", "380", "406", null, "29", "15", null, this);
            ...
            obj = new Button("btn_down01", "absolute", null, "214", "70", "21", "-75", null, this);
            obj.set_taborder("5");
            obj.set_text("파일다운");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Button("btn_down02", "absolute", null, "298", "70", "21", "-77", null, this);
            obj.set_taborder("8");
            obj.set_text("파일다운");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static75", "absolute", "13", "856", "599", "21", null, null, this);
            obj.set_taborder("119");
            obj.set_text(" - 유통계열사ㆍ조합 하나로마트ㆍ농협경제 판매사업과 최근 5년이내 연 1억원 이상 거래");
            obj.set_cssclass("sta_WF_DescriptionB01");
            obj.style.set_background("left middle");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 803, 940, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("신규계약 (수산 선어/활어 평가표)");
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item0","chk_a02","value","ds_rcev","EVL_HDNG_A2");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","rdo_a04","value","ds_rcev","EVL_HDNG_A4");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_21111.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_21111.xfdl", function() {
        ...
        this.OMG_DS_SC_21111_onload = function(obj,e)
        {
        	if(this.parent.edt_dsc.value == "popup")
        	{
        		...
        		this.chk_a02.set_readonly(true);
        ...
        //중매인 · 매참인
        this.chk_a02_onchanged = function(obj,e)
        {
        	if(this.chk_a02.value == 10)
        	{
        		chkA02 = 10;
        	...
        	if(this.chk_a02.value == 0)
        	{
        		chkA02 = 0;
        		this.FileUpload01.set_enable(false);
        ...
        {	
        	...
        	//중매인 · 매참인
        	if(this.gfn_isNull(this.chk_a02.value))
        	{
        		this.chk_a02.set_value(0);
        	}
        	chkA02 = this.chk_a02.value;
        	this.FileUpload01.set_enable(true);
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onload", this.OMG_DS_SC_21111_onload, this);
            this.Static77.addEventHandler("onclick", this.Static77_onclick, this);
            this.rdo_a01.addEventHandler("onitemchanged", this.rdo_a01_onitemchanged, this);
            this.rdo_a01.addEventHandler("onitemclick", this.rdo_a01_onitemclick, this);
            this.Static66.addEventHandler("onclick", this.Static66_onclick, this);
            this.Static70.addEventHandler("onclick", this.Static70_onclick, this);
            ...
            this.Static26.addEventHandler("onclick", this.Static26_onclick, this);
            this.rdo_a03.addEventHandler("onitemchanged", this.rdo_a03_onitemchanged, this);
            this.Static43.addEventHandler("onclick", this.Static43_onclick, this);
            this.rdo_a05.addEventHandler("onitemchanged", this.rdo_a05_onitemchanged, this);
            this.edt_down04.addEventHandler("oneditclick", this.edt_down04_oneditclick, this);
            ...
            this.chk_a06.addEventHandler("onclick", this.chk_a06_onclick, this);
            ...
            this.Static54.addEventHandler("onclick", this.Static54_onclick, this);
            this.chk_a07.addEventHandler("onchanged", this.chk_a07_onchanged, this);
            this.chk_a07.addEventHandler("onclick", this.chk_a07_onclick, this);
            this.btn_register01.addEventHandler("onclick", this.btn_register_onclick, this);
            this.Static188.addEventHandler("onclick", this.Static188_onclick, this);
            ...
            this.chk_a02.addEventHandler("onchanged", this.chk_a02_onchanged, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_21111.xfdl");
