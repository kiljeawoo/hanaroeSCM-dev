(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"code\" type=\"string\" size=\"13\"/><Column id=\"name\" type=\"string\" size=\"13\"/></ColumnInfo><Rows><Row><Col id=\"code\">101</Col><Col id=\"name\">마트상품부</Col></Row><Row><Col id=\"code\">201</Col><Col id=\"name\">선어/활어(냉동 원물 비규격포함)</Col></Row><Row><Col id=\"code\">202</Col><Col id=\"name\">건어/수산 가공품</Col></Row><Row><Col id=\"code\">203</Col><Col id=\"name\">수산 규격품(냉동·냉장)</Col></Row></Rows>");
        ...
        // User Script
        this.registerScript("OMG_DS_SC_0009.xfdl", function() {
        ...
        this.loadIncludeScript("OMG_DS_SC_0009.xfdl");
