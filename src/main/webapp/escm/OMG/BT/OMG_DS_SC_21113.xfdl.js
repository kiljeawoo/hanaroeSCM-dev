    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,803,1105);
            }
            ...
            obj = new Static("Static135", "absolute", null, "793", "60", "29", "15", null, this);
            obj.set_taborder("92");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static81", "absolute", "16", "653", "120", "200", null, null, this);
            obj.set_taborder("30");
            obj.set_text("기타\r\n(가점)");
            obj.set_cssclass("sta_WF_Label_c");
            this.addChild(obj.name, obj);

            obj = new Static("Static82", "absolute", "16", "850", "512", "29", null, null, this);
            obj.set_taborder("31");
            obj.set_text("소계");
            obj.set_cssclass("sta_WF_Label_c");
            this.addChild(obj.name, obj);

            obj = new Static("Static83", "absolute", "16", "879", null, "20", "-5", null, this);
            obj.set_taborder("32");
            obj.set_text("20");
            ...
            obj = new Button("btn_register01", "absolute", null, "902", "41", "21", "106", null, this);
            obj.set_taborder("25");
            obj.set_text("등록");
            ...
            obj = new Button("btn_insert", "absolute", null, "902", "84", "21", "23", null, this);
            obj.set_taborder("26");
            obj.set_text("상담가능");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_enable("false");
            ...
            obj = new Static("Static84", "absolute", "15", "920", "423", "21", null, null, this);
            obj.set_taborder("33");
            obj.set_text("○ 계약 조건");
            ...
            obj = new Static("Static86", "absolute", "15", "936", "423", "21", null, null, this);
            obj.set_taborder("35");
            ...
            obj = new Static("Static87", "absolute", "15", "955", "423", "21", null, null, this);
            obj.set_taborder("36");
            ...
            obj = new Static("Static90", "absolute", "16", "1040", "423", "21", null, null, this);
            obj.set_taborder("39");
            obj.set_text("계약종료 후 2년 내 계약상담 불가");
            obj.set_cssclass("sta_WF_DescriptionB01");
            this.addChild(obj.name, obj);

            obj = new Static("Static91", "absolute", "16", "1062", "423", "21", null, null, this);
            obj.set_taborder("40");
            obj.set_text("70점 이상 득점시 계약상담 가능");
            obj.set_cssclass("sta_WF_DescriptionB01");
            this.addChild(obj.name, obj);

            obj = new Static("Static92", "absolute", "113", "1088", "279", "15", null, null, this);
            obj.set_taborder("41");
            obj.set_visible("false");
            obj.style.set_background("#00ffff66");
            this.addChild(obj.name, obj);

            obj = new Static("Static94", "absolute", "135", "821", "246", "30", null, null, this);
            obj.set_taborder("43");
            obj.set_text("거래실적 확인서(계산서 등)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static95", "absolute", "135", "793", "246", "29", null, null, this);
            obj.set_taborder("44");
            ...
            obj = new Static("Static131", "absolute", "380", "793", null, "29", "133", null, this);
            obj.set_taborder("87");
            ...
            obj = new Static("Static134", "absolute", null, "850", "119", "29", "15", null, this);
            obj.set_taborder("91");
            obj.set_text("0");
            ...
            obj = new CheckBox("chk_a09", "absolute", null, "798", "25", "21", "26", null, this);
            obj.set_taborder("22");
            obj.set_value("0");
            obj.set_truevalue("5");
            ...
            obj = new Static("Static137", "absolute", null, "793", "60", "29", "74", null, this);
            obj.set_taborder("94");
            obj.set_text("5");
            obj.set_cssclass("sta_WF_Labelbg_R");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static00", "absolute", "15", "1000", "401", "21", null, null, this);
            obj.set_taborder("120");
            obj.set_text("농협 경제사업 참여");
            obj.set_cssclass("sta_WF_DescriptionB01");
            this.addChild(obj.name, obj);

            obj = new Static("Static01", "absolute", "15", "979", "423", "21", null, null, this);
            obj.set_taborder("121");
            obj.set_text("동종업체 거래 업력 : 계약상담일 현재 1년이내 거래실적 보유");
            obj.set_cssclass("sta_WF_DescriptionB01");
            this.addChild(obj.name, obj);

            obj = new Static("Static52", "absolute", "135", "737", "246", "29", null, null, this);
            obj.set_taborder("122");
            obj.set_text("동종업체 거래 업력");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "135", "765", "246", "29", null, null, this);
            obj.set_taborder("123");
            obj.set_text("거래실적 확인서(계산서 등)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static03", "absolute", "380", "821", null, "30", "15", null, this);
            obj.set_taborder("125");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_down08", "absolute", "384", "825", null, "21", "89", null, this);
            obj.set_taborder("126");
            obj.set_readonly("true");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new FileUpload("FileUpload08", "absolute", null, "825", "72", "21", "19", null, this);
            ...
            obj = new Static("Static54", "absolute", "380", "737", null, "29", "133", null, this);
            obj.set_taborder("128");
            obj.set_text("5개중 1개이상");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static56", "absolute", null, "737", "60", "29", "75", null, this);
            obj.set_taborder("129");
            obj.set_text("5");
            obj.set_cssclass("sta_WF_Labelbg_R");
            this.addChild(obj.name, obj);

            obj = new Static("Static57", "absolute", null, "737", "60", "29", "15", null, this);
            obj.set_taborder("130");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new CheckBox("chk_a08", "absolute", null, "742", "25", "21", "28", null, this);
            ...
            obj = new Static("Static186", "absolute", "528", "850", null, "29", "131", null, this);
            obj.set_taborder("133");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Button("btn_down08", "absolute", null, "827", "70", "21", "-77", null, this);
            obj.set_taborder("134");
            obj.set_text("파일다운");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static04", "absolute", "13", "1019", "599", "21", null, null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 803, 1105, this,
            	//-- Layout function
            	function(p) {
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","chk_a09","value","ds_rcev","EVL_HDNG_B3");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item35","chk_a08","value","ds_rcev","EVL_HDNG_B2");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_21113.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_21113.xfdl", function() {
        ...
        this.OMG_DS_SC_21113_onload = function(obj,e)
        {
        	if(this.parent.edt_dsc.value == "popup")
        	{
        		...
        		this.chk_a09.set_readonly(true);
        ...
        //농협 경제 사업 참여
        this.chk_a09_onchanged = function(obj,e)
        {
        	if(this.chk_a09.value == 5)
        	{
        		chkA09 = 5;
        ...
        {	
        	...
        	//농협 경제사업 참여
        	if(this.gfn_isNull(this.chk_a09.value))
        	{
        		this.chk_a09.set_value(0);
        	}
        	chkA09 = this.chk_a09.value;
        	this.FileUpload08.set_enable(true);
        ...
        this.fn_sum = function()
        {
        	...
        	num09 = nexacro.toNumber(chkA09);

        		
        	tot = num01 + num02 + num03 + num04 + num05 + num06 + num07 + num08 + num09;
        ...
        this.fn_validationCheck = function(){
        	...
        	if(this.edt_down07.enable == true && this.gfn_isNull(this.edt_down07.value)){
        		...
        		this.alert('거래실적 확인서(계산서 등)를 첨부 하세요.');
        		return false;
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.Static82.addEventHandler("onclick", this.Static82_onclick, this);
            this.Static83.addEventHandler("onclick", this.Static83_onclick, this);
            this.btn_register01.addEventHandler("onclick", this.btn_register_onclick, this);
            this.Static84.addEventHandler("onclick", this.Static84_onclick, this);
            this.Static91.addEventHandler("onclick", this.Static91_onclick, this);
            this.Static94.addEventHandler("onclick", this.Static94_onclick, this);
            this.edt_down00.addEventHandler("oneditclick", this.edt_down00_oneditclick, this);
            this.Static129.addEventHandler("onclick", this.Static129_onclick, this);
            this.Static131.addEventHandler("onclick", this.Static131_onclick, this);
            this.Static134.addEventHandler("onclick", this.Static134_onclick, this);
            ...
            this.chk_a09.addEventHandler("onchanged", this.chk_a09_onchanged, this);
            this.chk_a09.addEventHandler("onclick", this.chk_a09_onclick, this);
            ...
            this.Static02.addEventHandler("onclick", this.Static94_onclick, this);
            this.Static03.addEventHandler("onclick", this.Static132_onclick, this);
            ...
            this.Static186.addEventHandler("onclick", this.Static186_onclick, this);
            this.btn_down08.addEventHandler("onclick", this.btn_down08_onclick, this);
            this.Static04.addEventHandler("onclick", this.Static75_onclick, this);

        };

        this.loadIncludeScript("OMG_DS_SC_21113.xfdl");
