    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,803,996);
            }
            ...
            obj = new Static("Static60", "absolute", "16", "546", "120", "197", null, null, this);
            obj.set_taborder("79");
            obj.set_text("기타\r\n(가점)");
            obj.set_cssclass("sta_WF_Label_c");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static187", "absolute", null, "742", "119", "29", "15", null, this);
            obj.set_taborder("86");
            obj.set_text("0");
            obj.set_cssclass("sta_WF_Labelbg_R");
            this.addChild(obj.name, obj);

            obj = new Static("Static184", "absolute", "16", "742", "512", "29", null, null, this);
            obj.set_taborder("89");
            obj.set_text("소계");
            obj.set_cssclass("sta_WF_Label_c");
            this.addChild(obj.name, obj);

            obj = new Static("Static199", "absolute", "16", "771", null, "20", "-5", null, this);
            obj.set_taborder("90");
            obj.set_text("20");
            ...
            obj = new Button("btn_register01", "absolute", null, "800", "41", "21", "99", null, this);
            obj.set_taborder("21");
            obj.set_text("등록");
            ...
            obj = new Button("btn_insert", "absolute", null, "800", "84", "21", "15", null, this);
            obj.set_taborder("22");
            obj.set_text("상담가능");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_enable("false");
            ...
            obj = new Static("Static188", "absolute", "15", "814", "423", "21", null, null, this);
            obj.set_taborder("91");
            obj.set_text("○ 계약 조건");
            ...
            obj = new Static("Static190", "absolute", "15", "832", "423", "21", null, null, this);
            obj.set_taborder("93");
            ...
            obj = new Static("Static191", "absolute", "15", "851", "423", "21", null, null, this);
            obj.set_taborder("94");
            ...
            obj = new Static("Static193", "absolute", "15", "912", "639", "21", null, null, this);
            obj.set_taborder("96");
            obj.set_text("농협 경제사업 참여 : 유통계열사ㆍ조합 하나로마트ㆍ농협경제 판매사업");
            obj.set_cssclass("sta_WF_DescriptionB01");
            this.addChild(obj.name, obj);

            obj = new Static("Static194", "absolute", "15", "934", "423", "21", null, null, this);
            obj.set_taborder("97");
            obj.set_text("계약종료 후 2년 내 계약상담 불가");
            obj.set_cssclass("sta_WF_DescriptionB01");
            this.addChild(obj.name, obj);

            obj = new Static("Static61", "absolute", "15", "955", "423", "21", null, null, this);
            obj.set_taborder("98");
            obj.set_text("70점 이상 득점시 계약상담 가능");
            obj.set_cssclass("sta_WF_DescriptionB01");
            this.addChild(obj.name, obj);

            obj = new Static("Static68", "absolute", "119", "976", "279", "15", null, null, this);
            obj.set_taborder("99");
            obj.set_visible("false");
            ...
            obj = new Static("Static18", "absolute", "15", "869", "351", "25", null, null, this);
            obj.set_taborder("119");
            obj.set_text("농협 경제사업 참여");
            obj.set_cssclass("sta_WF_DescriptionB01");
            this.addChild(obj.name, obj);

            obj = new Static("Static23", "absolute", "135", "686", "246", "29", null, null, this);
            obj.set_taborder("120");
            obj.set_text("농협 경제사업 참여");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static94", "absolute", "135", "658", "246", "29", null, null, this);
            obj.set_taborder("121");
            obj.set_text("거래실적 확인서(계산서 등)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static132", "absolute", "380", "714", null, "29", "15", null, this);
            obj.set_taborder("123");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_down07", "absolute", "384", "718", null, "21", "89", null, this);
            obj.set_taborder("125");
            obj.set_readonly("true");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new FileUpload("FileUpload07", "absolute", null, "718", "72", "21", "19", null, this);
            ...
            obj = new Static("Static131", "absolute", "380", "686", null, "29", "133", null, this);
            obj.set_taborder("128");
            obj.set_text("5년이내 연 1억원 이상");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static137", "absolute", null, "686", "60", "29", "74", null, this);
            obj.set_taborder("129");
            obj.set_text("5");
            obj.set_cssclass("sta_WF_Labelbg_R");
            this.addChild(obj.name, obj);

            obj = new Static("Static135", "absolute", null, "686", "60", "29", "15", null, this);
            obj.set_taborder("130");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new CheckBox("chk_a08", "absolute", null, "691", "25", "21", "26", null, this);
            ...
            obj = new Static("Static53", "absolute", "135", "714", "246", "29", null, null, this);
            obj.set_taborder("132");
            obj.set_text("계산서 첨부");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Button("btn_down07", "absolute", null, "718", "70", "21", "-77", null, this);
            ...
            obj = new Static("Static186", "absolute", "528", "742", null, "29", "131", null, this);
            obj.set_taborder("135");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static24", "absolute", "9", "891", "599", "21", null, null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 803, 996, this,
            	//-- Layout function
            	function(p) {
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","chk_a08","value","ds_rcev","EVL_HDNG_B3");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        this.chk_a08_onclick = function(obj,e)
        {
        	
        }

        this.Static186_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.rdo_a05.addEventHandler("onitemclick", this.rdo_a05_onitemclick, this);
            ...
            this.Static187.addEventHandler("onclick", this.Static187_onclick, this);
            this.btn_register01.addEventHandler("onclick", this.btn_register_onclick, this);
            this.Static194.addEventHandler("onclick", this.Static194_onclick, this);
            this.Static61.addEventHandler("onclick", this.Static61_onclick, this);
            ...
            this.edt_down06.addEventHandler("oneditclick", this.edt_down06_oneditclick, this);
            ...
            this.Static132.addEventHandler("onclick", this.Static132_onclick, this);
            this.edt_down07.addEventHandler("oneditclick", this.edt_down07_oneditclick, this);
            ...
            this.Static135.addEventHandler("onclick", this.Static135_onclick, this);
            this.chk_a08.addEventHandler("onchanged", this.chk_a08_onchanged, this);
            this.chk_a08.addEventHandler("onclick", this.chk_a08_onclick, this);
            ...
            this.Static24.addEventHandler("onclick", this.Static75_onclick, this);
