(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_url("common::multiCheckCombo.xfdl");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_buyer_blg00", "absolute", "727", "8", "216", "21", null, null, this.div_search);
            obj.set_taborder("66");
            this.div_search.addChild(obj.name, obj);
        ...
        this.fn_afterCallSts = function (sVal)
        {
        	...
        	alert("this.fv_sts============>"+this.fv_sts);
        	this.div_search.edt_buyer_blg00.set_value(this.fv_sts);
        ...
        this.btn_search_onclick = function(obj,e)
        {
        	...
        	if(this.fn_validationCheck()){
        		...
        		var fv_sts = this.gfn_nullToEmpty(this.div_search.edt_buyer_blg00.value);  //계약시작0, 만료일1
