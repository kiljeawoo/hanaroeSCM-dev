(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static69", "absolute", "17", "506", "134", "29", null, null, this);
            ...
            obj = new Static("Static71", "absolute", "477", "506", "110", "29", null, null, this);
            ...
            obj = new Static("Static66", "absolute", "150", "506", "110", "29", null, null, this);
            ...
            obj = new Static("Static56", "absolute", "259", "506", "110", "29", null, null, this);
            ...
            obj = new Static("Static74", "absolute", "368", "506", "110", "29", null, null, this);
            ...
            obj = new Static("Static70", "absolute", "150", "534", "110", "29", null, null, this);
            ...
            obj = new Static("Static76", "absolute", "259", "534", "110", "29", null, null, this);
            ...
            obj = new Static("Static77", "absolute", "368", "534", "110", "29", null, null, this);
            ...
            obj = new Static("Static78", "absolute", "477", "534", "110", "29", null, null, this);
            ...
            obj = new Static("Static73", "absolute", "586", "506", null, "57", "17", null, this);
            ...
            obj = new Static("Static03", "absolute", "21", "563", "737", "20", null, null, this);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","Div02.Static01","text","ds_tax","MTAL");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_3141.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_3141.xfdl", function() {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        // 	}
        // 	else if(this.ds_tax.getColumn(0, "SOAC_PBC_STSC") == "05" || this.ds_tax.getColumn(0, "SOAC_PBC_STSC") == "04" ) //반려 
        // 	{
        ...
        this.loadIncludeScript("OMG_DS_SC_3141.xfdl");
