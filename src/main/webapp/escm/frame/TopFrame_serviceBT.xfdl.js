(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Menu("mnb_topMenu", "absolute", "192", "18", "1000", "46", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("11");
        ...
        // User Script
        this.addIncludeScript("TopFrame_serviceBT.xfdl", "lib::comLib.xjs");
        this.registerScript("TopFrame_serviceBT.xfdl", function() {
        //include "lib::comLib.xjs";

        this.form_onload = function(obj,e)
        {
        	//this.ds_topMenu.copyData(application.gds_serviceBT);//상단메뉴 표시하는 코드
        	//this._gfn_menuLength();
        	//this.ds_topMenu.filter("MENU_LEVEL <= 1 && DISPLAY_YN!='N'");//상단메뉴 표시하는 코드
        ...
        {	
        	...
        	var nTopRow = application.gds_serviceBT.findRow("MENU_ID", e.id);
        	
        	var sLFTitleText = application.gds_serviceBT.getColumn(nTopRow, "MENU_NAME");
        	...
        	} else if (e.id == '80200000') {
        		window.open("http://www.redwhistle.org/report/report.asp?organ=7862&RType=1");
        	} else {
        		this.gfn_OpenMenuId(e.id, "", "BT");
        	}	
        }
        ...
        * Return :  계산된 사이즈가 저장된  Size object
        ...
        this.loadIncludeScript("TopFrame_serviceBT.xfdl");
