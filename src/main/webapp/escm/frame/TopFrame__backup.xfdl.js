(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("TopFrame__backup.xfdl", "lib::comLib.xjs");
        this.registerScript("TopFrame__backup.xfdl", function() {
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	} else if (application.gv_userType == "02" || application.gv_userType == "03") {
        		if (application.gv_weakPwYn == "X") {
        			this.mnb_topMenu.set_visible(false);
        		}
        	}
        	
        	this.TopArea_onsize(this);
        }
        ...
        this.mnb_topMenu_onmouseleave = function(obj,e)
        {
        		var bStates = obj.isPopup();
        ...
        this.TopArea_onsize = function(obj,e)
        {
        	var BASE_WIDTH = 1008; // 기본사이즈(넓이)
        	if (obj.width > BASE_WIDTH) {
        		// right 121, width 0
        		this.mnb_topMenu.set_width("");
        		this.mnb_topMenu.set_right(121);
        	} else {
        		// right 0, width 695
        		this.mnb_topMenu.set_width(695);
        		this.mnb_topMenu.set_right("");
        	}
        }
        });
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onsize", this.TopArea_onsize, this);
            ...
            this.mnb_topMenu.addEventHandler("onmouseenter", this.mnb_topMenu_onmouseenter, this);
            this.mnb_topMenu.addEventHandler("onmouseleave", this.mnb_topMenu_onmouseleave, this);
        ...
        this.loadIncludeScript("TopFrame__backup.xfdl");
