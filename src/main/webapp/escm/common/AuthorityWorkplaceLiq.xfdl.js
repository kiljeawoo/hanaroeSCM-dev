(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_authorityWorkplaceLiq", this);
            ...
            this.addChild(obj.name, obj);
            obj.set_taborder("1");
            obj.set_innerdataset("@ds_authorityWorkplaceLiq");
        ...
        // User Script
        this.addIncludeScript("AuthorityWorkplaceLiq.xfdl", "lib::comLib.xjs");
        this.registerScript("AuthorityWorkplaceLiq.xfdl", function() {
        ...
        this.ds_authorityWorkplaceLiq_onload = function(obj,e)
        {	
        	var _index = 0;
        	if(this.isAuthEvent()){
        ...
        {
            this.ds_authorityWorkplaceLiq.addEventHandler("onload", this.ds_authorityWorkplaceLiq_onload, this);
        ...
        this.loadIncludeScript("AuthorityWorkplaceLiq.xfdl");
