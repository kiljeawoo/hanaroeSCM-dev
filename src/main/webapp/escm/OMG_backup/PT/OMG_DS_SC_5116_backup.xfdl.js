(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_hiddenArea", "absolute", "785", "535", "484", "90", null, null, this);
            obj.set_taborder("4");
            ...
            obj = new Div("Div05", "absolute", "17", "16", "719", "640", null, null, this);
            obj.set_taborder("10");
            obj.style.set_background("transparent");
            obj.set_visible("false");
            obj.set_scrollbars("autovert");
            this.addChild(obj.name, obj);
            obj = new Static("Static21", "absolute", "0", "506", "711", "29", null, null, this.Div05);
            obj.set_taborder("88");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static20", "absolute", "0", "567", "711", "29", null, null, this.Div05);
            obj.set_taborder("85");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static17", "absolute", "0", "595", "711", "29", null, null, this.Div05);
            obj.set_taborder("79");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div05.addChild(obj.name, obj);
            ...
            obj.set_falsevalue("N");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static13", "absolute", "0", "483", "197", "21", null, null, this.Div05);
            obj.set_taborder("75");
            obj.set_text("소속 및 회원유형 정보 변경");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("transparent URL('theme://images/sta_WF_Subtitle.png') left middle");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static14", "absolute", "0", "539", "711", "29", null, null, this.Div05);
            obj.set_taborder("76");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static15", "absolute", "0", "539", "120", "29", null, null, this.Div05);
            obj.set_taborder("77");
            obj.set_text("변경 사업장코드");
            obj.set_cssclass("sta_WF_Label");
            this.Div05.addChild(obj.name, obj);
            obj = new Edit("edt_TO_BZPLC", "absolute", "123", "543", "96", "21", null, null, this.Div05);
            obj.set_taborder("28");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_Readonly");
            this.Div05.addChild(obj.name, obj);
            obj = new Button("btn_search", "absolute", "221", "543", "104", "21", null, null, this.Div05);
            obj.set_taborder("29");
            obj.set_text("소속사업장 조회");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static16", "absolute", "0", "595", "120", "29", null, null, this.Div05);
            obj.set_taborder("78");
            obj.set_text("소속 변경");
            obj.set_cssclass("sta_WF_Label");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static18", "absolute", "336", "539", "120", "29", null, null, this.Div05);
            obj.set_taborder("80");
            obj.set_text("변경 사업장명");
            obj.set_cssclass("sta_WF_Label");
            this.Div05.addChild(obj.name, obj);
            obj = new Edit("edt_TO_BZPLNM", "absolute", "459", "543", "180", "21", null, null, this.Div05);
            obj.set_taborder("30");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_Readonly");
            this.Div05.addChild(obj.name, obj);
            obj = new Button("btn_chg", "absolute", "123", "599", "52", "21", null, null, this.Div05);
            obj.set_taborder("33");
            obj.set_text("변경");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_enable("false");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("sta_to_tpc", "absolute", "187", "599", "420", "21", null, null, this.Div05);
            obj.set_taborder("81");
            obj.set_text("소속사업장을 조회해주세요");
            this.Div05.addChild(obj.name, obj);
            obj = new Edit("edt_TO_BZNO", "absolute", "641", "543", "15", "21", null, null, this.Div05);
            obj.set_taborder("82");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_Readonly");
            obj.set_visible("false");
            this.Div05.addChild(obj.name, obj);
            obj = new Edit("edt_TO_TPC", "absolute", "658", "543", "15", "21", null, null, this.Div05);
            obj.set_taborder("83");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_Readonly");
            obj.set_visible("false");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static19", "absolute", "0", "567", "120", "29", null, null, this.Div05);
            obj.set_taborder("84");
            obj.set_text("변경 사무소");
            obj.set_cssclass("sta_WF_Label");
            this.Div05.addChild(obj.name, obj);
            obj = new Edit("edt_TO_DEPT_ID", "absolute", "123", "571", "96", "21", null, null, this.Div05);
            obj.set_taborder("31");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_Readonly");
            this.Div05.addChild(obj.name, obj);
            obj = new Edit("edt_TO_DEPT_NAME", "absolute", "221", "571", "207", "21", null, null, this.Div05);
            obj.set_taborder("32");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_Readonly");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static07", "absolute", "0", "506", "120", "29", null, null, this.Div05);
            obj.set_taborder("86");
            obj.set_text("현 회원유형");
            obj.set_cssclass("sta_WF_Label");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static22", "absolute", "336", "506", "120", "29", null, null, this.Div05);
            obj.set_taborder("89");
            obj.set_text("현 사무소 정보");
            obj.set_cssclass("sta_WF_Label");
            this.Div05.addChild(obj.name, obj);
            obj = new Edit("edt_FR_TPC", "absolute", "123", "510", "122", "21", null, null, this.Div05);
            obj.set_taborder("93");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_Readonly");
            obj.set_value("사업장");
            this.Div05.addChild(obj.name, obj);
            obj = new Edit("edt_FR_DEPT_ID", "absolute", "459", "510", "50", "21", null, null, this.Div05);
            obj.set_taborder("96");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_Readonly");
            this.Div05.addChild(obj.name, obj);
            obj = new Edit("edt_FR_DEPT_NAME", "absolute", "511", "510", "195", "21", null, null, this.Div05);
            obj.set_taborder("97");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_Readonly");
            this.Div05.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item22","Div05.edt_FR_DEPT_ID","value","ds_basicInfo","DEPT_ID");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item23","Div05.edt_FR_DEPT_NAME","value","ds_basicInfo","DEPT_NAME");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_5116_backup.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_5116_backup.xfdl", function() {
        ...
        ********************************************************************************************************************/
        ...
        // 		if (this.gfn_isNull(this.Div00.edt_confirmCertificate.value)) {
        // 			alert("인증번호를 입력 하세요.");
        // 			this.Div00.edt_confirmCertificate.setFocus();
        // 			return false;
        // 		}
        ...
        ********************************************************************************************************************/
        this.btn_certificate_onclick = function(obj,e)
        {
        	...
        	if (this.div_hiddenArea.edt_randomNumber.value != this.Div00.edt_confirmCertificate.value) {
        ...
        ********************************************************************************************************************/
        this.fn_callBack = function(svcID,ErrorCode,ErrorMsg)
        {
        	if (svcID=="checkMBPW") {
        		...
        		if (ErrorCode < 0) {
        			...
        			if (this.gfn_isNull(this.ds_basicInfo.getColumn(0, "DEPT_NAME"))) {
        				this.ds_basicInfo.setColumn(0, "DEPT_NAME", "없음(범농협)");
        			}
        		}
        		...
        		if (ErrorCode < 0) {
        			...
        			alert("정상 처리 되었습니다.");
        			this.Div00.edt_confirmCertificate.set_value("");
        ...
        this.fn_popupAfter = function(strId,strVal)
        {
        	if (!this.gfn_isNull(strVal)) {
        		...
        		if (temp[2] == "01") {
        			this.Div05.edt_TO_TPC.set_value("02");
        		}
        ...
        this.loadIncludeScript("OMG_DS_SC_5116_backup.xfdl");
