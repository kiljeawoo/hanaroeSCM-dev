...
(function()
{
    return function(path)
    {
        ...
        "제 5 조 (회원가입)\n"+
        " 1. 회원가입은 신청자가 온라인으로 하나로 eSCM 사이트에서 제공하는 소정의 가입신청 양식에서 요구하는 사항을 기록하여 가입을 완료하는 것으로 성립된다. \n"+
        ...
        "제 7 조 (서비스의 요금)\n"+
        "1. 하나로eSCM 서비스에 대한 서비스 이용요금은 하나로eSCM 홈페이지에 게시된 요금표에 따라 매월 사용량을 산정하여 이용자에게 청구한다.\n"+
        "2. 서비스이용료의 변경은 하나로eSCM 공지사항을 통해 변경내역을 사전에 게시한다.\n"+
        "3. 서비스 요금 중 회원의 귀책사유로 인해 발생한 요금은 환급되지 않습니다.\n\n"+
        "제 8 조 (이용요금 납입방법)\n"+
        "1. 요금청구 및 납부: 당사는 이용요금(세금계산서 작성일자 기준)을 사용 월 익월 전자세금계산서로 청구하고 이용자는 청구월 25일까지 이용요금이 자동이체, 가상계좌로 납부하여야 한다.\n"+
        "2. 본 약관에 동의함을 납부방식(자동이체, 가상계좌입금)에 대한 승인으로 간주 한다.\n"+
        "3. 전 항의 납입방법은 변경 또는 추가 시 사이트 공지사항을 통해 공지하여 시행할 수 있다.\n\n"+
        "제 9 조 (이용요금 납입자)\n"+
        "① 이용요금 납입자는 회사관리자를 원칙으로 한다. 단 당사의 합의하에 타인을 이용요금 납입자로 할 수 있다.\n"+
        ...
        "제 10 조 (이용요금에 대한 이의신청)\n"+
        "1. 운영자는 이용요금 청구 등에 오류가 있는 경우 다음과 같이 조치한다.\n"+
        " 1) 원칙적으로 회원이 과다 납입한 요금 등에 대하여는 그 금액을 반환한다. 다만, 회원이 동의할 경우 다음 회차에 청구할 요금에서 해당금액만큼을 감하여 청구할 수 있다.\n"+
        " 2) 운영자가 회원의 납입요금을 누락하여 청구한 경우 다음 회차에 합산하여 청구한다.\n"+
        " 3) 이용자 또는 이용요금 납입자는 이용요금에 관한 이의신청이 있는 경우 그 사유 발생을 안 날로부터 1월 이내, 그 사유가 발생한 날로부터 2월 이내에 하여야 합니다.\n\n"+
        "제 11 조 (사용자의 정보 보안)\n"+
        " 1. 사용자가 하나로 eSCM 시스템 가입 절차를 완료하는 순간부터 사용자는 입력한 정보의 비밀을 유지할 책임이 있으며, ID와 비밀번호를 사용하여 발생하는 모든 결과에 대한 책임은 사용자에게 있다. \n"+
        ...
        " 1. 하나로 eSCM 사이트는 서비스를 운영함에 있어서 각종 정보를 홈페이지에 게재하는 방법, SMS 또는 전자우편이나 서신 우편 발송등으로 이용자 본인에게 제공할 수 있다. \n"+
        " 2. 하나로 eSCM 사이트는 서비스에 적절하다고 판단되거나 공익성이 있는 홍보물을 게재할 수 있다. \n\n"+
        "제 13 조 (하나로 eSCM 사이트 게시물의 관리 운영)\n"+
        ...
        "제 14 조 (서비스 이용제한)\n"+
        " 1. 이용자가 제공하는 정보의 내용이 허위인 것으로 판명되거나, 허위가 있다고 의심할 만한 합리적인 사유가 발생할 경우 하나로 eSCM 사이트는 이용자의 본 서비스 사용을 일부 또는 전부 중지할 수 있으며, 이로 인해 발생하는 불이익에 대해 책임을 부담하지 아니한다. \n"+
        ...
        "제 15 조 (하나로 eSCM 사이트의 의무)\n"+
        " 1. 하나로 eSCM 사이트는 본 약관이 금지하거나 미풍양속에 반하는 행위를 하지 않으며, 지속적 안정적으로 서비스를 제공하기 위해 노력할 의무가 있다. \n"+
        ...
        "제 16 조 (회원의 의무)\n"+
        " 1. 회원 가입시에 요구되는 정보는 정확하게 기입하여야 한다. 또한 이미 제공된 귀하에 대한 정보가 정확한 정보가 되도록 유지, 갱신하여야 하며, 회원은 자신의 ID 및 비밀번호를 제3자가 이용하게 해서는 안된다. \n"+
        ...
        "제 17 조 (하나로 eSCM 사이트의 소유권)\n"+
        " 1. 하나로 eSCM 사이트가 제공하는 서비스, 그에 필요한 소프트웨어, 이미지, 마크, 로고, 디자인, 서비스명칭, 정보 및 상표 등과 관련된 지적재산권 및 기타 권리는 당 사이트에 소유권이 있다. \n"+
        ...
        this.policyPrivacy = 
        "개인정보취급처리(방침)\n\n"+
        "(주)이썸테크(이하 ‘이썸테크’라 합니다)는 「개인정보 보호법」 제30조 제1항 및 동법 시행령 제31조 제1항의 규정에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보취급(처리)방침을 수립 공개합니다.\n"+
        ...
        "  • 하나로 eSCM 사이트는 귀하의 개인정보보호를 매우 중요시하며, 『정보통신망이용촉진 및 정보보호에 관한법률』 상의 개인정보보호규정 및 정보통신부가 제정한 『개인정보보호지침』 을 준수하고 있습니다. 하나로 eSCM 사이트는 개인정보보호정책을 통하여 귀하께서 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.\n\n"+

        "제 1 조 (개인정보의 처리목적)\n"+
        "  ‘이썸테크’는 다음의 목적을 위하여 개인정보를 처리합니다.\n"+
        ...
        "  ‘이썸테크’는 법령에 따른 개인정보 보유 이용 기간 또는 정보 주체로부터 개인정보를 수집 시 동의 받은 개인정보 보유 이용기간 내에서 개인정보를 처리 보유합니다. 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.\n\n"+

        "  - 서비스 제공\n"+
        "    데이터연계 및 부가서비스 제공에 활용 : 서비스 탈퇴 및 보유 데이터 파기 시 까지\n\n"+

        "제 3 조 (개인정보의 제3자 제공)\n"+
        "  ‘이썸테크’는 정보주체의 개인정보를 제1조(개인정보의 처리목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.\n\n"+

        "제 4 조 (개인정보 처리의 위탁)\n"+
        "  1. ‘이썸테크’는 원활한 개인정보 업무 처리를 위하여 다음과 같이 개인정보 처리 업무를 위탁하고 있습니다.\n\n"+

        "  ① 금융결제원, 쿠콘(구KIBNET)\n"+
        "    - 위탁업무 내용: 자동이체(CMS) 은행계좌 등록 및 해지, 사용료 출금\n"+
        "    - 보유/이용 기간 : CMS 출금이체 신청일로부터 종료(해지) 일 후 5년까지\n"+
        "  ② 농협 중앙회, 경제지주, 금융지주 및 계열사와 관계사, 신세계아이앤씨\n"+
        "    - 위탁업무 내용: 문자, 알림톡 전송\n"+
        ...
        "제 5 조 (정보 주체의 권리•의무 및 행사 방법)\n"+
        "  1. 정보 주체는 ‘이썸테크’에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.\n"+
        "    - 개인정보 열람요구\n"+
        "    - 오류 등이 있을 경우 정정 요구\n"+
        "    - 삭제요구\n"+
        "    - 처리정지 요구\n\n"+
        ...
        "제 6 조 (처리하는 개인정보 항목)\n"+
        "  ‘이썸테크’는 다음과 같은 개인정보 항목을 처리하고 있습니다.\n"+
        ...
        "제 7 조 (개인정보 처리의 파기)\n"+
        "  1. ‘이썸테크’는 개인정보 보유 기간의 경과, 처리 목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체 없이 해당 개인정보를 파기합니다.\n"+
        ...
        "  ‘이썸테크’는 개인정보의 안정성 확보를 위해 다음과 같은 조치를 취하고 있습니다.\n\n"+
        ...
        "제 9 조 (개인정보 보호 책임자)\n"+
        "  ‘이썸테크’는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보 주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.\n\n"+
        ...
        "제 10 조 (개인정보 열람청구)\n"+
        "정보 주체는 「개인정보 보호법」 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. ‘이썸테크’는 정보 주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.\n\n"+
        ...
        "제 12 조 (고지의 의무)\n"+
        "개인정보취급(처리)방침 내용의 추가, 삭제 및 수정이 있을 시에는 개정 최소 7일 전부터 홈페이지의 공지사항을 통하여 고지할 것입니다. 다만, 이용자에게 불리하게 개인정보취급(처리)방침 내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예 기간을 두고 공지하겠습니다.\n\n\n"+

        "2015년 11월 2일 제정\n"+
        "2019년 8월 18일 개정\n"+
        "2021년 11월 1일 개정\n"+
        "제정 및 개정에 대한 상세한 내용은 하나로eSCM > 가입안내 > 개인정보처리방침에서 확인 가능합니다.";

        // 예금주 출금이체 동의서
        this.policyWithdraw =
        "제1조(약관의 적용)\n"+				
        "자동계좌이체제도(이하“자동이체”라 한다)에 의하여 각종 대금을 납부 하고자 하는 자(이하“납부자”\n라 한다)와 (주)이썸테크에 대하여 이 약관을 적용합니다.\n"+		
        "제2조(영업일)\n"+		
        ...
        "3. 근로자의 날\n"+		
        "제3조(출금)\n"+		
        "납부자가 지급하여야 할 요금에 대하여 별도의 통지 없이 납부자의 지정계좌에서 (주) 이썸테크가\n지정하는 납기일(휴일인 경우 익영업일)에 출금, 대체 납부됩니다.\n"+		
        "은행의 예금약관이나 약정서의 규정에 불구하고 예금청구서 기타 관련증서 없이 자동이체 처리절차에\n의하여 출금될 수 있습니다.\n"+		
        "제4조(과실 책임)\n"+		
        "자동이체 지정계좌의 예금잔액(자동대출 약정이 있는 경우 대출한도 포함)이 납기일 현재 (주)\n이썸테크가 청구한 금액보다 부족하거나, 예금의 지급제한, 약정대출의 연체 등 납부자의 과실에 의하여\n대체 납부가 불가능한 경우의 손해는 납부자의 책임으로 합니다.\n"+		
        "제5조(부분출금)\n"+		
        "부분출금방식으로 출금 처리할 경우 청구금액에 비해 예금잔액이 부족하여도 동 잔액을 전액 출금할\n"+
        "수 있습니다. 다만, 자동이체 대금으로 입금된 어음, 수표 등이 부도 처리되는 경우에는 현금이체\n분을 포함한 전액이 출금취소 됩니다.\n"+		
        "제6조(출금 우선 순위)\n"+		
        "납기일에 동일한 수종의 자동이체 청구가 있는 경우의 출금 우선 순위는 납부자의 거래은행에서 정하는\n바에 따릅니다.\n"+		
        "제7조(최초 개시일)\n"+		
        "자동이체 신규 신청에 의한 이체 개시일은 (주)이썸테크의 사정에 의하여 결정되며, \n(주) 이썸테크로부터 사전 통지 받은 납기일을 최초 개시일로 합니다.\n"+		
        "제8조(자동 이체 신청)\n"+		
        "(주)이썸테크는 자동이체를 실행하기 위하여 다음 각호에서 정하는 방법에 따라 미리 납부자로부터\n출금에 대한 동의를 얻어야 합니다.\n"+		
        "1. 은행이 납부자로부터 서면(공인전자 서명이 있는 전자문서를 포함한다. 이하 이 조에서 같다)에\n의하여 자동이체 신청을 받는 방법\n"+		
        "2. (주)이썸테크가 납부자로부터 서면에 의한 출금의 동의를 받아 은행에게 전달(전자적 방법으로 \n자동이체신청내역을 전송하는 경우를 포함한다.)하는 방법\n"+		
        "제9조(신청서 제출)\n"+		
        "제8조에 의한 자동이체(신규, 해지, 변경) 신청 시 공인전자 서명 방식의 전자문서로 신청서는 즉시\n제출되며, 해지신청이 제출 및 승인된 경우는 전자금융거래법에 규정된 출금동의의 철회로 봅니다.\n"+		
        "제10조(출금기준 및 이의 제기)\n"+		
        "자동이체 신청에 의한 지정계좌에서의 출금은 해당 납기일 은행 영업 시간 내에 입금된 예금에 한하여\n출금되며, 청구금액에 이의가 있는 경우에는 납부자와 (주) 이썸테크가 협의하여 조정합니다.\n"+		
        "제11조(정보 제공)\n"+		
        "자동이체 업무처리를 위하여 자동이체와 관련된 납부자의 정보(납부자명, 사업자(주민)등록번호, 거래\n은행명, 계좌번호 등)가 금융결제원 및 납부자 거래은행, 중계업체에 제공됩니다.\n"+		
        "제12조(은행의 자동이체 임의 해지)\n"+		
        "자동이체 등록 계좌가 2년 동안 자동이체 이용 실적이 없는 경우 은행에서 해당 납부자에게 사전 통지\n없이 자동이체를 해지 할 수 있습니다.";

        // 금융거래 정보제공 동의서
        this.policyFinancial =
        "1. 신용정보의 제공\n"+
        "예금주의 성명/상호, 요금내역, 금융기관명, 예금주, 계좌번호 등\n"+
        "2. 제공받는 자\n"+
        "자동이체 및 계좌확인을 위해 해당은행, 금융결제원, 케이아이비넷㈜ 등에 제공\n"+
        "3. 이용 및 보유기간\n"+
        "회원가입 시점부터 회원 해지일 까지 이용하며, 요금정산/요금과오납 등 분쟁을 대비하기 위해 해지 후\n"+
        "6개월까지, 요금정산이 미완료된 경우 해결일로 부터 6개월까지 보유 (단, 법령에 특별한 규정이 있을\n경우  관련 법령에 따름)";
        });
