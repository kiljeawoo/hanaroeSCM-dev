(function()
{
    return function()
    {
        ...
        this.loadTypedefition = function()
        {
            ...
            this._addService("default_typedef.xml", "OMG.GT", "form", "./OMG/GT/", "dynamic", null, "", "", "0");
		    this._addService("default_typedef.xml", "SCM2.UATTND", "form", "./SCM2/UATTND/", "dynamic", null, "", "0", "0");
			this._addService("default_typedef.xml", "SCM2.LQR", "form", "./SCM2/LQR/", "dynamic", null, "", "0", "0");
			this._addService("default_typedef.xml", "SCM2.AGR", "form", "./SCM2/AGR/", "dynamic", null, "", "", "0");
			this._addService("default_typedef.xml", "SCM2.MKT", "form", "./SCM2/MKT/", "dynamic", null, "", "0", "0");
			this._addService("default_typedef.xml", "SCM2.MLS", "form", "./SCM2/MLS/", "dynamic", null, "", "0", "0");
        ...
        this.on_loadGlobalVariables = function()
        {
            ...
            obj = new Dataset("gds_serviceGT", this);
            obj._setContents("<ColumnInfo><Column id=\"MENU_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MENU_LEVEL\" type=\"STRING\" size=\"256\"/><Column id=\"MENU_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"SVC_GROUP\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_PATH\" type=\"STRING\" size=\"256\"/><Column id=\"DISPLAY_YN\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"MENU_ID\">10000000</Col><Col id=\"MENU_LEVEL\">0</Col><Col id=\"MENU_NAME\">계약체결 및 거래중단</Col><Col id=\"FILE_TYPE\">xfdl</Col><Col id=\"DISPLAY_YN\">Y</Col><Col id=\"USE_YN\">Y</Col></Row><Row><Col id=\"MENU_ID\">10100000</Col><Col id=\"MENU_LEVEL\">1</Col><Col id=\"MENU_NAME\">계약체결</Col><Col id=\"SVC_GROUP\">OMG.GT</Col><Col id=\"FILE_NAME\">OMG_DS_SC_1001</Col><Col id=\"FILE_TYPE\">xfdl</Col><Col id=\"DISPLAY_YN\">Y</Col><Col id=\"USE_YN\">Y</Col></Row><Row><Col id=\"MENU_ID\">10200000</Col><Col id=\"MENU_LEVEL\">1</Col><Col id=\"MENU_NAME\">거래중단</Col><Col id=\"SVC_GROUP\">OMG.GT</Col><Col id=\"FILE_NAME\">OMG_DS_SC_1002</Col><Col id=\"FILE_TYPE\">xfdl</Col><Col id=\"DISPLAY_YN\">Y</Col><Col id=\"USE_YN\">Y</Col></Row><Row><Col id=\"MENU_ID\">20000000</Col><Col id=\"MENU_LEVEL\">0</Col><Col id=\"MENU_NAME\">판매장려금</Col><Col id=\"FILE_TYPE\">xfdl</Col><Col id=\"DISPLAY_YN\">Y</Col><Col id=\"USE_YN\">Y</Col></Row><Row><Col id=\"MENU_ID\">20100000</Col><Col id=\"MENU_LEVEL\">1</Col><Col id=\"MENU_NAME\">판매장려금 결정</Col><Col id=\"SVC_GROUP\">OMG.GT</Col><Col id=\"FILE_NAME\">OMG_DS_SC_2001</Col><Col id=\"FILE_TYPE\">xfdl</Col><Col id=\"DISPLAY_YN\">Y</Col><Col id=\"USE_YN\">Y</Col></Row><Row><Col id=\"MENU_ID\">30000000</Col><Col id=\"MENU_LEVEL\">0</Col><Col id=\"MENU_NAME\">판촉행사</Col><Col id=\"FILE_TYPE\">xfdl</Col><Col id=\"DISPLAY_YN\">Y</Col><Col id=\"USE_YN\">Y</Col></Row><Row><Col id=\"MENU_ID\">30100000</Col><Col id=\"MENU_LEVEL\">1</Col><Col id=\"MENU_NAME\">판촉행사 진행</Col><Col id=\"SVC_GROUP\">OMG.GT</Col><Col id=\"FILE_NAME\">OMG_DS_SC_3001</Col><Col id=\"FILE_TYPE\">xfdl</Col><Col id=\"DISPLAY_YN\">Y</Col><Col id=\"USE_YN\">Y</Col></Row><Row><Col id=\"MENU_ID\">40000000</Col><Col id=\"MENU_LEVEL\">0</Col><Col id=\"MENU_NAME\">매장 설비변경</Col><Col id=\"FILE_TYPE\">xfdl</Col><Col id=\"DISPLAY_YN\">Y</Col><Col id=\"USE_YN\">Y</Col></Row><Row><Col id=\"MENU_ID\">40100000</Col><Col id=\"MENU_LEVEL\">1</Col><Col id=\"MENU_NAME\">매장 설비변경 비용 분담기준</Col><Col id=\"SVC_GROUP\">OMG.GT</Col><Col id=\"FILE_NAME\">OMG_DS_SC_4001</Col><Col id=\"FILE_TYPE\">xfdl</Col><Col id=\"DISPLAY_YN\">Y</Col><Col id=\"USE_YN\">Y</Col></Row><Row><Col id=\"MENU_ID\">50000000</Col><Col id=\"MENU_LEVEL\">0</Col><Col id=\"MENU_NAME\">동반성장&amp;공정거래</Col><Col id=\"FILE_TYPE\">xfdl</Col><Col id=\"DISPLAY_YN\">Y</Col><Col id=\"USE_YN\">Y</Col></Row><Row><Col id=\"MENU_ID\">50100000</Col><Col id=\"MENU_LEVEL\">1</Col><Col id=\"MENU_NAME\">동반성장&amp;공정거래 게시판</Col><Col id=\"SVC_GROUP\">OMG.PT</Col><Col id=\"FILE_NAME\">OMG_DS_SC_4110</Col><Col id=\"FILE_TYPE\">xfdl</Col><Col id=\"DISPLAY_YN\">Y</Col><Col id=\"USE_YN\">Y</Col></Row></Rows>");
            this._addDataset(obj.name, obj);
            obj = null;
        ...
        this.application_onload = function(obj,e)
        {
        	...
        	if(checkServer.indexOf('file') != -1 || adlUrl.indexOf('localhost') != -1){//로컬
        		...
        		iconUrl = "http://localhost:8080/nhvan/escm/nhvan.ico";
        		 ...
        		 application.gv_chartJS_url      	= domain + "/chart/rMateChartH5";
        		 application.gv_chartHtml_url    	= domain + "/chart/rMateChartH5/Html/nexacroChartH5.html";
        		 application.gv_ozViewer_url     	= domain + "/nhvan/oz/ozViewer.nh";
        		 application.gv_serviceHtml_url  	= domain + "/";
        		 application.gv_userId = "";
        		 application.gv_redirect_url        = domain + "/index.html";		 
        		 iconUrl = domain+"/nhvan.ico";		 
        		 
        		 if(devMode){ //개발
        			application.services['svc_admin'].url = domain + ":8020/nhvanadmin/";
        			application.gv_serverAdmin_url        = domain + ":8020/nhvanadmin/";
        		 }else{//운영
