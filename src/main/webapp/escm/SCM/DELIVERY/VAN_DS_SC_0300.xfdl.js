(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_r1NaBzplC", this);
            obj._setContents("<ColumnInfo><Column id=\"NA_BZPLC\" type=\"STRING\" size=\"256\"/><Column id=\"SHRT_BZPLNM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_text("Div00");
            obj.set_url("common::AuthorityWorkplaceLiq.xfdl");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_dum_print", "absolute", null, "0", "51", "21", "71", null, this);
        ...
        this.loadPreloadList = function()
        {
            ...
            this._addPreloadList("fdl", "common::AuthorityWorkplaceLiq.xfdl");
        };
        
        // User Script
        this.addIncludeScript("VAN_DS_SC_0300.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0300.xfdl", function() {
        ...
        *****************************************************************************************/
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	this.fn_getR1NaBzplC();	// R1 사업장코드 조회
        };
        ...
        */
        ...
        // R1 사업장코드 조회
        this.fn_getR1NaBzplC = function () {
        	var sSvcID        = "retrieveR1NaBzplC";//통신아이디
        	var sURL          = "svc::/rest/scm/delivery/retrieveR1NaBzplC";// 호출할 서버 페이지 주소
        	var sInDatasets   = "";//보내는데이터셋
        	var sOutDatasets  = "ds_r1NaBzplC=ds_r1NaBzplC";	//화면에서 받는 데이터셋=보낸이름(1대1 맵핑)
        	var sArgument     = "";// 파라미터
        	var sCallbackFunc = "fn_callBack";//콜백
        	var sTranType     = "S"; // U:저장/삭제, S:조회
        ...
        this.fn_validationDetail = function()
        {
        	...
        	// 탄력가격업체일 때 확인하도록 변경(200219)
        	// 일반업체의 경우 수정이 되지 않아 발주가 잘못되면 진행이 되지 않음
        	if (var_rots_flex_pr_apl_yn == "1") {
        ...
        */
        	...
        	for (var i = 0; i < this.ds_r1NaBzplC.rowcount; i++) {
        		...
        		if (odrpl_na_trpl_c == naBzplc) {
        			if (   odrpl_na_trpl_c == "8808983322353"	// 농협안성저온물류센터(식자재)
        				...
        				|| odrpl_na_trpl_c == "8808983332277"	// 농협마트사업강원지사(저온) 220314
        			) {
        				isR1 = "N";
        			} else {
        				isR1 = "Y";
        ...
        this.fn_BizDtYn = function(chkPart,preDate,date)
        {
        	...
        	if (this.gfn_isNull(this.ds_dataM.getColumn(0, "ODRPL_NA_TRPL_C")) == false
        ...
        this.fn_popupAfter = function(strId,strVal)
        {
        	...
        	if (strId == "POPUP_TRNREL_ODRPL") {
        		...
        		// 발주처 조회 후 배송예정일 휴일 조회(180416, 무발주시 당일 배송예정서 작성은 저장 시점에만 휴일 체크되는 점 보완)
        		var dvy_pla_dt	= this.gfn_nullToEmpty(this.cal_dvy_pla_dt.value);
        		this.fn_BizDtYn("1", "", dvy_pla_dt);
        	}
        ...
        */
        ...
        this.fn_syncBizDtYn = function()
        {
        	...
        	if (this.ds_bizDtYn.getColumn(0, "BIZDY_YN") == "0") {
        		...
        		var dvy_pla_dt_num = this.gfn_getNum(postValue);
        		var bizDt_num = this.gfn_getNum(bizDt);
        		
        		var diffDate = bizDt_num - dvy_pla_dt_num;
        		var hldyDtInt = bizDt_num;
        		var hldyDtStr = "";
        		
        		if(diffDate > 0) {
        			hldyDtInt = bizDt_num - diffDate;
        		} else {
        			hldyDtInt = bizDt_num;
        		}
        		hldyDtStr = this.gfn_toString(hldyDtInt);
        		
        		//alert("[ "+bizDt.substring(4, 6)+"/"+bizDt.substring(6, 8)+" ] 은 해당 사업장의 휴일입니다.");
        		
        		if(diffDate > 0) {
        			alert("[ "+hldyDtStr.substring(4, 6)+"/"+hldyDtStr.substring(6, 8)+" ] 은 해당 사업장의 휴일입니다.\n영업가능일은 [ "+bizDt.substring(4, 6)+"/"+bizDt.substring(6, 8)+" ] 입니다.");
        		} else {
        			alert("[ "+bizDt.substring(4, 6)+"/"+bizDt.substring(6, 8)+" ] 은 해당 사업장의 휴일입니다.");
        		}
        ...
        this.fn_print = function()
        {
        	...
        	var ozParam = {
              ...
              paramType: 'param', 
              sParam: {naDvyPlashSlpno:var_na_dvy_plash_slpno, spyplNaTrplC:var_spypl_na_trpl_c, dvyaaNaTrplC:var_dvyaa_na_trpl_c, systemFileName:sFileName, ozType:ozType, odrpl_na_trpl_c: odrpl_na_trpl_c, dvyPlaDt: dvy_pla_dt}
              /*
              sUrl: '/rest/oz/delivery/printDeliveryNoticeOrder', 
              paramType: 'param', 
        ...
        // 덤상품 거래명세표 출력
        this.fn_dum_print = function()
        {
        	if (var_spypl_na_trpl_c == "" && var_dvyaa_na_trpl_c == "" && var_na_dvy_plash_slpno == "" && this.gfn_isNull(this.edt_na_dvy_plash_slpno.value)) {
        		this.alert("배송예정서를 입력하세요");
        		return;
        	}
        ...
        // 	trace(var_na_dvy_plash_slpno);
        	...
        	var ozParam = {
        		sId: 'VAN_DS_SC_0303', 
        		sUrl: '/rest/oz/delivery/printDeliveryNoticeOrderDum', 
        		paramType: 'param', 
        		sParam: {
        					naDvyPlashSlpno:var_na_dvy_plash_slpno, 
        					spyplNaTrplC:var_spypl_na_trpl_c, 
        					dvyaaNaTrplC:var_dvyaa_na_trpl_c, 
        ...
        this.fn_ds_dataM_oncolumnchanged = function(obj,e)
        {
        	if (!this.gfn_isNull(this.edt_na_dvy_plash_slpno.value)) {
        		this.cal_dvy_pla_dt.set_enable(false);
        	} else if (this.gfn_isNull(this.ds_dataM.getColumn(0, "DVYAA_NA_TRPL_C")) == false) {
        		var flag = true;
        ...
        {
            this.ds_dataM.addEventHandler("oncolumnchanged", this.fn_ds_dataM_oncolumnchanged, this);
            ...
            this.btn_dum_print.addEventHandler("onclick", this.fn_dum_print, this);

        };

        this.loadIncludeScript("VAN_DS_SC_0300.xfdl");
