(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("frmFillFunction.xfdl", "lib::comChart.xjs");
        this.registerScript("frmFillFunction.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("frmFillFunction.xfdl");
