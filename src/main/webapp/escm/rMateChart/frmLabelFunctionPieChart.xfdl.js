(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("frmLabelFunctionPieChart.xfdl", "lib::comChart.xjs");
        this.registerScript("frmLabelFunctionPieChart.xfdl", function() {
        ...
        this.frmLabelFunctionPieChart_onload = function(obj,e) {
        	...
        	this.rMateChartCreate(this.chart1, scriptRootUrl, htmlUrl, this.makeChartVars());
        }
        ...
        */
        ...
        this.loadIncludeScript("frmLabelFunctionPieChart.xfdl");
