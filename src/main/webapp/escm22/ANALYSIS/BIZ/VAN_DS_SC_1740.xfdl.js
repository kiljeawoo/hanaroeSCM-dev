    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1740");
                this.set_titletext("소분류 일평균 매출액 TOP10");
                this._setFormPosition(0,0,803,490);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_topMonthDivision", this);
            ...
            obj = new Layout("default", "", 803, 490, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("VAN_DS_SC_1750");
            		p.set_titletext("소분류 일평균 매출액 TOP10");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1740.xfdl", 'lib::comLib.xjs');
        this.addIncludeScript("VAN_DS_SC_1740.xfdl", 'lib::comChart.xjs');
        this.registerScript("VAN_DS_SC_1740.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_1740.xfdl", true);
