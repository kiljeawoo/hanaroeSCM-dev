(function()
{
    return function()
    {
        ...
        this.registerScript("OMG_DS_SC_6712.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_save.addEventHandler("onclick", this.btn_usernamechk_onclick, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_6712.xfdl", true);
