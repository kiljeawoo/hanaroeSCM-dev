    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1750");
                this.set_titletext("상품 판매순위 TOP10 조회");
                this._setFormPosition(0,0,803,490);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_topStore", this);
            ...
            obj.set_taborder("5");
            obj.set_binddataset("ds_topStore");
            ...
            obj = new Layout("default", "", 803, 490, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("상품 판매순위 TOP10 조회");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1750.xfdl", 'lib::comLib.xjs');
        this.addIncludeScript("VAN_DS_SC_1750.xfdl", 'lib::comChart.xjs');
        this.registerScript("VAN_DS_SC_1750.xfdl", function(exports) {
        ...
        this.search = function(trId){
        	...
        	this.gfn_callService(
        						trId, 
        						'svc::rest/analysis/biz/Intelligence/retrieveTopStore', 
        						'', 
        						'ds_topStore=ds_topStore', 
        						param,
        						'fn_callback',
        						'S'
        						);
        ...
        this.btn_excel_onclick = function(obj,e)
        {
        	...
        	//this.div_list.web_downExcelM.set_url(application.gv_server_url+"rest/excel/downloadExcelTopStore?"+params);
        	excelDownHandler(application.gv_server_url+"rest/excel/downloadExcelTopStore?"+params, this);
        }
        ...
        this.loadIncludeScript("VAN_DS_SC_1750.xfdl", true);
