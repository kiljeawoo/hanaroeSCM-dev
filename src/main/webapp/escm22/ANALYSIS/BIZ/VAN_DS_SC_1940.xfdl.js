    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1940");
                this.set_titletext("월별 판매순위 랭킹");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1940.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1940.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_1940.xfdl", true);
