    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1700");
                this.set_titletext("월별 일평균 매출추이 조회");
                this._setFormPosition(0,0,803,490);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_monthlyAverage", this);
            ...
            obj.set_taborder("1");
            obj.set_binddataset("ds_monthlyAverage");
            obj.set_autofittype("none");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"150\"/><Column size=\"150\"/><Column size=\"200\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/><Row size=\"28\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"판매월\"/><Cell col=\"1\" text=\"수량\"/><Cell col=\"2\" text=\"일평균매출액(천원)\"/></Band><Band id=\"body\"><Cell text=\"bind:YMD\" mask=\"@@@@-@@\"/><Cell col=\"1\" displaytype=\"number\" style=\"align:right;\" text=\"bind:QTY\" mask=\"#,##0\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" text=\"bind:AMOUNT\" mask=\"#,##0\"/></Band><Band id=\"summary\"><Cell style=\"align:center;\" text=\"합계\"/><Cell col=\"1\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:dataset.getSum('QTY')\" mask=\"#,###\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:dataset.getSum('AMOUNT')\" mask=\"#,###\"/></Band></Format></Formats>");
            ...
            obj = new Layout("default", "", 803, 490, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("VAN_DS_SC_1700");
            		p.set_titletext("월별 일평균 매출추이 조회");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1700.xfdl", 'lib::comLib.xjs');
        this.addIncludeScript("VAN_DS_SC_1700.xfdl", 'lib::comChart.xjs');
        this.registerScript("VAN_DS_SC_1700.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_1700.xfdl", true);
