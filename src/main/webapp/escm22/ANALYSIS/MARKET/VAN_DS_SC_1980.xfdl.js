    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1980");
                this.set_titletext("주별 경쟁사 시장분석");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1980.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1980.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_1980.xfdl", true);
