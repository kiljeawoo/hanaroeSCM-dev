    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1920");
                this.set_titletext("자사상품 월별 시장점유율 상세");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/><Column id=\"AMOUNT\" type=\"INT\" size=\"256\"/><Column id=\"POINT\" type=\"FLOAT\" size=\"256\"/><Column id=\"AMOUNT_TOT\" type=\"INT\" size=\"256\"/><Column id=\"QTY\" type=\"INT\" size=\"256\"/><Column id=\"AMOUNT_ORG\" type=\"STRING\" size=\"256\"/><Column id=\"AMOUNT_TOT_ORG\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            rdo_div_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">소분류/상품</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">소분류/사업장</Col></Row></Rows>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"90\"/><Column size=\"200\"/><Column size=\"80\"/><Column size=\"85\"/><Column size=\"80\"/><Column size=\"90\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/><Row size=\"28\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"상품코드\"/><Cell col=\"1\" text=\"상품명\"/><Cell col=\"2\" text=\"수량\"/><Cell col=\"3\" text=\"판매액(천원)\"/><Cell col=\"4\" text=\"점유율(%)\"/><Cell col=\"5\" text=\"그래프\"/></Band><Band id=\"body\"><Cell text=\"bind:CODE\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:NAME\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" text=\"bind:QTY\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:AMOUNT\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" text=\"bind:POINT\"/><Cell col=\"5\" displaytype=\"bar\" style=\"controlbackground:cornsilk;controlcolor:#ffffff00;\" text=\"bind:POINT\"/></Band><Band id=\"summary\"><Cell colspan=\"2\" style=\"align:center;\" text=\"합 계\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;padding:0 4 0 0;\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;padding:0 4 0 0;\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;padding:0 4 0 0;\"/><Cell col=\"5\" displaytype=\"bar\" style=\"padding:3 3 3 3;controlbackground:cornsilk;controlcolor:#ffffff00;\"/></Band></Format></Formats>");
            this.div_list.addChild(obj.name, obj);
            obj = new Grid("grd_left", "absolute", "0", "42", null, null, "62.56%", "0", this.div_list);
            obj.set_taborder("2");
            obj.set_binddataset("ds_left");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"90\"/><Column size=\"200\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"소분류코드\"/><Cell col=\"1\" text=\"소분류명\"/></Band><Band id=\"body\"><Cell text=\"bind:CODE\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:NAME\"/></Band></Format></Formats>");
            this.div_list.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 803, 490, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("자사상품 월별 시장점유율 상세");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1920.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1920.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_1920.xfdl", true);
