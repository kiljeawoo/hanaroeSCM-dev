    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1930");
                this.set_titletext("자사상품 주별 시장점유율 상세");
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("sta_div", "absolute", "16", "36", "79", "21", null, null, this.div_search);
            obj.set_taborder("4");
            obj.set_text("구분");
            obj.set_cssclass("sta_WFSA_Label");
            obj.style.set_padding("0 15 0 11");
            ...
            obj = new Radio("rdo_div", "absolute", "95", "36", "220", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 803, 490, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("자사상품 주별 시장점유율 상세");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1930.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1930.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_1930.xfdl", true);
