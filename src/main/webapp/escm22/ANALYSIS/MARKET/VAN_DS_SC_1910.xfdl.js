    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1910");
                this.set_titletext("자사상품 주별 시장점유율");
            ...
            obj = new Static("sta_location", "absolute", "333", "10", "79", "21", null, null, this.div_search);
            obj.set_taborder("1");
            obj.set_text("지역");
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_index("-1");
            obj = new Combo("cbo_locMain", "absolute", "412", "10", "207", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("8");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1910.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1910.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_1910.xfdl", true);
