(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("21");
            obj.set_text("시범기간동안 2016년 8월(15일 이후)만  조회됩니다. ");
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Combo("cbo_date", "absolute", "94", "10", "208", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("22");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1991_ver0.1.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1991_ver0.1.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_1991_ver0.1.xfdl", true);
