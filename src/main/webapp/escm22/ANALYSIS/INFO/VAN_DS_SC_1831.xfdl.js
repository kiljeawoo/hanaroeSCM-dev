    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1831");
                this.set_titletext("자사 월별 재고추이");
                this._setFormPosition(0,0,803,490);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_stockMonthly", this);
            ...
            obj.set_taborder("0");
            obj.set_binddataset("ds_stockMonthly");
            ...
            this.div_list.addChild(obj.name, obj);
            obj = new WebBrowser("web_downExcel", "absolute", "49.87%", "20", null, "17", "41.62%", null, this.div_list);
            obj.set_taborder("4");
            obj.set_visible("false");
            this.div_list.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1831.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("VAN_DS_SC_1831.xfdl", 'lib::comChart.xjs');
        this.registerScript("VAN_DS_SC_1831.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_1831.xfdl", true);
