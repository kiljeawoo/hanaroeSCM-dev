    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1811");
                this.set_titletext("자사 주별 판매추이");
                this._setFormPosition(0,0,803,490);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_salesWeekly", this);
            ...
            obj._setContents("<ColumnInfo><Column id=\"YMD\" type=\"STRING\" size=\"256\"/><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/><Column id=\"AMOUNT\" type=\"INT\" size=\"256\"/><Column id=\"QTY\" type=\"INT\" size=\"256\"/><Column id=\"WEEKS\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj.set_taborder("0");
            obj.set_binddataset("ds_salesWeekly");
            obj.set_autofittype("none");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"130\"/><Column size=\"130\"/><Column size=\"300\"/><Column size=\"130\"/><Column size=\"90\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell style=\"cursor: ;\" text=\"주차\"/><Cell col=\"1\" text=\"사업장코드\"/><Cell col=\"2\" text=\"사업장명\"/><Cell col=\"3\" text=\"매출액(천원)\"/><Cell col=\"4\" text=\"수량\"/></Band><Band id=\"body\"><Cell text=\"bind:WEEKS\"/><Cell col=\"1\" text=\"bind:CODE\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:NAME\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:AMOUNT\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" text=\"bind:QTY\"/></Band></Format></Formats>");
            this.div_list.addChild(obj.name, obj);
            obj = new WebBrowser("wb_chart", "absolute", "0", "42", null, null, "0", "0", this.div_list);
            obj.set_taborder("1");
            obj.set_visible("false");
            this.div_list.addChild(obj.name, obj);
            obj = new WebBrowser("web_downExcel", "absolute", "46.83%", "20", null, "17", "44.67%", null, this.div_list);
            obj.set_taborder("4");
            obj.set_visible("false");
            this.div_list.addChild(obj.name, obj);
            ...
            //-- Default Layout
            obj = new Layout("default", "", 788, 419, this.div_list,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("49");
            		p.set_text("Div02");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1811.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("VAN_DS_SC_1811.xfdl", 'lib::comChart.xjs');
        this.registerScript("VAN_DS_SC_1811.xfdl", function(exports) {
        ...
        this.search = function(trId){
        	...
        	this.gfn_callService(
        						trId, 
        						"svc::/rest/analysis/info/infoChange/retrieveSalesWeeklyList", 
        						"", 
        						"ds_salesWeekly=ds_salesWeekly ds_inte=ds_inte", 
        						param,
        						"fn_callback",
        						'S'
        						);
        ...
        this.fn_callback = function(trId,errCode,errMsg){
        	...
        	if(trId == "list" || trId == "init"){
        		...
        		if(analysis == 1){
        			codeText = '사업장코드';
        			nameText = '사업장명';
        			table = 'IAS_SL_WW_BZPLC';
        			msg = '등록된 관심사업장이 없습니다.\n관심사업장을 등록하세요.'
        		}
        		else if(analysis == 2){
        			codeText = '상품코드';
        			nameText = '상품명';
        			table = 'IAS_SL_WW_WRS_C';
        			msg = '등록된 관심상품이 없습니다.\n관심상품을 등록하세요.'
        		}
        ...
        this.chartInfoProp = function(){
        	...
        	var ds = this.ds_salesWeekly; //데이터셋
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.rdo_analysis.addEventHandler("onitemclick", this.div_search_rdo_analysis_onitemclick, this);
            this.div_list.btn_show.addEventHandler("onclick", this.btn_show_onclick, this);

        };

        this.loadIncludeScript("VAN_DS_SC_1811.xfdl", true);
