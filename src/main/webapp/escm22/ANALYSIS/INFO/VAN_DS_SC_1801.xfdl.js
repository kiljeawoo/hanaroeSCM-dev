    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1801");
                this.set_titletext("자사 월별 판매추이");
                this._setFormPosition(0,0,803,490);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_salesMonthly", this);
            ...
            obj.set_taborder("1");
            obj.set_binddataset("ds_salesMonthly");
            obj.set_autofittype("none");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"130\"/><Column size=\"130\"/><Column size=\"300\"/><Column size=\"130\"/><Column size=\"90\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell style=\"cursor: ;\" text=\"년월\"/><Cell col=\"1\" text=\"사업장코드\"/><Cell col=\"2\" text=\"사업장명\"/><Cell col=\"3\" text=\"매출액(천원)\"/><Cell col=\"4\" text=\"수량\"/></Band><Band id=\"body\"><Cell text=\"bind:YMD\" mask=\"@@@@-@@\"/><Cell col=\"1\" text=\"bind:CODE\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:NAME\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:AMOUNT\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" text=\"bind:QTY\"/></Band></Format></Formats>");
            ...
            this.div_list.addChild(obj.name, obj);
            obj = new WebBrowser("web_downExcel", "absolute", null, "20", "67", "17", "272", null, this.div_list);
            obj.set_taborder("4");
            obj.set_visible("false");
            this.div_list.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1801.xfdl", 'lib::comLib.xjs');
        this.addIncludeScript("VAN_DS_SC_1801.xfdl", 'lib::comChart.xjs');
        this.registerScript("VAN_DS_SC_1801.xfdl", function(exports) {
        ...
        this.search = function(trId){
        	...
        	//데이터셋 초기화
        	this.ds_salesMonthly.clearData();	
        	...
        	this.gfn_callService(
        						trId, 
        						'svc::rest/analysis/info/infoChange/retrieveSalesMonthlyList', 
        						'', 
        						'ds_salesMonthly=ds_salesMonthly ds_inte=ds_inte', 
        						param,
        						'fn_callback',
        						'S'
        						);
        ...
        this.fn_callback = function(trId,errCode,errMsg){
        	...
        	if(trId == "list" || trId == "init"){
        		...
        		if(analysis == 1){
        			codeText = '사업장코드';
        			nameText = '사업장명';
        			table = 'IAS_SL_MM_BZPLC';
        			msg = '등록된 관심사업장이 없습니다.\n관심사업장을 등록하세요.'
        		}else if(analysis == 2){
        			codeText = '상품코드';
        			nameText = '상품명';
        			table = 'IAS_SL_MM_WRS_C';
        			msg = '등록된 관심상품이 없습니다.\n관심상품을 등록하세요.'
        		}		
        ...
        this.chartInfoProp = function(){
        	...
        	var ds = this.ds_salesMonthly; //데이터셋
        	var grid = this.div_list.grd_list; //그리드
        	var btn = this.btn_chart; //버튼
        	var chartInfo = {
        						chartId: "salesMonthly",
        						chartType: "LINE",
        						title: "자사 월별 판매 추이",
        						subTitle: "(단위:천원)",
        						displayName: "",
        						xAxis: "YMD",
        						yAxis: "CODE:NAME", //대체컬럼 : 원컬럼
        						yAxisData: "AMOUNT",
        						orderBy: "S:YMD"
        					};
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onactivate", this.VAN_DS_SC_1801_onactivate, this);
        ...
        this.loadIncludeScript("VAN_DS_SC_1801.xfdl", true);
