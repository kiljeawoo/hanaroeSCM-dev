    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_1821");
                this.set_titletext("자사 일별 판매추이");
                this._setFormPosition(0,0,803,490);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_salesDaily", this);
            ...
            obj.set_taborder("0");
            obj.set_binddataset("ds_salesDaily");
            ...
            this.div_list.addChild(obj.name, obj);
            obj = new WebBrowser("web_downExcel", "absolute", "50.89%", "20", null, "17", "40.61%", null, this.div_list);
            obj.set_taborder("4");
            obj.set_visible("false");
            this.div_list.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1821.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("VAN_DS_SC_1821.xfdl", 'lib::comChart.xjs');
        this.registerScript("VAN_DS_SC_1821.xfdl", function(exports) {
        ...
        this.search = function(trId){
        	...
        	this.gfn_callService(
        						trId, 
        						"svc::/rest/analysis/info/infoChange/retrieveSalesDailyList", 
        						"", 
        						"ds_salesDaily=ds_salesDaily ds_inte=ds_inte", 
        						param,
        						"fn_callback",
        						'S'
        						);
        ...
        this.chartInfoProp = function(){
        	...
        	var ds = this.ds_salesDaily; //데이터셋
        ...
        this.loadIncludeScript("VAN_DS_SC_1821.xfdl", true);
