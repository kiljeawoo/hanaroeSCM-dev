    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("쿠폰대금업로드(집계)조회");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1631.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1631.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_1631.xfdl", true);
