    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("frm_VAN_DS_SC_0730");
                this.set_titletext("주류 물류센터_지사 출고 실적");
                this.set_name("frm_VAN_DS_SC_0730");
            ...
            obj = new Layout("default", "", 803, 1007, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("주류 물류센터_지사 출고 실적");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0730.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0730.xfdl", function(exports) {
        ...
        this.fn_search = function(){
        	...
        	if(this.fn_validationCheck()){		
        		...
        		var sURL          = "svc::rest/center/na/retrieveLiquorWrsMasterList";// 호출할 서버 페이지 주소
        ...
        this.fn_searchScd = function(){	
            ...
            */
        	...
        	var sURL          = "svc::rest/center/na/retrieveLiquorWrsDetailList";// 호출할 서버 페이지 주소
        	var sInDatasets   = "";//보내는데이터셋
        ...
        this.fn_excel = function(){
        	if(this.fn_validationCheck()){
        		...
        		//this.div_list.web_downExcelM.set_url(application.gv_server_url+"rest/excel/na/downloadExcelLiquorWrsMasterList?"+param);
        		excelDownHandler(application.gv_server_url+"rest/excel/na/downloadExcelLiquorWrsMasterList?"+param, this);
        	}
        }
        ...
        this.div_list_btn_gradD_excel_onclick = function(obj,e)
        {
        	...
        	if(this.fn_validationCheck()){
        		...
        		//this.div_list.web_downExcelD.set_url(application.gv_server_url+"rest/excel/na/downloadExcelLiquorWrsDetailList?"+param+param2);
        		excelDownHandler(application.gv_server_url+"rest/excel/na/downloadExcelLiquorWrsDetailList?"+param+param2, this);
        	}
        }
        ...
        this.btn_excelDetail_onclick = function(obj,e)
        {
        	...
        	this.div_list.web_downExcelD.set_url(application.gv_server_url+"rest/excel/na/downloadExcelLiquorDetail?"+param);
        }
        ...
        this.btn_excel00_onclick = function(obj,e)
        {
        	if(this.fn_validationCheck()){
        		...
        		//this.div_list.web_downExcelMaster.set_url(application.gv_server_url+"rest/excel/na/downloadExcelLiquorWrsMasterOnly?"+param);
        		excelDownHandler(application.gv_server_url+"rest/excel/na/downloadExcelLiquorWrsMasterOnly?"+param, this);
        	}
        }
        ...
        this.loadIncludeScript("VAN_DS_SC_0730.xfdl", true);
