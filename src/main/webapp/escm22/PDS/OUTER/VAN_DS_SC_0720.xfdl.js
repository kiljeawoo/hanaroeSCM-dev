    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("frm_VAN_DS_SC_0720");
                this.set_titletext("물류센터_지사 출고 실적");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"CSER_NA_TRPL_C\" type=\"string\" size=\"32\"/><Column id=\"CSER_NA_TRPL_N\" type=\"string\" size=\"32\"/><Column id=\"CSER_NA_TEAM_C\" type=\"string\" size=\"32\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("53");
            obj.set_innerdataset("@ds_master_data");
            obj.set_codecolumn("CSER_NA_TRPL_C");
            obj.set_datacolumn("CSER_NA_TRPL_N");
            ...
            obj.set_visible("false");
            this.div_list.addChild(obj.name, obj);
            obj = new WebBrowser("web_downExcelM", "absolute", "572", "12", "64", "17", null, null, this.div_list);
            obj.set_taborder("41");
            obj.set_visible("false");
            this.div_list.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0720.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0720.xfdl", function(exports) {
        ...
        this.fn_getNABizPlace = function(v_nacode){
        	...
        	//var nacode = v_nacode;
        	var nacode = application.gv_glnCode;
        	var search_type = "added";
        	
        	
        	
        	var param = "TRPL_C=" + nacode;
        ...
        this.fn_search = function(){
        	...
        	if(this.fn_validationCheck()){
        		...
        		var sURL          = "svc::rest/center/na/retrieveWrsMasterList";// 호출할 서버 페이지 주소
        	...
        	if(ErrorCode < 0)
        	{
        		...
        		if(svcID == "retrieveWrsMasterList"){
        			...
        			for (var i=0; i < this.ds_master_data.rowcount ;i++)			
        			{
        				...
        				if (this.ds_master_data.getColumn(i,0) == '8808983000015'){					
        					this.ds_master_data.deleteRow(i);					
        				}
        				
        					
        				this.ds_master_data.setColumn(i,"CSER_NA_TRPL_N","["+this.ds_master_data.getColumn(i,"CSER_NA_TRPL_C")+"] "+this.ds_master_data.getColumn(i,"CSER_NA_TRPL_N"));
        			}	
        			
        			if (this.ds_master_data.insertRow(0) != -1){
        				this.ds_master_data.setColumn(0,"CSER_NA_TRPL_C","");
        				this.ds_master_data.setColumn(0,"CSER_NA_TRPL_N","- 선택 -");
        				};
        ...
        this.fn_searchScd = function(){
            ...
            */
        	...
        	var sURL          = "svc::rest/center/na/retrieveWrsDetailList";// 호출할 서버 페이지 주소
        	var sInDatasets   = "";//보내는데이터셋
        ...
        this.fn_excel = function(){
        	if(this.fn_validationCheck()){
        		...
        		//this.div_list.web_downExcelM.set_url(application.gv_server_url+"rest/excel/na/downloadExcelWrsMasterList?"+param);
        		excelDownHandler(application.gv_server_url+"rest/excel/na/downloadExcelWrsMasterList?"+param, this);
        	}
        }
        ...
        this.div_list_btn_gradD_excel_onclick = function(obj,e)
        {
        	...
        	if(this.fn_validationCheck()){
        		...
        		//this.div_list.web_downExcelD.set_url(application.gv_server_url+"rest/excel/na/downloadExcelWrsDetailList?"+param+param2);
        		excelDownHandler(application.gv_server_url+"rest/excel/na/downloadExcelWrsDetailList?"+param+param2, this);
        	}	
        }
        ...
        this.btn_excelDetail_onclick = function(obj,e)
        {
        	...
        	this.div_list.web_downExcelD.set_url(application.gv_server_url+"rest/excel/na/downloadExcelDetail?"+param);
        }
        ...
        this.btn_excel00_onclick = function(obj,e)
        {
        	if(this.fn_validationCheck()){
        		...
        		//this.div_list.web_downExcelMaster.set_url(application.gv_server_url+"rest/excel/na/downloadExcelWrsMasterOnly?"+param);
        		excelDownHandler(application.gv_server_url+"rest/excel/na/downloadExcelWrsMasterOnly?"+param, this);
        	}
        }
        ...
        this.loadIncludeScript("VAN_DS_SC_0720.xfdl", true);
