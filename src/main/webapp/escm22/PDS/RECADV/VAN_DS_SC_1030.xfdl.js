    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("frm_van_ds_sc_1030");
                this.set_titletext("기간별상품별/점포별정보조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"TOTAL_BY_AM\" type=\"STRING\" size=\"256\"/><Column id=\"TOTAL_BY_QT\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj = new Div("div_page", "absolute", "229", null, "338", "44", null, "3", this.div_list);
            obj.set_taborder("56");
            obj.style.set_align("center");
            obj.set_visible("false");
            obj.set_url("common::pagingBTN.xfdl");
            this.div_list.addChild(obj.name, obj);
            obj = new Grid("grd_master", "absolute", "0", "45", null, null, "0", "42", this.div_list);
            obj.set_taborder("38");
            obj.set_binddataset("ds_dataM");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"200\"/><Column size=\"140\"/><Column size=\"140\"/><Column size=\"0\"/><Column size=\"0\"/><Column size=\"0\"/><Column size=\"0\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"상품코드\"/><Cell col=\"1\" text=\"상품명\"/><Cell col=\"2\" text=\"수량\"/><Cell col=\"3\" text=\"금액\"/><Cell col=\"4\" text=\"조회시작일\"/><Cell col=\"5\" text=\"조회종료일\"/><Cell col=\"6\" text=\"전체선택여부\"/><Cell col=\"7\" text=\"거래처코드\"/></Band><Band id=\"body\"><Cell text=\"bind:WRS_C\"/><Cell col=\"1\" cssclass=\"Cellgrd_WF_AlignLeft\" text=\"bind:WRSNM\"/><Cell col=\"2\" displaytype=\"number\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:BY_QT\" mask=\"#,##0\"/><Cell col=\"3\" displaytype=\"number\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:BY_AM\" mask=\"#,##0\"/><Cell col=\"4\" text=\"bind:SRH_BY_DT_FR\"/><Cell col=\"5\" text=\"bind:SRH_BY_DT_TO\"/><Cell col=\"6\" text=\"bind:SRH_CHK_ALL\"/><Cell col=\"7\" text=\"bind:SRH_TRPL_C\"/></Band><Band id=\"summary\"><Cell style=\"align:center;\" text=\"합    계\"/><Cell col=\"1\"/><Cell col=\"2\" displaytype=\"number\" expr=\"expr:comp.parent.parent.ds_total.getColumn(0,'TOTAL_BY_QT')\" mask=\"#,##0\"/><Cell col=\"3\" displaytype=\"number\" expr=\"expr:comp.parent.parent.ds_total.getColumn(0,'TOTAL_BY_AM')\" mask=\"#,##0\"/><Cell col=\"4\"/><Cell col=\"5\"/><Cell col=\"6\"/><Cell col=\"7\"/></Band></Format></Formats>");
            this.div_list.addChild(obj.name, obj);
            obj = new Button("Button75", "absolute", "365", "0", null, "12", "360", null, this.div_list);
            obj.set_taborder("55");
            ...
            obj = new Layout("default", "", 803, 490, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("기간별상품별/점포별정보조회");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1030.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1030.xfdl", function(exports) {
        /*##################################################################################
         화면명	: 기간별 상품별/점포별 정보
         화면ID  	: VAN_DS_SC_1030
         작성자 	: swha
        ...
        this.div_list_Button75_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_list.Button75.addEventHandler("onclick", this.div_list_Button75_onclick, this);

        };

        this.loadIncludeScript("VAN_DS_SC_1030.xfdl", true);
