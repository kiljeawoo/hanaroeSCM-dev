(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1593.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1593.xfdl", function(exports) {
        ...
        /* 공동상품여부 선택 */
        this.rdo_store_code01_onitemclick = function(obj,e)
        {
        		trace("123");
        	if (obj.value == "1") {
        		this.edt_data15.set_enable(false);
        ...
        this.on_initEvent = function()
        {
            ...
            this.rdo_store_code01.addEventHandler("onitemclick", this.rdo_store_code01_onitemclick, this);
        ...
        this.loadIncludeScript("VAN_DS_SC_1593.xfdl", true);
