    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,893,3561);
            }
            ...
            obj = new Edit("edt_NA_SPYPL_TEAM_NM", "absolute", "384", "680", "55", "21", null, null, this);
            ...
            obj.set_codecolumn("SIMP_C");
            obj.set_datacolumn("SIMP_CNM");
            obj = new Combo("cbo_na_wrs_sze_sex_c", "absolute", "113", "228", "151", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            ...
            cbo_cus_ag_lrg_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">0</Col><Col id=\"datacolumn\">해당없음</Col></Row><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">농협전용상품</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">기획상품</Col></Row></Rows>");
            ...
            obj = new Edit("edt_NA_SPYPL_C", "absolute", "113", "680", "110", "21", null, null, this);
            ...
            obj = new Edit("edt_NA_SPYPL_NM", "absolute", "226", "680", "131", "21", null, null, this);
            obj.set_taborder("298");
            obj.set_cssclass("WF_Essential");
            this.addChild(obj.name, obj);

            obj = new Button("btn_search_SPYPL", "absolute", "360", "680", "21", "21", null, null, this);
            obj.set_taborder("299");
            obj.set_cssclass("btn_WF_Searchbtn");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_NA_SPYPL_TEAM_C", "absolute", "384", "680", "55", "21", null, null, this);
            ...
            obj = new Button("btn_atch_del12", "absolute", "395", "2761", "56", "21", null, null, this);
            obj.set_taborder("316");
            obj.set_text("삭제");
            this.addChild(obj.name, obj);

            obj = new FileUpload("FileUpload12", "absolute", "139", "2761", "253", "21", null, null, this);
            ...
            obj = new Combo("cbo_div_list01", "absolute", "113", "792", "151", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_file_data12", "absolute", "505", "2761", "88", "21", null, null, this);
            ...
            //-- Default Layout
            obj = new Layout("default", "", 893, 3561, this,
            	//-- Layout function
            	function(p) {
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item162","edt_search_wrs08","value","ds_wrs_rg_req","BOX_HIGH");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","rdo_search_sep00","value","ds_wrs_rg_req","NA_C_RQ_OBJ_DSC");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item22","edt_fsrgmn_nm","value","ds_wrs_rg_req","FSRGMN_ENO");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item174","edt_ctcpl_telno","value","ds_wrs_rg_req","CTCPL_TELNO");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item176","edt_fsrgmn_nm00","value","ds_wrs_rg_req","FSRGMN_NA_BZPLC");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item18","edt_NA_SPYPL_C","value","ds_wrs_rg_req","NA_BZPLC");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item99","cbo_div_list01","value","ds_wrs_rg_req","CUS_AG_LRG_DSC");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1543_asis.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1543_asis.xfdl", function(exports) {
        ...
        {
        	trace("btn_save00_onclick (신청) 시작");
        	if (!this.validation()) {
        		return;
        	}
        ...
        //		this.ds_wrs_rg_req_filter.
        	...
        	trace("btn_save00_onclick (신청) 종료");
        }
        ...
        {
        	trace("fn_checkUpdateRow (신청시의 데이터셋 검사) 시작");
        //	var BASIC_COL = [ "RQ_NA_WRS_C", "WRS_C_DSC", "WRS_DSC", "NA_WRS_LCLC", "NA_WRS_MCLC", "NA_WRS_SCLC", "NA_WRS_DTCF_C", "WRSNM"];
        	var BASIC_COL = [];

        	for (var i=0; i<this.ds_wrs_rg_req_filter.colcount; i++){
        		BASIC_COL.push(this.ds_wrs_rg_req_filter.getColumnInfo(i).name);
        	}
        	var cnt = 0;
        	var bChanged = false;
        	...
        	if (reg_dsc == "2") {
        		for (var i=0; i<this.ds_gd_wrs.colcount; i++) {
        			...
        			trace(col.name+" : "+before+" / "+after+"=>"+(before!=after));
        //			trace(this.ds_wrs_rg_req.getColumnInfo(i).name +" : "+ this.ds_wrs_rg_req.getColumn(0, this.ds_wrs_rg_req.getColumnInfo(i).name));
        			//여기서 데이터 서버로 전송할 데이터 셋을 만들고 있음
        			// 로직 체크
        			if (BASIC_COL.indexOf(col.name) != -1) {
        				this.ds_wrs_rg_req_filter.setColumn(0, col.name, after);
        			} 
        			// 본래 else if 였으나 if 절로 변경
        			if (before != after && bChanged == false) {
        				bChanged = true;
        //				this.ds_wrs_rg_req_filter.setColumn(0, col.name, after);
        	...
        	trace("fn_checkUpdateRow (신청시의 데이터셋 검사) 완료");
        	//trace("변경된 컬럼 : "+cnt);
        	return bChanged;
        }
         ...
         this.div_search_FileUpload00_onitemchanged = function(obj,e)
         {
         	...
         	switch (obj.name) {
         		...
         		case "fu_img_upload_add2" : objName = "add2";
         		                            break;
         		case "FileUpload12" : objName = "add3";
         		                            break;
         		default                   : objName = "X";
         		                            break;
         	}
        ...
        this.FileUpload_onsuccess = function(obj,e)
        {
         	...
         	alert(this.ds_uploadresult.saveXML());
        ...
        this.fn_popupAfter = function(strId,strVal)
        {
        	...
        	if (strVal != undefined) {
        		...
        		if (strId == "pvopl_trpl") {
        			...
        			if (arrVal[2] == "") {
        				this.edt_NA_SPYPL_TEAM_C.set_value("팀없음");
        			} else {
        				this.edt_NA_SPYPL_TEAM_C.set_value(arrVal[2]);
        			}
        // 			if (arrVal[3] == "") {
        // 				this.div_search.edt_WRS_ABR_NM.set_value("00");
        // 			} else {
        // 				this.div_search.edt_WRS_ABR_NM.set_value(arrVal[3]);
        // 			}
        		}
        	}
        ...
        {
        	trace("btn_search_wrs_onclick 실행");
        	...
        	obj.set_enable(false);
        	trace("rest/pds/pricat/Product/retrieveProductInfForReg 요청");
        	var params = "gln="+TRPL_C
        				+" na_wrs_c=" + this.edt_gtin.value;
        //				+" van_c_rq_no=" + this.edt_gtin.value;
        	...
        	//API 호출
        	this.gfn_callService(sSvcID, sURL, sInDatasets, sOutDatasets, sArgument, sCallbackFunc, tranType);
        	trace("btn_search_wrs_onclick 종료");
        }
        ...
        {
        	trace("edt_NA_SPYPL_NM_onkeydown 시작");
        	if (e.keycode == 13) {
        		trace("공급처명 검색시작");
        		this.btn_search_SPYPL_onclick(true);
        		trace("공급처명 검색완료");
        	}
        	trace("edt_NA_SPYPL_NM_onkeydown 종료");
        }

        
        this.btn_search_SPYPL_onclick = function(params)	// param -> true: 자동검색 , false: 수동검색
        {
        	trace("btn_search_SPYPL_onclick 시작");
        	
        	if (params == true) {
        		trace("거래처검색을 위한 파라메터 검증 시작");
        		var bzplc = this.gfn_nullToEmpty(this.edt_NA_SPYPL_C_onkeydown.value);
        		...
        		trace("거래처검색을 위한 파라메터 검증 완료");
        	}

        	var code = this.edt_NA_SPYPL_C_onkeydown.value;		// 사업장 코드 Edit 박스
        	...
        	trace("팝업 POPUP::POPUP_SRC_RVOPL_TRPL 시작");
        	var oArg = {paramMode:"U", dsArg:this.Dataset00, autoPop:param};
        	...
        	trace("팝업 POPUP::POPUP_SRC_RVOPL_TRPL 종료");
        	
        	trace("btn_search_SPYPL_onclick 종료");
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.rdo_store_code02.addEventHandler("onitemchanged", this.div_search_rdo_store_code03_onitemchanged, this);
            ...
            this.FileUpload00.addEventHandler("onsuccess", this.local_FileUpload_onsuccess, this);
            ...
            this.FileUpload01.addEventHandler("onsuccess", this.local_FileUpload_onsuccess, this);
            ...
            this.FileUpload02.addEventHandler("onsuccess", this.local_FileUpload_onsuccess, this);
            ...
            this.FileUpload03.addEventHandler("onsuccess", this.local_FileUpload_onsuccess, this);
            ...
            this.FileUpload12.addEventHandler("onsuccess", this.fn_fileupload_onsuccess, this);
            this.FileUpload12.addEventHandler("onerror", this.FileUpload_onerror, this);
            this.FileUpload12.addEventHandler("onitemchanged", this.fn_fileupload_onitemchanged, this);

        };

        this.loadIncludeScript("VAN_DS_SC_1543_asis.xfdl", true);
