    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_0900");
                this.set_titletext("일자별 정보");
            ...
            obj = new Static("sta_searchType01", "absolute", "216", "10", "311", "21", null, null, this.div_search);
            obj.set_taborder("28");
            obj.set_text("해당 년도와 월만 입력해주세요. ( Ex - 201501 )");
            obj.style.set_color("red");
            obj.set_visible("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Div("Div00", "absolute", "94", "10", "109", "21", null, null, this.div_search);
            obj.set_taborder("30");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/><Row size=\"28\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"일자\"/><Cell col=\"1\" text=\"수량\"/><Cell col=\"2\" text=\"금액(천원)\"/></Band><Band id=\"body\"><Cell text=\"bind:YMD\" mask=\"@@@@-@@-@@\"/><Cell col=\"1\" style=\"align:right;\" text=\"bind:QTY\"/><Cell col=\"2\" style=\"align:right;\" text=\"bind:AMOUNT\"/></Band><Band id=\"summary\"><Cell style=\"align:center;\" text=\"합계\"/><Cell col=\"1\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:dataset.getSum('QTY')\" mask=\"#,###\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:dataset.getSum('AMOUNT')\" mask=\"#,###\"/></Band></Format></Formats>");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0900.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0900.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_0900.xfdl", true);
