    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_0931");
                this.set_titletext("기간별 상품별/사업장별 정보 상세");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/><Column id=\"QTY\" type=\"STRING\" size=\"256\"/><Column id=\"AMOUNT\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            this.addChild(obj.name, obj);
            obj = new Static("sta_searchType00", "absolute", "15", "10", "132", "21", null, null, this.div_search);
            obj.set_taborder("47");
            obj.set_text("상품코드/상품명");
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("sta_searchType01", "absolute", "147", "10", "90", "21", null, null, this.div_search);
            obj.set_taborder("48");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("sta_searchType02", "absolute", "252", "10", "300", "21", null, null, this.div_search);
            obj.set_taborder("49");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "242", "10", "15", "21", null, null, this.div_search);
            obj.set_taborder("50");
            obj.set_text("/");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("sta_searchType03", "absolute", "603", "10", "90", "21", null, null, this.div_search);
            obj.set_taborder("51");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/><Row size=\"28\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"사업장코드\"/><Cell col=\"1\" text=\"사업장명\"/><Cell col=\"2\" text=\"재고수량\"/><Cell col=\"3\" text=\"재고금액(천원)\"/></Band><Band id=\"body\"><Cell style=\"align:center;\" text=\"bind:CODE\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:NAME\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" text=\"bind:QTY\" mask=\"#,##0\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:AMOUNT\" mask=\"#,##0\"/></Band><Band id=\"summary\"><Cell colspan=\"2\" style=\"align:center;\" text=\"합계\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\"/><Cell col=\"3\" style=\"align:right;\"/></Band></Format></Formats>");
            ...
            obj = new Layout("default", "", 803, 490, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("VAN_DS_SC_0931");
            		p.set_titletext("기간별 상품별/사업장별 정보 상세");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0931.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0931.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_0931.xfdl", true);
