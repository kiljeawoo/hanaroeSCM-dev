    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_0920");
                this.set_titletext("기간별 사업장별/상품별 정보");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/><Column id=\"QTY\" type=\"INT\" size=\"256\"/><Column id=\"AMOUNT\" type=\"INT\" size=\"256\"/><Column id=\"PHD_FCLT_C\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            this.addChild(obj.name, obj);
            obj = new Static("sta_searchType02", "absolute", "15", "10", "79", "21", null, null, this.div_search);
            obj.set_taborder("33");
            obj.set_text("조회일");
            ...
            obj.set_value("null");
            obj = new Static("sta_start_date", "absolute", "527", "10", "71", "21", null, null, this.div_search);
            obj.set_taborder("41");
            obj.set_visible("false");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("sta_end_date", "absolute", "518", "10", "71", "21", null, null, this.div_search);
            obj.set_taborder("42");
            obj.set_visible("false");
            this.div_search.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/><Row size=\"30\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"사업장코드\"/><Cell col=\"1\" text=\"사업장명\"/><Cell col=\"2\" text=\"재고수량\"/><Cell col=\"3\" text=\"재고금액\"/><Cell col=\"4\" text=\"물류기능코드\"/></Band><Band id=\"body\"><Cell style=\"align:center;\" text=\"bind:CODE\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:NAME\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" text=\"bind:QTY\" mask=\"#,##0\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:AMOUNT\" mask=\"#,##0\"/><Cell col=\"4\" text=\"bind:PHD_FCLT_C\"/></Band><Band id=\"summary\"><Cell colspan=\"2\" style=\"align:center;\" text=\"합계\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"expr:comp.parent.parent.ds_dataTotal.getColumn(0,'TOTAL_TOT_SLAM')\"/><Cell col=\"4\"/></Band></Format></Formats>");
            ...
            obj = new Layout("default", "", 803, 490, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("VAN_DS_SC_0920");
            		p.set_titletext("기간별 사업장별/상품별 정보");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0920.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0920.xfdl", function(exports) {
        ...
        {
        	// 초기 날짜를 입력
        	var initmonth = this.gfn_today('yyyyMMdd'); // 해당 PC의 오늘 날짜 + 01
        ...
        this.div_list_grd_main00_oncellclick = function(obj,e)
        {
        	...
        	var oArg = {paramMode:"U", pTrpl_c:this.getTrplCode(), sTartD:this.div_search.sta_start_date.text, dsArg:this.ds_daily_store};
        	var sOption = "autosize=true, titleText=false";
        	var sPopupCallBack = "fn_popupAfter";
        	this.gfn_openPopup("detailstock","PDS.STOCK::VAN_DS_SC_0921.xfdl",oArg,sOption,sPopupCallBack);
        }
        ...
        this.btn_excel_onclick = function(obj,e)
        {
        	var params = "TRPL_C="+this.getTrplCode()
        				 ...
        				 +"&fileName=기간별 사업장/상품.xls";
        	
        	params = encodeURI(encodeURI(params));
        	excelDownHandler(application.gv_server_url+"rest/excel/downloadExcelPeriodStoreSum?"+params, this);
        	//this.div_list.web_downExcelM.set_url(application.gv_server_url+"rest/excel/downloadExcelPeriodStoreSum?"+params);
        }
        ...
        this.loadIncludeScript("VAN_DS_SC_0920.xfdl", true);
