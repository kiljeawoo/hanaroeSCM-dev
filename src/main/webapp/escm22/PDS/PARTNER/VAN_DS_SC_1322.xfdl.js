    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("탄력업체요청거래관계조회");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1322.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1322.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_1322.xfdl", true);
