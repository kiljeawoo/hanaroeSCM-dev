    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("하나로마트요청거래관계조회");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_1311.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_1311.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function() //onload
        {
        	...
        	var init_splr_c = this.parent.splrc;
        	var init_splr_nm = this.parent.splrnm;
        	
        	//그리드 조회없음 표시
        	this.grd_pop_data.set_nodatatext(this.gfn_getTextMessage('result.message.search.no.exist.data'));
        	
        	// 팝업조회 시 로그인 정보를 입력
        	this.div_search.edt_data03.set_value(init_splr_c); 
        	this.div_search.edt_data04.set_value(init_splr_nm);
        	this.search();
        }

        this.validation = function()
        {
        	if(this.gfn_nullToEmpty(this.div_search.edt_data03.value) == ""){
        		return false;
        	}
        	return true;
        }
        ...
        {
        	if(!this.validation()){
        		this.alert("필수값이 없습니다. 확인 후 다시 실행하세요.");
        		return;
        	}
        	this.search();
        }
        ...
        this.search = function()
        {
        	...
        	json.TRPL_C = this.parent.trpl_c;	//사업장코드
        ...
        this.loadIncludeScript("VAN_DS_SC_1311.xfdl", true);
