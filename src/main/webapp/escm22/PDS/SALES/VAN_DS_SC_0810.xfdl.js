    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("frm_VAN_DS_SC_0810");
                this.set_titletext("판매정보 - 기간별정보");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"140\"/><Column size=\"250\"/><Column size=\"250\"/><Column size=\"140\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"일자\"/><Cell col=\"1\" text=\"수량\"/><Cell col=\"2\" text=\"금액\"/><Cell col=\"3\" text=\"점유율(%)\"/></Band><Band id=\"body\"><Cell text=\"bind:SL_DT\" mask=\"####-##-##\"/><Cell col=\"1\" style=\"align:right;\" text=\"bind:SL_QT\" mask=\"###,##0\"/><Cell col=\"2\" style=\"align:right;\" text=\"bind:SL_AM\" mask=\"###,##0\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SHARE_SLAM\"/></Band><Band id=\"summary\"><Cell style=\"align:center;\" text=\"합   계\"/><Cell col=\"1\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:dataset.getSum('SL_QT');\" mask=\"###,##0\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" expr=\"expr:dataset.getSum('SL_AM');\" mask=\"###,##0\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"0\"/></Band></Format></Formats>");
            this.div_list.addChild(obj.name, obj);
            ...
            obj = new WebBrowser("web_downExcel", "absolute", "385", "23", "53", "17", null, null, this);
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0810.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0810.xfdl", function(exports) {
        /*##################################################################################
         화면명	: 기간별정보
         화면ID  	: VAN_DS_SC_1010
         작성자 	: swha
        ...
        this.loadIncludeScript("VAN_DS_SC_0810.xfdl", true);
