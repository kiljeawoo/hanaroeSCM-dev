    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("frm_van_ds_sc_0820");
                this.set_titletext("기간별 사업장별/상품별");
            ...
            obj._setContents("<ColumnInfo><Column id=\"BZPLC\" type=\"string\" size=\"32\"/><Column id=\"BZPLCNM\" type=\"string\" size=\"32\"/><Column id=\"SL_QT\" type=\"bigdecimal\" size=\"8\"/><Column id=\"SL_AM\" type=\"float\" size=\"8\"/><Column id=\"SRH_BY_DT_FR\" type=\"string\" size=\"32\"/><Column id=\"SRH_BY_DT_TO\" type=\"string\" size=\"32\"/><Column id=\"SRH_TRPL_C\" type=\"string\" size=\"32\"/><Column id=\"SHARE_SLAM\" type=\"float\" size=\"8\"/></ColumnInfo>");
            ...
            obj = new Grid("grd_master", "absolute", "0", "65", null, "335", "0", null, this.div_list);
            obj.set_taborder("38");
            obj.set_binddataset("ds_dataM");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"140\"/><Column size=\"200\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"사업장코드\"/><Cell col=\"1\" text=\"사업장명\"/><Cell col=\"2\" text=\"수량\"/><Cell col=\"3\" text=\"금액\"/><Cell col=\"4\" text=\"점유율(%)\"/></Band><Band id=\"body\"><Cell text=\"bind:BZPLC\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:BZPLCNM\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SL_QT\" mask=\"###,##0\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SL_AM\" mask=\"###,##0\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SHARE_SLAM\"/></Band><Band id=\"summary\"><Cell colspan=\"2\" style=\"align:center;\" text=\"합   계\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" mask=\"###,##0\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" mask=\"###,##0\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" mask=\"###,##0\"/></Band></Format></Formats>");
            this.div_list.addChild(obj.name, obj);
            ...
            this.div_list.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "732", "432", "55", "30", null, null, this.div_list);
            obj.set_taborder("40");
            obj.set_text("30");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            this.div_list.addChild(obj.name, obj);
            obj = new Div("div_page", "absolute", "28.55%", "400", "338", "44", null, null, this.div_list);
            obj.set_taborder("41");
            ...
            obj = new WebBrowser("web_downExcel", "absolute", "676", "36", "54", "17", null, null, this);
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0820.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0820.xfdl", function(exports) {
        /*##################################################################################
         화면명	: 기간별 점포별/상품별 정보조회 (판매정보)
         화면ID  	: VAN_DS_SC_0820
         작성자 	: hroh
        ####################################################################################*/
        ...
        this.div_list_grd_master_oncellclick = function(obj,e)
        {
        	...
        	srhByDtFr = "20150501";
        	srhByDtTo = "20150530";
        	srhTrplC = "2500000147609";
        	*/
        	var oArg = {BZPLC:bzplc, BZPLCNM:bzplcnm, SRH_BY_DT_FR:srhByDtFr, SRH_BY_DT_TO:srhByDtTo, SRH_TRPL_C:srhTrplC};
        	var sOption = "autosize=true,title=true";
        	var sPopupCallBack = "";
        	this.gfn_openPopup("popId","PDS.SALES::VAN_DS_SC_0821.xfdl",oArg,sOption,sPopupCallBack);
        ...
        this.btn_excel_onclick = function(obj,e)
        {
        	...
        	excelDownHandler(application.gv_server_url+"rest/excel/downloadExcelSalesPeriodStoreSumList?"+params, this);
        }
        ...
        {
        	var oArg = {form_id:"VAN_DS_SC_0820", trplC:this.getTrplCode()};
        ...
        this.loadIncludeScript("VAN_DS_SC_0820.xfdl", true);
