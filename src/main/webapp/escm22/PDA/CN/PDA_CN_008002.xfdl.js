    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("PDA_CN_008002");
                this.set_titletext("검수실적제외 상품관리");
                this._setFormPosition(0,0,803,490);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_kpiExptWrs", this);
            ...
            obj._setContents("<ColumnInfo><Column id=\"NA_BZPLC\" type=\"STRING\" size=\"13\"/><Column id=\"STR_NM\" type=\"STRING\" size=\"50\"/><Column id=\"NA_WRS_C\" type=\"STRING\" size=\"50\"/><Column id=\"WRS_NM\" type=\"STRING\" size=\"50\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"1\"/></ColumnInfo>");
            ...
            obj = new Dataset("ds_kpiExptWrsChg", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"NA_BZPLC\" type=\"String\" size=\"256\"/><Column id=\"WRS_C\" type=\"String\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("Edit_wrsnum", "absolute", "44.27%", "10", null, "21", "46.82%", null, this.div_search);
            obj.set_taborder("46");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("Edit_wrsname", "absolute", "53.44%", "10", null, "21", "37.15%", null, this.div_search);
            obj.set_taborder("47");
            obj.set_enable("true");
            this.div_search.addChild(obj.name, obj);
            obj = new Button("btn_wrsname", "absolute", "63.1%", "10", null, "21", "34.22%", null, this.div_search);
            obj.set_taborder("48");
            obj.set_cssclass("btn_WF_Searchbtn");
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_taborder("49");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static05", "absolute", "61.58%", "42", null, "21", "30.03%", null, this.div_search);
            obj.set_taborder("50");
            obj.set_text("처리결과");
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new TextArea("txa_excel00", "absolute", "69.97%", "42", null, "21", "2.04%", null, this.div_search);
            obj.set_taborder("51");
            ...
            obj.set_taborder("2");
            obj.set_binddataset("ds_kpiExptWrs");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"45\"/><Column size=\"100\"/><Column size=\"140\"/><Column size=\"100\"/><Column size=\"140\"/><Column size=\"0\"/><Column size=\"100\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"사업장코드\"/><Cell col=\"2\" text=\"사업장명\"/><Cell col=\"3\" text=\"상품코드\"/><Cell col=\"4\" text=\"상품명\"/><Cell col=\"5\" text=\"레벨\"/><Cell col=\"6\" text=\"사용/중지\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" text=\"bind:RN\"/><Cell col=\"1\" edittype=\"expr:(dataset.getRowType(currow)==2||NA_BZPLC==null)?'normal':'none'\" text=\"bind:NA_BZPLC\" tooltiptext=\"bind:NA_BZPLC\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:STR_NM\" tooltiptext=\"bind:STR_NM\"/><Cell col=\"3\" edittype=\"expr:(dataset.getRowType(currow)==2||WRS_C==null)?'normal':'none'\" text=\"bind:NA_WRS_C\" tooltiptext=\"bind:WRS_C\"/><Cell col=\"4\" style=\"align:left;\" text=\"bind:WRS_NM\" tooltiptext=\"bind:WRS_NM\"/><Cell col=\"5\" displaytype=\"number\" text=\"bind:LEV\" tooltiptext=\"bind:LEV\"/><Cell col=\"6\" displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:USE_YN\" tooltiptext=\"bind:USE_YN\"/></Band></Format></Formats>");
            this.Div02.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("PDA_CN_008002.xfdl", "lib::comLib.xjs");
        this.registerScript("PDA_CN_008002.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/	
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.Edit_comnum.addEventHandler("oneditclick", this.div_search_Edit_comnum_oneditclick, this);
            this.div_search.btn_comname.addEventHandler("onclick", this.div_search_btn_comname_onclick, this);
            this.div_search.Edit_wrsname.addEventHandler("oneditclick", this.div_search_Edit_wrsname_oneditclick, this);
        ...
        this.loadIncludeScript("PDA_CN_008002.xfdl", true);
