(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.addChild(obj.name, obj);
            obj = new Button("Button06", "absolute", "46.12%", "0", null, "12", "47.53%", null, this.Div02);
            obj.set_taborder("12");
        ...
        // User Script
        this.registerScript("pattern_01_test.xfdl", function() {
        this.Button10_onclick = function(obj,e)
        {
        	this.Div00.set_height(5);
        	this.Div02.Button10.set_visible(false);
        	this.Div02.Button06.set_visible(true);

        	var nBottom = nexacro.toNumber(this.Div00.top) + nexacro.toNumber(this.Div00.height) -1;
        	this.Div02.set_top(nexacro.toNumber(nBottom));
        }

        this.Div02_Button06_onclick = function(obj,e)
        {	
        	this.Div00.set_height(69);
        	this.Div02.Button10.set_visible(true);
        	this.Div02.Button06.set_visible(false);
        ...
        this.loadIncludeScript("pattern_01_test.xfdl");
