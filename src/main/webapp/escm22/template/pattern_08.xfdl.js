(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static05", "absolute", "732", "134", "56", "5", null, null, this);
            obj.set_taborder("70");
            obj.set_text("5");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            ...
            obj = new Static("Static11", "absolute", "732", "310", "56", "15", null, null, this);
            obj.set_taborder("71");
            obj.set_text("15");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            ...
            obj = new Static("Static12", "absolute", "732", "346", "56", "5", null, null, this);
            obj.set_taborder("72");
            obj.set_text("5");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            ...
            obj.set_text("Div02");
            this.addChild(obj.name, obj);
            obj = new Button("Button04", "absolute", null, "16", "53", "21", "0", null, this.Div02);
            obj.set_taborder("0");
            obj.set_text("행삭제");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"그리드타이틀01\"/><Cell col=\"2\" text=\"그리드타이틀02\"/><Cell col=\"3\" text=\"그리드타이틀03\"/><Cell col=\"4\" text=\"그리드타이틀04\"/><Cell col=\"5\" text=\"그리드타이틀05\"/><Cell col=\"6\" text=\"그리드타이틀06\"/><Cell col=\"7\" text=\"그리드타이틀07\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:Column0\"/><Cell col=\"1\" text=\"bind:Column1\"/><Cell col=\"2\" text=\"bind:Column2\"/><Cell col=\"3\" text=\"bind:Column3\"/><Cell col=\"4\" text=\"bind:Column4\"/><Cell col=\"5\" text=\"bind:Column5\"/><Cell col=\"6\" text=\"bind:Column6\"/><Cell col=\"7\" text=\"bind:Column7\"/></Band></Format></Formats>");
            this.Div02.addChild(obj.name, obj);
            ...
            this.Div02.addChild(obj.name, obj);
            obj = new Static("Static04", "absolute", "0", "229", "228", "21", null, null, this.Div02);
            obj.set_taborder("3");
            obj.set_text("서브타이틀02");
            obj.set_cssclass("sta_WF_Subtitle");
            this.Div02.addChild(obj.name, obj);
            obj = new Button("Button03", "absolute", null, "16", "53", "21", "55", null, this.Div02);
            obj.set_taborder("4");
            obj.set_text("행추가");
            this.Div02.addChild(obj.name, obj);
            obj = new Button("Button00", "absolute", null, "228", "53", "21", "55", null, this.Div02);
            obj.set_taborder("5");
            obj.set_text("행추가");
            this.Div02.addChild(obj.name, obj);
            obj = new Button("Button01", "absolute", null, "228", "53", "21", "0", null, this.Div02);
            obj.set_taborder("6");
            obj.set_text("행삭제");
            this.Div02.addChild(obj.name, obj);
            obj = new Grid("Grid00", "absolute", "0", "254", null, null, "0", "0", this.Div02);
            obj.set_taborder("7");
            obj.set_binddataset("Dataset00");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/><Column size=\"130\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"그리드타이틀01\"/><Cell col=\"2\" text=\"그리드타이틀02\"/><Cell col=\"3\" text=\"그리드타이틀03\"/><Cell col=\"4\" text=\"그리드타이틀04\"/><Cell col=\"5\" text=\"그리드타이틀05\"/><Cell col=\"6\" text=\"그리드타이틀06\"/><Cell col=\"7\" text=\"그리드타이틀07\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:Column0\"/><Cell col=\"1\" text=\"bind:Column1\"/><Cell col=\"2\" text=\"bind:Column2\"/><Cell col=\"3\" text=\"bind:Column3\"/><Cell col=\"4\" text=\"bind:Column4\"/><Cell col=\"5\" text=\"bind:Column5\"/><Cell col=\"6\" text=\"bind:Column6\"/><Cell col=\"7\" text=\"bind:Column7\"/></Band></Format></Formats>");
            this.Div02.addChild(obj.name, obj);
            obj = new Button("Button44", "absolute", "396", "223", "22", "22", null, null, this.Div02);
            obj.set_taborder("8");
            obj.set_cssclass("btn_WF_ShuttleU");
            this.Div02.addChild(obj.name, obj);
            obj = new Button("Button45", "absolute", "369", "223", "22", "22", null, null, this.Div02);
            obj.set_taborder("9");
        ...
        this.loadIncludeScript("pattern_08.xfdl", true);
