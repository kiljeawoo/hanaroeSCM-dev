    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("팝업 발주번호_장비_배송요청일 조회 ");
            ...
            obj = new Layout("default", "", 740, 402, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("팝업 발주번호_장비_배송요청일 조회 ");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_FN_0207.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_FN_0207.xfdl", function(exports) {
        ...
        this.fn_search = function(){
        	...
        	var sURL          = "svc::/rest/mds/delivery/retrieveOrdersPopUp";// 호출할 서버 페이지 주소
        ...
        this.fn_callBack = function(svcID,ErrorCode,ErrorMsg)
        {
        	if(ErrorCode < 0)
        	{
        		...
        		if(svcID == "billangMarkUp"){
        			...
        			if(DSTR_TER_YN == "Y" && odrpl_na_trpl_c != "8808983322353" && odrpl_na_trpl_c != "8808983324562" && odrpl_na_trpl_c != "8808983325958"){
        				alert('선택하신 발주서는 일반등록 화면에서 작성하셔야 합니다.');
        				return false;
        			}
        			
        			if(DSTR_TER_YN == "N" && (odrpl_na_trpl_c == "8808983322353" || odrpl_na_trpl_c == "8808983324562" || odrpl_na_trpl_c == "8808983325958")){
        ...
        this.fn_billingMarkUpService = function(trplO,teamO,odrDt,odrSlpno){
        	...
        	var sURL          = "svc::/rest/mds/delivery/billangMarkUp";// 호출할 서버 페이지 주소
        	var sInDatasets   = "";//보내는데이터셋
        ...
        this.loadIncludeScript("VAN_DS_FN_0207.xfdl", true);
