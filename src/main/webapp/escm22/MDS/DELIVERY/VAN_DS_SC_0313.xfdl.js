    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_0313");
                this.set_titletext("배송예정서 장비등록");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0313.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0313.xfdl", function(exports) {
        ...
        */
        ...
        this.btn_pup_van_seq_onclick = function(obj,e)
        {
        	...
        	var oArg = {opt_odr_dt:opt_odr_dt, form_id:"VAN_DS_SC_0313", ddly_yn:'0', trplC:trplC, DSTR_TER_YN:'N'};
        	var sOption = "autosize=true,title=false";
        	var sPopupCallBack = "fn_popupAfter";    
        	this.gfn_openPopup("retrieveOrdersPopUp","MDS.DELIVERY::VAN_DS_FN_0207.xfdl",oArg,sOption,sPopupCallBack);
        }
        ...
        this.fn_srhDeliveryNotice = function(){
        	...
        	var sURL          = "svc::/rest/mds/delivery/getDeliveryNoticeOrder";// 호출할 서버 페이지 주소
        ...
        this.fn_srhOrder = function(){
        	...
        	var sURL          = "svc::/rest/mds/delivery/getOrder";// 호출할 서버 페이지 주소
        	var sInDatasets   = "";//보내는데이터셋
        	var sOutDatasets  = "ds_dataM=ds_dataM ds_dataD=ds_dataD";	//화면에서 받는 데이터셋=보낸이름(1대1 맵핑)
        	var sArgument     = params;// 파라미터
        	var sCallbackFunc = "fn_callBack";//콜백
        ...
        this.fn_setVhcno = function(){
        	...
        	var sURL          = "svc::/rest/mds/delivery/retrieveVhcno";// 호출할 서버 페이지 주소
        	var sInDatasets   = "";//보내는데이터셋
        ...
        this.fn_getR1NaBzplC = function () {
        	...
        	var sURL          = "svc::/rest/mds/delivery/retrieveR1NaBzplC";// 호출할 서버 페이지 주소
        	var sInDatasets   = "";//보내는데이터셋
        ...
        this.fn_validationDetail = function(){
        	...
        	if(this.fParseFloat(odr_pcs) <= 0){//단가가 없는 경우 바이어 호출
        		...
        		var sURL          = "svc::/rest/mds/delivery/getBuyer";// 호출할 서버 페이지 주소
        		var sInDatasets   = "";//보내는데이터셋
        ...
        */
        ...
        this.fn_cancelProc = function(){
        	...
        	var sURL          = "svc::/rest/mds/delivery/deliveryNoticeCancelProc";// 호출할 서버 페이지 주소
        	var sInDatasets   = "";//보내는데이터셋
        ...
        this.fn_BizDtYn = function(chkPart,preDate,date){
        	...
        	var sURL          = "svc::/rest/mds/delivery/getBizDtYn";// 호출할 서버 페이지 주소
        	var sInDatasets   = "";//보내는데이터셋
        ...
        this.fn_save = function(){
        	...
        	params += " slp_no=" + this.ds_dataM.getColumn(0, "ODR_SLPNO");
        	
        	this.ds_dataM.addColumn("DDLY_YN", "string", 1);
        	this.ds_dataM.setColumn(0, "DDLY_YN", "0");
        	this.ds_dataM.setColumn(0, "ODR_SLPNO", "");
        	...
        	var sURL          = "svc::/rest/mds/delivery/saveDeliveryNoticeOrder";// 호출할 서버 페이지 주소
        ...
        this.fn_getBizDt = function(trplO,teamO,trplR,teamR,dvy_pla_dt){
        	...
        	var sURL          = "svc::/rest/mds/delivery/getBizDt";// 호출할 서버 페이지 주소
        	var sInDatasets   = "";//보내는데이터셋
        	var sOutDatasets  = "ds_bizDtYn=ds_bizDtYn";	//화면에서 받는 데이터셋=보낸이름(1대1 맵핑)
        	var sArgument     = params;// 파라미터
        	var sCallbackFunc = "fn_callBack";//콜백
        ...
        */
        		...
        		if(svcID == "saveDeliveryNoticeOrder"){
        		   ...
        		   catch(e)
        		   {
        			...
        			if(msgArr.length == 3){
        				...
        				var strRtn = this.gfn_getMessage("confirm","msg.VAN_DS_SC_0313.trading.statments.print.yn", var_na_dvy_plash_slpno);
        				if(strRtn == true){
        					this.fn_print();
        				}
        			}else{
        		...
        		if((tempYn == '' || tempYn == 'Y' || tempYn =='N') && (postValue != preValue)){
        			if(this.gfn_isNull(this.edt_odr_slpno.value) && this.gfn_isNull(this.edt_na_dvy_plash_slpno.value)){
        				...
        				if(isYn){
        					...
        					var sURL          = "svc::/rest/mds/delivery/getOrderDetail";// 호출할 서버 페이지 주소
        					//var sURL          = "svc::/rest/mds/delivery/saveDeliveryNoticeOrder";// 호출할 서버 페이지 주소
        					var sInDatasets   = "";//보내는데이터셋
        				...
        				if(isYn){
        					...
        					var sURL          = "svc::/rest/mds/delivery/getDeliveryNoticeOrderDetail";// 호출할 서버 페이지 주소
        					var sInDatasets   = "";//보내는데이터셋
        					var sOutDatasets  = "ds_dataD=ds_dataD";	//화면에서 받는 데이터셋=보낸이름(1대1 맵핑)
        					var sArgument     = params;// 파라미터
        					var sCallbackFunc = "fn_callBack";//콜백
        ...
        this.fn_beForPrint = function(){
        	...
        	var sURL          = "svc::/rest/mds/delivery/isOKdlvpnsht";// 호출할 서버 페이지 주소
        	var sInDatasets   = "";//보내는데이터셋
        	var sOutDatasets  = "";	//화면에서 받는 데이터셋=보낸이름(1대1 맵핑)
        	var sArgument     = params;// 파라미터
        	var sCallbackFunc = "fn_callBack";//콜백
        ...
        this.fn_print = function(){
        	...
        	var ozParam = {
              sId: 'VAN_DS_SC_0300',
              sUrl: '/rest/oz/mds/delivery/printDeliveryNoticeOrder',
              paramType: 'param',
        ...
        this.fn_dum_print = function(){
        	...
        	var ozParam = {
        		sId: 'VAN_DS_SC_0303',
        		sUrl: '/rest/oz/mds/delivery/printDeliveryNoticeOrderDum',
        		paramType: 'param',
        		sParam: {
        ...
        {
        	var trplC = this.getTrplCode();//권한사업장
        	var oArg = {form_id:"VAN_DS_SC_0313", trplC:trplC, DSTR_TER_YN:'N'};
        	var sOption = "autosize=true,title=false";
        	var sPopupCallBack = "fn_popupAfter";    
        ...
        this.btn_popup02_onclick = function(obj,e)
        {
        	...
        	var oArg = {form_id:"VAN_DS_SC_0313", odrpl_na_trpl_c:this.edt_orpl_na_trpl_c.value};
        	var sOption = "autosize=true,title=false";
        	var sPopupCallBack = "fn_popupAfter";    
        ...
        this.edt_orpl_na_trpl_c_onkeydown = function(obj,e)
        {
        	...
        	if(e.keycode == '13'){
        		...
        		var trplC = this.getTrplCode();//권한사업장
        		var oArg = {form_id:"VAN_DS_SC_0313", trplC:trplC, idx:idx, auto:"1", trplO:trplO};
        		var sOption = "autosize=true,title=false";
        		var sPopupCallBack = "fn_popupAfter";    
        		this.gfn_openPopup("POPUP_TRNREL_ODRPL","POPUP::POPUP_TRNREL_ODRPL.xfdl",oArg,sOption,sPopupCallBack);
        	}
        ...
        this.edt_shrt_bzplnm_onkeydown = function(obj,e)
        {
        	if(e.keycode == "13"){
        		...
        		var trplON = this.edt_shrt_bzplnm.value;
        		var trplC = this.getTrplCode();//권한사업장
        		var oArg = {form_id:"VAN_DS_SC_0313", trplC:trplC, idx:idx, auto:"1", trplON:trplON};
        		var sOption = "autosize=true,title=false";
        		var sPopupCallBack = "fn_popupAfter";    
        		this.gfn_openPopup("POPUP_TRNREL_ODRPL","POPUP::POPUP_TRNREL_ODRPL.xfdl",oArg,sOption,sPopupCallBack);
        	}
        ...
        this.loadIncludeScript("VAN_DS_SC_0313.xfdl", true);
