...
(function()
{
    return function(path)
    {
        ...
        //trace("rMateChart_DocumentComplete");
        	...
        	var _rMateChartH5License = p.getRMateChartH5License(p);
        	if (obj._ifrm_elem._plugin_object) {	// Runtime
        		...
        		doc.callMethod("rMateChartSetLicense", _rMateChartH5License);
        		...
        		obj._ifrm_elem._window.rMateChartSetLicense(_rMateChartH5License);
