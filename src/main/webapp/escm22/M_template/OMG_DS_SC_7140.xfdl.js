(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.addChild(obj.name, obj);
            obj = new Static("Static02", "absolute", "15", "16", "142", "54", null, null, this.Div00);
            ...
            this.Div00.addChild(obj.name, obj);
            obj = new Combo("Combo00", "absolute", "157", "78", "368", "54", null, null, this.Div00);
            this.Div00.addChild(obj.name, obj);
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.Div00.addChild(obj.name, obj);
            obj = new Calendar("Calendar01", "absolute", "157", "16", "180", "54", null, null, this.Div00);
            this.Div00.addChild(obj.name, obj);
            obj.set_taborder("94");
            obj.set_value("20150501");
            obj.set_dateformat("yyyy-MM-dd");
            obj = new Calendar("Calendar02", "absolute", "345", "16", "180", "54", null, null, this.Div00);
            this.Div00.addChild(obj.name, obj);
            obj.set_taborder("95");
            obj.set_value("20150501");
            obj.set_dateformat("yyyy-MM-dd");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 540, 353, this.Div01,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("52");
            		p.set_text("Div01");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 540, 586, this,
            	//-- Layout function
            	function(p) {
