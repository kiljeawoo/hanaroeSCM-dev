    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,540,834);
            }
            ...
            obj = new Static("Static21", "absolute", "0", "553", "203", "281", null, null, this);
            obj.getSetter("taborder").set("66");
            obj.set_text("미납사유");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static22", "absolute", "203", "553", "337", "281", null, null, this);
            obj.getSetter("taborder").set("67");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static23", "absolute", "525", "554", "15", "93", null, null, this);
            obj.getSetter("taborder").set("70");
            obj.set_visible("false");
            obj.style.set_background("#00ffff33");
            this.addChild(obj.name, obj);

            obj = new Combo("Combo00", "absolute", "207", "558", "318", "54", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new TextArea("TextArea00", "absolute", "207", "616", "318", "213", null, null, this);
            obj.set_taborder("72");
            this.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 540, 834, this,
            	//-- Layout function
            	function(p) {
        ...
        this.loadIncludeScript("OMG_DS_SC_7030_02.xfdl");
