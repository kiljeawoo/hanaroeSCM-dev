    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_7100");
                this.set_classname("OMG_DS_SC_7022");
                this.set_titletext("마트별/상품별 판매정보 조회");
            ...
            obj.set_autofittype("col");
            obj.set_summarytype("top");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"180\"/><Column size=\"228\"/><Column size=\"130\"/></Columns><Rows><Row size=\"50\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"63\"/><Row size=\"63\"/></Rows><Band id=\"head\"><Cell text=\"마트코드\"/><Cell col=\"1\" colspan=\"2\" text=\"마트명\"/><Cell row=\"1\" text=\"수량\"/><Cell row=\"1\" col=\"1\" text=\"금액(만원)\"/><Cell row=\"1\" col=\"2\" text=\"합계대비(%)\"/></Band><Band id=\"body\"><Cell style=\"align: ;\" cssclass=\"Cellgrd_WF_txt\" text=\"bind:Column0\"/><Cell col=\"1\" colspan=\"2\" style=\"align:left middle;\" cssclass=\"Cellgrd_WF_txt\" text=\"bind:Column1\" wordwrap=\"char\"/><Cell row=\"1\" style=\"align:right middle;\"/><Cell row=\"1\" col=\"1\" style=\"align:right middle;\"/><Cell row=\"1\" col=\"2\" style=\"align:right middle;\"/></Band></Format></Formats>");
            this.Div01.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 540, 680, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("마트별/상품별 판매정보 조회");
        ...
        this.loadIncludeScript("OMG_DS_SC_7100.xfdl");
