...
<head>
    ...
    <title>SCORE DTI for OpenWeb 설치</title>
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
...
<ul id="nxtsdemoinstall">
  <li> SCORE DTI for OpenWeb 프로그램 설치 </li>
  ...
  <li> <a class="btn02" href="../../dti/">처음으로</a> <a class="btn02" href="window.history.back();">뒤로</a> </li>
</ul>
