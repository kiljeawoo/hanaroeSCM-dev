    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_0320");
                this.set_titletext("배송예정일괄등록");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0320.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0320.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_0320.xfdl", true);
