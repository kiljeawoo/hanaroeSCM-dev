    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_0300");
                this.set_titletext("배송예정서 신선등록");
            ...
            obj = new Button("btn_popup00", "absolute", "524", "351", "21", "21", null, null, this);
            ...
            obj = new Grid("grd_master", "absolute", "0", "530", null, "393", "16", null, this);
            obj.set_taborder("70");
            obj.set_binddataset("ds_dataD");
            obj.set_autofittype("none");
            obj.set_enable("true");
            obj.set_useselcolor("true");
            obj.getSetter("titletext").set("배송예정서신선등록");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"0\"/><Column size=\"0\"/><Column size=\"0\"/><Column size=\"0\"/><Column size=\"0\"/><Column size=\"121\"/><Column size=\"330\"/><Column size=\"80\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"0\"/><Column size=\"90\"/><Column size=\"165\"/><Column size=\"165\"/><Column size=\"90\"/><Column size=\"0\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\" band=\"head\"/><Row size=\"30\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"순번\"/><Cell col=\"1\" rowspan=\"2\" text=\"발주처코드\"/><Cell col=\"2\" rowspan=\"2\" text=\"발주처팀코드\"/><Cell col=\"3\" rowspan=\"2\" text=\"발주일자\"/><Cell col=\"4\" rowspan=\"2\" text=\"발주전표번호\"/><Cell col=\"5\" rowspan=\"2\" text=\"발주상세일련번호\"/><Cell col=\"6\" rowspan=\"2\" text=\"상품코드\"/><Cell col=\"7\" rowspan=\"2\" text=\"상품명\"/><Cell col=\"8\" text=\"규격\"/><Cell col=\"9\" rowspan=\"2\" text=\"BOX입수\"/><Cell col=\"10\" text=\"수주량\"/><Cell col=\"11\" text=\"계약단가\"/><Cell col=\"12\" text=\"금액\"/><Cell col=\"13\" text=\"공병단가\"/><Cell col=\"14\" text=\"공상자단가\"/><Cell col=\"15\" text=\"장려금율\"/><Cell col=\"16\" rowspan=\"2\" colspan=\"2\" text=\"유통기한(제조일자)\"/><Cell col=\"18\" rowspan=\"2\" text=\"삭제\"/><Cell col=\"19\" rowspan=\"2\" text=\"보관상태\"/><Cell row=\"1\" col=\"8\" text=\"단위\"/><Cell row=\"1\" col=\"10\" text=\"배송예정량\"/><Cell row=\"1\" col=\"11\" text=\"납품단가\"/><Cell row=\"1\" col=\"12\" text=\"부가세\"/><Cell row=\"1\" col=\"13\" text=\"공병금액\"/><Cell row=\"1\" col=\"14\" text=\"공상자금액\"/><Cell row=\"1\" col=\"15\" text=\"장려금\"/></Band><Band id=\"body\"><Cell rowspan=\"2\" text=\"bind:DVY_PLA_SQNO\"/><Cell col=\"1\" rowspan=\"2\" text=\"bind:ODRPL_NA_TRPL_C\"/><Cell col=\"2\" rowspan=\"2\" text=\"bind:ODRPL_NA_TEAM_C\"/><Cell col=\"3\" rowspan=\"2\" text=\"bind:ODR_DT\"/><Cell col=\"4\" rowspan=\"2\" text=\"bind:ODR_SLPNO\"/><Cell col=\"5\" rowspan=\"2\" text=\"bind:ODR_DSQNO\"/><Cell col=\"6\" rowspan=\"2\" style=\"align:center;\" text=\"bind:NA_WRS_C\"/><Cell col=\"7\" rowspan=\"2\" style=\"align:left;\" cssclass=\"Cellgrd_WF_AlignLeft\" text=\"bind:WRSNM\"/><Cell col=\"8\" text=\"bind:WRS_STDNM\"/><Cell col=\"9\" rowspan=\"2\" displaytype=\"number\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:BOXPE_AQZ\" mask=\"#,##0\"/><Cell col=\"10\" displaytype=\"number\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:ODR_QT\" mask=\"#,##0\"/><Cell col=\"11\" displaytype=\"number\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:ODR_PCS\" mask=\"#,##0.99\"/><Cell col=\"12\" displaytype=\"number\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:ODR_AM\" mask=\"#,##0.99\"/><Cell col=\"13\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:VCBT_UPR\" mask=\"#,##0\"/><Cell col=\"14\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:VCBX_UPR\" mask=\"#,##0\"/><Cell col=\"15\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:SSDYRT\"/><Cell col=\"16\" rowspan=\"2\" expr=\"expr:DSTR_TER_MRK_DSC == '1' ? '유통기한' : DSTR_TER_MRK_DSC == '2' ? '제조일자' : '해당없음'\"/><Cell col=\"17\" rowspan=\"2\" displaytype=\"date\" expr=\"DSTR_TER_DT\"/><Cell col=\"18\" rowspan=\"2\" displaytype=\"checkbox\" edittype=\"checkbox\" style=\"cursor:pointer;\" text=\"bind:DEL_YN\"/><Cell col=\"19\" rowspan=\"2\" text=\"bind:NA_WRS_CSTD_METC\"/><Cell row=\"1\" col=\"8\" text=\"bind:NA_WRS_UNT_C\"/><Cell row=\"1\" col=\"10\" displaytype=\"number\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:DVY_PLA_QT\" mask=\"#,##0\"/><Cell row=\"1\" col=\"11\" displaytype=\"number\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:DVY_WRS_UPR\" mask=\"#,##0.99\"/><Cell row=\"1\" col=\"12\" displaytype=\"number\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:ODR_VAT\" mask=\"#,##0.99\"/><Cell row=\"1\" col=\"13\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:VCBT_AM\" mask=\"#,##0\"/><Cell row=\"1\" col=\"14\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:VCBX_AM\" mask=\"#,##0\"/><Cell row=\"1\" col=\"15\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:SSDY_BAS_AM\" mask=\"#,##0\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_back_bar00", "absolute", "69", "487", null, "29", "15", null, this);
            obj.set_taborder("379");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("sta_title15", "absolute", "0", "487", "110", "29", null, null, this);
            obj.set_taborder("378");
            obj.set_text("유통/제조일자");
            obj.set_cssclass("sta_WF_Label");
            obj.style.set_font("9 Gulim");
            this.addChild(obj.name, obj);

            obj = new Combo("cbo_dstr_ter_mrk_dsc", "absolute", "112", "491", "145", "21", null, null, this);
            this.addChild(obj.name, obj);
            var cbo_dstr_ter_mrk_dsc_innerdataset = new Dataset("cbo_dstr_ter_mrk_dsc_innerdataset", this.cbo_dstr_ter_mrk_dsc);
            cbo_dstr_ter_mrk_dsc_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">유통기한</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">제조일자</Col></Row></Rows>");
            obj.set_innerdataset(cbo_dstr_ter_mrk_dsc_innerdataset);
            obj.set_taborder("381");
            obj.set_enable("false");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");

            obj = new Calendar("cal_dstr_ter_dt", "absolute", "263", "491", "145", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("382");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_enable("true");

            obj = new Static("Static00", "absolute", "1", "516", "786", "15", null, null, this);
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0390.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0390.xfdl", function(exports) {
        ...
        */
        ...
        this.btn_pup_van_seq_onclick = function(obj,e)
        {
        	...
        	var oArg = {opt_odr_dt:opt_odr_dt, form_id:"VAN_DS_SC_0300", ddly_yn:'0', trplC:trplC, DSTR_TER_YN:'Y'};
        ...
        this.grd_afterFnc = function(obj,e)
        {
        	if(e.cell == 17){
        		...
        		this.cbo_dstr_ter_mrk_dsc.set_value(this.ds_dataD.getColumn(this.ds_dataD.rowposition,"DSTR_TER_MRK_DSC"));
        		this.cal_dstr_ter_dt.set_value(this.ds_dataD.getColumn(this.ds_dataD.rowposition,"DSTR_TER_DT"));
        		//상품보관상태 0:없음, 1:상온, 2:냉동, 3:냉장, 4:Dry
        		var na_wrs_cstd_metc = this.gfn_nullToEmpty(this.ds_dataD.getColumn(this.ds_dataD.rowposition,"NA_WRS_CSTD_METC"));
        		trace("DSTR_TER_MRK_DSC : " + this.ds_dataD.getColumn(this.ds_dataD.rowposition,"DSTR_TER_MRK_DSC"));
        		trace("DSTR_TER_DT : " + this.ds_dataD.getColumn(this.ds_dataD.rowposition,"DSTR_TER_DT"));
        		trace("NA_WRS_CSTD_METC : " + this.ds_dataD.getColumn(this.ds_dataD.rowposition,"NA_WRS_CSTD_METC"));
        		
        		
        		
        		
        		if(var_rots_flex_pr_apl_yn == "1"){//탄력가격적용상품
        ...
        this.btn_rowUpdate_onclick = function(obj,e)
        {
        	...
        	this.fn_checkPHD_FCLT_C();
        }

        this.fn_afterPHD_FCLT_C = function() {
        ...
        this.fn_checkPHD_FCLT_C = function(){
        	var searchType 		= "code"; //검색조건
        	var searchText 		= this.gfn_nullToEmpty(this.edt_na_wrs_c.value);
        	var odrpl_na_trpl_c = this.gfn_nullToEmpty(var_odrpl_na_trpl_c);
        	var odrpl_na_team_c = this.gfn_nullToEmpty(var_odrpl_na_team_c);
        	var prgr_c			= this.gfn_nullToEmpty(var_prgr_c);
        	var ddly_yn 		= this.gfn_nullToEmpty(var_ddly_yn);
        	var trplC			= this.getTrplCode();
        	var chkDate			= this.gfn_nullToEmpty(this.ds_dataM.getColumn(0, "DVY_PLA_DT"));
        	var cser_ctr_tpc	= this.gfn_nullToEmpty(var_cser_ctr_tpc);
        	var orginTrplS		= "";
        	...
        	var sSvcID        = "fn_checkPHD_FCLT_C";//통신아이디
        ...
        this.fn_validationDetail = function(){
        	...
        	**/
        	...
        	if ( dvy_pla_qt > 0 && var_prgr_c == "00" && this.gfn_getNum(var_min_odr_qt) > 0 &&
                 (dvy_pla_qt % this.gfn_getNum(var_min_odr_qt)) != 0 ) {
                alert("배송예정수량["+dvy_pla_qt+"]이 발주배수["+var_min_odr_qt+"]와 맞지 않습니다");
                return;
            }
        ...
        */
        ...
        this.fn_validationMaster = function(){
        	...
        	*/
        	...
        	/**
        	if(this.gfn_isNull(this.edt_odr_slpno)){
        		alert("저온배송은 무발주로 입력하실 수 없습니다.");
        		return false;
        	}
        	**/
        	if(var_dlvpnsht_temp_yn == "X"){
        ...
        this.btn_popup01_onclick = function(obj,e)
        {
        	var param = "";
        	var trplC = this.getTrplCode();//권한사업장
        	var DSTR_TER_YN = "Y";//신선발주여부(Y인경우 8808983322353, 8808983324562, 8808983325958, 8808983332277 발주처로만 검색)
        	
        	
        	var oArg = {AuthorityNo:param, ddly_yn:'0', temp_yn:'', trplC:trplC, DSTR_TER_YN:DSTR_TER_YN};
        	var sOption = "autosize=true,title=false";
        	var sPopupCallBack = "fn_popupAfter";    
        ...
        */
        ...
        this.fn_callBack = function(svcID,ErrorCode,ErrorMsg)
        {
        	if(ErrorCode < 0)
        	{
        		...
        		if(svcID == "fn_checkPHD_FCLT_C"){
        			trace("---------------"+this.ds_wrs.getColumn(0, "PHD_FCLT_C"));
        			if(this.ds_wrs.rowcount != 0){
        				trace(this.ds_wrs.rowcount);
        				trace(var_cser_na_usr_sys_kdc);
        				if ((this.gfn_trim(var_cser_na_usr_sys_kdc) =="52") || (this.gfn_trim(var_cser_na_usr_sys_kdc) =="54")) {
        					
        					var dvy_pla_qt 			= this.gfn_getNum(this.mae_dvy_pla_qt.value);//배송예정량
        					var boxpe_aqz 			= this.gfn_getNum(this.gfn_nullToEmpty(this.mae_boxpe_aqz.value));//박스입수량			
        					trace("dvy_pla_qt "+dvy_pla_qt);
        					trace("boxpe_aqz "+boxpe_aqz);
        					if((this.ds_wrs.getColumn(0, "PHD_FCLT_C") == "DC") && ((dvy_pla_qt % boxpe_aqz) != 0)){
        						var trplO = this.edt_orpl_na_trpl_c.value;
        						var trplON = this.edt_shrt_bzplnm.value;
        						
        						var msg =    "물류센터 DC 상품의  경우 배송예정수량은 박스당입수의 배수 값을 입력해야 합니다. \n"
        									+"발주처 : " +  trplON + "[" + trplO + "] \n"
        									+"입수 배송예정량 :["+ dvy_pla_qt +"] \n"
        									+"박스당 입수 : ["+ boxpe_aqz + "]";
        						this.alert(msg);
        		...
        		if(svcID == "getTrnrel"){
        			...
        			var_cser_na_usr_sys_kdc = this.ds_trnrel.getColumn(0, "CSER_NA_USR_SYS_KDC");//발주처사용시스템
        			trace(this.ds_trnrel.saveXML());
        			trace("거래관계 Set 완료");
        ...
        this.fn_print = function(){
        	...
        	if(naDvyPlashSlpnoList == ""){//배송예정서 1건 출력하는 경우
        		if(var_spypl_na_trpl_c == "" && var_dvyaa_na_trpl_c == "" && var_na_dvy_plash_slpno == "" && this.gfn_isNull(this.edt_na_dvy_plash_slpno.value)){
        			alert("배송예정서를 입력하세요");
        			return false;
        		}
        		...
        		var sFileName = this.gfn_nullToEmpty(this.ds_uploadresult.getColumn(0,"SYSTEMFILENAME")) //직인파일;
        		 ...
        		 var ozParam = {
        		  sId: 'VAN_DS_SC_0390',
        		  sUrl: '/rest/oz/delivery/printDeliveryNoticeOrderList',
        		  paramType: 'param',
        		  sParam: {naDvyPlashSlpnoList:';'+var_spypl_na_trpl_c+';'+var_dvyaa_na_trpl_c+';'+var_na_dvy_plash_slpno, systemFileName:sFileName, dvyPlaDt: dvy_pla_dt}
        	   };
        	   this.ozViewer(ozParam);
        	}else{
        		var sFileName = this.gfn_nullToEmpty(this.ds_uploadresult.getColumn(0,"SYSTEMFILENAME")) //직인파일;
        		
        		var lstNa = naDvyPlashSlpnoList.split(";");
        		
        		 var ozParam = {
        		  sId: 'VAN_DS_SC_0390',
        		  sUrl: '/rest/oz/delivery/printDeliveryNoticeOrderList',
        		  paramType: 'param',
        		  sParam: {naDvyPlashSlpnoList:';'+lstNa[1]+';'+lstNa[2]+';'+lstNa[3], systemFileName:sFileName, dvyPlaDt: dvy_pla_dt}
        	   };
        	   this.ozViewer(ozParam);
        	}
        	...
        	for(var row=0; row < this.ds_dataD.rowcount; row++){
        		...
        		if(odr_pcs != new_odr_pcs && new_odr_pcs != "99999999"){
        			...
        			if(option == "order"){
        				...
        				trace("############### ROTS_FLEX_PR_APL_YN : " + this.ds_trnrel.getColumn(0, "ROTS_FLEX_PR_APL_YN"));
        ...
        this.loadIncludeScript("VAN_DS_SC_0390.xfdl", true);
