(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0303.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0303.xfdl", function(exports) {
        ...
        this.loadIncludeScript("VAN_DS_SC_0303.xfdl", true);
