    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("배송예정 수산거래처별조회");
            ...
            obj = new Div("div_list", "absolute", "0", "147", null, null, "15", "15", this);
            obj.set_taborder("0");
            obj.set_text("Div02");
            ...
            obj.set_visible("false");
            this.div_list.addChild(obj.name, obj);
            obj = new Grid("grd_detail", "absolute", "0", "333", null, null, "0", "-74", this.div_list);
            obj.set_taborder("26");
            ...
            this.div_list.addChild(obj.name, obj);
            obj = new Div("div_page02", "absolute", "23.1%", null, "338", "44", null, "-204", this.div_list);
            obj.set_taborder("41");
            obj.style.set_align("center");
            obj.set_visible("false");
            obj.set_url("common::pagingBTN.xfdl");
            this.div_list.addChild(obj.name, obj);
            obj = new Static("Static01", "absolute", "646", "328", null, "5", "-8", null, this.div_list);
            obj.set_taborder("47");
            obj.set_text("5");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            ...
            obj = new Button("btn_excel", "absolute", null, "0", "41", "21", "245", null, this);
            obj.set_taborder("47");
            obj.set_text("엑셀");
            ...
            obj = new Button("btn_print", "absolute", null, "0", "41", "21", "-45", null, this);
            obj.set_taborder("50");
            obj.set_text("출력");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Button("btn_excel01", "absolute", null, "0", "65", "21", "178", null, this);
            obj.set_taborder("51");
            obj.set_text("엑셀상세");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0332.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0332.xfdl", function(exports) {
        ...
        */	
        ...
        this.loadIncludeScript("VAN_DS_SC_0332.xfdl", true);
