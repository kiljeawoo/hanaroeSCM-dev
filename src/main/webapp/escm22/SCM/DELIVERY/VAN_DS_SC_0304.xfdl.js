    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("VAN_DS_SC_0304");
                this.set_titletext("배송예정서 위탁등록");
        ...
        // User Script
        this.addIncludeScript("VAN_DS_SC_0304.xfdl", "lib::comLib.xjs");
        this.registerScript("VAN_DS_SC_0304.xfdl", function(exports) {
        ...
        */
        ...
        {
        	/*
        		if(this.getTrplCode() != '8808990111575'){
        			alert('위탁 사업장 시범업체만 이용하실 수 있습니다.');
        			return;
        		}
        	*/
        ...
        */
        ...
        {
        	var systemFileName ="NoticeOrderA.pptx";
        	var fileName = "VAN_DS_SC_0300_SIMPLE.pptx";
        ...
        this.loadIncludeScript("VAN_DS_SC_0304.xfdl", true);
