(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button00", "absolute", "30.96%", "117", null, "135", "53.13%", null, this);
            obj.set_taborder("0");
            obj.set_text("POPUP");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("Sample003_Popup.xfdl", "lib::comLib.xjs");
        this.registerScript("Sample003_Popup.xfdl", function(exports) {
        ...
        this.loadIncludeScript("Sample003_Popup.xfdl", true);
