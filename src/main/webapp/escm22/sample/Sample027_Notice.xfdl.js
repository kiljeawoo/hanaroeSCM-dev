(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_close", "absolute", "643", "0", "37", "32", null, null, this);
            obj.set_taborder("15");
            ...
            obj = new Static("TextArea00", "absolute", "18", "154", "566", "182", null, null, this);
            obj.set_taborder("18");
        ...
        // User Script
        this.addIncludeScript("Sample027_Notice.xfdl", "lib::comLib.xjs");
        this.registerScript("Sample027_Notice.xfdl", function(exports) {
        ...
        this.loadIncludeScript("Sample027_Notice.xfdl", true);
