(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new TextArea("TextArea00", "absolute", "274", "16", "207", "63", null, null, this);
            obj.set_taborder("3");
            this.addChild(obj.name, obj);

            obj = new TextArea("TextArea01", "absolute", "498", "16", "207", "63", null, null, this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);

            obj = new TextArea("TextArea02", "absolute", "50", "16", "207", "63", null, null, this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("TEST_XSS.xfdl", "lib::comLib.xjs");
        this.registerScript("TEST_XSS.xfdl", function(exports) {
        ...
        this.loadIncludeScript("TEST_XSS.xfdl", true);
