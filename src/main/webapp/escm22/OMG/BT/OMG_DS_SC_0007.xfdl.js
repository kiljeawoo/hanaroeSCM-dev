    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_0007");
                this.set_titletext("상담 및 계약시 제출 서류");
            ...
            obj = new Layout("default", "", 900, 1100, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("상담 및 계약시 제출 서류");
        ...
        // User Script
        this.registerScript("OMG_DS_SC_0007.xfdl", function(exports) {
        /* Form Load */
        this.OMG_DS_SC_1110_onload = function(obj,e)
        {
        	this.div.WebB.set_url(application.gv_serviceHtml_url  +"escm/CTR/OMG_DS_SC_0007.html");
        }
        });
        ...
        this.loadIncludeScript("OMG_DS_SC_0007.xfdl", true);
