(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_3122.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_3122.xfdl", function() {
        ...
        this.insert = function()
        {
        	...
        	trace(this.ds_rc.saveXML());
        		var sSvcID        = "insert";
        		var sURL          = "svc::rest/businessTalk/insertRequestCounseling";							     
        ...
        this.OMG_DS_SC_3122_onload = function(obj,e)
        {
        ...
        alert("3333");
        	...
        	alert("fv_cslt_rq_no   : "  +  fv_cslt_rq_no);	
        	
              if( fv_cslt_rq_no == "" ){
        			fv_cslt_rq_no = "20150000000008" ;
        		}
        	//var sSvcID        = "search";
        ...
        {
            this.addEventHandler("onload", this.OMG_DS_SC_3122_onload, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_3122.xfdl");
