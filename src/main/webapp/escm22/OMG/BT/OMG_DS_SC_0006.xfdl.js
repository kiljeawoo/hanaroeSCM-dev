    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_0006");
                this.set_titletext("계약상세 안내");
        ...
        // User Script
        this.registerScript("OMG_DS_SC_0006.xfdl", function(exports) {
        /* Form Load */
        this.OMG_DS_SC_1110_onload = function(obj,e)
        {
        	this.div.WebB.set_url(application.gv_serviceHtml_url  +"escm/CTR/OMG_DS_SC_0006.html");
        }
        });
        ...
        this.loadIncludeScript("OMG_DS_SC_0006.xfdl", true);
