(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"code\" type=\"string\" size=\"13\"/><Column id=\"name\" type=\"string\" size=\"13\"/></ColumnInfo><Rows><Row><Col id=\"code\">201</Col><Col id=\"name\">선어/활어</Col></Row><Row><Col id=\"code\">202</Col><Col id=\"name\">건어/가공</Col></Row><Row><Col id=\"code\">203</Col><Col id=\"name\">냉동</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div01", "absolute", "0", "887", "800", "100", null, null, this);
            obj.set_taborder("9");
            obj.set_text("평가표");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div_privacy", "absolute", "0", "1000", "800", "260", null, null, this);
            obj.set_taborder("11");
            this.addChild(obj.name, obj);
            ...
            this.div_privacy.addChild(obj.name, obj);
            obj = new Button("btn_insert", "absolute", null, "235", "84", "21", "10", null, this.div_privacy);
            obj.set_taborder("8");
            obj.set_text("상담가능");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_enable("false");
            this.div_privacy.addChild(obj.name, obj);
            obj = new Button("btn_register01", "absolute", null, "235", "41", "21", "98", null, this.div_privacy);
            obj.set_taborder("9");
            obj.set_text("등록");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_enable("false");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 800, 100, this.div01,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("9");
            		p.set_text("평가표");
        ...
        this.registerScript("OMG_DS_SC_2111.xfdl", function(exports) {
        ...
        this.loadIncludeScript("OMG_DS_SC_2111.xfdl", true);
