(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("OMG_DS_SC_0004.xfdl", function(exports) {
        /* Form Load */
        this.OMG_DS_SC_1110_onload = function(obj,e)
        {
        	this.div.WebB.set_url(application.gv_serviceHtml_url  +"escm/CTR/OMG_DS_SC_0004.html");
        }
        });
        ...
        this.loadIncludeScript("OMG_DS_SC_0004.xfdl", true);
