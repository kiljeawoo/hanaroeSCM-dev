    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_5001");
                this.set_titletext("가공생필ㆍ수산");
        ...
        // User Script
        this.registerScript("OMG_DS_SC_5001.xfdl", function(exports) {
        /* Form Load */
        this.OMG_DS_SC_5001_onload = function(obj,e)
        {
        	this.div.WebB.set_url("http://www.redwhistle.org/report/report.asp?organ=7655");
        }
        });
        ...
        {
            this.addEventHandler("onload", this.OMG_DS_SC_5001_onload, this);

        };

        this.loadIncludeScript("OMG_DS_SC_5001.xfdl", true);
