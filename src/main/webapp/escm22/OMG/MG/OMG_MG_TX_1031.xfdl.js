    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_MG_TX_1031");
                this.set_titletext("eMail재전송");
            ...
            obj.set_taborder("70");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static05", "absolute", "420", "62", "235", "21", null, null, this.div_search);
            obj.set_taborder("71");
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_suppliee00", "absolute", "106", "88", "157", "21", null, null, this.div_search);
            obj.set_taborder("90");
            this.div_search.addChild(obj.name, obj);
            obj = new Button("btn_popup00", "absolute", "266", "88", "21", "21", null, null, this.div_search);
            obj.set_taborder("91");
            obj.set_cssclass("btn_WF_Searchbtn");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_suppliee01", "absolute", "290", "88", "100", "21", null, null, this.div_search);
            obj.set_taborder("92");
            obj.set_enable("false");
            this.div_search.addChild(obj.name, obj);
            ...
            this.div_grd.addChild(obj.name, obj);
            obj = new Button("btn_resend", "absolute", null, "16", "53", "21", "92", null, this.div_grd);
            obj.set_taborder("10");
            obj.set_text("재전송");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"125\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"90\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"90\"/><Column size=\"70\"/><Column size=\"120\"/><Column size=\"130\"/><Column size=\"100\"/><Column size=\"130\"/><Column size=\"100\"/><Column size=\"170\"/></Columns><Rows><Row size=\"35\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"0\"/><Cell col=\"1\" text=\"발행상태\"/><Cell col=\"2\" text=\"전송수단\"/><Cell col=\"3\" text=\"전송결과\"/><Cell col=\"4\" text=\"수신결과\"/><Cell col=\"5\" text=\"세금계산서종류\"/><Cell col=\"6\" text=\"작성일자\"/><Cell col=\"7\" text=\"등록일자\"/><Cell col=\"8\" text=\"공급받는자상호\"/><Cell col=\"9\" text=\"공급받는자&#13;&#10;사업자번호\"/><Cell col=\"10\" text=\"공급자상호\"/><Cell col=\"11\" text=\"공급자&#13;&#10;사업자번호\"/><Cell col=\"12\" text=\"품목\"/><Cell col=\"13\" text=\"공급가액\"/><Cell col=\"14\" text=\"세액\"/><Cell col=\"15\" text=\"합계액\"/><Cell col=\"16\" text=\"매출사업장/팀코드\"/><Cell col=\"17\" text=\"매출사업장명\"/><Cell col=\"18\" text=\"매입사업장/팀코드\"/><Cell col=\"19\" text=\"매입사업자명\"/><Cell col=\"20\" text=\"승인번호\"/></Band><Band id=\"body\"><Cell displaytype=\"expr:TXBIL_STSC=='미발행'?'checkbox':'none'\" edittype=\"expr:TXBIL_STSC=='미발행'?'checkbox':'none'\" text=\"bind:ISCHECKED\"/><Cell col=\"1\" displaytype=\"normal\" text=\"bind:TXBIL_STSC\"/><Cell col=\"2\"/><Cell col=\"3\"/><Cell col=\"4\"/><Cell col=\"5\" text=\"bind:TXBIL_KD\"/><Cell col=\"6\" displaytype=\"date\" text=\"bind:CRT_DT\"/><Cell col=\"7\" displaytype=\"date\" text=\"bind:RG_DT\"/><Cell col=\"8\" style=\"align:left;\" text=\"bind:BUY_MTALNM\"/><Cell col=\"9\" text=\"bind:BUY_BZNO\"/><Cell col=\"10\" style=\"align:left;\" text=\"bind:SPLR_MTALNM\" maskchar=\" \"/><Cell col=\"11\" text=\"bind:SPLR_BZNO\"/><Cell col=\"12\" edittype=\"none\" style=\"align:left;selectfont: ;\" text=\"bind:LATCNM\" tooltiptext=\"bind:LATCNM\"/><Cell col=\"13\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SPRTT\"/><Cell col=\"14\" displaytype=\"number\" style=\"align:right;\" text=\"bind:TXA_TT\"/><Cell col=\"15\" displaytype=\"number\" style=\"align:right;\" text=\"bind:TOT_AM\"/><Cell col=\"16\" text=\"bind:NA_TRPL_C_TEAM_C\"/><Cell col=\"17\" text=\"bind:NA_CLNTNM\"/><Cell col=\"18\" text=\"bind:NA_BZPLC_TEAM_C\"/><Cell col=\"19\" text=\"bind:NA_BZPLNM\"/><Cell col=\"20\" text=\"bind:NTS_TMS_SQNO\"/></Band></Format></Formats>");
            this.div_grd.addChild(obj.name, obj);
            obj = new Button("btn_modEmail", "absolute", null, "16", "89", "21", "147", null, this.div_grd);
            obj.set_taborder("13");
            obj.set_text("메일주소변경");
            this.div_grd.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item10","div_search.edt_suppliee01","value","ds_condition","NA_BZPLC");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_MG_TX_1031.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_MG_TX_1031.xfdl", "lib::comTSToolKit.xjs");
        this.registerScript("OMG_MG_TX_1031.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_reSendEmail = function()
        {
        	var sSvcID        = "reSendEmail";
        	var sURL          = "svc::rest/tx/reSendEmail";
        	var sInDatasets   = "ds_email=ds_email";
        	var sOutDatasets  = "";	
        	var sArgument     = "";
        	var sCallbackFunc = "fn_callBack";
        ...
        this.common_onclick = function(obj,e)
        {
        	switch(obj.name)
        	{
        		...
        		case "btn_excel": 
        			...
        			excelDownHandler(application.gv_serverAdmin_url+"rest/excel/tx/retrieveEmailResendListExcel?"+params, this);
        			break;
        		...
        		case "btn_resend":
        			...
        			if(this.ds_tax.getCaseCount("ISCHECKED=='1'") > 0)
        			{
        				for(var i = 0 ; i < this.ds_tax.rowcount ; i++)
        				{
        					if(this.ds_tax.getColumn(i, "ISCHECKED") == "1" )
        					{
        						nRow = this.ds_email.addRow();
        						this.ds_email.copyRow(nRow, this.ds_tax, i);
        					}
        				}
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.edt_suppliee00.addEventHandler("onkeydown", this.edt_suppliee_onkeydown, this);
            this.div_search.edt_suppliee00.addEventHandler("onchanged", this.div_search_edt_suppliee_onchanged, this);
            this.div_search.btn_popup00.addEventHandler("onclick", this.common_onclick, this);
        ...
        this.loadIncludeScript("OMG_MG_TX_1031.xfdl", true);
