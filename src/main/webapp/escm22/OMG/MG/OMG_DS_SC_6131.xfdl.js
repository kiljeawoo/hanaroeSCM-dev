    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_6131");
                this.set_titletext("유형코드등록/수정");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"FINAL_SIMP_TPC\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_simpTpcnm", "absolute", "130", "109", "230", "21", null, null, this);
            obj.set_taborder("128");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_simpTexpl", "absolute", "130", "136", "597", "21", null, null, this);
            obj.set_taborder("129");
            this.addChild(obj.name, obj);

            obj = new Button("btn_dupCheck", "absolute", "326", "80", "65", "21", null, null, this);
            obj.set_taborder("131");
            obj.set_text("중복확인");
            this.addChild(obj.name, obj);

            obj = new Static("Static01", "absolute", "384", "104", "110", "29", null, null, this);
            obj.set_taborder("132");
            obj.set_text("시스템명");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_sysNm", "absolute", "497", "109", "230", "21", null, null, this);
            obj.set_taborder("137");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "17", "160", "110", "29", null, null, this);
            obj.set_taborder("138");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static10", "absolute", "126", "160", null, "29", "17", null, this);
            obj.set_taborder("139");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_useYn", "absolute", "130", "164", "158", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","edt_simpTpcnm","value","ds_in","SIMP_TPCNM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","edt_simpTexpl","value","ds_in","SIMP_T_EXPL");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","edt_simpTpc00","value","ds_in","SIMP_TPC");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item5","edt_sysNm","value","ds_in","SYSNM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_6131.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_6131.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.edt_simpTpcnm.addEventHandler("oneditclick", this.edt_simpC_oneditclick, this);
            this.btn_dupCheck.addEventHandler("onclick", this.fn_dupCheck, this);
            this.edt_sysNm.addEventHandler("oneditclick", this.edt_sysNm_oneditclick, this);
            this.rdo_useYn.addEventHandler("onitemclick", this.Radio00_onitemclick, this);

        };

        this.loadIncludeScript("OMG_DS_SC_6131.xfdl", true);
