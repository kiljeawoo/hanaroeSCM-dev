(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_supplier", "absolute", "106", "36", "156", "21", null, null, this.div_search);
            obj.set_taborder("70");
            this.div_search.addChild(obj.name, obj);
            ...
            obj = new Button("btn_seller", "absolute", "265", "36", "21", "21", null, null, this.div_search);
            obj.set_taborder("78");
            obj.set_cssclass("btn_WF_Searchbtn");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_supplier2", "absolute", "289", "36", "100", "21", null, null, this.div_search);
            obj.set_taborder("79");
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_suppliee", "absolute", "106", "88", "156", "21", null, null, this.div_search);
            obj.set_taborder("90");
            this.div_search.addChild(obj.name, obj);
            obj = new Button("btn_buyer", "absolute", "265", "88", "21", "21", null, null, this.div_search);
            obj.set_taborder("91");
            obj.set_cssclass("btn_WF_Searchbtn");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_suppliee2", "absolute", "289", "88", "100", "21", null, null, this.div_search);
            obj.set_taborder("92");
            obj.set_enable("false");
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_text("건");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static10", "absolute", "420", "88", "114", "21", null, null, this.div_search);
            obj.set_taborder("96");
            obj.set_text("역발행구분");
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Combo("cbo_rpbcDsc", "absolute", "567", "88", "113", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("97");
            obj.set_innerdataset("@ds_combo2");
            obj.set_codecolumn("SIMP_C");
            obj.set_datacolumn("SIMP_CNM");
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item9","div_search.edt_supplier2","value","ds_condition","NA_TRPL_C");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item10","div_search.edt_suppliee2","value","ds_condition","NA_BZPLC");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item11","div_search.cbo_rpbcDsc","value","ds_condition","RPBC_DSC");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_MG_TX_6001.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_MG_TX_6001.xfdl", "lib::comTSToolKit.xjs");
        this.registerScript("OMG_MG_TX_6001.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_afterFormOnload = function()
        {
           ...
           var param = [  
         		...
         		{code:"RPBC_DSC",   dsName:"ds_combo2",   selecttype:""}
            ];
        ...
        this.fn_commonAfterOnload= function()
        {
            ...
            this.ds_condition.setColumn(0, "RPBC_DSC", "2");//1:정발행 2:역발행
         	...
         	else 
         	{
        		switch(svcID)
        		{
        			case "retrieveEmailResendList":
        				//정발행/역발행 여부에 따라서 체크박스가 다르게 보인다.
        				if(this.div_search.cbo_rpbcDsc.value == '1')//정발행
        				{
        					this.div_grd.grd_tax.setCellProperty('body', 0, 'displaytype', "expr:TXBIL_STSC!='미발행'&&TXBIL_STSC!='수신'?'checkbox':'none'");
        					this.div_grd.grd_tax.setCellProperty('body', 0, 'edittype', "expr:TXBIL_STSC!='미발행'&&TXBIL_STSC!='수신'?'checkbox':'none'");
        				}
        				else//역발행
        				{
        					this.div_grd.grd_tax.setCellProperty('body', 0, 'displaytype', "expr:TXBIL_STSC=='미발행'?'checkbox':'none'");
        					this.div_grd.grd_tax.setCellProperty('body', 0, 'edittype', "expr:TXBIL_STSC=='미발행'?'checkbox':'none'");
        				}
        ...
        ************************************************************************************************/
        this.common_onclick = function(obj,e)
        {
        	switch(obj.name)
        	{
        		...
        		case "btn_seller":
        			var oArg = {searchWord:this.div_search.edt_supplier.value};
        ...
        this.div_search_edt_supplier_onchanged = function(obj,e)
        {
        	if(e.keycode == '13')
        	{
        		this.div_search.btn_seller.click();
        	}
        }

        this.edt_supplier_onkeydown = function(obj,e)
        {
        	this.div_search.edt_supplier2.set_value("");
        }
        ...
        this.edt_suppliee_onkeydown = function(obj,e)
        {
        	if(e.keycode == '13')
        	{
        		this.div_search.btn_buyer.click();
        	}
        }
        ...
        ************************************************************************************************/
        	...
        	switch(strId)
        	{
        		...
        		case "POPUP_TRPL":
        			if(!this.gfn_isNull(strVal))
        			{
        				...
        				this.div_search.edt_supplier2.set_value(this.ds_buyer.getColumn(0, "NA_TRPL_C"));
        				this.div_search.edt_supplier.set_value(this.ds_buyer.getColumn(0, "CLNTNM"));
        			}
        			break;
        ...
        this.div_search_cbo_rpbcDsc_onitemchanged = function(obj,e)
        {
        	if(e.postvalue == '1')//정발행
        	{
        		this.div_search.edt_suppliee.set_value("주식회사이썸테크");
        		this.div_search.edt_suppliee2.set_value("1148164826000");
        		
        		this.div_search.edt_suppliee.set_enable(false);
        		this.div_search.btn_buyer.set_enable(false);
        		this.div_search.edt_suppliee2.set_enable(false);
        	}
        	else//역발행
        	{	
        		this.div_search.edt_suppliee.set_value("");
        		this.div_search.edt_suppliee2.set_value("");
        		
        		this.div_search.edt_suppliee.set_enable(true);
        		this.div_search.btn_buyer.set_enable(true);
        	}
        }
        });
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("ontimer", this.OMG_DS_TX_6001_ontimer, this);
            this.div_search.edt_supplier.addEventHandler("onkeydown", this.edt_supplier_onkeydown, this);
            this.div_search.edt_supplier.addEventHandler("onchanged", this.div_search_edt_supplier_onchanged, this);
            ...
            this.div_search.btn_seller.addEventHandler("onclick", this.common_onclick, this);
            ...
            this.div_search.btn_buyer.addEventHandler("onclick", this.common_onclick, this);
            this.div_search.cbo_rpbcDsc.addEventHandler("onitemchanged", this.div_search_cbo_rpbcDsc_onitemchanged, this);
        ...
        this.loadIncludeScript("OMG_MG_TX_6001.xfdl", true);
