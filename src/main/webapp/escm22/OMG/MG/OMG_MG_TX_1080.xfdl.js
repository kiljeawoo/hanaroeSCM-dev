(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "15", "10", "76", "21", null, null, this.div_search);
            obj.set_taborder("38");
            obj.set_text("작성일");
            ...
            obj = new BindItem("item3","div_search.edt_suppliee2","value","ds_condition","NA_TRPL_C");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_MG_TX_1080.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_MG_TX_1080.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_commonAfterOnload= function()
        {
            ...
            this.fn_retrieveRptPsttEScm();
        }

        /************************************************************************************************
         * TRANSACTION 및 추가 FUNCTION 영역
        ************************************************************************************************/
        this.fn_retrieveRptPsttEScm = function()
        {
        	var sSvcID        = "retrieveRptPsttEScm";
        	var sURL          = "svc::rest/tx/retrieveRptPsttEScm";
        ...
        this.fn_callBack = function(svcID,ErrorCode,ErrorMsg)
        {
        	if(ErrorCode < 0) //에러
         	...
         	else 
         	{
        		switch(svcID)
        		{
        			case "retrieveRptPsttEScm":
        				trace("retrieveRptPsttEScm");
        				break;
        		}
         	}
        }
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_MG_TX_1080.xfdl", true);
