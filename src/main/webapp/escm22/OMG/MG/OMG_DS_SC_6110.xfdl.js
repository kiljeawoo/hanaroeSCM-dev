    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_6110");
                this.set_titletext("농협공통코드조회");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"NUMBER\" type=\"STRING\" size=\"256\"/><Column id=\"CHK\" type=\"STRING\" size=\"32\"/><Column id=\"SIMP_TPC\" type=\"STRING\" size=\"30\"/><Column id=\"SIMP_C\" type=\"STRING\" size=\"20\"/><Column id=\"SIMP_CNM\" type=\"STRING\" size=\"150\"/><Column id=\"SIMP_C_EXPL\" type=\"STRING\" size=\"100\"/><Column id=\"SIMP_C_SORT_SQ\" type=\"INT\" size=\"256\"/><Column id=\"BIZ_TYPE\" type=\"STRING\" size=\"50\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"1\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_simpTpc", "absolute", "154", "10", "140", "21", null, null, this.div_search);
            obj.set_taborder("1");
            ...
            obj = new Static("Static05", "absolute", "649", "29", "30", "69", null, null, this);
            obj.set_taborder("11");
            obj.set_text("69");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            ...
            obj = new Static("Static03", "absolute", "90.91%", "98", null, "41", "2.12%", null, this);
            obj.set_taborder("13");
            obj.set_text("15");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            ...
            obj = new Button("btn_update", "absolute", null, "0", "45", "21", "78", null, this);
            obj.set_taborder("14");
            obj.set_text("수정");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_6110.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_6110.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_list.grd_nacfcomncList.addEventHandler("onheadclick", this.Div02_Grid01_onheadclick, this);

        };

        this.loadIncludeScript("OMG_DS_SC_6110.xfdl", true);
