    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_6313_P02");
            ...
            obj = new Radio("rdo_useYn", "absolute", "131", "164", "158", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            cbo_bsnDsc_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">ESCM</Col><Col id=\"datacolumn\">ESCM</Col></Row><Row><Col id=\"codecolumn\">배송예정서</Col><Col id=\"datacolumn\">DELIVERY</Col></Row></Rows>");
            ...
            obj = new Edit("edt_blockCntn", "absolute", "131", "136", "529", "21", null, null, this);
            obj.set_taborder("28");
            obj.set_maxlength("250");
            this.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","edt_blockCntn","value","ds_block","BLOCK_CNTN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_6313_P02.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_6313_P02.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_validationCheck = function(){
        	...
        	if(this.gfn_isNull(this.edt_blockCntn.value)){
        		this.alert('차단사유를 입력바랍니다.');
        		this.edt_blockCntn.setFocus();
        		return false;
        	}
        ...
        this.insert = function()
        {
        	if(this.fn_validationCheck()){
        		...
        		this.ds_block.setColumn(0, "BLOCK_CNTN", this.gfn_nullToEmpty(this.edt_blockCntn.value));
        ...
        this.loadIncludeScript("OMG_DS_SC_6313_P02.xfdl", true);
