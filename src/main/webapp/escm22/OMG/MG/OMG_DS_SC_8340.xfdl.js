(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "15", "39", "79", "21", null, null, this.div_search);
            obj.set_taborder("17");
            obj.set_text("거래처");
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static03", "absolute", "414", "10", "79", "21", null, null, this.div_search);
            obj.set_taborder("31");
            obj.set_text("용도구분");
            obj.set_cssclass("sta_WFSA_Label");
            obj.style.set_padding("0 20 0 11");
            this.div_search.addChild(obj.name, obj);
            obj = new Combo("cbo_uz", "absolute", "517", "10", "232", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            var cbo_uz_innerdataset = new Dataset("cbo_uz_innerdataset", this.div_search.cbo_uz);
            cbo_uz_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">all</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">001</Col><Col id=\"datacolumn\">혁신점포 공급업체 모니터링</Col></Row></Rows>");
            obj.set_innerdataset(cbo_uz_innerdataset);
            obj.set_taborder("32");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_value("all");
            obj.set_text("전체");
            obj = new Combo("cbo_bsn", "absolute", "118", "10", "140", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            var cbo_bsn_innerdataset = new Dataset("cbo_bsn_innerdataset", this.div_search.cbo_bsn);
            cbo_bsn_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">all</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">ESCM</Col><Col id=\"datacolumn\">eSCM</Col></Row><Row><Col id=\"codecolumn\">CONSULT</Col><Col id=\"datacolumn\">컨설팅</Col></Row><Row><Col id=\"codecolumn\">MDS</Col><Col id=\"datacolumn\">장비쇼핑몰</Col></Row><Row><Col id=\"codecolumn\">IF</Col><Col id=\"datacolumn\">인터페이스</Col></Row></Rows>");
            obj.set_innerdataset(cbo_bsn_innerdataset);
            obj.set_taborder("33");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_value("all");
            obj.set_text("전체");
            obj = new Edit("edt_search", "absolute", "261", "39", "140", "21", null, null, this.div_search);
            obj.set_taborder("34");
            this.div_search.addChild(obj.name, obj);
            obj = new Combo("cbo_search", "absolute", "118", "39", "140", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"70\"/><Column size=\"106\"/><Column size=\"126\"/><Column size=\"224\"/><Column size=\"90\"/><Column size=\"111\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"0\"/><Cell col=\"1\" text=\"업무구분\"/><Cell col=\"2\" text=\"용도구분\"/><Cell col=\"3\" text=\"거래처코드\"/><Cell col=\"4\" text=\"거래처명\"/><Cell col=\"5\" text=\"등록일\"/><Cell col=\"6\" text=\"비고\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" text=\"bind:ISCHECKED\" autosizecol=\"none\"/><Cell col=\"1\" text=\"bind:BSN_DSC\" autosizecol=\"none\"/><Cell col=\"2\" text=\"expr:comp.parent.parent.fn_displayUzDsc(UZ_DSC)\" autosizecol=\"none\"/><Cell col=\"3\" text=\"bind:NA_TRPL_C\"/><Cell col=\"4\" text=\"bind:CLNTNM\" autosizecol=\"none\"/><Cell col=\"5\" text=\"bind:FSRG_DTM\"/><Cell col=\"6\" displaytype=\"normal\" text=\"bind:RMK_CNTN\"/></Band></Format></Formats>");
        ...
        ************************************************************************************************/
        ...
        this.btn_search_onclick = function(obj,e)
        {
        	...
        	var sParams = "BSN_DSC="+this.gfn_nullToEmpty(this.div_search.cbo_bsn.value)
        				+ " UZ_DSC="+this.gfn_nullToEmpty(this.div_search.cbo_uz.value)
        				+ " SEARCH_TYPE="+this.gfn_nullToEmpty(this.div_search.cbo_search.value)
        				+ " SEARCH_TEXT="+this.gfn_nullToEmpty(this.div_search.edt_search.value)
        				;

        	var sSvcID        = "ctlList";
        	var sURL          ="svc::rest/mg/survey/retrieveCtlTrplList";
        	var sInDatasets   = "";
        ...
        this.btn_insert_onclick = function(obj,e)
        {
        	...
        	this.gfn_openPopup("popId","OMG.MG::OMG_DS_SC_8340_P01.xfdl",oArg,sOption,sPopupCallBack);
        }
        ...
        this.btn_delete_onclick = function(obj,e)
        {
        	...
        	if (checkCnt > 0) {
        		...
        		if (cfm) {
        			var sParams       = "";
        			var sSvcID        = "delete";
        			var sURL          = "svc::rest/mg/survey/deleteCtlTrpl";
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.cbo_uz.addEventHandler("onitemchanged", this.div_search_cbo_displayYn_onitemchanged, this);
            this.div_search.cbo_bsn.addEventHandler("onitemchanged", this.div_search_cbo_displayYn_onitemchanged, this);
