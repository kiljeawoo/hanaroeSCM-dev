    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_MG_TX_1071");
                this.set_titletext("매입합계표(정발행) - 사용안함");
            ...
            obj = new Layout("default", "", 803, 490, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("매입합계표(정발행) - 사용안함");
        ...
        // User Script
        this.addIncludeScript("OMG_MG_TX_1071.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_MG_TX_1071.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_afterFormOnload = function()
        {
           //페이지 로딩후 실행부분
            ...
            this.ds_condition.setColumn(0,"OCU_DSC", "01"); // 1:경제통합, 2:하나로eSCM
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_MG_TX_1071.xfdl", true);
