(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.addChild(obj.name, obj);
            obj = new Combo("cbo_select", "absolute", "23", "10", "92", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            var cbo_select_innerdataset = new Dataset("cbo_select_innerdataset", this.div_search.cbo_select);
            cbo_select_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">유형코드</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">유형코드명</Col></Row></Rows>");
            obj.set_innerdataset(cbo_select_innerdataset);
            obj.set_taborder("1");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_index("-1");
            obj = new Static("Static01", "absolute", "535", "10", "139", "21", null, null, this.div_search);
            obj.set_taborder("3");
            obj.set_text("페이지당 게시물수");
            obj.set_cssclass("sta_WFSA_Label");
            obj.style.set_padding("0 20 0 11");
            this.div_search.addChild(obj.name, obj);
            obj = new Combo("cbo_pageNum", "absolute", "673", "10", "61", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_datacolumn("datacolumn");
            obj.set_index("-1");
            obj = new Edit("edt_simpTpc_TpcNm", "absolute", "117", "10", "141", "21", null, null, this.div_search);
            obj.set_taborder("5");
            obj.set_maxlength("150");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "301", "10", "79", "21", null, null, this.div_search);
            obj.set_taborder("6");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WFSA_Label");
            obj.style.set_padding("0 20 0 11");
            this.div_search.addChild(obj.name, obj);
            obj = new Combo("cbo_useYn", "absolute", "380", "10", "105", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_taborder("0");
            obj.set_binddataset("ds_tpc");
            obj.set_cellsizingtype("col");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"80\"/><Column size=\"135\"/><Column size=\"207\"/><Column size=\"250\"/><Column size=\"280\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"번호\"/><Cell col=\"2\" text=\"단순유형코드\"/><Cell col=\"3\" text=\"단순유형코드명\"/><Cell col=\"4\" text=\"시스템명\"/><Cell col=\"5\" text=\"단순유형코드설명\"/><Cell col=\"6\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:NUMBER\"/><Cell col=\"2\" text=\"bind:SIMP_TPC\"/><Cell col=\"3\" text=\"bind:SIMP_TPCNM\"/><Cell col=\"4\" text=\"bind:SYSNM\"/><Cell col=\"5\" text=\"bind:SIMP_T_EXPL\"/><Cell col=\"6\" text=\"bind:UYN\"/></Band></Format></Formats>");
            ...
            this.div_list.addChild(obj.name, obj);
            obj = new Button("btn_flag", "absolute", "42.89%", "0", null, "12", "45.43%", null, this.div_list);
            obj.set_taborder("3");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_6130.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_6130.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.edt_simpTpc_TpcNm.addEventHandler("oneditclick", this.div_search_edt_menuId00_oneditclick, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_6130.xfdl", true);
