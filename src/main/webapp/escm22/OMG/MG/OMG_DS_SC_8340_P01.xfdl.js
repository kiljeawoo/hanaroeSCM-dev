    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,577,181);
            }
            ...
            obj = new Static("Static13", "absolute", "126", "104", null, "29", "17", null, this);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static08", "absolute", "126", "132", null, "29", "17", null, this);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static04", "absolute", "17", "132", "110", "29", null, null, this);
            obj.set_taborder("12");
            obj.set_text("비고");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static12", "absolute", "126", "76", null, "29", "17", null, this);
            obj.set_taborder("21");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static19", "absolute", "282", "76", "91", "29", null, null, this);
            obj.set_taborder("22");
            obj.set_text("용도구분");
            obj.set_cssclass("sta_WF_Label");
            ...
            obj = new Edit("edt_rmk", "absolute", "131", "136", "414", "21", null, null, this);
            obj.set_taborder("23");
            ...
            obj = new Combo("cbo_uzDsc", "absolute", "377", "80", "168", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_bzplc", "absolute", "131", "108", "300", "21", null, null, this);
            obj.set_taborder("31");
            obj.set_cssclass("WF_Essential");
            this.addChild(obj.name, obj);

            obj = new Button("btn_search", "absolute", "430", "108", "21", "21", null, null, this);
            obj.set_taborder("30");
            obj.set_cssclass("btn_WF_Searchbtn");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_gln", "absolute", "490", "108", "52", "21", null, null, this);
            obj.set_taborder("32");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 577, 181, this,
            	//-- Layout function
            	function(p) {
        ...
        ************************************************************************************************/
        ...
        this.insert = function()
        {
        	if (this.fn_validationCheck()) {
        		var sSvcID        = "insert";
        		var sURL          = "svc::rest/mg/survey/insertCtlTrpl";
