    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("사용자 만족도 설문조사 팝업");
                this._setFormPosition(0,0,773,905);
            }
            ...
            obj = new Static("Static02", "absolute", "8", "249", null, "33", "10", null, this);
            obj.set_taborder("21");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 773, 905, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("OMG_DS_SC_8331");
            		p.style.set_border("2 solid #067394ff");
            		p.set_titletext("사용자 만족도 설문조사 팝업");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_8331.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_8331.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.OMG_DS_SC_8331_onactivate = function(obj,e)
        {
        /*	confirm("설문조사 기간입니다.");*/
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onactivate", this.OMG_DS_SC_8331_onactivate, this);
            this.btn_save.addEventHandler("onclick", this.btn_save_onclick, this);
            this.div_chk.chk.addEventHandler("onchanged", this.div_chk_chk_onchanged, this);

        };

        this.loadIncludeScript("OMG_DS_SC_8331.xfdl", true);
