(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_6712_P01.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_6712_P01.xfdl", function(exports) {
        ...
        this.on_initEvent = function()
        {
            ...
            this.edt_search.addEventHandler("oneditclick", this.edt_search_oneditclick, this);
            this.edt_search.addEventHandler("onkeydown", this.edt_search_onkeydown, this);
            this.btn_search.addEventHandler("onclick", this.btn_search_onclick, this);

        };

        this.loadIncludeScript("OMG_DS_SC_6712_P01.xfdl", true);
