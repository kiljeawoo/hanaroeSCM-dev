(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_8323.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_8323.xfdl", function() {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.btn_delrow_onclick = function(obj,e)
        {
        	...
        	if (cnt > 0) {
        		...
        		if (updateDel) {
        			alert("기존 항목들은 화면에서 바로 행삭제가 되지 않으며, 수정시 오른쪽 체크박스를 선택한 항목들이 삭제됩니다.");
        		}
        	}
        }
        });
        ...
        this.loadIncludeScript("OMG_DS_SC_8323.xfdl");
