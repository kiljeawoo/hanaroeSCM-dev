(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"SRV_Q_NUM\" type=\"STRING\" size=\"256\"/><Column id=\"QUESTION\" type=\"STRING\" size=\"256\"/><Column id=\"A_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"SRV_A_NUM\" type=\"STRING\" size=\"256\"/><Column id=\"ANSWER\" type=\"STRING\" size=\"256\"/><Column id=\"CNT\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grd_comncList", "absolute", "-1", "128", null, null, "19", "29", this);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"40\"/><Column size=\"200\"/><Column size=\"110\"/><Column size=\"40\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"질문번호\"/><Cell col=\"1\" text=\"질문유형\"/><Cell col=\"2\" text=\"질문\"/><Cell col=\"3\" text=\"답변\"/><Cell col=\"4\" text=\"답변횟수\"/></Band><Band id=\"body\"><Cell text=\"bind:SRV_Q_NUM\"/><Cell col=\"1\" text=\"bind:A_TYPE\"/><Cell col=\"2\" text=\"bind:QUESTION\" wordwrap=\"char\"/><Cell col=\"3\" text=\"bind:ANSWER\" wordwrap=\"char\"/><Cell col=\"4\" text=\"bind:CNT\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_8312.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_8312.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_8312.xfdl", true);
