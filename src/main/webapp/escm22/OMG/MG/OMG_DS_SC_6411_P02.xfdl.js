    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_6411_P02");
                this.set_titletext("회원서비스이용 수정 이력");
            ...
            obj._setContents("<ColumnInfo><Column id=\"SVC_ENT_DTM\" type=\"STRING\" size=\"256\"/><Column id=\"SVC_ID\" type=\"STRING\" size=\"256\"/><Column id=\"ENT_PRG_STSC\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Dataset("ds_svcId", this);
            obj._setContents("<ColumnInfo><Column id=\"code\" type=\"STRING\" size=\"256\"/><Column id=\"name\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"code\">21</Col><Col id=\"name\">정액제</Col></Row><Row><Col id=\"code\">22</Col><Col id=\"name\">종량제</Col></Row><Row><Col id=\"code\">31</Col><Col id=\"name\">BI조회</Col></Row><Row><Col id=\"code\">32</Col><Col id=\"name\">추이분석</Col></Row><Row><Col id=\"code\">33</Col><Col id=\"name\">시장분석(자사)</Col></Row><Row><Col id=\"code\">34</Col><Col id=\"name\">카테고리 시장분석</Col></Row><Row><Col id=\"code\">35</Col><Col id=\"name\">자사판매정보 제공동의</Col></Row><Row><Col id=\"code\">38</Col><Col id=\"name\">마감간소화</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"121\"/><Column size=\"278\"/><Column size=\"127\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"27\"/></Rows><Band id=\"head\"><Cell text=\"등록 시간\"/><Cell col=\"1\" text=\"서비스ID\"/><Cell col=\"2\" text=\"수정여부\"/></Band><Band id=\"body\"><Cell text=\"bind:SVC_ENT_DTM\" mask=\"####-##-## ##:##:##\"/><Cell col=\"1\" displaytype=\"combo\" text=\"bind:SVC_ID\" combodataset=\"ds_svcId\" combocodecol=\"code\" combodatacol=\"name\"/><Cell col=\"2\" displaytype=\"combo\" text=\"bind:ENT_PRG_STSC\" combodataset=\"ds_entPrgStsc\" combocodecol=\"code\" combodatacol=\"name\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_6411_P02.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_6411_P02.xfdl", function(exports) {
        ...
        this.loadIncludeScript("OMG_DS_SC_6411_P02.xfdl", true);
