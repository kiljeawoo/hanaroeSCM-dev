(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "210", "9", "200", "21", null, null, this.Div02);
            obj.set_taborder("59");
            obj.set_text("하나로 eSCM 사용자교육 신청");
            obj.style.set_font("bold 9 arial");
            this.Div02.addChild(obj.name, obj);

            obj = new Static("Static107", "absolute", "10", "296", "580", "29", null, null, this);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static00", "absolute", "10", "324", "580", "29", null, null, this);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static113", "absolute", "10", "436", "580", "29", null, null, this);
            obj.set_taborder("6");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static115", "absolute", "10", "408", "580", "29", null, null, this);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static12", "absolute", "10", "352", "580", "29", null, null, this);
            obj.set_taborder("26");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01", "absolute", "10", "380", "580", "29", null, null, this);
            obj.set_taborder("32");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("36");
            obj.set_value("교육의 원활한 진행을 위해 사용자 교육 신청은 업체별 최대 2명까지 참여 가능합니다. ");
            obj.style.set_padding("0 0 0 10");
            obj.style.set_border("0 solid #bfbfbfff");
            obj.style.set_align("left middle");
            this.addChild(obj.name, obj);

            obj = new Static("Static05", "absolute", "300", "436", "80", "29", null, null, this);
            obj.set_taborder("38");
            obj.set_text("이메일");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static06", "absolute", "300", "324", "80", "29", null, null, this);
            obj.set_taborder("39");
            obj.set_text("업체명");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_USR_EMAIL00", "absolute", "388", "440", "82", "21", null, null, this);
            obj.set_taborder("40");
            obj.set_imemode("alpha");
            obj.set_maxlength("25");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_USR_COMP00", "absolute", "388", "328", "183", "21", null, null, this);
            obj.set_taborder("41");
            obj.set_lengthunit("utf8");
            obj.set_maxlength("20");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_USR_EMAIL03", "absolute", "489", "440", "82", "21", null, null, this);
            obj.set_taborder("42");
            obj.set_imemode("alpha");
            obj.set_maxlength("25");
            this.addChild(obj.name, obj);

            obj = new Static("Static07", "absolute", "475", "440", "13", "21", null, null, this);
            obj.set_taborder("43");
            obj.set_text("@");
            this.addChild(obj.name, obj);

            obj = new Static("Static08", "absolute", "300", "408", "80", "29", null, null, this);
            obj.set_taborder("44");
            obj.set_text("연락처");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Combo("cbo_HP00", "absolute", "388", "412", "51", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("45");
            obj.set_innerdataset("ds_hpNo");
            obj.set_codecolumn("SIMP_C");
            ...
            obj = new Static("Static09", "absolute", "439", "412", "9", "21", null, null, this);
            obj.set_taborder("46");
            obj.set_text("-");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_HP00", "absolute", "448", "412", "48", "21", null, null, this);
            obj.set_taborder("47");
            obj.set_inputtype("number");
            obj.set_maxlength("4");
            this.addChild(obj.name, obj);

            obj = new Static("Static11", "absolute", "496", "412", "9", "21", null, null, this);
            obj.set_taborder("48");
            obj.set_text("-");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_HP03", "absolute", "505", "412", "48", "21", null, null, this);
            obj.set_taborder("49");
            obj.set_inputtype("number");
            obj.set_maxlength("4");
            this.addChild(obj.name, obj);

            obj = new Static("Static13", "absolute", "300", "352", "80", "29", null, null, this);
            obj.set_taborder("50");
            obj.set_text("참가자명");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Calendar("edt_EDU_DT00", "absolute", "388", "300", "120", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("51");
            obj.set_readonly("true");
            obj.set_dateformat("yyyy-MM-dd");

            obj = new Edit("edt_USR_NM00", "absolute", "388", "356", "183", "21", null, null, this);
            obj.set_taborder("52");
            obj.set_maxlength("16");
            this.addChild(obj.name, obj);

            obj = new Static("Static14", "absolute", "300", "380", "80", "29", null, null, this);
            obj.set_taborder("53");
            obj.set_text("직급");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_USR_POSITION00", "absolute", "388", "384", "183", "21", null, null, this);
            obj.set_taborder("54");
            obj.set_maxlength("16");
            this.addChild(obj.name, obj);

            obj = new Static("Static15", "absolute", "300", "296", "80", "29", null, null, this);
            obj.set_taborder("55");
            obj.set_text("교육일시");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj = new TextArea("TextArea00", "absolute", "100", "50", "400", "100", null, null, this.Div00);
            obj.set_taborder("0");
            obj.set_value("하나로 eSCM 사용자교육 신청");
            obj.style.set_border("0 solid #bfbfbfff");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_8212.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_DS_SC_8212.xfdl", "lib::comPolicy.xjs");
        this.registerScript("OMG_DS_SC_8212.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	this.cbo_HP00.set_index(1);
         	this.edt_EDU_DT.set_value(this.getOwnerFrame().EDU_DT);
         	this.edt_EDU_DT00.set_value(this.getOwnerFrame().EDU_DT);
         	this.edt_USR_COMP.set_value(application.gv_companyName);
         	this.edt_USR_COMP00.set_value(application.gv_companyName);
         	this.edt_USR_NM.set_value(application.gv_userName);

         	var cnt = this.getOwnerFrame().CNT;

         	if (cnt > 0) {
        		this.edt_EDU_DT00.set_enable(false);
        		this.edt_USR_COMP00.set_enable(false);
        		this.edt_USR_NM00.set_enable(false);
        		this.edt_USR_POSITION00.set_enable(false);
        		this.cbo_HP00.set_enable(false);
        		this.edt_HP00.set_enable(false);
        		this.edt_HP03.set_enable(false);
        		this.edt_USR_EMAIL00.set_enable(false);
        		this.edt_USR_EMAIL03.set_enable(false);
         	}
        }
        ...
        this.fn_subscription = function(obj,e)
        {
        	...
        	var eduDt2 = this.edt_EDU_DT00.value;
        	var compNm2 = this.edt_USR_COMP00.value;
        	var usrNm2 = this.edt_USR_NM00.value;
        	var position2 = this.edt_USR_POSITION00.value;
        	var telNo2 = this.cbo_HP00.value + "-" + this.edt_HP00.value + "-" + this.edt_HP03.value;
        	var email2 = this.edt_USR_EMAIL00.value + "@" + this.edt_USR_EMAIL03.value;
        	...
        	if (!this.gfn_isNull(usrNm2)) {
        		if (this.gfn_isNull(position2)) {
        			this.alert("직책을 입력하셔야 합니다.");
        			return;
        		}
        		...
        		if (this.gfn_isNull(this.edt_HP00.value)) {
        			this.alert("전화번호를 입력하셔야 합니다.");
        			return;
        		}
        		if (this.gfn_isNull(this.edt_HP03.value)) {
        			this.alert("전화번호를 입력하셔야 합니다.");
        			return;
        		}
        		...
        		this.ds_usr_detail.setColumn(1, "SEQ", this.ds_usr_detail.getColumn(0, "SEQ"));
        		this.ds_usr_detail.setColumn(1, "EDU_DATE", eduDt2);
        		this.ds_usr_detail.setColumn(1, "COMPANY_NM", compNm2);
        		this.ds_usr_detail.setColumn(1, "USER_NM", usrNm2);
        		this.ds_usr_detail.setColumn(1, "POSITION", position2);
        		this.ds_usr_detail.setColumn(1, "TEL_NO", telNo2);
        		this.ds_usr_detail.setColumn(1, "EMAIL", email2);
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.Static05.addEventHandler("onclick", this.Div05_Static03_onclick, this);
            this.Static13.addEventHandler("onclick", this.Div05_Static03_onclick, this);
            this.Static14.addEventHandler("onclick", this.Div05_Static03_onclick, this);

        };

        this.loadIncludeScript("OMG_DS_SC_8212.xfdl", true);
