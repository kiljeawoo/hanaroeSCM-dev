(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"SEQ\" type=\"STRING\" size=\"32\"/><Column id=\"ATTACHMENT\" type=\"STRING\" size=\"256\"/><Column id=\"TITLE\" type=\"STRING\" size=\"32\"/><Column id=\"REG_NM\" type=\"STRING\" size=\"256\"/><Column id=\"EDU_DATE\" type=\"STRING\" size=\"20\"/><Column id=\"CNT\" type=\"STRING\" size=\"100\"/><Column id=\"USR_CNT\" type=\"STRING\" size=\"100\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj.set_value("20");
            obj.set_index("-1");
            obj = new Edit("edu_title", "absolute", "57", "10", "140", "21", null, null, this.div_search);
            obj.set_taborder("11");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"54\"/><Column size=\"271\"/><Column size=\"95\"/><Column size=\"134\"/><Column size=\"180\"/><Column size=\"100\"/><Column size=\"82\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"첨부\"/><Cell col=\"2\" text=\"제목\"/><Cell col=\"3\" text=\"작성자\"/><Cell col=\"4\" text=\"날짜\"/><Cell col=\"5\" text=\"조회수\"/><Cell col=\"6\" text=\"신청자수\"/><Cell col=\"7\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell text=\"expr:currow + 1\"/><Cell col=\"1\" text=\"bind:ATTACHMENT\"/><Cell col=\"2\" text=\"bind:TITLE\"/><Cell col=\"3\" text=\"bind:REG_NM\"/><Cell col=\"4\" displaytype=\"date\" text=\"bind:EDU_DATE\"/><Cell col=\"5\" text=\"bind:CNT\"/><Cell col=\"6\" text=\"bind:USR_CNT\"/><Cell col=\"7\" text=\"bind:USE_YN\"/></Band></Format></Formats>");
            ...
            obj = new Button("btn_insert01", "absolute", null, "0", "41", "21", "81", null, this);
            obj.set_taborder("16");
            obj.set_text("등록");
        ...
        this.registerScript("OMG_DS_SC_8110.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_paging = function(vPageNum)
        {
        	...
        	this.fn_retrieveEducationList();
        }

        /* 조회-서비스 Call */ 
        this.fn_retrieveEducationList = function()
        {
        	this.ds_param.clearData();
        	this.ds_param.addRow();
        	
        	this.ds_param.setColumn(0, "TITLE", this.gfn_nullToEmpty(this.div_search.edu_title.value));
        ...
        this.fn_insert_onclick = function(obj,e)
        {
        	...
        	this.gfn_openPopup("OMG_DS_SC_8111", "OMG.MG::OMG_DS_SC_8111.xfdl", oArg, sOption, sPopupCallBack);
        }

        this.fn_update_onclick = function(obj,e)
        {
        	var seq = this.ds_edu.getColumn(e.row, "SEQ");
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.edu_title.addEventHandler("oneditclick", this.div_search_edt_menuId_oneditclick, this);
            this.div_list.grd_comncList.addEventHandler("oncellclick", this.fn_update_onclick, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_8110.xfdl", true);
