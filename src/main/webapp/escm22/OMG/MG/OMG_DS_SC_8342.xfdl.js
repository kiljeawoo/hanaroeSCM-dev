    ...
    return function()
    {
        ...
        ************************************************************************************************/
        ...
        this.fn_insert_onclick = function()
        {
        	...
        	var sURL          = "svc::rest/mg/survey/saveMonitorSurvey";
        ...
        this.grd_comncList_oncellclick = function(obj,e)
        {
        	if (e.cell == 0) {
        		...
        		if (!this.gfn_isNull(this.ds_survey_q.getColumn(this.ds_survey_q.rowposition, "SRV_Q_SEQ"))) {
        			this.div_ans.sta_ans.set_text("답변목록 : 질문 "+ this.ds_survey_q.getColumn(this.ds_survey_q.rowposition, "SRV_Q_SEQ"));
        			this.fn_answerList();
        		}
        	}
        }
