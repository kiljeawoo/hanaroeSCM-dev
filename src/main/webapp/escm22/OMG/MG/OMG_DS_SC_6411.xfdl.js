(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static87", "absolute", "97.87%", "1", null, "1195", "0%", null, this);
            obj.set_taborder("1");
            obj.set_text("17");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            ...
            obj = new Radio("rdo_COMP_TPC", "absolute", "68.93%", "234", null, "21", "2.67%", null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static03", "absolute", "2.13%", "335", null, "21", "78.93%", null, this);
            obj.set_taborder("33");
            obj.set_text("회원 정보");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("transparent URL('theme://images/sta_WF_Subtitle.png') left middle");
            ...
            obj = new Static("Static121", "absolute", "2.13%", "520", null, "21", "78.93%", null, this);
            obj.set_taborder("40");
            obj.set_text("권한 정보");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("transparent URL('theme://images/sta_WF_Subtitle.png') left middle");
            ...
            obj = new Div("Div03", "absolute", "1.47%", "593", null, "770", "0%", null, this);
            obj.set_taborder("66");
            obj.style.set_background("transparent");
            obj.set_visible("true");
            this.addChild(obj.name, obj);
            obj = new Static("Static18", "absolute", "0.68%", "130", null, "29", "2.71%", null, this.Div03);
            obj.set_taborder("443");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static03", "absolute", "0.68%", "102", null, "29", "2.71%", null, this.Div03);
            obj.set_taborder("373");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static121", "absolute", "0.68%", "-3", null, "21", "80.51%", null, this.Div03);
            obj.set_taborder("374");
            obj.set_text("서비스 이용");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("transparent URL('theme://images/sta_WF_Subtitle.png') left middle");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static124", "absolute", "0.68%", "17", null, "58", "2.71%", null, this.Div03);
            obj.set_taborder("375");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static01", "absolute", "0.68%", "74", null, "29", "2.71%", null, this.Div03);
            obj.set_taborder("376");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static123", "absolute", "0.68%", "17", null, "58", "82.54%", null, this.Div03);
            obj.set_taborder("377");
            obj.set_text("기본서비스 이용");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "0.68%", "74", null, "29", "82.54%", null, this.Div03);
            obj.set_taborder("378");
            obj.set_text("부가정보 이용");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static02", "absolute", "0.68%", "102", null, "29", "82.54%", null, this.Div03);
            obj.set_taborder("379");
            obj.set_text("정보분석 이용");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static04", "absolute", "18.13%", "23", null, "46", "7.31%", null, this.Div03);
            ...
            this.Div03.addChild(obj.name, obj);
            obj = new Radio("rdo_SVC_ID", "absolute", "18%", "79", null, "21", "57.37%", null, this.Div03);
            this.Div03.addChild(obj.name, obj);
            ...
            obj.set_readonly("true");
            obj.set_direction("vertical");
            obj = new CheckBox("cbk_SVC31", "absolute", "133", "107", "58", "21", null, null, this.Div03);
            ...
            obj.set_readonly("true");
            this.Div03.addChild(obj.name, obj);
            obj = new CheckBox("cbk_SVC32", "absolute", "208", "107", "74", "21", null, null, this.Div03);
            ...
            obj.set_readonly("true");
            this.Div03.addChild(obj.name, obj);
            obj = new CheckBox("cbk_SVC33", "absolute", "295", "107", "112", "21", null, null, this.Div03);
            ...
            obj.set_readonly("true");
            this.Div03.addChild(obj.name, obj);
            obj = new CheckBox("cbk_SVC34", "absolute", "417", "107", "132", "21", null, null, this.Div03);
            ...
            obj.set_readonly("true");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static09", "absolute", "0.68%", "591", null, "29", "2.71%", null, this.Div03);
            obj.set_taborder("387");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static10", "absolute", "0.68%", "619", null, "29", "2.71%", null, this.Div03);
            obj.set_taborder("388");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static110", "absolute", "0.68%", "647", null, "29", "2.71%", null, this.Div03);
            obj.set_taborder("389");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static08", "absolute", "0.68%", "568", null, "21", "80.51%", null, this.Div03);
            obj.set_taborder("390");
            obj.set_text("납부 정보");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("transparent URL('theme://images/sta_WF_Subtitle.png') left middle");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static11", "absolute", "0.68%", "675", null, "29", "2.71%", null, this.Div03);
            obj.set_taborder("391");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static111", "absolute", "48.58%", "647", null, "29", "32.61%", null, this.Div03);
            obj.set_taborder("392");
            obj.set_text("생년월일");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static12", "absolute", "48.58%", "675", null, "29", "32.61%", null, this.Div03);
            obj.set_taborder("393");
            obj.set_text("계좌번호");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static13", "absolute", "0.68%", "703", null, "29", "2.71%", null, this.Div03);
            obj.set_taborder("394");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static17", "absolute", "0.68%", "703", null, "29", "82.54%", null, this.Div03);
            obj.set_taborder("395");
            obj.set_text("통장사본");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static21", "absolute", "0.68%", "591", null, "29", "82.54%", null, this.Div03);
            obj.set_taborder("396");
            obj.set_text("결제방식");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static22", "absolute", "0.68%", "619", null, "29", "82.54%", null, this.Div03);
            obj.set_taborder("397");
            obj.set_text("희망출금일");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static109", "absolute", "0.68%", "647", null, "29", "82.54%", null, this.Div03);
            obj.set_taborder("398");
            obj.set_text("예금주");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static23", "absolute", "0.68%", "675", null, "29", "82.54%", null, this.Div03);
            obj.set_taborder("399");
            obj.set_text("거래은행");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Radio("rdo_STL_METH_DSC", "absolute", "18%", "596", null, "21", "20.84%", null, this.Div03);
            this.Div03.addChild(obj.name, obj);
            ...
            obj.set_readonly("true");
            obj.set_direction("vertical");
            obj = new Radio("rdo_HOP_DRW_DD", "absolute", "18%", "624", null, "21", "41.41%", null, this.Div03);
            this.Div03.addChild(obj.name, obj);
            ...
            obj.set_readonly("true");
            obj.set_direction("vertical");
            obj = new Edit("edt_DPRNM", "absolute", "18%", "651", null, "21", "69.55%", null, this.Div03);
            obj.set_taborder("402");
            obj.set_readonly("true");
            obj.set_maxlength("20");
            obj.set_cssclass("edt_WF_Readonly");
            this.Div03.addChild(obj.name, obj);
            obj = new Edit("edt_AC_NO", "absolute", "67.79%", "679", null, "21", "4.06%", null, this.Div03);
            ...
            obj.set_cssclass("edt_WF_Readonly");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static122", "absolute", "0.41%", "276", null, "20", "0.41%", null, this.Div03);
            obj.set_taborder("405");
            obj.set_text("20");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            this.Div03.addChild(obj.name, obj);
            obj = new MaskEdit("mae_BZNO", "absolute", "67.79%", "651", null, "21", "17.05%", null, this.Div03);
            ...
            obj.set_visible("true");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static15", "absolute", "0.68%", "731", null, "29", "2.71%", null, this.Div03);
            obj.set_taborder("407");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static20", "absolute", "0.68%", "731", null, "29", "82.54%", null, this.Div03);
            obj.set_taborder("408");
            obj.set_text("사업자등록증 사본");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("exist_BB_FLNM", "absolute", "18.4%", "708", null, "19", "8.93%", null, this.Div03);
            obj.set_taborder("409");
            obj.set_text("통장사본이 존재하지 않습니다.");
            obj.style.set_cursor("hand");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("exist_BZ_RGWRRT_FLNM", "absolute", "18.4%", "737", null, "19", "7.31%", null, this.Div03);
            ...
            obj.style.set_background("#dc143c5b");
            this.Div03.addChild(obj.name, obj);
            obj = new Radio("rdo_PSCRP_DSC", "absolute", "31.39%", "653", null, "21", "55.48%", null, this.Div03);
            this.Div03.addChild(obj.name, obj);
            ...
            obj.set_readonly("true");
            obj.set_direction("vertical");
            obj = new Calendar("mae_BRITH", "absolute", "67.79%", "651", null, "21", "17.05%", null, this.Div03);
            this.Div03.addChild(obj.name, obj);
            obj.set_taborder("413");
            obj.set_readonly("true");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("cal_WF_Readonly");
            obj = new Edit("edt_AC_NO00", "absolute", "18%", "679", null, "21", "53.86%", null, this.Div03);
            ...
            obj.set_cssclass("edt_WF_Readonly");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static06", "absolute", "0.68%", "299", null, "21", "80.51%", null, this.Div03);
            obj.set_taborder("432");
            obj.set_text("청구 정보");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("transparent URL('theme://images/sta_WF_Subtitle.png') left middle");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static07", "absolute", "0.68%", "545", null, "20", "0.81%", null, this.Div03);
            obj.set_taborder("433");
            obj.set_text("20");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static14", "absolute", "0", "159", "717", "20", null, null, this.Div03);
            obj.set_taborder("435");
            obj.set_text("20");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static40", "absolute", "0.68%", "179", "155", "21", null, null, this.Div03);
            obj.set_taborder("436");
            obj.set_text("자사판매정보 제공동의");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("transparent URL('theme://images/sta_WF_Subtitle.png') left middle");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static42", "absolute", "0.68%", "202", null, "74", "2.71%", null, this.Div03);
            obj.set_taborder("437");
            obj.set_cssclass("sta_WF_Labelbg");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("sta_contents02", "absolute", "2.03%", "206", "634", "21", null, null, this.Div03);
            obj.set_taborder("438");
            obj.set_text("판매상세정보를 이용하기 위해서는 자사판매정보 제공동의를 체크하셔야 이용이 가능합니다.");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("sta_contents03", "absolute", "3.25%", "252", "634", "21", null, null, this.Div03);
            obj.set_taborder("439");
            obj.set_text("※ 제공동의 체크시 과금은 발생하지 않으며, 서비스 이용시(엑셀 다운로드) 과금이 SKU당 1,500원/월 부과됩니다.");
            this.Div03.addChild(obj.name, obj);
            obj = new CheckBox("cbk_SVC35", "absolute", "3.25%", "229", "167", "21", null, null, this.Div03);
            ...
            obj.set_readonly("true");
            this.Div03.addChild(obj.name, obj);
            obj = new CheckBox("cbk_SVC36", "absolute", "555", "106", "132", "21", null, null, this.Div03);
            ...
            obj.set_readonly("true");
            this.Div03.addChild(obj.name, obj);
            obj = new CheckBox("cbk_SVC38", "absolute", "133", "134", "160", "21", null, null, this.Div03);
            ...
            obj.set_readonly("true");
            this.Div03.addChild(obj.name, obj);
            obj = new Static("Static16", "absolute", "0.68%", "130", null, "29", "82.54%", null, this.Div03);
            obj.set_taborder("442");
            obj.set_text("마감서비스");
            obj.set_cssclass("sta_WF_Label");
            this.Div03.addChild(obj.name, obj);
            obj = new Button("btn_BL_CHG_YN_HIST", "absolute", "23.41%", "568", null, "21", "68.2%", null, this.Div03);
            obj.set_taborder("446");
            obj.set_text("수정이력");
            obj.set_cssclass("btn_WF_CRUD");
            this.Div03.addChild(obj.name, obj);
            obj = new Button("btn_SVC_CHG_YN_HIST", "absolute", "22.73%", "-2", null, "21", "68.88%", null, this.Div03);
            ...
            obj = new Static("Static15", "absolute", "0%", "3", null, "1205", "97.73%", null, this);
            obj.set_taborder("80");
            obj.set_text("17");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            ...
            obj = new Static("Static17", "absolute", "2.27%", "500", null, "20", "-34.8%", null, this);
            obj.set_taborder("82");
            obj.set_text("20");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            ...
            obj = new CheckBox("chk_CONTRACT_AUTH", "absolute", "238", "546", "12.27%", "21", null, null, this);
            obj.set_taborder("84");
            obj.set_text("전자계약");
            obj.set_falsevalue("N");
            obj.set_truevalue("Y");
            ...
            obj = new CheckBox("chk_TAX_AUTH", "absolute", "330", "546", "12.27%", "21", null, null, this);
            obj.set_taborder("85");
            obj.set_text("세금계산서");
            obj.set_truevalue("Y");
            obj.set_falsevalue("N");
            ...
            obj = new Static("Static24", "absolute", "17", "912", "92", "29", null, null, this);
            obj.set_taborder("100");
            obj.set_text("회사명");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("sta_CLNTNM", "absolute", "108", "912", null, "29", "16", null, this);
            obj.set_taborder("101");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static25", "absolute", "17", "940", "92", "29", null, null, this);
            obj.set_taborder("102");
            obj.set_text("사업자번호");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static26", "absolute", "108", "940", null, "29", "16", null, this);
            obj.set_taborder("103");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_B_BZN01_C", "absolute", "115", "944", "35", "21", null, null, this);
            ...
            obj = new Edit("edt_B_BZN02_C", "absolute", "159", "944", "30", "21", null, null, this);
            ...
            obj = new Edit("edt_B_BZN03_C", "absolute", "198", "944", "65", "21", null, null, this);
            ...
            obj = new Static("Static27", "absolute", "152", "944", "9", "21", null, null, this);
            obj.set_taborder("107");
            obj.set_text("-");
            this.addChild(obj.name, obj);

            obj = new Static("Static28", "absolute", "191", "944", "9", "21", null, null, this);
            obj.set_taborder("108");
            obj.set_text("-");
            this.addChild(obj.name, obj);

            obj = new Static("Static29", "absolute", "17", "968", "92", "29", null, null, this);
            obj.set_taborder("109");
            obj.set_text("대표자명");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static30", "absolute", "108", "968", null, "29", "16", null, this);
            obj.set_taborder("110");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_REPMNM_C", "absolute", "115", "972", "180", "21", null, null, this);
            ...
            obj = new Static("Static31", "absolute", "17", "996", "92", "29", null, null, this);
            obj.set_taborder("112");
            obj.set_text("우편번호");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static32", "absolute", "108", "996", null, "29", "16", null, this);
            obj.set_taborder("113");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ZIP_C", "absolute", "115", "1000", "70", "21", null, null, this);
            ...
            obj = new Static("Static33", "absolute", "17", "1024", "92", "58", null, null, this);
            obj.set_taborder("115");
            obj.set_text("회사주소");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static34", "absolute", "108", "1024", null, "58", "16", null, this);
            obj.set_taborder("116");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_DONGUP_C", "absolute", "115", "1029", null, "21", "22", null, this);
            ...
            obj = new Edit("edt_DONGBW_C", "absolute", "115", "1055", null, "21", "22", null, this);
            ...
            obj = new Static("Static35", "absolute", "17", "1081", "92", "29", null, null, this);
            obj.set_taborder("119");
            obj.set_text("업태");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static36", "absolute", "108", "1081", null, "29", "16", null, this);
            obj.set_taborder("120");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_BZTPNM_C", "absolute", "115", "1085", null, "21", "22", null, this);
            ...
            obj = new Static("Static37", "absolute", "17", "1109", "92", "29", null, null, this);
            obj.set_taborder("122");
            obj.set_text("종목");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static38", "absolute", "108", "1109", null, "29", "16", null, this);
            obj.set_taborder("123");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_BZCCNM_C", "absolute", "115", "1113", null, "21", "22", null, this);
            ...
            obj = new Static("Static39", "absolute", "32.67%", "1000", null, "21", "49.47%", null, this);
            obj.set_taborder("125");
            obj.set_text("('-' 제외)");
            obj.style.set_color("gray");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_REPMNM00_C", "absolute", "115", "916", "180", "21", null, null, this);
            ...
            obj = new Static("Static41", "absolute", "367", "940", "126", "29", null, null, this);
            obj.set_taborder("127");
            obj.set_text("종사업자번호(선택)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_TX_BZN", "absolute", "497", "944", "65", "21", null, null, this);
            ...
            obj = new Button("btn_change", "absolute", "12.67%", "16", null, "21", "73.47%", null, this);
            obj.set_taborder("131");
            obj.set_text("세금계산서 변경");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_AUTH_CHG_YN_HIST", "absolute", "24%", "521", null, "21", "67.6%", null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 0, 770, this.Div03,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("66");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_6411.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_6411.xfdl", function(exports) {
        ...
        ****************************************************/
        ...
        {
        	// 정액제
        	if (this.ds_entSvc.findRowExpr("SVC_ID == '21' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        		this.Div03.rdo_SVC_ID.set_value("21");
        	}
        	// 종량제
        	if (this.ds_entSvc.findRowExpr("SVC_ID == '22' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        		this.Div03.rdo_SVC_ID.set_value("22");
        	}
        	
        	// BI조회
        	if (this.ds_entSvc.findRowExpr("SVC_ID == '31' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        	...
        	// 추이분석
        	if (this.ds_entSvc.findRowExpr("SVC_ID == '32' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        	...
        	// 시장분석(자사)
        	if (this.ds_entSvc.findRowExpr("SVC_ID == '33' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        	...
        	// 카테고리 시장분석
        	if (this.ds_entSvc.findRowExpr("SVC_ID == '34' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        	...
        	// 자사판매정보 제공동의
        	if (this.ds_entSvc.findRowExpr("SVC_ID == '35' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        		this.Div03.cbk_SVC35.set_value("Y");
        	} else {
        		this.Div03.cbk_SVC35.set_value("N");
        	}
        	
        	// 신규통계서비스 (사용안함)
        	if (this.ds_entSvc.findRowExpr("SVC_ID == '36' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        		this.Div03.cbk_SVC36.set_value("Y");
        	} else {
        		this.Div03.cbk_SVC36.set_value("N");
        	}
        	
        	// 마감간소화
        	if (this.ds_entSvc.findRowExpr("SVC_ID == '38' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        		this.Div03.cbk_SVC38.set_value("Y");
        	} else {
        		this.Div03.cbk_SVC38.set_value("N");
        	}
        }
        ...
        ****************************************************/
        ...
        {
        	if (this.ds_userAuth.findRowExpr("USR_AUTH_DSC == '1' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        		this.chk_BILLING_AUTH.set_value("Y");
        	} else {
        		this.chk_BILLING_AUTH.set_value("N");
        	}
        	
        	if (this.ds_userAuth.findRowExpr("USR_AUTH_DSC == '2' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        		this.chk_CONTRACT_AUTH.set_value("Y");
        	} else {
        		this.chk_CONTRACT_AUTH.set_value("N");
        	}
        	
        	if (this.ds_userAuth.findRowExpr("USR_AUTH_DSC == '3' && RQ_DSC == '1' && ENT_PRG_STSC !='2' && ENT_PRG_STSC != '4'") != -1) {
        ...
        ****************************************************/
        		...
        		if (svcID == "retrieveMbApvrqr") {
        			...
        			if (this.ds_basicInfo.rowcount >0) {
        				...
        				if (this.ds_basicInfo.getColumn(0, "SVC_CHG_YN") == "Y") {
        					this.Div03.btn_SVC_CHG_YN_HIST.set_visible(true);
        				} else {
        					this.Div03.btn_SVC_CHG_YN_HIST.set_visible(false);
        				}
        			...
        			this.resetScroll();
        		} else if (svcID=="updateMbApvrqr" || svcID=="updateMbHoffApvrqr" || svcID=="sechangeMbApvrqr") {
        ...
        this.btn_change_onclick = function(obj,e)
        {
        	if (this.gfn_isNull(this.edt_ENT_PRG_CNTN.value)) {
        		...
        		if (confirm("정말로 [세금계산서 변경]하시겠습니까?\n확인 후에는 변경이 불가합니다.")) {
        			if (this.ds_basicInfo.getColumn(0,"ENT_PRG_STSC") == "1") {
        				...
        				var sSvcID        = "sechangeMbApvrqr";
        				var sURL          = "svc::rest/mg/usrinf/sechangeMbApvrqr";
        				var sInDatasets   = "";
        				var sOutDatasets  = "";
        				var sArgument     = sParam;
        				var sCallbackFunc = "fn_callBack";
        ...
        // 회원서비스이용 수정이력
        this.btn_SVC_CHG_YN_HIST_onclick = function(obj,e)
        {
        	var oArg = {paramMode:"S", dsArg:this.ds_basicInfo};
        	var sOption = "autosize=true, title=true";
        	var sPopupCallBack = "fn_hstpopupAfter";
        	this.gfn_openPopup("popId_SVC_CHG", "OMG.MG::OMG_DS_SC_6411_P02.xfdl", oArg, sOption, sPopupCallBack);
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.Static121.addEventHandler("onclick", this.Static121_onclick, this);
            this.Div03.Static04.addEventHandler("onclick", this.Div05_Div03_Static04_onclick, this);
            ...
            this.Div03.btn_SVC_CHG_YN_HIST.addEventHandler("onclick", this.btn_SVC_CHG_YN_HIST_onclick, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_6411.xfdl", true);
