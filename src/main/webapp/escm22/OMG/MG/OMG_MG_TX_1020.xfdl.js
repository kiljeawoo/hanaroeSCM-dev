    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("세금계산서발행내역");
                this._setFormPosition(0,0,803,550);
            }
            ...
            obj = new Dataset("ds_combo4", this);
            obj._setContents("");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div_search", "absolute", "0", "29", null, "123", "15", null, this);
            obj.set_taborder("48");
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static05", "absolute", "420", "62", "170", "21", null, null, this.div_search);
            obj.set_taborder("71");
            ...
            obj = new Static("Static06", "absolute", "277", "10", "12", "21", null, null, this.div_search);
            obj.set_taborder("73");
            obj.set_text("~");
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_text("건");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static09", "absolute", "-0.13%", "83", null, "5", "1.91%", null, this.div_search);
            obj.set_taborder("95");
            obj.set_text("8");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static10", "absolute", "92.49%", "113", null, "10", "1.91%", null, this.div_search);
            obj.set_taborder("96");
            obj.set_text("8");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            this.div_search.addChild(obj.name, obj);
            obj = new Combo("cbo_rpbcDsc", "absolute", "106", "88", "113", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("97");
            obj.set_innerdataset("@ds_combo4");
            obj.set_codecolumn("SIMP_C");
            obj.set_datacolumn("SIMP_CNM");
            obj.set_index("-1");
            obj = new Static("Static11", "absolute", "15", "88", "118", "21", null, null, this.div_search);
            obj.set_taborder("98");
            obj.set_text("역발행구분");
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static12", "absolute", "420", "88", "106", "21", null, null, this.div_search);
            obj.set_taborder("99");
            obj.set_text("발생구분코드");
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Combo("cbo_ocu", "absolute", "567", "88", "113", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            var cbo_ocu_innerdataset = new Dataset("cbo_ocu_innerdataset", this.div_search.cbo_ocu);
            cbo_ocu_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\"/><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">01</Col><Col id=\"datacolumn\">경제통합</Col></Row><Row><Col id=\"codecolumn\">02</Col><Col id=\"datacolumn\">하나로eSCM</Col></Row></Rows>");
            obj.set_innerdataset(cbo_ocu_innerdataset);
            ...
            obj = new Div("div_grd", "absolute", "0", "151", null, null, "15", "-28", this);
            obj.set_taborder("39");
            this.addChild(obj.name, obj);
            ...
            this.div_grd.addChild(obj.name, obj);
            obj = new Button("btn_cancel", "absolute", null, "15", "65", "21", "716", null, this.div_grd);
            obj.set_taborder("10");
            obj.set_text("발행취소");
            obj.set_visible("false");
            this.div_grd.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 0, 123, this.div_search,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("48");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 803, 550, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("pattern_01");
            		p.set_titletext("세금계산서발행내역");
            ...
            obj = new BindItem("item8","div_search00.edt_suppliee","value","ds_condition","SEARCH");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item9","div_search00.edt_suppliee2","value","ds_condition","NA_TRPL_C");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item10","div_search00.cbo_dt","value","ds_condition","DT_TYPE");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item11","div_search00.cal_start","value","ds_condition","STARTDT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item12","div_search00.cal_end","value","ds_condition","ENDDT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item13","div_search00.cbo_stat","value","ds_condition","TXBIL_STSC");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item14","div_search00.edt_NTS_TMS_SQNO","value","ds_condition","NTS_TMS_SQNO");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item15","div_search00.edt_BizNo","value","ds_condition","BIZ_NUMBER");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item16","div_search00.cbo_kind","value","ds_condition","TXBIL_KD");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item17","div_search00.chk_01","value","ds_condition","CODE01");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item18","div_search00.chk_02","value","ds_condition","CODE02");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item0","div_search.cbo_stat","value","ds_condition","TXBIL_STSC");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","div_search.edt_BizNo","value","ds_condition","NA_TRPL_C");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","div_search.cbo_dt","value","ds_condition","DT_TYPE");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","div_search.cal_start","value","ds_condition","STARTDT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","div_search.cal_end","value","ds_condition","ENDDT");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item19","div_search.chk_01","value","ds_condition","CODE01");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item20","div_search.chk_02","value","ds_condition","CODE02");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item21","div_search.cbo_rpbcDsc","value","ds_condition","RPBC_DSC");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item22","div_search.cbo_ocu","value","ds_condition","OCU_DSC");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_MG_TX_1020.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_MG_TX_1020.xfdl", "lib::comTSToolKit.xjs");
        this.registerScript("OMG_MG_TX_1020.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_afterFormOnload = function()
        {
           ...
           var param = [  
         		...
         		{code:"RPBC_DSC",   dsName:"ds_combo4",   selecttype:""}
            ];
        ...
        this.fn_commonAfterOnload= function()
        {
            ...
            this.ds_condition.setColumn(0, "TXBIL_STSC", "04");//02:미발행04:발행05:발행취소07:국세청접수99:발행오류00:국세청신고완료
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.cbo_rpbcDsc.addEventHandler("onitemchanged", this.div_search_cbo_stat_onitemchanged, this);
        ...
        this.loadIncludeScript("OMG_MG_TX_1020.xfdl", true);
