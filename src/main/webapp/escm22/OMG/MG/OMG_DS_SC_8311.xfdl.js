(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static10", "absolute", "126", "400", null, "29", "17", null, this);
            obj.set_taborder("139");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Radio("use_yn", "absolute", "130", "404", "158", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01", "absolute", "17", "400", "110", "29", null, null, this);
            ...
            obj = new Calendar("APL_ST_DT", "absolute", "130", "375", "99", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("4");
            ...
            obj = new Calendar("APL_ED_DT", "absolute", "240", "375", "100", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("5");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_visible("true");
            ...
            obj = new Static("st_char", "absolute", "229", "374", "12", "21", null, null, this);
            ...
            obj = new Static("Static14", "absolute", "380", "372", "110", "29", null, null, this);
            obj.set_taborder("160");
            obj.set_text("설문기간");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Calendar("SRV_ST_DT", "absolute", null, "376", "100", "21", "175", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("6");
            obj.set_dateformat("yyyy-MM-dd");
            obj.style.set_align("center middle");

            obj = new Calendar("SRV_ED_DT", "absolute", null, "376", "100", "21", "64", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("7");
            obj.set_dateformat("yyyy-MM-dd");
            obj.style.set_align("center middle");

            obj = new Static("st_char00", "absolute", null, "377", "12", "21", "162", null, this);
        ...
        this.registerScript("OMG_DS_SC_8311.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        this.insert = function()
        {
        	if (this.fn_validationCheck()) {
        		if (confirm("설문을 등록하시겠습니까?")) {
        			this.ds_survey.setColumn(0,"SRV_DSC", "001");
        			this.ds_survey.setColumn(0,"TITLE", this.gfn_nullToEmpty(this.ed_title.value));
        			this.ds_survey.setColumn(0,"SUBTITLE", this.gfn_nullToEmpty(this.ed_subtitle.value));
        			this.ds_survey.setColumn(0,"INTRO", this.gfn_nullToEmpty(this.ed_intro.value));
        			this.ds_survey.setColumn(0,"APL_ST_DT", this.gfn_nullToEmpty(this.APL_ST_DT.value));
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_8311.xfdl", true);
