    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_MG_TX_1061");
                this.set_titletext("매출합계표(정발행)");
        ...
        // User Script
        this.addIncludeScript("OMG_MG_TX_1061.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_MG_TX_1061.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_afterFormOnload = function()
        {
           //페이지 로딩후 실행부분
            ...
            this.ds_condition.setColumn(0,"OCU_DSC", "01"); // 01:경제통합, 02:하나로eSCM
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_MG_TX_1061.xfdl", true);
