    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_MG_TX_1060");
                this.set_titletext("매출합계표(이용료)");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"START\" type=\"STRING\" size=\"256\"/><Column id=\"END\" type=\"STRING\" size=\"256\"/><Column id=\"NA_TRPL_C\" type=\"STRING\" size=\"256\"/><Column id=\"NA_BZPLC\" type=\"STRING\" size=\"256\"/><Column id=\"RPBC_DSC\" type=\"STRING\" size=\"256\"/><Column id=\"SPLR_BZNO\" type=\"STRING\" size=\"256\"/><Column id=\"BUY_BZNO\" type=\"STRING\" size=\"256\"/><Column id=\"OCU_DSC\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_index("0");
            obj = new Static("st_period", "absolute", "487", "36", "232", "21", null, null, this.div_search);
            obj.set_taborder("37");
            obj.set_text("2015-05-04 ~ 2015-05-31");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_company", "absolute", "487", "10", "287", "21", null, null, this.div_search);
            obj.set_taborder("44");
        ...
        // User Script
        this.addIncludeScript("OMG_MG_TX_1060.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_MG_TX_1060.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_afterFormOnload = function()
        {
           //페이지 로딩후 실행부분
            ...
            this.ds_condition.setColumn(0,"SPLR_BZNO", "1148164826"); // 공급자사업자번호
            this.ds_condition.setColumn(0,"RPBC_DSC", "1"); // 1:정발행, 2:역발행
            this.ds_condition.setColumn(0,"OCU_DSC", "02"); // 01:경제통합, 02:하나로eSCM
            ...
            this.fn_retrieveByngsltttblAdmin();
        }
        ...
        ************************************************************************************************/
        ...
        this.fn_retrieveByngsltttblAdmin = function()
        {
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_MG_TX_1060.xfdl", true);
