    ...
    return function()
    {
        ...
        ************************************************************************************************/
        ...
        this.fn_insert_onclick = function(obj,e)
        {
        	...
        	this.gfn_openPopup("popId", "OMG.MG::OMG_DS_SC_8341_P01.xfdl", oArg, sOption, sPopupCallBack);
        }
        ...
        this.grd_comncList_oncellclick = function(obj,e)
        {
        	...
        	var sOption = "autosize=true";
        	var sPopupCallBack = "fn_popupAfter";  
        	this.gfn_openPopup("OMG_DS_SC_8341_P01", "OMG.MG::OMG_DS_SC_8341_P01.xfdl",oArg,sOption,sPopupCallBack);	
        }
        });
