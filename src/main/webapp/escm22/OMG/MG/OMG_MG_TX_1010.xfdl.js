    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_TX_1010");
                this.set_titletext("세금계산서발행");
        ...
        // User Script
        this.addIncludeScript("OMG_MG_TX_1010.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_MG_TX_1010.xfdl", "lib::comTSToolKit.xjs");
        this.registerScript("OMG_MG_TX_1010.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_MG_TX_1010.xfdl", true);
