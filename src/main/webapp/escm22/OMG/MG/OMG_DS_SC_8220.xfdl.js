(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"MENU_ID\" type=\"string\" size=\"32\"/><Column id=\"MENU_NM\" type=\"string\" size=\"32\"/><Column id=\"VIDEO_FLNM\" type=\"string\" size=\"32\"/><Column id=\"IMG_FLNM\" type=\"string\" size=\"32\"/><Column id=\"MENU_PATH\" type=\"string\" size=\"32\"/><Column id=\"CNT\" type=\"string\" size=\"32\"/><Column id=\"VIDEO_LVL\" type=\"STRING\" size=\"32\"/><Column id=\"VIDEO_LNGTH\" type=\"STRING\" size=\"32\"/><Column id=\"FSRG_DTM\" type=\"STRING\" size=\"32\"/><Column id=\"MENU_D\" type=\"STRING\" size=\"256\"/><Column id=\"MENU_M\" type=\"STRING\" size=\"256\"/><Column id=\"MENU_S\" type=\"STRING\" size=\"256\"/><Column id=\"VIDEO_DSC\" type=\"STRING\" size=\"256\"/><Column id=\"INQ_CN\" type=\"STRING\" size=\"32\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_search", "absolute", null, "0", "57", "21", "15", null, this);
            obj.set_taborder("6");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"21\"/><Column size=\"117\"/><Column size=\"332\"/><Column size=\"52\"/><Column size=\"62\"/><Column size=\"44\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"대분류\"/><Cell col=\"1\" text=\"중분류\"/><Cell col=\"2\" colspan=\"2\"><Cell/><Cell col=\"1\" style=\"align:left;\" text=\"        강의명\"/></Cell><Cell col=\"4\" text=\"내용\"/><Cell col=\"5\" text=\"강의시간\"/><Cell col=\"6\" text=\"등록일\"/><Cell col=\"7\" text=\"조회수\"/></Band><Band id=\"body\"><Cell style=\"font:11 arial;selectfont:11 arial;\" text=\"bind:MENU_D\"/><Cell col=\"1\" style=\"font:11 arial;selectfont:11 arial;\" text=\"bind:MENU_M\"/><Cell col=\"2\" colspan=\"2\"><Cell displaytype=\"image\" style=\"align:left;\" expr=\"expr:&quot;theme://images/Icon_VideoPlay.png&quot;\"/><Cell col=\"1\" style=\"align:left;padding:0 0 0 5;font:11 arial;selectfont:11 arial;\" text=\"bind:MENU_NM\"/></Cell><Cell col=\"4\" style=\"align:left;padding:0 0 0 10;font:11 arial;selectfont:11 arial;\" text=\"bind:VIDEO_DSC\" wordwrap=\"none\"/><Cell col=\"5\" displaytype=\"normal\" style=\"font:11 arial;selectfont:11 arial;\" text=\"bind:VIDEO_LNGTH\"/><Cell col=\"6\" displaytype=\"normal\" style=\"font:11 arial;selectfont:11 arial;\" text=\"bind:FSRG_DTM\"/><Cell col=\"7\" displaytype=\"normal\" style=\"font:11 arial;selectfont:11 arial;\" text=\"bind:INQ_CN\"/></Band></Format></Formats>");
            this.div_list.addChild(obj.name, obj);
        ...
        this.registerScript("OMG_DS_SC_8220.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        // 	menuId = this.ds_videoList.getColumn(obj.id.substr(11), "MENU_ID");	//이미지 ID(ImageViewer0~)에 해당하는 메뉴 아이디 가져오기
        // 	menuPath = this.ds_videoList.getColumn(obj.id.substr(11), "MENU_PATH");	//이미지 ID(ImageViewer0~)에 해당하는 메뉴 경로 가져오기
        // 	videoLvl = this.ds_videoList.getColumn(obj.id.substr(11), "VIDEO_LVL");	//이미지 ID(ImageViewer0~)에 해당하는 메뉴 경로 가져오기
        // 	videoFlm = this.ds_videoList.getColumn(obj.id.substr(11), "VIDEO_FLNM");	//이미지 ID(ImageViewer0~)에 해당하는 메뉴 경로 가져오기
        // 	imgFlm = this.ds_videoList.getColumn(obj.id.substr(11), "IMG_FLNM");	//이미지 ID(ImageViewer0~)에 해당하는 메뉴 경로 가져오기
        	if (this.INIT) {
        ...
        /*이미지 클릭*/
        // this.img_videoImage_onclick = function(obj:ImageViewer, e:nexacro.ClickEventInfo)
        // {
        // 	menuId = this.ds_videoList.getColumn(obj.id.substr(11), "MENU_ID");	//이미지 ID(ImageViewer0~)에 해당하는 메뉴 아이디 가져오기
        // 	menuPath = this.ds_videoList.getColumn(obj.id.substr(11), "MENU_PATH");	//이미지 ID(ImageViewer0~)에 해당하는 메뉴 경로 가져오기
        // 	videoLvl = this.ds_videoList.getColumn(obj.id.substr(11), "VIDEO_LVL");	//이미지 ID(ImageViewer0~)에 해당하는 메뉴 경로 가져오기
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_8220.xfdl", true);
