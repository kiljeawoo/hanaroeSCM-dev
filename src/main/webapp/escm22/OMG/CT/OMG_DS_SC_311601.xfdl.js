    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this._setFormPosition(0,0,788,931);
            }
            ...
            obj = new Static("Static17", "absolute", "0", "115", "59.26%", "21", null, null, this);
            obj.set_taborder("81");
            obj.set_text("[첨부 1]");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("left middle");
            ...
            obj = new Static("Static10", "absolute", "0", "479", "59.26%", "21", null, null, this);
            obj.set_taborder("84");
            obj.set_text("납품 대상 상품 내역");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static65", "absolute", "16.88%", "794", null, "129", "0.89%", null, this);
            obj.set_taborder("95");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Grid("GridI", "absolute", "0%", "503", null, "249", "0.89%", null, this);
            obj.set_taborder("111");
            obj.set_binddataset("ds_ctEtcItemIList");
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"49\"/><Column size=\"200\"/><Column size=\"265\"/><Column size=\"90\"/><Column size=\"172\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"삭제\"/><Cell col=\"1\" text=\"직영점명\"/><Cell col=\"2\" text=\"상품품목\"/><Cell col=\"3\" text=\"수량\"/><Cell col=\"4\" text=\"단가(VAT포함)\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"none\" text=\"bind:ISCHECKED\" autosizecol=\"none\"/><Cell col=\"1\" displaytype=\"text\" edittype=\"text\" text=\"bind:BRAND\"/><Cell col=\"2\" displaytype=\"text\" edittype=\"text\" style=\"align:center middle;\" text=\"bind:ITEM_NAME\" editlimit=\"190\" editlengthunit=\"ascii\" autosizecol=\"none\"/><Cell col=\"3\" edittype=\"text\" text=\"bind:QTY\" autosizecol=\"none\"/><Cell col=\"4\" edittype=\"text\" style=\"align:center;\" text=\"bind:UPR\" editlimit=\"190\" editlengthunit=\"ascii\" autosizecol=\"none\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn_addRowI", "absolute", "91.5%", "478", null, "21", "0.89%", null, this);
            obj.set_taborder("16");
            obj.set_text("행추가");
            this.addChild(obj.name, obj);

            obj = new Button("btn_delRowI", "absolute", "83.12%", "478", null, "21", "9.26%", null, this);
            obj.set_taborder("17");
            obj.set_text("행삭제");
            this.addChild(obj.name, obj);

            obj = new TextArea("edt_ETC52", "absolute", "19.67%", "799", null, "118", "1.78%", null, this);
            obj.set_taborder("18");
            ...
            obj = new Static("Static01", "absolute", "0%", "794", null, "129", "80.96%", null, this);
            obj.set_taborder("149");
            obj.set_text("기타특약사항");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Grid("GridA", "absolute", "0%", "166", null, "249", "1.02%", null, this);
            obj.set_taborder("152");
            obj.set_binddataset("ds_ctEtcItemAList");
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"49\"/><Column size=\"200\"/><Column size=\"527\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"삭제\"/><Cell col=\"1\" text=\"직영점명\"/><Cell col=\"2\" text=\"사업장 주소\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"none\" text=\"bind:ISCHECKED\" autosizecol=\"none\"/><Cell col=\"1\" displaytype=\"text\" edittype=\"text\" style=\"align:center middle;\" text=\"bind:BRAND\" editlimit=\"190\" editlengthunit=\"ascii\" autosizecol=\"none\"/><Cell col=\"2\" edittype=\"text\" text=\"bind:ITEM_NAME\" autosizecol=\"none\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn_delRowA", "absolute", "83.12%", "141", null, "21", "9.26%", null, this);
            obj.set_taborder("153");
            obj.set_text("행삭제");
            this.addChild(obj.name, obj);

            obj = new Button("btn_addRowA", "absolute", "91.5%", "141", null, "21", "1.02%", null, this);
            obj.set_taborder("154");
            obj.set_text("행추가");
            this.addChild(obj.name, obj);

            obj = new Static("Static00", "absolute", "16.88%", "424", null, "29", "1.02%", null, this);
            obj.set_taborder("155");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC22", "absolute", "19.67%", "428", null, "21", "49.24%", null, this);
            obj.set_taborder("156");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("190");
            this.addChild(obj.name, obj);

            obj = new Static("Static05", "absolute", "0", "424", null, "29", "80.96%", null, this);
            obj.set_taborder("158");
            obj.set_text("납품기일");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "0", "771", "59.26%", "21", null, null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 788, 931, this,
            	//-- Layout function
            	function(p) {
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311601.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311601.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	for (var i = 0 ; i < this.parent.ds_etcEltStylAmm.rowcount; i++) {
        		if (this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "151") {
        	...
        	for (var i = 0; i < this.parent.ds_eltCtrwDtl.rowcount; i++) {
        		if (this.parent.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "151") {
        			fv_chk = 1 ;
         ...
         * 편집값 세팅 
         */
        this.OMG_DS_SC_311601_ontextchanged = function(obj,e)
        {
        	// 꺽쇠 사용 방지
        ...
        this.btn_addrowA_onclick = function(obj,e)
        {
        	...
        	this.ds_ctEtcItemAList.setColumn(nRow, "ITEM_CODE", "A" );
        ...
        this.on_initEvent = function()
        {
            ...
            this.edt_ETC52.addEventHandler("ontextchanged", this.OMG_DS_SC_311601_ontextchanged, this);
            ...
            this.edt_ETC22.addEventHandler("ontextchanged", this.OMG_DS_SC_311601_ontextchanged, this);

        };

        this.loadIncludeScript("OMG_DS_SC_311601.xfdl", true);
