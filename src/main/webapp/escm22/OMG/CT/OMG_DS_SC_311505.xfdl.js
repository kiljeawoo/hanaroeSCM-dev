    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311505");
                this.set_titletext("단기 특약매입 거래계약서(테넌트)");
            ...
            obj = new Layout("default", "", 788, 890, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("단기 특약매입 거래계약서(테넌트)");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311505.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311505.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	for (var i = 0 ; i < this.parent.ds_etcEltStylAmm.rowcount; i++) {
        		if (this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "145") {
        	...
        	for (var i = 0; i < this.parent.ds_eltCtrwDtl.rowcount; i++) {
        		if (this.parent.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "145") {
        			fv_chk = 1 ;
        ...
        this.loadIncludeScript("OMG_DS_SC_311505.xfdl", true);
