    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311395");
                this.set_titletext("부속계약서(테넌트_임대차)");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311595.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311595.xfdl", function(exports) {
        ...
        this.loadIncludeScript("OMG_DS_SC_311595.xfdl", true);
