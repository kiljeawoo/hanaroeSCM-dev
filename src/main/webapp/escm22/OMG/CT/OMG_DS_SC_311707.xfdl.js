    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311707");
                this.set_titletext("농업용 파이프 구매공급 계약서");
            ...
            obj.set_taborder("81");
            obj.set_text("[붙임 1] 농업용 파이프(SPVHS) 구매공급 가격표");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("left middle");
            obj.style.set_padding("0 0 1 5");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"49\"/><Column size=\"221\"/><Column size=\"130\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"삭제\"/><Cell col=\"1\" text=\"규격\"/><Cell col=\"2\" text=\"단가(원)\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"none\" text=\"bind:ISCHECKED\" autosizecol=\"none\"/><Cell col=\"1\" edittype=\"text\" style=\"align:center middle;\" text=\"bind:ITEM_NAME\" editlimit=\"190\" editlengthunit=\"ascii\" autosizecol=\"none\"/><Cell col=\"2\" displaytype=\"number\" edittype=\"masknumber\" editfilter=\"number\" text=\"bind:UPR\" mask=\"#,###\" autosizecol=\"none\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 788, 470, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("농업용 파이프 구매공급 계약서");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311707.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311707.xfdl", function(exports) {
        if (this.executeIncludeScript) { this.executeIncludeScript("lib::comLib.xjs", null, exports); }	//include "lib::comLib.xjs";

        var ELT_CODE = "167"; // 메인계약서코드
        ...
        {
            var strTitletext = "농업용 파이프 구매공급 계약서";
        	...
        	// [붙임1] 농업용 파이프(SPVHS) 구매공급 가격표
        	if (this.ds_ctEtcItemList.getRowCount() > 0) {
        		for (var i=0; i<this.ds_ctEtcItemList.getRowCount(); i++) {
        			var c1 = this.ds_ctEtcItemList.getColumn(i, "ITEM_NAME"); // 규격
        			var c2 = this.ds_ctEtcItemList.getColumn(i, "UPR"); // 계
        			if (this.gfn_nullToEmpty(c1) == "" || this.gfn_nullToEmpty(c2) == "") {
        				alert("농업용 파이프(SPVHS) 구매공급 가격표에 입력되지 않은 행이 있습니다.\n해당 행을 입력하시거나 불필요한 경우 행삭제를 해주세요.");
        				return false;
        			}
        		}
        	} else {
        		alert("농업용 파이프(SPVHS) 구매공급 가격표를 입력해주세요");
        		return false;
        	}
        ...
        // 농업용 파이프(SPVHS) 구매공급 가격표 그리드 삭제 체크
        ...
        this.loadIncludeScript("OMG_DS_SC_311707.xfdl", true);
