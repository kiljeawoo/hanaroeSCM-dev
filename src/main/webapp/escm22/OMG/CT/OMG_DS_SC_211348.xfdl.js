    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_211348");
                this.set_titletext("특약서(매장의 철수 등) 축산");
                this.set_scrollbars("none");
                this._setFormPosition(0,0,788,115);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_etcEltStylAmm414", this);
            ...
            obj = new Dataset("ds_sctrwDtl14", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj = new Button("Button16", "absolute", "711", "0", "77", "21", null, null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 788, 115, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("pattern_01");
            		p.set_titletext("특약서(매장의 철수 등) 축산");
            ...
            obj = new BindItem("item4","txa_sctrSjt","value","ds_sctrwDtl14","SCTR_SJT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_211348.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_211348.xfdl", function(exports) {
        ...
        //	this.ds_sctrwPmtnEmpeDspBrk.copyData(this.parent.ds_sctrwPmtnEmpeDspBrk);   
           ...
           for(var i = 0 ; i < this.parent.ds_etcEltStylAmm.rowcount; i++){		
        		...
        		if(this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "414"){

        			this.ds_etcEltStylAmm414.copyRow(0, this.parent.ds_etcEltStylAmm ,i);   	
        		}
        	}		 		
        	...
        	for(var i = 0 ; i < this.parent.ds_sctrwDtl.rowcount; i++){		
         			...
         			if(this.parent.ds_sctrwDtl.getColumn(i, "SCTRW_KDC") =="414"){
         			
         				fv_position = i;
         				fv_chk = 1 ;
         				this.ds_sctrwDtl14.addRow();
         				this.ds_sctrwDtl14.copyRow(0, this.parent.ds_sctrwDtl ,fv_position);   	
        		...
        		var nRow = this.parent.ds_sctrwDtl.addRow();
        			fv_position = nRow;
        			this.parent.ds_sctrwDtl.setColumn(fv_position, "SCTRW_KDC" , "414") ;		
        			this.parent.ds_sctrwDtl.setColumn(fv_position, "CHG_SQNO" ,this.parent.ds_register.getColumn(0 ,"CHG_SQNO" ) ) ;	
        			this.parent.ds_sctrwDtl.setColumn(fv_position, "CTRW_STY_VER" , this.ds_etcEltStylAmm414.getColumn(0,"CTRW_STY_VER") ) ;	
        			this.ds_sctrwDtl14.addRow();
        			this.ds_sctrwDtl14.copyRow(0, this.parent.ds_sctrwDtl ,fv_position);   	
        ...
        this.loadIncludeScript("OMG_DS_SC_211348.xfdl", true);
