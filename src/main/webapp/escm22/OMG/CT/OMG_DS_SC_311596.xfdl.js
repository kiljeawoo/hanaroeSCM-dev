(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static07", "absolute", "15.74%", "739", null, "29", "0.89%", null, this);
            obj.set_taborder("53");
            ...
            obj = new Static("Static23", "absolute", "0", "739", null, "29", "80.96%", null, this);
            obj.set_taborder("44");
            obj.set_text("판매수수료율(합계)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC23", "absolute", "19.67%", "743", null, "21", "70.3%", null, this);
            obj.set_taborder("14");
            obj.set_value("0");
            obj.set_mask("990.00");
            obj.set_limitbymask("both");
            ...
            obj = new Static("Static17", "absolute", "29.82%", "743", null, "21", "67.39%", null, this);
            obj.set_taborder("46");
            obj.set_text("%");
            this.addChild(obj.name, obj);

            obj = new Static("Static21", "absolute", "32.99%", "739", null, "29", "47.97%", null, this);
            obj.set_taborder("47");
            obj.set_text("마진율");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC21", "absolute", "52.66%", "743", null, "21", "37.31%", null, this);
            obj.set_taborder("15");
            obj.set_value("0");
            obj.set_mask("990.00");
            obj.set_limitbymask("both");
            ...
            obj = new Static("Static18", "absolute", "62.82%", "743", null, "21", "34.39%", null, this);
            obj.set_taborder("49");
            obj.set_text("%");
            this.addChild(obj.name, obj);

            obj = new Static("Static22", "absolute", "65.99%", "739", null, "29", "14.97%", null, this);
            obj.set_taborder("50");
            obj.set_text("부가가치세율");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC22", "absolute", "85.79%", "743", null, "21", "4.19%", null, this);
            obj.set_taborder("16");
            obj.set_value("0");
            obj.set_mask("990.00");
            obj.set_limitbymask("both");
            ...
            obj = new Static("Static20", "absolute", "95.94%", "743", null, "21", "1.27%", null, this);
            obj.set_taborder("52");
            obj.set_text("%");
            this.addChild(obj.name, obj);

            obj = new Static("Static08", "absolute", "15.74%", "231", null, "29", "0.89%", null, this);
            obj.set_taborder("54");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static24", "absolute", "0", "231", null, "29", "82.99%", null, this);
            obj.set_taborder("56");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311596.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311596.xfdl", function(exports) {
        ...
        this.loadIncludeScript("OMG_DS_SC_311596.xfdl", true);
