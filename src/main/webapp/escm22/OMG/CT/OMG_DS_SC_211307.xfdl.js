    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_211307");
                this.set_titletext("직매입 거래계약서(표준)");
                this._setFormPosition(0,0,788,139);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_etcEltStylAmm107", this);
            ...
            obj = new Dataset("ds_eltCtrwDtl07", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj = new BindItem("item1","edt_ctrClo","value","ds_eltCtrwDtl07","CTR_CLO");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item41","edt_wrsPrmPy","value","ds_eltCtrwDtl07","WRS_PRM_PY");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","txa_sctrSjt","value","ds_eltCtrwDtl07","SCTR_SJT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_211307.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_211307.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
           ...
           for(var i = 0 ; i < this.parent.ds_etcEltStylAmm.rowcount; i++){		
        		...
        		if(this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "107"){

        			this.ds_etcEltStylAmm107.copyRow(0, this.parent.ds_etcEltStylAmm ,i);   	
        		}
        	}	
           ...
           for(var i = 0 ; i < this.parent.ds_eltCtrwDtl.rowcount; i++){		
        		...
        		if(this.parent.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "107"){
        			...
        			if(this.parent.ds_eltCtrwDtl.getColumn(i, "CTRW_STY_VER") == "" ){
        				this.parent.ds_eltCtrwDtl.setColumn(fv_position, "CTRW_STY_VER" , this.ds_etcEltStylAmm107.getColumn(0,"CTRW_STY_VER") ) ;		

        			}

        			this.ds_eltCtrwDtl07.addRow();
        			this.ds_eltCtrwDtl07.copyRow(0, this.parent.ds_eltCtrwDtl ,fv_position);   	
        	...
        	if (fv_chk == 0 ){
        		...
        		fv_position = nRow;
        		this.parent.ds_eltCtrwDtl.setColumn(fv_position, "MN_CTRW_KDC" , "107") ;		
        ...
        this.OMG_DS_SC_211307_ontextchanged = function(obj,e)
        {
        ...
        this.loadIncludeScript("OMG_DS_SC_211307.xfdl", true);
