    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("특약매입거래계약서 (공통)");
                this._setFormPosition(0,0,788,865);
            }
            ...
            obj = new Static("Static25", "absolute", "17.77%", "307", null, "29", "0%", null, this);
            obj.set_taborder("167");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static06", "absolute", "17.77%", "239", null, "29", "0%", null, this);
            obj.set_taborder("160");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static62", "absolute", "16.88%", "618", null, "29", "0.89%", null, this);
            obj.set_taborder("87");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static72", "absolute", "16.88%", "674", null, "29", "0.89%", null, this);
            obj.set_taborder("93");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "16.88%", "646", null, "29", "0.89%", null, this);
            obj.set_taborder("132");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static21", "absolute", "16.75%", "73", null, "29", "0.89%", null, this);
            obj.set_taborder("41");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static22", "absolute", "0", "73", null, "29", "70.05%", null, this);
            obj.set_taborder("42");
            obj.set_text("계약의 유효기간");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Calendar("edt_ETC17", "absolute", "30.33%", "77", null, "21", "57.49%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("0");
            ...
            obj = new Static("Static131", "absolute", "42.77%", "77", null, "21", "56.09%", null, this);
            obj.set_taborder("44");
            obj.set_text("~");
            this.addChild(obj.name, obj);

            obj = new Calendar("edt_ETC18", "absolute", "43.91%", "77", null, "21", "43.78%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("1");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_enable("false");
            ...
            obj = new Static("Static03", "absolute", "0", "593", "59.26%", "21", null, null, this);
            obj.set_taborder("77");
            ...
            obj = new Static("Static17", "absolute", "0", "552", "59.26%", "21", null, null, this);
            obj.set_taborder("81");
            obj.set_text("[첨부]");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("left middle");
            ...
            obj = new Static("Static64", "absolute", "0", "618", null, "29", "80.96%", null, this);
            obj.set_taborder("88");
            obj.set_text("점포명");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC21", "absolute", "19.67%", "622", null, "21", "51.4%", null, this);
            obj.set_taborder("8");
            ...
            obj = new Edit("edt_ETC22", "absolute", "63.32%", "622", null, "21", "28.93%", null, this);
            obj.set_taborder("9");
            ...
            obj = new Static("Static71", "absolute", "49.75%", "618", null, "29", "37.31%", null, this);
            obj.set_taborder("92");
            obj.set_text("운영층");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static73", "absolute", "0", "674", null, "29", "80.96%", null, this);
            obj.set_taborder("94");
            obj.set_text("매장 위치(첨부파일)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static65", "absolute", "16.88%", "730", null, "129", "0.89%", null, this);
            obj.set_taborder("95");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static66", "absolute", "0%", "730", null, "129", "80.96%", null, this);
            obj.set_taborder("96");
            obj.set_text("기타특약사항");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new FileUpload("FileUpload", "absolute", "19.42%", "678", null, "24", "20.43%", null, this);
            obj.set_taborder("12");
            ...
            obj = new Static("Static85", "absolute", "49.75%", "646", null, "29", "37.31%", null, this);
            obj.set_taborder("129");
            obj.set_text("매장 위치");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC24", "absolute", "63.32%", "650", null, "21", "5.58%", null, this);
            obj.set_taborder("11");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("190");
            this.addChild(obj.name, obj);

            obj = new TextArea("edt_ETC52", "absolute", "19.67%", "735", null, "118", "1.78%", null, this);
            obj.set_taborder("18");
            ...
            obj = new Edit("edt_ETC23", "absolute", "19.67%", "650", null, "21", "51.4%", null, this);
            obj.set_taborder("10");
            obj.style.set_align("left middle");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("190");
            ...
            obj = new Static("Static13", "absolute", "0", "646", null, "29", "80.96%", null, this);
            obj.set_taborder("137");
            obj.set_text("영업시간");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static04", "absolute", "16.88%", "702", null, "29", "0.89%", null, this);
            obj.set_taborder("138");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static11", "absolute", "49.75%", "702", null, "29", "37.31%", null, this);
            obj.set_taborder("139");
            obj.set_text("판촉사원 수");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static18", "absolute", "0", "702", null, "29", "80.96%", null, this);
            obj.set_taborder("142");
            obj.set_text("매장면적");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static20", "absolute", "28.43%", "706", null, "21", "68.65%", null, this);
            obj.set_taborder("143");
            obj.set_text("㎡");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC25", "absolute", "19.67%", "706", null, "21", "72.34%", null, this);
            obj.set_taborder("13");
            ...
            obj = new Static("Static26", "absolute", "72.08%", "706", null, "21", "25%", null, this);
            obj.set_taborder("145");
            obj.set_text("명");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC26", "absolute", "63.32%", "706", null, "21", "28.68%", null, this);
            obj.set_taborder("14");
            obj.set_mask("9990");
            obj.set_limitbymask("both");
            obj.style.set_align("right middle");
            ...
            obj = new Button("btn_delPlan", "absolute", "81.22%", "678", null, "21", "11.17%", null, this);
            obj.set_taborder("149");
            obj.set_text("변경");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static09", "absolute", "17.77%", "144", null, "29", "0%", null, this);
            obj.set_taborder("150");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static14", "absolute", "0", "144", null, "29", "70.05%", null, this);
            obj.set_taborder("151");
            obj.set_text("현금지급조건");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static15", "absolute", "0", "121", "59.26%", "21", null, null, this);
            obj.set_taborder("152");
            obj.set_text("납품대금 지금 및 감액금지 등");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static16", "absolute", "30.33%", "148", null, "21", "54.7%", null, this);
            obj.set_taborder("153");
            obj.set_text("매월말일 마감 후 익월");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC10", "absolute", "46.19%", "148", null, "21", "49.24%", null, this);
            obj.set_taborder("2");
            obj.set_mask("990");
            obj.set_limitbymask("both");
            obj.style.set_align("right middle");
            ...
            obj = new Static("Static23", "absolute", "51.14%", "148", null, "21", "43.78%", null, this);
            obj.set_taborder("155");
            obj.set_text("일");
            this.addChild(obj.name, obj);

            obj = new Static("Static00", "absolute", "0", "239", null, "29", "70.05%", null, this);
            obj.set_taborder("156");
            obj.set_text("마진율");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static05", "absolute", "35.28%", "243", null, "21", "59.64%", null, this);
            obj.set_taborder("159");
            obj.set_text("%");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC12", "absolute", "30.33%", "243", null, "21", "65.1%", null, this);
            obj.set_taborder("4");
            obj.style.set_align("right middle");
            obj.set_lengthunit("ascii");
            ...
            obj = new Static("Static07", "absolute", "50%", "239", null, "29", "21.32%", null, this);
            obj.set_taborder("161");
            obj.set_text("부가가치세의 세율");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static08", "absolute", "79.06%", "243", null, "21", "9.26%", null, this);
            obj.set_taborder("162");
            obj.set_text("마진율의 10%인");
            this.addChild(obj.name, obj);

            obj = new Static("Static10", "absolute", "95.3%", "243", null, "21", "2.28%", null, this);
            obj.set_taborder("163");
            obj.set_text("%");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC13", "absolute", "90.48%", "243", null, "21", "4.95%", null, this);
            obj.set_taborder("5");
            obj.style.set_align("right middle");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("20");
            ...
            obj = new Static("Static12", "absolute", "0", "189", "59.26%", "21", null, null, this);
            obj.set_taborder("165");
            obj.set_text("판매수수료율 등");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static24", "absolute", "0", "307", null, "29", "70.05%", null, this);
            obj.set_taborder("166");
            obj.set_text("하자보증보험증권의 금액 또는 보증금");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC14", "absolute", "58.76%", "311", null, "21", "36.68%", null, this);
            obj.set_taborder("6");
            obj.style.set_align("right middle");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("20");
            ...
            obj = new Static("Static01", "absolute", "63.71%", "311", null, "21", "31.22%", null, this);
            obj.set_taborder("169");
            obj.set_text("%");
            this.addChild(obj.name, obj);

            obj = new Static("Static27", "absolute", "30.33%", "311", null, "21", "40.74%", null, this);
            obj.set_taborder("170");
            obj.set_text("계약종료일 직전 월의 판매된 상품대금의");
            this.addChild(obj.name, obj);

            obj = new Static("Static28", "absolute", "17.77%", "211", null, "29", "0%", null, this);
            obj.set_taborder("171");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static29", "absolute", "0", "211", null, "29", "70.05%", null, this);
            obj.set_taborder("172");
            obj.set_text("판매대금 공제가능 판매수익");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC11", "absolute", "43.78%", "215", null, "21", "51.65%", null, this);
            obj.set_taborder("3");
            obj.style.set_align("right middle");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("20");
            ...
            obj = new Static("Static30", "absolute", "48.86%", "215", null, "21", "36.93%", null, this);
            obj.set_taborder("174");
            obj.set_text("%의 판매수수료율");
            this.addChild(obj.name, obj);

            obj = new Static("Static31", "absolute", "30.33%", "215", null, "21", "55.96%", null, this);
            obj.set_taborder("175");
            obj.set_text("상품의 판매대금 X");
            this.addChild(obj.name, obj);

            obj = new Static("Static32", "absolute", "0", "284", "59.26%", "21", null, null, this);
            obj.set_taborder("176");
            obj.set_text("사후 고객관리를 위한 조치");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static33", "absolute", "16.88%", "380", null, "129", "0.89%", null, this);
            obj.set_taborder("177");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static34", "absolute", "0%", "380", null, "129", "80.96%", null, this);
            obj.set_taborder("178");
            obj.set_text("기타특약사항");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new TextArea("edt_ETC51", "absolute", "19.67%", "385", null, "118", "1.78%", null, this);
            obj.set_taborder("7");
            obj.set_scrollbars("autovert");
            obj.set_wordwrap("char");
            obj.set_lengthunit("ascii");
            ...
            obj = new Static("Static35", "absolute", "0", "358", "59.26%", "21", null, null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 788, 865, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("pattern_01");
            		p.set_titletext("특약매입거래계약서 (공통)");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311305.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311305.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	for (var i = 0 ; i < this.parent.ds_etcEltStylAmm.rowcount; i++) {
        		if (this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "123") {
        	...
        	for (var i = 0; i < this.parent.ds_eltCtrwDtl.rowcount; i++) {
        		if (this.parent.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "123") {
        			fv_chk = 1 ;
        ...
        this.loadIncludeScript("OMG_DS_SC_311305.xfdl", true);
