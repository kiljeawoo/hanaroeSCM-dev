(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311334.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311334.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	if (fv_chk == 0 ) {
        		...
        		fv_position = nRow;
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "SCTRW_KDC" , "415");
        ...
        this.OMG_DS_SC_311334_ontextchanged = function(obj,e)
        {
        	obj.updateToDataset();
        ...
        this.on_initEvent = function()
        {
            ...
            this.vld_prd_st_dt.addEventHandler("onchanged", this.OMG_DS_SC_311334_ontextchanged, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_311334.xfdl", true);
