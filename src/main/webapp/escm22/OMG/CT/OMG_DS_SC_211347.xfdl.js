    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("특약서(매장위치 및 면적) 축산");
            ...
            obj = new Dataset("ds_etcEltStylAmm413", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj = new Dataset("ds_sctrwDtl13", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"98\"/><Column size=\"98\"/><Column size=\"98\"/><Column size=\"100\"/><Column size=\"98\"/><Column size=\"98\"/><Column size=\"98\"/></Columns><Rows><Row size=\"34\" band=\"head\"/><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" displaytype=\"checkbox\" edittype=\"checkbox\"/><Cell col=\"1\" colspan=\"2\" text=\"점포명\"/><Cell col=\"3\" colspan=\"2\" text=\"매장면적\"/><Cell col=\"5\" colspan=\"2\" text=\"점포명\"/><Cell col=\"7\" colspan=\"2\" text=\"매장면적\"/><Cell row=\"1\" col=\"1\" text=\"명\"/><Cell row=\"1\" col=\"2\" text=\"층\"/><Cell row=\"1\" col=\"3\" text=\"㎡\"/><Cell row=\"1\" col=\"4\" text=\"평\"/><Cell row=\"1\" col=\"5\" text=\"명\"/><Cell row=\"1\" col=\"6\" text=\"층\"/><Cell row=\"1\" col=\"7\" text=\"㎡\"/><Cell row=\"1\" col=\"8\" text=\"평\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:ISCHECKED\"/><Cell col=\"1\" displaytype=\"text\" edittype=\"text\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:STORNM1\"/><Cell col=\"2\" displaytype=\"number\" edittype=\"mask\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:STOR_LY1\" mask=\"####\"/><Cell col=\"3\" displaytype=\"number\" edittype=\"mask\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:SELA_AREA_M1\" mask=\"####\"/><Cell col=\"4\" displaytype=\"number\" edittype=\"mask\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:SELA_AREA_PCN1\" mask=\"####\"/><Cell col=\"5\" displaytype=\"text\" edittype=\"text\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:STORNM2\"/><Cell col=\"6\" displaytype=\"number\" edittype=\"mask\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:STOR_LY2\" mask=\"####\"/><Cell col=\"7\" displaytype=\"number\" edittype=\"mask\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:SELA_AREA_M2\" mask=\"####\"/><Cell col=\"8\" displaytype=\"number\" edittype=\"mask\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:SELA_AREA_PCN2\" mask=\"####\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 788, 303, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("특약서(매장위치 및 면적) 축산");
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","txa_sctrSjt","value","ds_sctrwDtl13","SCTR_SJT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_211347.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_211347.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
           ...
           for(var i = 0 ; i < this.parent.ds_etcEltStylAmm.rowcount; i++){		
        		...
        		if(this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "413"){

        			this.ds_etcEltStylAmm413.copyRow(0, this.parent.ds_etcEltStylAmm ,i);   	
        		}
        	}		 

        	for(var i = 0 ; i < this.parent.ds_sctrwDtl.rowcount; i++){		

        		if(this.parent.ds_sctrwDtl.getColumn(i, "SCTRW_KDC") =="413"){
        		
        			fv_position = i;
        			fv_chk = 1 ;
        			this.ds_sctrwDtl13.addRow();
        			this.ds_sctrwDtl13.copyRow(0, this.parent.ds_sctrwDtl ,fv_position);   	
         	...
         	if (fv_chk == 0 ){
        		...
        		fv_position = nRow;
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "SCTRW_KDC" , "413") ;		
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "CHG_SQNO" ,this.parent.ds_register.getColumn(0 ,"CHG_SQNO" ) ) ;	
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "CTRW_STY_VER" , this.ds_etcEltStylAmm413.getColumn(0,"CTRW_STY_VER") ) ;
        ...
        //		this.cal_evtPrdEdDt.set_value(chkDay);
        	...
        	if(this.parent.ds_sctrwAllXpcPmtnCst.rowcount  > 0){
        		...
        		this.ds_sctrwAllXpcPmtnCst.addRow();
        		this.ds_sctrwAllXpcPmtnCst.setColumn(0, "SCTRW_KDC" , "413") ;
        ...
        this.btn_sctrwAllXpcPmtnCst_addRow_onclick = function(obj,e)
        {
        	...
        	this.ds_sctrwAllXpcPmtnCst.setColumn(nRow, "SCTRW_KDC" , "413") ;
        ...
        this.btn_sctrwDtl13_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_sctrwDtl03.addEventHandler("onclick", this.btn_sctrwDtl13_onclick, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_211347.xfdl", true);
