    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311502");
                this.set_titletext("직매입거래계약서(테넌트)");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311502.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311502.xfdl", function() {
        ...
        */
        ...
        this.loadIncludeScript("OMG_DS_SC_311502.xfdl");
