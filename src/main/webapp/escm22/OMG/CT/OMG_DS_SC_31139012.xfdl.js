(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_31139012.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_31139012.xfdl", function() {
        ...
        this.loadIncludeScript("OMG_DS_SC_31139012.xfdl");
