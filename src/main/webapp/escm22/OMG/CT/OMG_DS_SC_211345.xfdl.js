    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_211345");
                this.set_titletext("특약서(원산지등) 축산");
            ...
            obj = new Dataset("ds_etcEltStylAmm411", this);
            ...
            obj = new Dataset("ds_sctrwDtl11", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj = new BindItem("item0","vld_prd_st_dt","value","ds_sctrwDtl02","DSPC_PRD_ST_DT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","txa_sctrSjt","value","ds_sctrwDtl11","SCTR_SJT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_211345.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_211345.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
           ...
           for(var i = 0 ; i < this.parent.ds_etcEltStylAmm.rowcount; i++){		
        		...
        		if(this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "411"){

        			this.ds_etcEltStylAmm411.copyRow(0, this.parent.ds_etcEltStylAmm ,i);   	
        		}
        	}		
        	
        	for(var i = 0 ; i < this.parent.ds_sctrwDtl.rowcount; i++){		

         			if(this.parent.ds_sctrwDtl.getColumn(i, "SCTRW_KDC") =="411"){
         			
         				fv_position = i;
         				fv_chk = 1 ;
         				this.ds_sctrwDtl11.addRow();
         				this.ds_sctrwDtl11.copyRow(0, this.parent.ds_sctrwDtl ,fv_position);   	
        	...
        	if (fv_chk == 0 ){
        		...
        		var nRow = this.parent.ds_sctrwDtl.addRow();
        			fv_position = nRow;
        			this.parent.ds_sctrwDtl.setColumn(fv_position, "SCTRW_KDC" , "411") ;		
        			this.parent.ds_sctrwDtl.setColumn(fv_position, "CHG_SQNO" ,this.parent.ds_register.getColumn(0 ,"CHG_SQNO" ) ) ;	
        			this.parent.ds_sctrwDtl.setColumn(fv_position, "CTRW_STY_VER" , this.ds_etcEltStylAmm411.getColumn(0,"CTRW_STY_VER") ) ;
        ...
        this.on_initEvent = function()
        {
            ...
            this.vld_prd_st_dt.addEventHandler("onchanged", this.OMG_DS_SC_211310_ontextchanged, this);
            this.vld_prd_st_dt.addEventHandler("ontextchanged", this.OMG_DS_SC_211331_ontextchanged, this);
            this.txa_sctrSjt.addEventHandler("ontextchanged", this.txatext_changed, this);

        };

        this.loadIncludeScript("OMG_DS_SC_211345.xfdl", true);
