    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311701");
                this.set_titletext("농약 원제·제품 연계사업 계약서");
                this._setFormPosition(0,0,788,1050);
            }
            ...
            obj.set_taborder("34");
            obj.set_text("제품 및 수량");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static03", "absolute", "0", "543", "59.26%", "21", null, null, this);
            obj.set_taborder("77");
            obj.set_text("제품내역");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("78");
            obj.set_text("[농약 원제·제품 연계사업 계약서]");
            obj.set_cssclass("sta_WF_Subtitle");
            ...
            obj.set_taborder("81");
            obj.set_text("[붙임 1] 연계사업 제품 및 원제 계약명세표");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("left middle");
            obj.style.set_padding("0 0 1 5");
            this.addChild(obj.name, obj);

            obj = new Static("Static10", "absolute", "0", "864", "59.26%", "21", null, null, this);
            obj.set_taborder("84");
            obj.set_text("원제내역");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Grid("GridI", "absolute", "0%", "888", null, "150", "0.89%", null, this);
            obj.set_taborder("19");
            ...
            obj = new Button("btn_addRowI", "absolute", "91.5%", "863", null, "21", "0.89%", null, this);
            obj.set_taborder("18");
            obj.set_text("행추가");
            this.addChild(obj.name, obj);

            obj = new Button("btn_delRowI", "absolute", "83.12%", "863", null, "21", "9.26%", null, this);
            obj.set_taborder("17");
            obj.set_text("행삭제");
            this.addChild(obj.name, obj);

            obj = new Grid("GridA", "absolute", "0%", "591", null, "249", "1.02%", null, this);
            obj.set_taborder("16");
            obj.set_binddataset("ds_ctEtcItemAList");
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"49\"/><Column size=\"160\"/><Column size=\"90\"/><Column size=\"70\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"삭제\"/><Cell col=\"1\" rowspan=\"2\" text=\"제품명\"/><Cell col=\"2\" rowspan=\"2\" text=\"규격\"/><Cell col=\"3\" rowspan=\"2\" text=\"수량\"/><Cell col=\"4\" colspan=\"3\" text=\"납품단가\"/><Cell col=\"7\" rowspan=\"2\" text=\"장려금율\"/><Cell row=\"1\" col=\"4\" text=\"원료부문\"/><Cell row=\"1\" col=\"5\" text=\"가공부문\"/><Cell row=\"1\" col=\"6\" text=\"계\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"none\" text=\"bind:ISCHECKED\" autosizecol=\"none\"/><Cell col=\"1\" edittype=\"text\" style=\"align:center middle;\" text=\"bind:ITEM_NAME\" editlimit=\"190\" editlengthunit=\"ascii\" autosizecol=\"none\"/><Cell col=\"2\" edittype=\"text\" text=\"bind:STANDARD\" autosizecol=\"none\"/><Cell col=\"3\" edittype=\"text\" editfilter=\"number\" text=\"bind:QTY\"/><Cell col=\"4\" edittype=\"text\" editfilter=\"number\" text=\"bind:COMPANY\"/><Cell col=\"5\" edittype=\"text\" editfilter=\"number\" text=\"bind:COUNTRY\"/><Cell col=\"6\" edittype=\"text\" editfilter=\"number\" text=\"bind:UPR\"/><Cell col=\"7\" edittype=\"text\" editfilter=\"number\" text=\"bind:BRAND\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static04", "absolute", null, "571", "207", "21", "1.02%", null, this);
            obj.set_taborder("160");
            obj.set_text("(단위 : 개/병/봉, 원, %)");
            obj.style.set_align("right middle");
            this.addChild(obj.name, obj);

            obj = new Static("Static36", "absolute", "44.67%", "62", null, "29", "34.26%", null, this);
            ...
            obj = new MaskEdit("edt_ETC01", "absolute", "19.29%", "66", null, "21", "75.51%", null, this);
            obj.set_taborder("0");
            obj.set_mask("90");
            obj.set_limitbymask("both");
            this.addChild(obj.name, obj);

            obj = new Static("Static47", "absolute", "24.87%", "66", null, "21", "66.37%", null, this);
            obj.set_taborder("170");
            obj.set_text("% 범위 내");
            this.addChild(obj.name, obj);

            obj = new Static("Static83", "absolute", "17.39%", "66", null, "21", "80.71%", null, this);
            ...
            obj = new Div("cal_by_dt", "absolute", "66.24%", "66", "100", "21", null, null, this);
            obj.set_taborder("1");
            ...
            obj = new Edit("edt_ETC04", "absolute", "66.12%", "131", null, "21", "8.88%", null, this);
            obj.set_taborder("3");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("190");
            obj.style.set_align("left middle");
            ...
            obj = new Static("Static20", "absolute", "79.31%", "66", null, "21", "11.93%", null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 788, 1050, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("pattern_01");
            		p.set_titletext("농약 원제·제품 연계사업 계약서");
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item11","edt_ETC05","value","ds_eltCtrwDtl01","ETC5");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","edt_ETC06","value","ds_eltCtrwDtl01","ETC6");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","edt_ETC04","value","ds_eltCtrwDtl01","ETC4");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item13","edt_ETC09","value","ds_eltCtrwDtl01","ETC9");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item12","edt_ETC13","value","ds_eltCtrwDtl01","ETC13");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item10","edt_ETC14","value","ds_eltCtrwDtl01","ETC14");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","edt_ETC12","value","ds_eltCtrwDtl01","ETC12");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","edt_ETC07","value","ds_eltCtrwDtl01","ETC7");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item5","edt_ETC08","value","ds_eltCtrwDtl01","ETC8");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item6","edt_ETC9_2","value","ds_eltCtrwDtl01","ETC9");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item7","edt_ETC10","value","ds_eltCtrwDtl01","ETC10");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item8","edt_ETC11","value","ds_eltCtrwDtl01","ETC11");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311701.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311701.xfdl", function(exports) {
        if (this.executeIncludeScript) { this.executeIncludeScript("lib::comLib.xjs", null, exports); }	//include "lib::comLib.xjs";

        var ELT_CODE = "161"; // 메인계약서코드
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	for (var i = 0; i < this.parent.ds_eltCtrwDtl.rowcount; i++) {
        		if (this.parent.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == ELT_CODE) {
        			...
        			if (this.gfn_nullToEmpty(this.parent.ds_eltCtrwDtl.getColumn(i, "ETC2")) == "") {
        				var initdate = this.gfn_today('yyyy');
        				this.cal_by_dt._setValue(initdate + "11"); // ETC2 반품기간
        				this.parent.ds_eltCtrwDtl.setColumn(fv_position, "ETC3", initdate + "1211"); // 대금지급일 기본 값
        				...
        				this.cal_by_dt._setValue(this.parent.ds_eltCtrwDtl.getColumn(fv_position, "ETC2")); // ETC2 반품기간
        			}
        ...
        {	
        	this.parent.ds_eltCtrwDtl.setColumn(fv_position, "ETC1" , this.edt_ETC01.value) ; // 증감발주
        	this.parent.ds_eltCtrwDtl.setColumn(fv_position, "ETC2" , this.cal_by_dt._getValue()) ; // 반품기간
        	this.parent.ds_eltCtrwDtl.setColumn(fv_position, "ETC3" , this.edt_ETC03.value) ; // 대금지급일
        ...
        {
            var strTitletext = "농약 원제·제품 연계사업 계약서";
            
            if (this.gfn_nullToEmpty(this.edt_ETC01.value) == "") {
        		alert("증감발주 범위를 입력해주세요.");
        		this.edt_ETC01.setFocus();
        		return false;
        	}
        	
        	if (this.gfn_nullToEmpty(this.cal_by_dt._getValue()) == "") {
        		alert("반품기간을 입력해주세요.");
        		this.cal_by_dt.setFocus();
        		return false;
        	}
        	...
        	if (this.ds_ctEtcItemAList.getRowCount() > 0) {
        		for (var i=0; i<this.ds_ctEtcItemAList.getRowCount(); i++) {
        			...
        			var c4 = this.ds_ctEtcItemAList.getColumn(i, "COMPANY"); // 원류(선택)
        			var c5 = this.ds_ctEtcItemAList.getColumn(i, "COUNTRY"); // 가공(선택)
        			var c6 = this.ds_ctEtcItemAList.getColumn(i, "UPR"); // 계
        			var c7 = this.ds_ctEtcItemAList.getColumn(i, "BRAND"); // 장려금율
        			if (this.gfn_nullToEmpty(c1) == "" || this.gfn_nullToEmpty(c2) == "" || this.gfn_nullToEmpty(c3) == "" || this.gfn_nullToEmpty(c6) == "" || this.gfn_nullToEmpty(c7) == "") {
        				alert("제품내역 리스트에 입력되지 않은 행이 있습니다.\n해당 행을 입력하시거나 불필요한 경우 행삭제를 해주세요.");
        				return false;
        			}
        		}
        	} else {
        		alert("제품내역 리스트를 입력해주세요");
        		return false;
        	}
        	...
        	if (this.ds_ctEtcItemIList.getRowCount() > 0) {
        		for (var i=0; i<this.ds_ctEtcItemIList.getRowCount(); i++) {
        			...
        			var c3 = this.ds_ctEtcItemIList.getColumn(i, "BRAND"); // 비고(선택)
        			
        			if (this.gfn_nullToEmpty(c1) == "" || this.gfn_nullToEmpty(c2) == "") {
        				alert("원제내역 리스트에 입력되지 않은 행이 있습니다.\n해당 행을 입력하시거나 불필요한 경우 행삭제를 해주세요.");
        				return false;
        			}
        		}
        	} else {
        		alert("원제내역 리스트를 입력해주세요");
        		return false;
        	}
        ...
        this.loadIncludeScript("OMG_DS_SC_311701.xfdl", true);
