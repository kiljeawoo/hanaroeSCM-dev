    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_3116");
                this.set_titletext("전자계약 신청화면(수산)");
            ...
            obj.set_cssclass("sta_WF_Labelbg");
            this.div_sctrw.addChild(obj.name, obj);
            obj = new CheckBox("chk_sctrw18", "absolute", "14.85%", "105", null, "21", "60.28%", null, this.div_sctrw);
            obj.set_taborder("26");
            obj.set_text("(협력업체 기여도평가)");
            obj.set_value("0");
            obj.set_truevalue("1");
            obj.set_falsevalue("0");
            this.div_sctrw.addChild(obj.name, obj);
            ...
            obj = new Div("div_sctrw18", "absolute", "15", "3821", null, "140", "1.83%", null, this);
            ...
            obj = new Div("div_mnCtrwKd51", "absolute", "19", "713", null, "112", "2.32%", null, this);
            ...
            obj = new Div("div_mnCtrwKd52", "absolute", "19", "855", null, "84", "2.32%", null, this);
            obj.set_taborder("311");
            obj.set_text("특약매입 거래계약서(수산)");
            obj.style.set_background("transparent");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            ...
            //-- Default Layout
            obj = new Layout("default", "", 788, 259, this.div_sctrw18,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("196");
            		p.set_text("(협력업체 기여도평가)");
            		p.style.set_background("transparent");
            		p.set_visible("false");

            	}
            );
            this.div_sctrw18.addLayout(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_3116.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_DS_SC_3116.xfdl", "lib::comDate.xjs");
        this.registerScript("OMG_DS_SC_3116.xfdl", function(exports) {
        ...
        // 직매입 계약서(142)는 없으나 공통과 형식을 유지하기 위해 코드는 유지함
        			...
        			if (cdm == param1 || fv_ctrwChgObjChk == 1) {
        				if (ctype == 'MN_CTRW_KD' && param2=='MN_CTRW_KD') {
        					...
        					if (ctype == 'ADD_CTRW_KDC' && param2 == 'ADD_CTRW_KDC') {
        						...
        						// 특약서 부분
        						if (cdd == "418") {
        							this.div_sctrw.chk_sctrw18.set_enable(true);
        						}
        ...
        this.chkinit = function(param) {
        	if (param == 'ADD_CTRW_KDC') {
        		...
        		this.div_sctrw.chk_sctrw18.set_enable(false);
        ...
        this.unCHK = function(param)
        {
        	...
        	if (param == 'all') {
        		...
        		this.div_sctrw.chk_sctrw18.set_value(0);
                this.div_sctrw18.set_url("");
        		this.div_sctrw18.set_visible(false);

        		this.fn_sctrw18(param);
        ...
        this.insert = function(flag)
        {
        	...
        	if (this.fn_validationCheck()) {
        		if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value == "151") {
        			// 직매입 거래계약서(수산)
        			sDataSet += " ds_ctEtcItemList=ds_ctEtcItemList";
        			this.ds_ctEtcItemList.clear();
        			this.ds_ctEtcItemList.appendData(this.div_mnCtrwKd51.ds_ctEtcItemAList);
        			this.ds_ctEtcItemList.appendData(this.div_mnCtrwKd51.ds_ctEtcItemIList);
        			validationCheck = this.div_mnCtrwKd51.fn_validationCheck();
        		} else if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value == "152") {
        			// 특약매입 거래계약서(수산)
        			sDataSet += " ds_ctEtcItemList=ds_ctEtcItemList";
        			this.ds_ctEtcItemList.clear();
        			this.ds_ctEtcItemList.appendData(this.div_mnCtrwKd52.ds_ctEtcItemAList);
        			this.ds_ctEtcItemList.appendData(this.div_mnCtrwKd52.ds_ctEtcItemIList);
        			validationCheck = this.div_mnCtrwKd52.fn_validationCheck();
        		} 
        	}
        ...
        this.update = function()
        {
        	...
        	if (this.chk_sctrw.value == 1) {
        		if (this.div_sctrw.chk_sctrw18.value == 1 && validationCheck) {
        			//validationCheck = this.div_sctrw18.fn_validationCheck();
        		}
        	}
        ...
        this.fn_validationCheck = function()
        {
        	...
        	if (this.chk_addCtrw.value == 1) {
        		if (this.div_addCtrw.chk_addCtrw01.value == "0") {
        	...
        	// 특약서
        	if (this.chk_sctrw.value == 1) {
        		if (this.div_sctrw.chk_sctrw18.value == "0") {
        			this.alert("특약서를 선택하여 주세요. ");
        			this.div_sctrw.chk_sctrw18.setFocus();
        			return false;
        		}
        	}
        	...
        	if (this.chk_etcCtrw.value == 1) {
        		if (this.div_etcCtrw.chk_etcCtrw03.value == "0") {
        			this.alert("기타 계약서를 선택하여 주세요.");
        			this.div_etcCtrw.chk_etcCtrw03.setFocus();
        			return false;
        		}
        	}
        ...
        {
        	this.ds_buyerCode.filter("SIMP_C == '15'");
        ...
        this.fn_callBack = function(svcID,ErrorCode,ErrorMsg)
        {
        	...
        	if (svcID == "initsearch") {
        		...
        		if (fv_ctrwChgObjChk == 0) {
        			this.div_mnCtrwKd.rdo_mnCtrwKdC.set_value("151");
        			this.div_mnCtrwKd51.set_url("OMG.CT::OMG_DS_SC_311601.xfdl");
        			this.div_mnCtrwKd51.set_visible(true);
        			...
        			this.setAvailableSubEltCtrw("15");
        			...
        			if (this.ds_sctrwDtl.rowcount > 0) {
        			   for (var i = 0; i < this.ds_sctrwDtl.rowcount; i++) {
        					if (this.ds_sctrwDtl.getColumn(i, "SCTRW_KDC") == "418") {
        						this.fn_sctrwKd();
        						this.div_sctrw.chk_sctrw18.set_value(1);
        						this.fn_sctrw18();
        					}
        				}
        			}
        ...
        // 		this.chk_etcCtrw.set_enable(true);
        		...
        		if (mainValue == "51") {
        			this.div_mnCtrwKd.rdo_mnCtrwKdC.set_value("151"); // 151	직매입 거래계약서(수산)
        			this.fn_ctrChrr();
        		} else if (mainValue == "52") {
        			this.div_mnCtrwKd.rdo_mnCtrwKdC.set_value("152"); // 152	특약매입 거래계약서(수산)
        			this.fn_ctrChrr();
        		} 
        ...
        {
        	this.div_mnCtrwKd51.set_url("");
        	this.div_mnCtrwKd52.set_url("");
        	
        	this.div_mnCtrwKd51.set_visible(false);
        	this.div_mnCtrwKd52.set_visible(false);
        ...
        this.fn_mnCtrwKd = function() {
        	...
        	if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value  == "151") {
        		this.div_mnCtrwKd51.set_url("OMG.CT::OMG_DS_SC_311601.xfdl"); // 직매입 거래계약서(수산)
        		this.div_mnCtrwKd51.set_visible(true);
        		this.cbo_mnCtrwKdM.set_value("51");
        		if (fv_ctrwChgObjChk == 0) {
        			this.btn_preview.set_visible(true);
        		}
        	}else if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value  == "152") {
        		this.div_mnCtrwKd52.set_url("OMG.CT::OMG_DS_SC_311602.xfdl"); // 특약매입 거래계약서(수산)
        		this.div_mnCtrwKd52.set_visible(true);
        		this.cbo_mnCtrwKdM.set_value("52");
        		if (fv_ctrwChgObjChk == 0) {
        			this.btn_preview.set_visible(true);
        		}
        	}
        ...
        this.position_chk = function()
        {
        	...
        	if (this.gfn_isNull( this.div_mnCtrwKd.rdo_mnCtrwKdC.value)) {
        		this.div_mnCtrwKd51.set_top(mnCtrwKd);
        		mnCtrwKd = nexacro.toNumber(this.div_mnCtrwKd51.top)+nexacro.toNumber(this.div_mnCtrwKd51.height) + 20 ;
        	}

        	if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value == 151) {
        		this.div_mnCtrwKd51.set_top(mnCtrwKd);
        		this.div_mnCtrwKd51.set_height(931); // 높이설정
        		mnCtrwKd = nexacro.toNumber(this.div_mnCtrwKd51.top) + nexacro.toNumber(this.div_mnCtrwKd51.height) +20 ;
        	} else if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value == 152) {
        		this.div_mnCtrwKd52.set_top(mnCtrwKd);
        		this.div_mnCtrwKd52.set_height(1037); // 높이설정
        		mnCtrwKd = nexacro.toNumber(this.div_mnCtrwKd52.top) + nexacro.toNumber(this.div_mnCtrwKd52.height) +20 ;
        	}
        ...
        this.chk_sctrw18_onchanged = function(obj,e)
        {
        	this.fn_sctrw18();
        }

        this.fn_sctrw18 = function(noChk)
        {
        	if (this.div_sctrw.chk_sctrw18.value == 1) {
        		this.div_sctrw18.set_url("OMG.CT::OMG_DS_SC_311336.xfdl");
        		this.div_sctrw18.set_visible(true);
        	} else {
        		var fv_position = 0;
        		fv_position = this.ds_sctrwDtl.findRow("SCTRW_KDC","418").toString();
        ...
        this.position_div_sctrw = function()
        {
        	if (this.chk_sctrw.value == 1) {
        		...
        		if (this.div_sctrw.chk_sctrw18.value == 1) {
        			this.div_sctrw18.set_top(mnCtrwKd);
        			mnCtrwKd = nexacro.toNumber(this.div_sctrw18.top)+nexacro.toNumber(this.div_sctrw18.height) +20 ;
        		}
        	}
        ...
        this.cal_ctrStDt_onchanged = function(obj,e)
        {
        	...
        	for (var i = 0 ; i < this.ds_eltCtrwDtl.rowcount; i++) {
        		if (this.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "151") {
        			this.ds_eltCtrwDtl.setColumn(i, "ETC17", this.cal_ctrStDt.value); // [메인계약서] 유효기간 시작일
        			this.div_mnCtrwKd51.edt_ETC17.set_value(this.cal_ctrStDt.value);
        		} else if (this.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "152") {
        			this.ds_eltCtrwDtl.setColumn(i, "ETC17", this.cal_ctrStDt.value); // [메인계약서] 계약 유효기간 시작일
        			this.div_mnCtrwKd52.edt_ETC17.set_value(this.cal_ctrStDt.value);
        		} 
        	}
        }
        ...
        this.cal_ctrEdDt_onchanged = function(obj,e)
        {
        	...
        	for (var i = 0 ; i < this.ds_eltCtrwDtl.rowcount; i++) {
        		if (this.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "151") {
        			this.ds_eltCtrwDtl.setColumn(i, "ETC18", this.cal_ctrEdDt.value); // [메인계약서] 유효기간 종료일
        			this.div_mnCtrwKd51.edt_ETC18.set_value(this.cal_ctrEdDt.value);
        		} else if (this.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "152") {
        			this.ds_eltCtrwDtl.setColumn(i, "ETC18", this.cal_ctrEdDt.value); // [메인계약서] 유효기간 종료일
        			this.div_mnCtrwKd52.edt_ETC18.set_value(this.cal_ctrEdDt.value);
        		} 
        	}
        }
        ...
        this.cal_ctrwDrup_Dt_onchanged = function(obj,e)
        {
        	...
        	for (var i = 0 ; i < this.ds_sctrwDtl.rowcount; i++) {
        		if (this.ds_sctrwDtl.getColumn(i, "SCTRW_KDC") == "418") {
        			...
        			this.div_sctrw18.vld_prd_st_dt.set_value(this.cal_ctrwDrup_Dt.value);
        		}
        	}
        }
        ...
        {
        	var oArg = {sts:"A", buyerCd:"15", filter: this.div_mnCtrwKd.rdo_mnCtrwKdC.value}; // 완료(A), 수산(15), 부속계약서 종류에 따른 조회 필터
        	var sOption = "autosize=true";
        	var sPopupCallBack = "fn_popupAfter";
        ...
        this.fn_ctrChrr = function()
        {
        	...
        	this.edt_ctrChrrDongbw.set_value("농협복합건물 7층"); // 주소2
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_sctrw.chk_sctrw18.addEventHandler("onchanged", this.chk_sctrw18_onchanged, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_3116.xfdl", true);
