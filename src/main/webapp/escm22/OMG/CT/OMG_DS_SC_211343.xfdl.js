    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("특약서(피해보상의 불청구)");
                this._setFormPosition(0,0,788,118);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_etcEltStylAmm409", this);
            ...
            obj = new Dataset("ds_sctrwDtl09", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj = new Button("btn_sctrwDtl09", "absolute", "711", "0", "77", "21", null, null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 788, 118, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("pattern_01");
            		p.set_scrollbars("none");
            		p.set_titletext("특약서(피해보상의 불청구)");
            ...
            obj = new BindItem("item4","txa_sctrSjt","value","ds_sctrwDtl09","SCTR_SJT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_211343.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_211343.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	for (var i = 0; i < this.parent.ds_etcEltStylAmm.rowcount; i++) {
        		if (this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "409") {
        			this.ds_etcEltStylAmm409.copyRow(0, this.parent.ds_etcEltStylAmm, i);
        		}
        	}

        	for (var i = 0; i < this.parent.ds_sctrwDtl.rowcount; i++) {
        		if (this.parent.ds_sctrwDtl.getColumn(i, "SCTRW_KDC") == "409") {
        			fv_position = i;
        			fv_chk = 1;
        			this.ds_sctrwDtl09.addRow();
        			this.ds_sctrwDtl09.copyRow(0, this.parent.ds_sctrwDtl, fv_position);
        //			this.txa_sctrSjt.set_value(this.parent.ds_sctrwDtl.getColumn(fv_position, "SCTR_SJT"));
        	...
        	if (fv_chk == 0) {
        		...
        		fv_position = nRow;
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "SCTRW_KDC", "409");
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "CHG_SQNO", this.parent.ds_register.getColumn(0 , "CHG_SQNO"));
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "CTRW_STY_VER", this.ds_etcEltStylAmm409.getColumn(0, "CTRW_STY_VER"));
        //		this.parent.ds_sctrwDtl.setColumn(fv_position, "SCTR_SJT", this.parent.ds_sctrwDtl.getColumn(0, "SCTR_SJT"));
        		this.ds_sctrwDtl09.addRow();
        		this.ds_sctrwDtl09.copyRow(0, this.parent.ds_sctrwDtl, fv_position);
        	}
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_sctrwDtl09.addEventHandler("onclick", this.btn_sctrwDtl09_onclick, this);
            this.txa_sctrSjt.addEventHandler("ontextchanged", this.txatext_changed, this);

        };

        this.loadIncludeScript("OMG_DS_SC_211343.xfdl", true);
