    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311392");
                this.set_titletext("부속계약서(임대차)");
            ...
            obj = new Static("Static08", "absolute", "15.74%", "664", null, "29", "0.89%", null, this);
            obj.set_taborder("33");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static07", "absolute", "0", "664", null, "29", "80.96%", null, this);
            obj.set_taborder("32");
            obj.set_text("임대료(율)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);
            ...
            obj = new Radio("rdo_rent", "absolute", "30.58%", "668", "93", "21", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new MaskEdit("edt_ETC17", "absolute", "19.67%", "668", null, "21", "70.3%", null, this);
            obj.set_taborder("12");
            obj.set_value("0");
            obj.set_mask("#,###,###,###");
            obj.set_limitbymask("both");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311392.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311392.xfdl", function(exports) {
        ...
        this.loadIncludeScript("OMG_DS_SC_311392.xfdl", true);
