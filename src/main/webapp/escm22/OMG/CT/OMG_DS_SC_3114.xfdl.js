    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_3114");
                this.set_titletext("전자계약 신청화면(농산본부)");
            ...
            obj = new Static("Static43", "absolute", "117.11%", "635", null, "29", "-800", null, this);
            ...
            obj = new Div("div_mnCtrwKd31", "absolute", "15", "715", null, "163", "1.83%", null, this);
            obj.set_taborder("26");
            obj.set_text("위수탁계약서(농산)");
            obj.set_visible("false");
            obj.style.set_background("transparent");
            this.addChild(obj.name, obj);

            obj = new Div("div_addCtrw", "absolute", "15", "1227", null, "54", "1.83%", null, this);
            obj.set_taborder("28");
            obj.set_text("Div07");
            ...
            obj.set_cssclass("sta_WF_Labelbg");
            this.div_addCtrw.addChild(obj.name, obj);
            obj = new CheckBox("chk_addCtrw01", "absolute", "47.34%", "30", null, "21", "30.46%", null, this.div_addCtrw);
            obj.set_taborder("6");
            ...
            obj.set_visible("false");
            this.div_addCtrw.addChild(obj.name, obj);
            obj = new CheckBox("chk_addCtrw03", "absolute", "72.08%", "30", null, "21", "0.38%", null, this.div_addCtrw);
            obj.set_taborder("8");
            ...
            obj.set_visible("false");
            this.div_addCtrw.addChild(obj.name, obj);
            obj = new CheckBox("chk_addCtrw06", "absolute", "14.97%", "30", null, "21", "54.95%", null, this.div_addCtrw);
            obj.set_taborder("12");
            obj.set_text("자기상표부착상품(PB) 거래 계약서");
            obj.set_value("0");
            obj.set_truevalue("1");
            obj.set_falsevalue("0");
            obj.set_enable("false");
            ...
            obj = new Div("div_pmiw", "absolute", "15", "2249", null, "84", "1.83%", null, this);
            obj.set_taborder("30");
            obj.set_text("약정서");
            obj.style.set_background("transparent");
            obj.set_visible("false");
            ...
            obj = new Div("div_pmiw02", "absolute", "15", "2787", null, "595", "1.83%", null, this);
            obj.set_taborder("32");
            ...
            obj = new Static("Static45", "absolute", "15", "2612", "803", "20", null, null, this);
            ...
            obj = new Div("div_pmiw01", "absolute", "15", "2665", null, "104", "1.83%", null, this);
            obj.set_taborder("31");
            ...
            obj = new Static("Static46", "absolute", "15", "4387", "803", "20", null, null, this);
            ...
            obj = new Div("div_sctrw", "absolute", "15", "4420", null, "148", "1.83%", null, this);
            obj.set_taborder("34");
            obj.set_text("특약서");
            obj.style.set_background("transparent");
            obj.set_visible("false");
            ...
            obj = new Static("Static50", "absolute", "15", "3660", "803", "20", null, null, this);
            ...
            obj = new Div("div_sctrw01", "absolute", "15", "4548", null, "487", "1.83%", null, this);
            obj.set_taborder("35");
            obj.set_text("특약서(마진율)");
            obj.style.set_background("transparent");
            obj.set_visible("false");
            ...
            obj = new Static("Static51", "absolute", "12", "5034", "803", "20", null, null, this);
            ...
            obj = new Div("div_sctrw03", "absolute", "15", "5054", null, "295", "1.83%", null, this);
            obj.set_taborder("36");
            ...
            obj = new Static("Static53", "absolute", "16", "5350", "803", "20", null, null, this);
            ...
            obj = new Div("div_sctrw16", "absolute", "15", "5371", null, "150", "1.83%", null, this);
            obj.set_taborder("37");
            ...
            obj = new Static("Static54", "absolute", "16", "5518", "803", "20", null, null, this);
            ...
            obj = new Div("div_sctrw15", "absolute", "15", "5538", null, "211", "1.83%", null, this);
            obj.set_taborder("38");
            ...
            obj = new Div("div_etcCtrw", "absolute", "15", "6371", null, "54", "1.83%", null, this);
            obj.set_taborder("39");
            obj.set_text("Div09");
            obj.style.set_background("transparent");
            obj.set_visible("false");
            ...
            obj = new Static("Static55", "absolute", "0", "25", null, "29", "86.04%", null, this.div_etcCtrw);
            obj.set_taborder("11");
            obj.set_text("기타 종류");
            obj.set_cssclass("sta_WF_Label");
            this.div_etcCtrw.addChild(obj.name, obj);
            obj = new Static("Static56", "absolute", "13.83%", "25", null, "29", "0", null, this.div_etcCtrw);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_Labelbg");
            this.div_etcCtrw.addChild(obj.name, obj);
            ...
            obj.set_visible("false");
            this.div_etcCtrw.addChild(obj.name, obj);
            obj = new CheckBox("chk_etcCtrw02", "absolute", "14.97%", "29", null, "21", "62.82%", null, this.div_etcCtrw);
            obj.set_taborder("14");
            ...
            obj = new Div("div_etcCtrw01", "absolute", "15", "6452", null, "220", "1.83%", null, this);
            obj.set_taborder("40");
            obj.set_text("협력사원 매장근무 요청서");
            obj.style.set_background("transparent");
            obj.set_visible("false");
            ...
            obj = new Static("Static57", "absolute", "16", "6672", "803", "20", null, null, this);
            ...
            obj = new Div("div_etcCtrw02", "absolute", "15", "6692", null, "149", "1.83%", null, this);
            obj.set_taborder("42");
            ...
            obj = new Div("div_space", "absolute", "15", "4400", "500", "0", null, null, this);
            ...
            obj = new Div("div_pmiw03", "absolute", "15", "3411", null, "245", "1.83%", null, this);
            obj.set_taborder("33");
            obj.set_text("대량거래수수료 약정서");
            obj.set_visible("false");
            obj.style.set_background("transparent");
            ...
            obj = new Div("div_ctrwModCntn", "absolute", "15", "6874", null, "139", "1.83%", null, this);
            obj.set_taborder("44");
            ...
            obj = new Static("Static69", "absolute", "16", "6839", "803", "20", null, null, this);
            ...
            obj = new Static("Static71", "absolute", "15", "3382", "803", "20", null, null, this);
            ...
            obj = new Div("div_pmiw04", "absolute", "15", "3683", null, "576", "1.83%", null, this);
            ...
            obj = new Div("div_sctrw07", "absolute", "15", "5764", null, "259", "1.83%", null, this);
            ...
            obj = new Static("Static59", "absolute", "16", "5740", "803", "20", null, null, this);
            ...
            obj = new Static("Static74", "absolute", "16", "6019", "803", "20", null, null, this);
            ...
            obj = new Div("div_sctrw08", "absolute", "15", "6044", null, "146", "1.83%", null, this);
            obj.set_taborder("206");
            obj.set_text("특약서(상품의 공급 등)");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static79", "absolute", "14", "6188", "803", "20", null, null, this);
            ...
            obj = new Div("div_sctrw09", "absolute", "15", "6207", null, "151", "0.61%", null, this);
            ...
            obj = new Static("Static89", "absolute", "15", "4276", "803", "20", null, null, this);
            ...
            obj = new Div("div_pmiw05", "absolute", "15", "4297", null, "90", "1.83%", null, this);
            ...
            obj = new Radio("rdo_ctrPrdAutXtnYn", "absolute", "117.6%", "639", null, "21", "-36.92%", null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sts_position1", "absolute", "830", "635", null, "29", "-17.24%", null, this);
            ...
            obj = new Static("Static91", "absolute", "15", "1054", "803", "20", null, null, this);
            ...
            obj = new Div("div_pmiw07", "absolute", "15", "2330", null, "280", "1.83%", null, this);
            ...
            obj = new Static("Static08", "absolute", "15", "876", "803", "20", null, null, this);
            ...
            obj = new Div("div_mnCtrwKd32", "absolute", "15", "899", null, "150", "1.83%", null, this);
            obj.set_taborder("292");
            obj.set_text("직매입계약서(농산)");
            obj.style.set_background("transparent");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div_mnCtrwKd90", "absolute", "15", "1079", null, "65", "1.83%", null, this);
            ...
            obj = new Div("div_addCtrw06", "absolute", "15", "2007", null, "203", "1.83%", null, this);
            ...
            obj = new Static("Static16", "absolute", "15", "2228", "803", "20", null, null, this);
            ...
            obj = new Layout("default", "", 818, 490, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("전자계약 신청화면(농산본부)");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_3114.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_DS_SC_3114.xfdl", "lib::comDate.xjs");
        this.registerScript("OMG_DS_SC_3114.xfdl", function(exports) {
        			...
        			if (cdm == param1 || fv_ctrwChgObjChk == 1) {
        				if (ctype == 'MN_CTRW_KD' && param2=='MN_CTRW_KD') {
        					...
        					if (ctype == 'ADD_CTRW_KDC' && param2=='ADD_CTRW_KDC') {
        						...
        						if (cdd== '206') {
        							this.div_addCtrw.chk_addCtrw06.set_enable(true); // 부가계약서로 변경됨
        						}
        ...
        this.chkinit = function(param){
        	if (param == 'ADD_CTRW_KDC') {
        		...
        		this.div_addCtrw.chk_addCtrw06.set_enable(false);
        ...
        this.unCHK = function(param)
        {
        	...
        	if (param == 'all') {
        		...
        		this.div_addCtrw.chk_addCtrw06.set_value(0);
        		...
        		this.div_addCtrw06.set_url("");
        		this.div_addCtrw06.set_visible(false);

        		this.fn_addCtrw01(param);
        //		this.fn_addCtrw03();
        		this.fn_addCtrw04(param);
        		this.fn_addCtrw05(param);
        		this.fn_addCtrw06(param);
        ...
        //		this.div_pmiw06.set_visible(false);
        		...
        		this.fn_pmiw01(param);
        		this.fn_pmiw02(param);
        		this.fn_pmiw03(param);
        		this.fn_pmiw04(param);
        		this.fn_pmiw05(param);
        ...
        {		
        	...
        	if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value != "193") {
        	...
        	if (this.fn_validationCheck()) {
        		if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value == "131") {
        			// 위수탁(농산) 계약서
        			sDataSet += " ds_ctEtcItemList=ds_ctEtcItemList";
        			this.ds_ctEtcItemList.copyData(this.div_mnCtrwKd31.ds_ctEtcItemList);
        			validationCheck = this.div_mnCtrwKd31.fn_validationCheck();
        		} else if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value == "132") {
        			// 직매입(농산) 계약서
        			sDataSet += " ds_ctEtcItemList=ds_ctEtcItemList";
        			this.ds_ctEtcItemList.copyData(this.div_mnCtrwKd32.ds_ctEtcItemList);
        			validationCheck = this.div_mnCtrwKd32.fn_validationCheck();
        		} else if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value == "193") {
        			// 부속계약서(농산)
        ...
        this.fn_validationCheck = function()
        {
        	...
        	if (this.chk_addCtrw.value == 1) {
        		if (this.div_addCtrw.chk_addCtrw01.value == "0" && this.div_addCtrw.chk_addCtrw04.value == "0" && this.div_addCtrw.chk_addCtrw05.value == "0" && this.div_addCtrw.chk_addCtrw06.value == "0") {
        ...
        /*
        	if (this.gfn_isNull(this.edt_laAgnt.value) && application.gv_userType == "02") {
        		this.edt_laAgnt.setFocus();
        		this.alert('사업장 정보 법률상 대리인을  입력 하세요.');
        		return false;
        	}
        	
        	if (this.gfn_isNull(this.edt_ctrChrrRepDtyNm.value)  && application.gv_userType == "02") {
        		this.edt_ctrChrrRepDtyNm.setFocus();
        		this.alert('사업장 정보 법률상 대리 직책명을 입력 하세요.');
        		return false;
        	}
        */
        	if (this.gfn_isNull(this.edt_laAgnt.value) && !this.gfn_isNull(this.edt_ctrChrrRepDtyNm.value)) {
        		this.edt_laAgnt.setFocus();
        		this.alert('사업장 정보 법률상 대리인직책명 입력시 대리인도 함께 작성해주세요.');
        		return false;
        	} else if (!this.gfn_isNull(this.edt_laAgnt.value) && this.gfn_isNull(this.edt_ctrChrrRepDtyNm.value)) {
        		this.edt_laAgnt.setFocus();
        	...
        	/*
        	// 직매입 계약서일 때 법인등록번호 입력
        	if (this.cbo_mnCtrwKdM.value == "32" && (this.gfn_isNull(this.mae_copNo.value) || this.mae_copNo.value.length < 13)) {
        ...
        this.fn_setBuyerCD = function()
        {
             if(application.gv_userType == "02"){
        		this.ds_buyerCode.filter("SIMP_C == '13'");
             ...
             if(application.gv_userType == "03"){
        		this.ds_buyerCode.filter("SIMP_C == '13'");
        		this.cbo_mnCtrwKdM2.set_index(0); // 직매장 기본세팅
             }
         }
        ...
        //		this.cal_ctrEdDt.set_value(toEndDay);
        		...
        		this.cal_ctrStDt.set_value('20210401');
        		this.cal_ctrEdDt.set_value('20220331');
        ...
        // 			this.edt_laAgnt.set_value("김 승 철");           //법률상 대리인
        ...
        // 			this.edt_laAgntDtyNm.set_value("");      //법률상 대리 직책명
        		...
        		// 법률상 대리인 기본값 설정(200129)
        		this.edt_laAgnt.set_value("김 문 기"); //법률상 대리인
        		this.edt_laAgntDtyNm.set_value("농축산물류본부장"); //법률상 대리 직책명
        ...
        // 		this.btn_preview.set_visible(true);
        		...
        		if (fv_ctrwChgObjChk == 0) {
        			this.div_mnCtrwKd.rdo_mnCtrwKdC.set_value("131") ;
        			this.div_mnCtrwKd31.set_url("OMG.CT::OMG_DS_SC_311302.xfdl");
        			this.div_mnCtrwKd31.set_visible(true);
        			this.cbo_mnCtrwKdM.set_value(1) ;
        ...
        // 			this.chk_etcCtrw.set_enable(true);
        			this.setAvailableSubEltCtrw("13");
        	...
        	//		alert(this.ds_eltCtrwDtl.getColumn(0,'MN_CTRW_KDC'));
        			...
        			if (this.ds_addEltCtrwDtl.rowcount > 0) {
        				for (var i = 0 ; i < this.ds_addEltCtrwDtl.rowcount; i++) {
        					...
        					if (this.ds_addEltCtrwDtl.getColumn(i, "ADD_CTRW_KDC") =="206") {
        						this.fn_addCtrwKd();
        						this.div_addCtrw.chk_addCtrw06.set_value(1);
        						this.fn_addCtrw06();
        					}
        				}
        			}
        ...
        {
        	var mainValue = this.cbo_mnCtrwKdM.value;	//메인계약서 선택
        ...
        // 		this.chk_etcCtrw.set_enable(true);
        		...
        		if (mainValue == "31") {
        			this.div_mnCtrwKd.rdo_mnCtrwKdC.set_value("131"); // 131	위수탁 거래계약서(농산)
        		} else if(mainValue == "32") {
        			this.div_mnCtrwKd.rdo_mnCtrwKdC.set_value("132"); // 132	직매입 거래계약서(농산)
        		} else if (mainValue == "93") {
        			this.div_mnCtrwKd.rdo_mnCtrwKdC.set_value("193"); // 193	부속계약서(농산)
        			// 부속계약서
        // 			this.mnCtrwKd_init();
        // 			this.unCHK('all');
        ...
        {
        	this.div_mnCtrwKd31.set_url("");
        	this.div_mnCtrwKd32.set_url("");
        	this.div_mnCtrwKd90.set_url("");

        	this.div_mnCtrwKd31.set_visible(false);
        	this.div_mnCtrwKd32.set_visible(false);
        ...
        this.fn_mnCtrwKd = function(){
        	...
        	if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value  == "131") {
        		this.div_mnCtrwKd31.set_url("OMG.CT::OMG_DS_SC_311302.xfdl"); // 위수탁 계약서
        		this.div_mnCtrwKd31.set_visible(true);
        		this.cbo_mnCtrwKdM.set_value("31");
        		if (fv_ctrwChgObjChk == 0) {
        			this.btn_preview.set_visible(true);
        		}
        	} else if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value  == "132") {
        		this.div_mnCtrwKd32.set_url("OMG.CT::OMG_DS_SC_311303.xfdl"); // 직매입 계약서
        		this.div_mnCtrwKd32.set_visible(true);
        		this.cbo_mnCtrwKdM.set_value("32");
        		if (fv_ctrwChgObjChk == 0) {
        			this.btn_preview.set_visible(true);
        		}
        	} else if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value  == "193") {
        		this.div_mnCtrwKd90.set_url("OMG.CT::OMG_DS_SC_311393.xfdl"); // 부속계약서(농산)
        		this.div_mnCtrwKd90.set_visible(true);
        		this.cbo_mnCtrwKdM.set_value("93");
        ...
        this.position_chk = function()
        {
        	...
        	if (this.gfn_isNull( this.div_mnCtrwKd.rdo_mnCtrwKdC.value)) {
        		this.div_mnCtrwKd31.set_top(mnCtrwKd);
        		mnCtrwKd = nexacro.toNumber(this.div_mnCtrwKd31.top)+nexacro.toNumber(this.div_mnCtrwKd31.height) + 20 ;
        	}

        	if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value == 131) {
        		this.div_mnCtrwKd31.set_top(mnCtrwKd);
        		this.div_mnCtrwKd31.set_height(795); // 높이설정
        		mnCtrwKd = nexacro.toNumber(this.div_mnCtrwKd31.top) + nexacro.toNumber(this.div_mnCtrwKd31.height) +20 ;
        	} else if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value == 132) {
        		this.div_mnCtrwKd32.set_top(mnCtrwKd);
        		this.div_mnCtrwKd32.set_height(780); // 높이설정
        		mnCtrwKd = nexacro.toNumber(this.div_mnCtrwKd32.top) + nexacro.toNumber(this.div_mnCtrwKd32.height) +20 ;
        	} else if (this.div_mnCtrwKd.rdo_mnCtrwKdC.value == 193) {
        		this.div_mnCtrwKd90.set_top(mnCtrwKd);
        		this.div_mnCtrwKd90.set_height(500); // 높이설정
        ...
        //자기상표부착상품(PB) 거래 계약서
        this.chk_addCtrw06_onchanged = function(obj,e)
        {
        	this.fn_addCtrw06();
        }

        this.fn_addCtrw06 = function(noChk)
        {
        	if (this.div_addCtrw.chk_addCtrw06.value == 1) {
        		this.div_addCtrw06.set_url("OMG.CT::OMG_DS_SC_311411.xfdl");
        		//this.div_addCtrw06.set_visible(true);
        	} else {
        		//dataset 삭제
        		var fv_position = 0;
        		fv_position = this.ds_addEltCtrwDtl.findRow("ADD_CTRW_KDC","206").toString(); //파일Row위치
        		this.ds_addEltCtrwDtl.deleteRow(fv_position);
        ...
        this.fn_sctrw01 = function(noChk)
        {
        ...
        {
        	var mainValue = this.cbo_mnCtrwKdM.value;
        ...
        this.position_add_chk = function()
        {
        	if (this.chk_addCtrw.value == 1) {
        		...
        		if (this.div_addCtrw.chk_addCtrw06.value == 1) {
        			this.div_addCtrw06.set_top(mnCtrwKd);
        			// 자기상표부착상품(PB) 거래 계약서 - 입력폼을 사용하지 않으므로 높이계산 제외
        			// mnCtrwKd = nexacro.toNumber(this.div_addCtrw06.top)+nexacro.toNumber(this.div_addCtrw06.height) + 20 ;
        		}
        	}
        ...
        this.position_div_etcCtrw = function()
        {
        	if (this.chk_etcCtrw.value == 1) {
        		...
        		if (this.div_etcCtrw.chk_etcCtrw02.value == 1) {
        			...
        			// 품질보증 협정서 - 입력폼을 사용하지 않으므로 높이계산 제외
        ...
        this.setAvailableSubEltCtrw = function(buyerCd,orgKdc)
        {
        	...
        	for (var i=0; i<this.ds_mnCtrwKdMC.rowcount; i++) {
        		if (this.ds_mnCtrwKdMC.getColumn(i, "CD_M") == buyerCd) {
        			// trace("CD_TYPE :" +this.ds_mnCtrwKdMC.getColumn(i, "CD_TYPE"));
        	...
        	if (mnCtrwKdc == '31') {
        		...
        		sub_sctrw = false;
        		sub_etc = false;
        	} else if (mnCtrwKdc == '32') {
        		allowSubElt = "206|502";
        		sub_pmiw = false;
        		sub_sctrw = false;
        	} else if (mnCtrwKdc == '93') {
        		allowSubElt = "";
        		sub_add = false;
        		sub_pmiw = false;
        		sub_sctrw = false;
        		...
        		allowSubElt = "201|204|205|206|301|302|303|305|306|307|401|415|416|501|502|503";
        	}
        ...
        {
        	for (var i = 0 ; i < this.ds_eltCtrwDtl.rowcount; i++) {
        		if (this.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "131") {
        			this.ds_eltCtrwDtl.setColumn(i, "ETC17", this.cal_ctrStDt.value); // [메인계약서] 계약 유효기간 시작일
        			this.div_mnCtrwKd31.edt_ETC17.set_value(this.cal_ctrStDt.value);
        		} else if (this.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "132") {
        			this.ds_eltCtrwDtl.setColumn(i, "ETC17", this.cal_ctrStDt.value); // [메인계약서] 계약 유효기간 시작일
        			this.div_mnCtrwKd32.edt_ETC17.set_value(this.cal_ctrStDt.value);
        		}
        	}
        }
        ...
        this.cal_ctrEdDt_onchanged = function(obj,e)
        {
        	for (var i = 0 ; i < this.ds_eltCtrwDtl.rowcount; i++) {
        		if (this.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "131") {
        			...
        			this.div_mnCtrwKd31.edt_ETC18.set_value(this.cal_ctrEdDt.value);
        		} else if (this.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "132") {
        			this.ds_eltCtrwDtl.setColumn(i, "ETC18", this.cal_ctrEdDt.value); // [메인계약서] 계약 유효기간 종료일
        			this.div_mnCtrwKd32.edt_ETC18.set_value(this.cal_ctrEdDt.value);
        		}
        	}
        }
        ...
        {
        	var oArg = {sts:"A", buyerCd:"13"}; // 완료(A), 농산(13)
        	var sOption = "autosize=true";
        	var sPopupCallBack = "fn_popupAfter";
        ...
        this.fn_setEndEltInfo = function()
        {
        	...
        	this.ds_register.setColumn(0, "MN_CTRW_KD", "93"); // 부속계약서(농산) - 93
        ...
        // 	this.ds_register.setColumn(0, "BUYER_EMAIL", this.ds_register_org.getColumn(0, "BUYER_EMAIL"));
        	...
        	this.ds_register.setColumn(0, "LA_AGNT_DTYNM", this.ds_register_org.getColumn(0, "LA_AGNT_DTYNM"));
        	...
        	this.setAvailableSubEltCtrw("13", this.ds_register_org.getColumn(0, "MN_CTRW_KD"));
        ...
        this.fn_compareCorp = function(strVal)
        {
        	...
        	if (chgInfoAlert == 1) {
        		if (!application.confirm("계약업체의 정보가 변경됐습니다. 변경정보로 자동입력됩니다.\n취소 시 작성중인 계약서가 초기화 됩니다.")) {
        			this.reload();
        		}
        	}
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_addCtrw.chk_addCtrw06.addEventHandler("onchanged", this.chk_addCtrw06_onchanged, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_3114.xfdl", true);
