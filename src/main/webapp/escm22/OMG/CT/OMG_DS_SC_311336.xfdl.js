    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("특약서(협력업체 기여도평가)");
                this.set_scrollbars("none");
                this._setFormPosition(0,0,788,140);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_etcEltStylAmm405", this);
            ...
            obj = new Dataset("ds_sctrwDtl05", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj = new Button("btn_sctrwDtl05", "absolute", "703", "0", "77", "21", null, null, this);
            ...
            obj = new Static("Static174", "absolute", "0", "27", null, "29", "86.04%", null, this);
            obj.set_taborder("721");
            obj.set_text("계약일자");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static175", "absolute", "13.96%", "27", null, "29", "0%", null, this);
            obj.set_taborder("722");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Calendar("vld_prd_st_dt", "absolute", "14.34%", "31", null, "21", "72.97%", null, this);
            this.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 788, 140, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("pattern_01");
            		p.set_titletext("특약서(협력업체 기여도평가)");
            ...
            obj = new BindItem("item0","vld_prd_st_dt","value","ds_sctrwDtl05","VLD_PRD_ST_DT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","txa_sctrSjt","value","ds_sctrwDtl05","SCTR_SJT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311336.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311336.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	for (var i = 0 ; i < this.parent.ds_etcEltStylAmm.rowcount; i++) {
        		if (this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "418") {
        			this.ds_etcEltStylAmm405.copyRow(0, this.parent.ds_etcEltStylAmm, i);
        		}
        	}
        	
        	for (var i = 0 ; i < this.parent.ds_sctrwDtl.rowcount; i++) {
        		if (this.parent.ds_sctrwDtl.getColumn(i, "SCTRW_KDC") =="418") {
        			fv_position = i;
        			fv_chk = 1 ;
        			this.ds_sctrwDtl05.addRow();
        			this.ds_sctrwDtl05.copyRow(0, this.parent.ds_sctrwDtl ,fv_position);
        		}
        	}
        	...
        	if (fv_chk == 0 ) {
        		...
        		fv_position = nRow;
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "SCTRW_KDC" , "418");
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "CHG_SQNO" ,this.parent.ds_register.getColumn(0 ,"CHG_SQNO"));
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "CTRW_STY_VER" , this.ds_etcEltStylAmm405.getColumn(0,"CTRW_STY_VER"));
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "VLD_PRD_ST_DT", this.parent.cal_ctrwDrup_Dt.value);
        ...
        this.OMG_DS_SC_311336_ontextchanged = function(obj,e)
        {
        	obj.updateToDataset();
        	this.parent.ds_sctrwDtl.setColumn(fv_position, "VLD_PRD_ST_DT" , this.vld_prd_st_dt.value); //계약일자
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.vld_prd_st_dt.addEventHandler("onchanged", this.OMG_DS_SC_311336_ontextchanged, this);
            this.vld_prd_st_dt.addEventHandler("ontextchanged", this.OMG_DS_SC_311334_ontextchanged, this);
            this.txa_sctrSjt.addEventHandler("ontextchange", this.txatext_changed, this);
            this.txa_sctrSjt.addEventHandler("onkillfocus", this.txatext_changed, this);

        };

        this.loadIncludeScript("OMG_DS_SC_311336.xfdl", true);
