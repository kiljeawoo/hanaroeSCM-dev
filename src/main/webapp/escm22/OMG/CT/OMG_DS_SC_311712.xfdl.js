    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311710");
                this.set_titletext("농협 수탁농기계 구매납품 계약서");
                this._setFormPosition(0,0,788,550);
            }
            ...
            obj = new Static("Static06", "absolute", "16.88%", "160", null, "29", "0.89%", null, this);
            ...
            obj = new Static("Static01", "absolute", "0", "137", "59.26%", "21", null, null, this);
            obj.set_taborder("170");
            obj.set_text("취급수수료");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static03", "absolute", "0%", "160", null, "29", "82.99%", null, this);
            obj.set_taborder("172");
            obj.set_text("수수료율");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC02", "absolute", "17.39%", "164", null, "21", "75.25%", null, this);
            obj.set_taborder("174");
            obj.set_mask("90.0");
            obj.set_limitbymask("both");
            this.addChild(obj.name, obj);

            obj = new Static("Static47", "absolute", "25.25%", "164", null, "21", "65.99%", null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 788, 550, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("pattern_01");
            		p.set_titletext("농협 수탁농기계 구매납품 계약서");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311712.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311712.xfdl", function(exports) {
        if (this.executeIncludeScript) { this.executeIncludeScript("lib::comLib.xjs", null, exports); }	//include "lib::comLib.xjs";

        var ELT_CODE = "172"; // 메인계약서코드
        ...
        {
            var strTitletext = "농협 수탁농기계(무인비행장치(드론 포함)) 구매납품 계약서";
        	...
        	if (this.ds_ctEtcItemList.getRowCount() > 0) {
        		for (var i=0; i<this.ds_ctEtcItemList.getRowCount(); i++) {
        			...
        			if (this.gfn_nullToEmpty(c1) == "" || this.gfn_nullToEmpty(c3) == "" || this.gfn_nullToEmpty(c5) == "" || this.gfn_nullToEmpty(c7) == "") {
        				alert("수탁농기계(무인비행장치(드론 포함)) 모델별 계약명세표에 입력되지 않은 행이 있습니다.\n해당 행을 입력하시거나 불필요한 경우 행삭제를 해주세요.");
        				return false;
        			}
        		}
        	} else {
        		alert("수탁농기계(무인비행장치(드론 포함)) 모델별 계약명세표를 입력해주세요");
        		return false;
        	}
        ...
        this.loadIncludeScript("OMG_DS_SC_311712.xfdl", true);
