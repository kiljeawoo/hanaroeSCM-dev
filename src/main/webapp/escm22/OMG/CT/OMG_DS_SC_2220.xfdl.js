    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("전자 계약개별변경대상조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"ISCHECKED\" type=\"STRING\" size=\"256\"/><Column id=\"ELT_CTRW_NO\" type=\"STRING\" size=\"256\"/><Column id=\"MN_CTRW_KD\" type=\"STRING\" size=\"256\"/><Column id=\"MN_CTRW_KD_NM\" type=\"STRING\" size=\"256\"/><Column id=\"NA_TRPL_C\" type=\"STRING\" size=\"256\"/><Column id=\"CHG_NM\" type=\"STRING\" size=\"256\"/><Column id=\"DCM_APD_CHK\" type=\"STRING\" size=\"256\"/><Column id=\"STYL_AMM_CHK\" type=\"STRING\" size=\"256\"/><Column id=\"BZNO\" type=\"STRING\" size=\"256\"/><Column id=\"CTR_ST_DT\" type=\"STRING\" size=\"256\"/><Column id=\"CTR_ED_DT\" type=\"STRING\" size=\"256\"/><Column id=\"CTRW_DRUP_DT\" type=\"STRING\" size=\"256\"/><Column id=\"CTR_DT\" type=\"STRING\" size=\"256\"/><Column id=\"BF_CTR_NO\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"169\"/><Column size=\"100\"/><Column size=\"191\"/><Column size=\"131\"/><Column size=\"90\"/><Column size=\"100\"/><Column size=\"120\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"계약서종류\"/><Cell col=\"2\" text=\"거래처코드\"/><Cell col=\"3\" text=\"계약자상호\"/><Cell col=\"4\" text=\"계약기간\"/><Cell col=\"5\" text=\"계약일자\"/><Cell col=\"6\" text=\"상태\"/><Cell col=\"7\" text=\"계약서 변경 사항\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:ISCHECKED\"/><Cell col=\"1\" displaytype=\"normal\" text=\"bind:MN_CTRW_KD_NM\" combodataset=\"ds_contstyle\" combocodecol=\"code\" combodatacol=\"style\"/><Cell col=\"2\" style=\"align:center;\" text=\"bind:NA_TRPL_C\"/><Cell col=\"3\" text=\"bind:MTALNM\"/><Cell col=\"4\" text=\"bind:CTR_DT\" mask=\"@@@@-@@-@@@@@@@-@@-@@\" calendardisplay=\"display\"/><Cell col=\"5\" text=\"bind:CTRW_DRUP_DT\" mask=\"@@@@-@@-@@\"/><Cell col=\"6\" text=\"bind:STS_NM\"/><Cell col=\"7\" text=\"bind:CHG_NM\"/></Band></Format></Formats>");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_2220.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_2220.xfdl", function(exports) {
        ...
        this.fn_excel = function(){
        	...
        	var toDay = this.gfn_today("yyyyMMdd");
        	var fileName = "계약서개별변경 대상조회"+toDay+".xls";//엑셀 파일 이름
        	...
        	//this.web_downExcel.set_url(application.gv_server_url+"rest/excel/downloadExcelCtrwChgIdvdList?"+param);
        	excelDownHandler(application.gv_server_url+"rest/excel/downloadExcelCtrwChgIdvdList?"+param, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_2220.xfdl", true);
