    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311705");
                this.set_titletext("하우스용 필름 구매 공급 계약서");
            ...
            obj.set_taborder("78");
            obj.set_text("[하우스용 필름 구매 공급 계약서]");
            ...
            obj = new Layout("default", "", 788, 130, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("하우스용 필름 구매 공급 계약서");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311705.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311705.xfdl", function(exports) {
        if (this.executeIncludeScript) { this.executeIncludeScript("lib::comLib.xjs", null, exports); }	//include "lib::comLib.xjs";

        var ELT_CODE = "165"; // 메인계약서코드
        ...
        {
            var strTitletext = "하우스용 필름 구매 공급 계약서";
        ...
        this.loadIncludeScript("OMG_DS_SC_311705.xfdl", true);
