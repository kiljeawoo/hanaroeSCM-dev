    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_211346");
                this.set_titletext("특약서(마진율) 축산");
            ...
            obj = new Dataset("ds_etcEltStylAmm412", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj = new Dataset("ds_sctrwDtl12", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"132\"/><Column size=\"135\"/><Column size=\"135\"/><Column size=\"135\"/><Column size=\"135\"/><Column size=\"130\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell><Cell displaytype=\"checkbox\" edittype=\"checkbox\"/></Cell><Cell col=\"1\"><Cell text=\"점포명\"/></Cell><Cell col=\"2\" text=\"정상마진율(%) 도매\"/><Cell col=\"3\" text=\"정상마진율(%) 소매\"/><Cell col=\"4\" text=\"행사마진율(%) 도매\"/><Cell col=\"5\" text=\"행사마진율(%) 소매\"/><Cell col=\"6\" text=\"비고\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:ISCHECKED\"/><Cell col=\"1\" displaytype=\"text\" edittype=\"text\" cssclass=\"Cellgrd_WF_AlignLeft\" text=\"bind:STORNM1\"/><Cell col=\"2\" displaytype=\"number\" edittype=\"mask\" text=\"bind:NML_MRGN_RT\" mask=\"##\"/><Cell col=\"3\" displaytype=\"number\" edittype=\"mask\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:NML_MRGN_RTM\" mask=\"##\"/><Cell col=\"4\" displaytype=\"number\" edittype=\"mask\" text=\"bind:EVT_MRGN_RT\" mask=\"##\"/><Cell col=\"5\" displaytype=\"number\" edittype=\"mask\" cssclass=\"Cellgrd_WF_AlignRight\" text=\"bind:EVT_MRGN_RTM\" mask=\"##\"/><Cell col=\"6\" displaytype=\"text\" edittype=\"text\" cssclass=\"Cellgrd_WF_AlignLeft\" text=\"bind:RMK\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","txa_sctrSjt","value","ds_sctrwDtl12","SCTR_SJT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_211346.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_211346.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
           ...
           for(var i = 0 ; i < this.parent.ds_etcEltStylAmm.rowcount; i++){		
        		...
        		if(this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "412"){

        			this.ds_etcEltStylAmm412.copyRow(0, this.parent.ds_etcEltStylAmm ,i);   	
        		}
        	}		

        	for(var i = 0 ; i < this.parent.ds_sctrwDtl.rowcount; i++){		

        		if(this.parent.ds_sctrwDtl.getColumn(i, "SCTRW_KDC") =="412"){
        		
        			fv_position = i;
        			fv_chk = 1 ;
        			this.ds_sctrwDtl12.addRow();
        			this.ds_sctrwDtl12.copyRow(0, this.parent.ds_sctrwDtl ,fv_position);   	
        	...
        	if (fv_chk == 0 ){
        		...
        		fv_position = nRow;
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "SCTRW_KDC" , "412") ;		
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "CHG_SQNO" ,this.parent.ds_register.getColumn(0 ,"CHG_SQNO" ) ) ;	
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "CTRW_STY_VER" , this.ds_etcEltStylAmm412.getColumn(0,"CTRW_STY_VER") ) ;		
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "VLD_PRD_ST_DT" , toDay) ;		
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "VLD_PRD_ED_DT" , chkDay ) ;		
        		this.ds_sctrwDtl12.addRow();
        		this.ds_sctrwDtl12.copyRow(0, this.parent.ds_sctrwDtl ,fv_position);   	
        ...
        // 			this.parent.ds_sctrwNmlMrgnRt.setColumn(fv_position, "SCTRW_KDC" , "412") ;
        			this.ds_sctrwNmlMrgnRt.copyData(this.parent.ds_sctrwNmlMrgnRt);   

        		}else{
        			this.ds_sctrwNmlMrgnRt.addRow();
        			this.ds_sctrwNmlMrgnRt.setColumn(0, "SCTRW_KDC" , "412") ;
        ...
        // 			this.parent.ds_sctrwCtrMrgnRt.setColumn(fv_position, "SCTRW_KDC" , "412") ;
        			this.ds_sctrwCtrMrgnRt.copyData(this.parent.ds_sctrwCtrMrgnRt);   
        		}else{
        			this.ds_sctrwCtrMrgnRt.addRow();
        			this.ds_sctrwCtrMrgnRt.setColumn(0, "SCTRW_KDC" , "412") ;
        ...
        // 	this.ds_sctrwCtrMrgnRt.setColumn(nRow, "SCTRW_KDC" , "412") ;
        ...
        // 	this.fn_sctrwCtrMrgnRt_update();
        	...
        	this.ds_sctrwNmlMrgnRt.setColumn(nRow, "SCTRW_KDC" , "412") ;
        ...
        this.loadIncludeScript("OMG_DS_SC_211346.xfdl", true);
