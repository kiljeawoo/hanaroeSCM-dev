    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("특약서(판매장려금 등) 수산");
                this.set_scrollbars("none");
                this._setFormPosition(0,0,788,142);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_etcEltStylAmm406", this);
            ...
            obj = new Dataset("ds_sctrwDtl06", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj = new Calendar("cal_vldPrdEdDt", "absolute", "64.21%", "31", null, "21", "23.1%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("2");
            obj.set_dateformat("yyyy-MM-dd");

            obj = new Static("Static60", "absolute", "37.94%", "32", "93", "21", null, null, this);
            obj.set_taborder("18");
            obj.set_text("% (부가세포함)");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_wrkSpyam", "absolute", "14.21%", "31", null, "21", "62.69%", null, this);
            obj.set_taborder("21");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 788, 142, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("pattern_01");
            		p.set_titletext("특약서(판매장려금 등) 수산");
            ...
            obj = new BindItem("item0","cal_vldPrdEdDt","value","ds_sctrwDtl06","VLD_PRD_ED_DT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item7","edt_wrkSpyam","value","ds_sctrwDtl06","WRS_SPYAM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","txa_sctrSjt","value","ds_sctrwDtl06","SCTR_SJT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_211335.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_211335.xfdl", function(exports) {
        ...
        this.OMG_DS_SC_211336_ontextchanged = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.cal_vldPrdEdDt.addEventHandler("ontextchanged", this.OMG_DS_SC_211336_ontextchanged, this);
            this.edt_wrkSpyam.addEventHandler("ontextchanged", this.OMG_DS_SC_211336_ontextchanged, this);
            this.txa_sctrSjt.addEventHandler("ontextchanged", this.txatext_changed, this);

        };

        this.loadIncludeScript("OMG_DS_SC_211335.xfdl", true);
