    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("임대차거래계약서(공통)");
            ...
            obj = new Static("Static08", "absolute", "16.88%", "310", null, "29", "0.89%", null, this);
            obj.set_taborder("121");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static44", "absolute", "16.88%", "366", null, "29", "0.89%", null, this);
            obj.set_taborder("65");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static45", "absolute", "15.74%", "103", null, "29", "0.89%", null, this);
            obj.set_taborder("104");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static04", "absolute", "0", "103", null, "29", "82.99%", null, this);
            obj.set_taborder("31");
            obj.set_text("임대차목적물의 표시");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static11", "absolute", "16.88%", "131", null, "29", "0.89%", null, this);
            obj.set_taborder("30");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static59", "absolute", "44.29%", "131", null, "29", "41.75%", null, this);
            obj.set_taborder("32");
            obj.set_text("공유면적");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC15", "absolute", "58.63%", "135", null, "21", "31.35%", null, this);
            obj.set_taborder("3");
            ...
            obj = new Static("Static75", "absolute", "0", "131", null, "29", "82.99%", null, this);
            obj.set_taborder("33");
            obj.set_text("점유면적");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static60", "absolute", "27.54%", "135", null, "21", "69.67%", null, this);
            obj.set_taborder("35");
            obj.set_text("㎡");
            this.addChild(obj.name, obj);

            obj = new Static("Static89", "absolute", "68.78%", "135", null, "21", "27.92%", null, this);
            obj.set_taborder("36");
            obj.set_text("㎡");
            this.addChild(obj.name, obj);

            obj = new Static("Static12", "absolute", "200", "48", "414", "27", null, null, this);
            obj.set_taborder("37");
            obj.set_text("27");
            ...
            obj = new Static("Static20", "absolute", "73.35%", "131", null, "29", "11.68%", null, this);
            obj.set_taborder("38");
            obj.set_text("계");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC16", "absolute", "88.71%", "135", null, "21", "3.3%", null, this);
            obj.set_taborder("39");
            obj.getSetter("inputtype").set("number");
            obj.style.set_align("right middle");
            obj.set_value("0");
            ...
            obj = new Static("Static00", "absolute", "97.08%", "134", null, "21", "0.51%", null, this);
            obj.set_taborder("40");
            obj.set_text("㎡");
            this.addChild(obj.name, obj);

            obj = new Static("Static21", "absolute", "16.75%", "158", null, "29", "0.89%", null, this);
            obj.set_taborder("41");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static22", "absolute", "0", "158", null, "29", "82.99%", null, this);
            obj.set_taborder("42");
            obj.set_text("임대차기간");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Calendar("edt_ETC17", "absolute", "17.39%", "162", null, "21", "70.43%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("43");
            ...
            obj = new Static("Static131", "absolute", "29.82%", "162", null, "21", "69.04%", null, this);
            obj.set_taborder("44");
            obj.set_text("~");
            this.addChild(obj.name, obj);

            obj = new Calendar("edt_ETC18", "absolute", "30.96%", "162", null, "21", "56.73%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("45");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_enable("false");
            ...
            obj = new Static("Static23", "absolute", "0", "186", null, "29", "82.99%", null, this);
            obj.set_taborder("46");
            obj.set_text("임대보증금");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static24", "absolute", "16.88%", "186", null, "29", "0.89%", null, this);
            obj.set_taborder("47");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static25", "absolute", "44.29%", "186", null, "29", "45.81%", null, this);
            obj.set_taborder("48");
            obj.set_text("월임대료");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC20", "absolute", "58.63%", "190", null, "21", "33.38%", null, this);
            obj.set_taborder("5");
            obj.getSetter("inputtype").set("number");
            obj.style.set_align("right middle");
            obj.set_mask("#,###,###,###");
            ...
            obj = new Static("Static27", "absolute", "95.56%", "189", null, "21", "1.9%", null, this);
            obj.set_taborder("49");
            obj.set_text("%");
            this.addChild(obj.name, obj);

            obj = new Static("Static29", "absolute", "31.6%", "190", null, "21", "62.44%", null, this);
            obj.set_taborder("50");
            obj.set_text("일정(\\)");
            this.addChild(obj.name, obj);

            obj = new Static("Static30", "absolute", "17.39%", "190", null, "21", "78.68%", null, this);
            obj.set_taborder("51");
            obj.set_text("일금");
            this.addChild(obj.name, obj);

            obj = new Static("Static26", "absolute", "55.08%", "190", null, "21", "40.99%", null, this);
            obj.set_taborder("52");
            obj.set_text("일금");
            this.addChild(obj.name, obj);

            obj = new Static("Static31", "absolute", "67.26%", "190", null, "21", "26.78%", null, this);
            obj.set_taborder("53");
            obj.set_text("일정(\\)");
            this.addChild(obj.name, obj);

            obj = new Static("Static32", "absolute", "16.88%", "214", null, "29", "0.89%", null, this);
            obj.set_taborder("29");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static33", "absolute", "44.29%", "214", null, "29", "45.81%", null, this);
            obj.set_taborder("54");
            obj.set_text("매장명");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static35", "absolute", "73.35%", "214", null, "29", "11.68%", null, this);
            obj.set_taborder("55");
            obj.set_text("주요판매상품");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static40", "absolute", "0", "214", null, "29", "82.99%", null, this);
            obj.set_taborder("56");
            obj.set_text("업종");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static34", "absolute", "16.88%", "282", null, "29", "0.89%", null, this);
            obj.set_taborder("57");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static36", "absolute", "44.67%", "282", null, "29", "34.26%", null, this);
            obj.set_taborder("58");
            obj.set_text("연체료비율");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static37", "absolute", "0%", "310", null, "29", "82.99%", null, this);
            obj.set_taborder("59");
            obj.set_text("임대보증금공제액");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static38", "absolute", "0%", "282", null, "29", "82.99%", null, this);
            obj.set_taborder("60");
            obj.set_text("보증금전액납부기일");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Calendar("edt_ETC29", "absolute", "17.39%", "286", null, "21", "70.43%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("10");
            obj.set_dateformat("yyyy-MM-dd");

            obj = new MaskEdit("edt_ETC31", "absolute", "17.39%", "314", null, "21", "76.65%", null, this);
            obj.set_taborder("12");
            obj.style.set_align("right middle");
            obj.set_mask("990");
            obj.set_limitbymask("both");
            ...
            obj = new Static("Static39", "absolute", "16.88%", "338", null, "29", "0.89%", null, this);
            obj.set_taborder("61");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static41", "absolute", "44.67%", "338", null, "29", "34.26%", null, this);
            obj.set_taborder("62");
            obj.set_text("월 임대료연체료율");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static42", "absolute", "0%", "366", null, "29", "82.99%", null, this);
            obj.set_taborder("63");
            obj.set_text("상품판매대금 지급일");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static43", "absolute", "0%", "338", null, "29", "82.99%", null, this);
            obj.set_taborder("64");
            obj.set_text("월 임대료 납부기일");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static49", "absolute", "75.25%", "342", null, "21", "22.84%", null, this);
            obj.set_taborder("66");
            obj.set_text("%");
            this.addChild(obj.name, obj);

            obj = new Static("Static50", "absolute", "66.75%", "370", null, "21", "29.31%", null, this);
            obj.set_taborder("67");
            obj.set_text("익월");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC35", "absolute", "70.81%", "370", null, "21", "23.86%", null, this);
            obj.set_taborder("16");
            obj.style.set_align("right middle");
            obj.set_mask("90");
            obj.set_limitbymask("both");
            ...
            obj = new Static("Static51", "absolute", "76.65%", "370", null, "21", "11.29%", null, this);
            obj.set_taborder("68");
            obj.set_text("일까지 납부");
            this.addChild(obj.name, obj);

            obj = new Static("Static52", "absolute", "16.88%", "422", null, "29", "0.89%", null, this);
            obj.set_taborder("69");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static53", "absolute", "0%", "422", null, "29", "82.99%", null, this);
            obj.set_taborder("70");
            obj.set_text("지연이자 비율");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static54", "absolute", "44.67%", "422", null, "29", "34.26%", null, this);
            obj.set_taborder("71");
            obj.set_text("계약해지 위약벌");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static55", "absolute", "17.77%", "426", null, "21", "80.33%", null, this);
            obj.set_taborder("72");
            obj.set_text("연");
            this.addChild(obj.name, obj);

            obj = new Static("Static56", "absolute", "25.63%", "426", null, "21", "72.46%", null, this);
            obj.set_taborder("73");
            obj.set_text("%");
            this.addChild(obj.name, obj);

            obj = new Static("Static58", "absolute", "17.77%", "369", null, "21", "67.26%", null, this);
            obj.set_taborder("74");
            obj.set_text("판매마감일로부터");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC34", "absolute", "32.23%", "369", null, "21", "63.2%", null, this);
            obj.set_taborder("15");
            obj.style.set_align("right middle");
            obj.set_mask("990");
            obj.set_limitbymask("both");
            ...
            obj = new Static("Static01", "absolute", "72.72%", "426", null, "21", "3.05%", null, this);
            obj.set_taborder("75");
            obj.set_text("개월분의 임대료를 위약벌로 지급");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "200", "495", "414", "27", null, null, this);
            obj.set_taborder("76");
            obj.set_text("27");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            ...
            obj = new Static("Static03", "absolute", "0", "497", "59.26%", "21", null, null, this);
            obj.set_taborder("77");
            ...
            obj = new Static("Static05", "absolute", "16.88%", "516", null, "29", "0.89%", null, this);
            obj.set_taborder("79");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static16", "absolute", "0", "516", null, "29", "82.99%", null, this);
            obj.set_taborder("80");
            obj.set_text("판매장소");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static17", "absolute", "0", "466", "59.26%", "21", null, null, this);
            obj.set_taborder("81");
            obj.set_text("[별지 1]");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("left middle");
            ...
            obj = new Edit("edt_ETC40", "absolute", "17.39%", "520", null, "21", "16.24%", null, this);
            obj.set_taborder("21");
            ...
            obj = new Static("Static06", "absolute", "16.75%", "544", null, "29", "0.89%", null, this);
            obj.set_taborder("82");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static09", "absolute", "0", "544", null, "29", "82.99%", null, this);
            obj.set_taborder("83");
            obj.set_text("판매기간");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static10", "absolute", "0", "587", "59.26%", "21", null, null, this);
            obj.set_taborder("84");
            obj.set_text("판매상품 내역");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static14", "absolute", "200", "911", "414", "27", null, null, this);
            obj.set_taborder("85");
            obj.set_text("27");
            obj.set_visible("false");
            obj.style.set_background("#dc143c5b");
            ...
            obj = new Static("Static28", "absolute", "74.24%", "190", null, "21", "12.56%", null, this);
            obj.set_taborder("98");
            obj.set_text("또는 월 매출액의");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC24", "absolute", "88.71%", "218", null, "21", "3.3%", null, this);
            obj.set_taborder("9");
            obj.style.set_align("left middle");
            obj.set_maxlength("190");
            obj.set_lengthunit("ascii");
            ...
            obj = new Static("Static67", "absolute", "0", "255", "59.26%", "21", null, null, this);
            obj.set_taborder("99");
            obj.set_text("임대보증금");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static74", "absolute", "16.88%", "394", null, "29", "0.89%", null, this);
            obj.set_taborder("100");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static77", "absolute", "0%", "394", null, "29", "82.99%", null, this);
            obj.set_taborder("101");
            obj.set_text("비밀유지 의무기간");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC37", "absolute", "76.9%", "398", null, "21", "17.89%", null, this);
            obj.set_taborder("18");
            obj.set_mask("990.0");
            obj.set_limitbymask("both");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC39", "absolute", "66.75%", "426", null, "21", "28.3%", null, this);
            obj.set_taborder("20");
            obj.getSetter("inputtype").set("number");
            ...
            obj = new Button("btu_zip", "absolute", "32.11%", "79", null, "21", "65.36%", null, this);
            obj.set_taborder("102");
            obj.set_cssclass("btn_WF_Searchbtn");
            this.addChild(obj.name, obj);

            obj = new Static("Static98", "absolute", "23.48%", "79", null, "21", "75.38%", null, this);
            obj.set_taborder("103");
            obj.set_text("-");
            this.addChild(obj.name, obj);

            obj = new Static("Static79", "absolute", "15.74%", "75", null, "29", "0.89%", null, this);
            obj.set_taborder("105");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static80", "absolute", "0", "75", null, "29", "82.99%", null, this);
            obj.set_taborder("106");
            obj.set_text("우편번호");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Button("btn_zip00", "absolute", "33.38%", "79", null, "21", "64.09%", null, this);
            obj.set_taborder("0");
            obj.set_cssclass("btn_WF_Searchbtn");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC13", "absolute", "44.67%", "107", null, "21", "4.19%", null, this);
            obj.set_taborder("1");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("190");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC22", "absolute", "17.39%", "218", null, "21", "57.61%", null, this);
            obj.set_taborder("7");
            obj.style.set_align("left middle");
            obj.set_maxlength("190");
            obj.set_lengthunit("ascii");
            ...
            obj = new Edit("edt_ETC23", "absolute", "54.57%", "218", null, "21", "27.54%", null, this);
            obj.set_taborder("8");
            obj.style.set_align("left middle");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("190");
            ...
            obj = new MaskEdit("edt_ETC36", "absolute", "32.36%", "398", null, "21", "63.07%", null, this);
            obj.set_taborder("17");
            obj.style.set_align("right middle");
            obj.set_mask("90");
            obj.set_limitbymask("both");
            ...
            obj = new Static("Static48", "absolute", "17.77%", "397", null, "21", "67.26%", null, this);
            obj.set_taborder("107");
            obj.set_text("거래가 종료된 이후");
            this.addChild(obj.name, obj);

            obj = new Static("Static78", "absolute", "37.56%", "399", null, "21", "58.63%", null, this);
            ...
            obj = new Edit("edt_ETC41", "absolute", "17.39%", "547", null, "21", "62.44%", null, this);
            obj.set_taborder("22");
            obj.set_maxlength("190");
            obj.set_lengthunit("ascii");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC14", "absolute", "17.39%", "135", null, "21", "72.59%", null, this);
            obj.set_taborder("2");
            obj.getSetter("inputtype").set("number");
            obj.style.set_align("right middle");
            obj.set_value("0");
            ...
            obj = new MaskEdit("edt_ETC19", "absolute", "21.19%", "190", null, "21", "68.78%", null, this);
            obj.set_taborder("4");
            obj.getSetter("inputtype").set("number");
            obj.style.set_align("right middle");
            obj.set_mask("#,###,###,###");
            ...
            obj = new Static("Static07", "absolute", "37.56%", "370", null, "21", "57.36%", null, this);
            obj.set_taborder("110");
            obj.set_text("일 이내");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00", "absolute", "0%", "611", null, "249", "0.89%", null, this);
            ...
            obj = new Button("btn_addRow", "absolute", "91.5%", "586", null, "21", "0.89%", null, this);
            obj.set_taborder("24");
            obj.set_text("행추가");
            this.addChild(obj.name, obj);

            obj = new Static("Static13", "absolute", "44.67%", "366", null, "29", "34.26%", null, this);
            obj.set_taborder("112");
            obj.set_text("관리비 및 시설 이용료 납부");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static18", "absolute", "44.67%", "394", null, "29", "34.26%", null, this);
            obj.set_taborder("113");
            obj.set_text("위약벌 비율");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC10", "absolute", "17.39%", "79", null, "21", "75%", null, this);
            ...
            obj = new Edit("edt_ETC11", "absolute", "25.51%", "79", null, "21", "66.88%", null, this);
            ...
            obj = new Edit("edt_ETC12", "absolute", "17.39%", "107", null, "21", "55.71%", null, this);
            ...
            obj = new MaskEdit("edt_ETC21", "absolute", "88.83%", "189", null, "21", "5.96%", null, this);
            obj.set_taborder("6");
            obj.set_mask("990.0");
            obj.set_limitbymask("both");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC30", "absolute", "69.04%", "287", null, "21", "25.76%", null, this);
            obj.set_taborder("11");
            obj.set_mask("990.0");
            obj.set_limitbymask("both");
            this.addChild(obj.name, obj);

            obj = new Static("Static47", "absolute", "75.25%", "287", null, "21", "22.84%", null, this);
            obj.set_taborder("117");
            obj.set_text("%");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC33", "absolute", "69.04%", "342", null, "21", "25.76%", null, this);
            obj.set_taborder("14");
            obj.set_mask("990.0");
            obj.set_limitbymask("both");
            this.addChild(obj.name, obj);

            obj = new Static("Static57", "absolute", "83.76%", "398", null, "21", "14.34%", null, this);
            obj.set_taborder("118");
            obj.set_text("%");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC38", "absolute", "19.92%", "426", null, "21", "74.87%", null, this);
            obj.set_taborder("19");
            obj.set_mask("990.0");
            obj.set_limitbymask("both");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static46", "absolute", "23.98%", "314", null, "21", "56.85%", null, this);
            obj.set_taborder("122");
            obj.set_text("개월분의 관리비 상당액");
            this.addChild(obj.name, obj);

            obj = new Static("Static68", "absolute", "17.64%", "342", null, "21", "78.43%", null, this);
            obj.set_taborder("123");
            obj.set_text("익월");
            this.addChild(obj.name, obj);

            obj = new Static("Static81", "absolute", "28.17%", "342", null, "21", "59.77%", null, this);
            obj.set_taborder("124");
            obj.set_text("일까지 납부");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC32", "absolute", "21.7%", "342", null, "21", "72.46%", null, this);
            obj.set_taborder("13");
            obj.style.set_align("right middle");
            obj.set_mask("90");
            obj.set_limitbymask("both");
            ...
            obj = new Static("Static82", "absolute", "66.75%", "398", null, "21", "23.1%", null, this);
            obj.set_taborder("125");
            obj.set_text("임대보증금의 ");
            this.addChild(obj.name, obj);

            obj = new Static("Static83", "absolute", "66.75%", "287", null, "21", "31.35%", null, this);
            obj.set_taborder("126");
            obj.set_text("연");
            this.addChild(obj.name, obj);

            obj = new Static("Static84", "absolute", "66.75%", "342", null, "21", "31.35%", null, this);
            obj.set_taborder("127");
            obj.set_text("연");
            this.addChild(obj.name, obj);

            obj = new Button("btn_delRow", "absolute", "83.12%", "586", null, "21", "9.26%", null, this);
            obj.set_taborder("128");
            obj.set_text("행삭제");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC42", "absolute", "13.96%", "586", null, "21", "36.8%", null, this);
            obj.set_taborder("23");
            obj.set_maxlength("190");
            obj.set_lengthunit("ascii");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static87", "absolute", "36.8%", "342", null, "21", "50.63%", null, this);
            obj.set_taborder("130");
            obj.set_text("99 = '말'로 표시");
            obj.style.set_color("blue");
            this.addChild(obj.name, obj);

            obj = new Static("Static88", "absolute", "85.28%", "370", null, "21", "2.16%", null, this);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311301.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311301.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	for (var i = 0 ; i < this.parent.ds_etcEltStylAmm.rowcount; i++) {
        		if (this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "121") {
        	...
        	for (var i = 0; i < this.parent.ds_eltCtrwDtl.rowcount; i++) {
        		if (this.parent.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "121") {
        			fv_chk = 1 ;
        	...
        	if (fv_chk == 0) {
        		...
        		this.parent.ds_eltCtrwDtl.setColumn(fv_position, "CTRW_STY_VER", this.ds_etcEltStylAmm101.getColumn(0, "CTRW_STY_VER"));
        		this.parent.ds_eltCtrwDtl.setColumn(fv_position, "MN_CTRW_KDC", "121");
        		this.parent.ds_eltCtrwDtl.setColumn(fv_position, "CHG_SQNO" , this.parent.ds_register.getColumn(0 ,"CHG_SQNO"));
        		this.parent.ds_eltCtrwDtl.setColumn(fv_position, "ETC17", this.parent.cal_ctrStDt.value) ; // 임대차기간 시작일
        		this.parent.ds_eltCtrwDtl.setColumn(fv_position, "ETC18", this.parent.cal_ctrEdDt.value) ; // 임대차기간 종료일
        ...
        this.loadIncludeScript("OMG_DS_SC_311301.xfdl", true);
