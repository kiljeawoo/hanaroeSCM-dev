    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311711");
                this.set_titletext("농협 건설기계(자동차 포함) 구매납품 계약서");
            ...
            obj.set_taborder("78");
            obj.set_text("[농협 건설기계(자동차 포함) 구매납품 계약서]");
            ...
            obj.set_taborder("81");
            obj.set_text("[첨부 1] 건설기계(자동차 포함) 모델별 계약명세표");
            obj.set_cssclass("sta_WF_Subtitle");
            obj.style.set_background("left middle");
            obj.style.set_padding("0 0 1 5");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 788, 550, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("농협 건설기계(자동차 포함) 구매납품 계약서");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311711.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311711.xfdl", function(exports) {
        ...
        this.loadIncludeScript("OMG_DS_SC_311711.xfdl", true);
