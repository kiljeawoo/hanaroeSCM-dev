(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_211334.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_211334.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	if (fv_chk == 0) {
        		...
        		fv_position = nRow;
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "SCTRW_KDC", "405");
        ...
        this.loadIncludeScript("OMG_DS_SC_211334.xfdl", true);
