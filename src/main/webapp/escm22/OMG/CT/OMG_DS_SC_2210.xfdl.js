(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Radio("rdo_DT_YN", "absolute", "871", "85", "11.68%", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_2210.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_2210.xfdl", function(exports) {
        ...
        this.loadIncludeScript("OMG_DS_SC_2210.xfdl", true);
