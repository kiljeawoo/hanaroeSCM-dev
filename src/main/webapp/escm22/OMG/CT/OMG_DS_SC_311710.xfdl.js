(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("78");
            obj.set_text("[농협 수탁농기계 구매납품 계약서]");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311710.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311710.xfdl", function(exports) {
        if (this.executeIncludeScript) { this.executeIncludeScript("lib::comLib.xjs", null, exports); }	//include "lib::comLib.xjs";

        var ELT_CODE = "170"; // 메인계약서코드
        ...
        {
            var strTitletext = "농협 수탁농기계 구매납품 계약서";
        ...
        this.loadIncludeScript("OMG_DS_SC_311710.xfdl", true);
