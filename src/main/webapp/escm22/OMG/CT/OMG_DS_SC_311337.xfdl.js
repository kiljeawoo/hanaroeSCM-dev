    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311333");
                this.set_titletext("특약서(매장의 철수 등)_테넌트");
            ...
            obj = new Dataset("ds_etcEltStylAmm404", this);
            ...
            obj = new Dataset("ds_sctrwDtl04", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj = new Layout("default", "", 788, 115, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("특약서(매장의 철수 등)_테넌트");
            ...
            obj = new BindItem("item4","txa_sctrSjt","value","ds_sctrwDtl04","SCTR_SJT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311337.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311337.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	if (fv_chk == 0) {
        		...
        		fv_position = nRow;
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "SCTRW_KDC", "419");
        ...
        this.loadIncludeScript("OMG_DS_SC_311337.xfdl", true);
