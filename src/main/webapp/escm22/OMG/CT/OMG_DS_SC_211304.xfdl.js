    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_211304");
            ...
            obj = new Dataset("ds_etcEltStylAmm104", this);
            ...
            obj = new Dataset("ds_eltCtrwDtl04", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj = new Static("Static92", "absolute", "85.53%", "31", null, "21", "12.06%", null, this);
            ...
            obj = new Static("Static90", "absolute", "0", "55", null, "29", "86.04%", null, this);
            ...
            obj = new TextArea("txa_sctrSjt", "absolute", "14.21%", "87", null, "72", "0.76%", null, this);
            obj.set_taborder("6");
            ...
            obj = new BindItem("item1","edt_psgMm","value","ds_eltCtrwDtl04","PSG_MM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item6","txa_sctrSjt","value","ds_eltCtrwDtl04","SCTR_SJT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item7","edt_cnrDt","value","ds_eltCtrwDtl04","CNR_DT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","mae_blmGr","value","ds_eltCtrwDtl04","RT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item0","mae_rt","value","ds_eltCtrwDtl04","BLM_GRMY");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_211304.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_211304.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
           ...
           for(var i = 0 ; i < this.parent.ds_etcEltStylAmm.rowcount; i++){		
        		...
        		if(this.parent.ds_etcEltStylAmm.getColumn(i, "CTRW_KDC") == "104"){

        			this.ds_etcEltStylAmm104.copyRow(0, this.parent.ds_etcEltStylAmm ,i);   	
        		}
        	}	
           ...
           for(var i = 0 ; i < this.parent.ds_eltCtrwDtl.rowcount; i++){		
        		...
        		if(this.parent.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "104"){
        			...
        			this.parent.ds_eltCtrwDtl.setColumn(i, "ETR_FEE" , " ") ;           //수탁 수수료
        ...
        //			this.parent.ds_eltCtrwDtl.setColumn(i, "RT" , " ") ;  //마진율
        			...
        			if(this.parent.ds_eltCtrwDtl.getColumn(i, "CTRW_STY_VER") == "" ){
        				this.parent.ds_eltCtrwDtl.setColumn(fv_position, "CTRW_STY_VER" , this.ds_etcEltStylAmm104.getColumn(0,"CTRW_STY_VER") ) ;		

        			}

        			//this.parent.ds_eltCtrwDtl.setColumn(fv_position, "CTRW_STY_VER" , this.ds_etcEltStylAmm102.getColumn(0,"CTRW_STY_VER") ) ;
        			this.ds_eltCtrwDtl04.addRow();
        			this.ds_eltCtrwDtl04.copyRow(0, this.parent.ds_eltCtrwDtl ,fv_position);   	

        			var edt_psgDd = this.ds_eltCtrwDtl04.getColumn(0,"PSG_DD") ;
        	...
        	if (fv_chk == 0 ){
        		...
        		fv_position = nRow;
        		this.parent.ds_eltCtrwDtl.setColumn(fv_position, "MN_CTRW_KDC" , "104") ;		
        ...
        this.OMG_DS_SC_211304_ontextchanged = function(obj,e)
        {
        ...
        var psgDd = "";
        	...
        	/**
        	if(( this.gfn_isNull(this.edt_psgDd.value) == false )  && (this.gfn_isNull(this.edt_psgDd00.value) == false) && (this.gfn_isNull(this.edt_psgDd01.value) == false) ){
        		 psgDd = this.edt_psgDd.value  + "|" + this.edt_psgDd00.value + "|" + this.edt_psgDd01.value;             //경과분/일
        	...
        	}else if(this.gfn_isNull(this.edt_psgDd01.value) == false) {
        		psgDd = this.edt_psgDd01.value ;             //경과분/일
        	}
        	**/
        	...
        	this.ds_eltCtrwDtl04.setColumn(0,"PSG_DD" , val) ;                              //경과분/월 
        ...
        this.fn_validationCheck = function(){
        	...
        	if(this.gfn_isNull(this.edt_psgDd.value) ==true   &&  this.gfn_isNull(this.edt_psgDd00.value) ==true){
        		...
        		if(this.edt_psgDd.value == "말" ||  this.edt_psgDd00.value == "말" ||  this.edt_psgDd01.value == "말" || this.edt_psgDd.value == "초" ||  this.edt_psgDd00.value == "초" ||  this.edt_psgDd01.value == "초" ){
        				...
        				if(this.gfn_isNum(this.edt_psgMm.value) == false){
        					this.edt_psgDd.setFocus();	
        ...
        this.Button00_onclick = function(obj,e)
        {
        	...
        	trace(this.ds_eltCtrwDtl04.saveXML()) ;
        	trace(this.parent.ds_eltCtrwDtl.saveXML()) ;
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.edt_psgMm.addEventHandler("ontextchanged", this.OMG_DS_SC_211304_ontextchanged, this);
            this.edt_psgDd.addEventHandler("ontextchanged", this.OMG_DS_SC_211304_ontextchanged, this);
            ...
            this.edt_cnrDt.addEventHandler("ontextchanged", this.OMG_DS_SC_211304_ontextchanged, this);
            this.mae_blmGr.addEventHandler("ontextchanged", this.OMG_DS_SC_211304_ontextchanged, this);
            this.mae_rt.addEventHandler("ontextchanged", this.OMG_DS_SC_211304_ontextchanged, this);
            this.edt_psgDd00.addEventHandler("ontextchanged", this.OMG_DS_SC_211304_ontextchanged, this);
            this.edt_psgDd01.addEventHandler("ontextchanged", this.OMG_DS_SC_211304_ontextchanged, this);

        };

        this.loadIncludeScript("OMG_DS_SC_211304.xfdl", true);
