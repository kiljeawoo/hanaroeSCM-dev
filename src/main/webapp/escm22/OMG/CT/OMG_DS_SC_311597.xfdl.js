    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311597");
                this.set_titletext("부속계약서(테넌트_단기 임대차)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"GBN\" type=\"STRING\" size=\"256\"/><Column id=\"CONTENT\" type=\"STRING\" size=\"256\"/><Column id=\"ISCHECKED\" type=\"STRING\" size=\"1\"/><Column id=\"ETC\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"GBN\">매장의 추가입점</Col><Col id=\"CONTENT\">본 계약에 근거하여 他매장 입점</Col><Col id=\"ISCHECKED\">0</Col></Row><Row><Col id=\"GBN\">매장도면</Col><Col id=\"CONTENT\">매장추가입점에 따른 도면첨부</Col><Col id=\"ISCHECKED\">0</Col></Row><Row><Col id=\"GBN\">대표자 변경</Col><Col id=\"CONTENT\">대표이사 등 대표자변경</Col><Col id=\"ISCHECKED\">0</Col></Row><Row><Col id=\"GBN\">계약기간의 연장</Col><Col id=\"CONTENT\">계약기간 연장과 관련한 건</Col><Col id=\"ETC\">재계약 등</Col><Col id=\"ISCHECKED\">0</Col></Row><Row><Col id=\"GBN\">추가임시임대료(율)</Col><Col id=\"CONTENT\">본 계약상 체결된 임대료(율) 外 행사 등으로 인한 임시 임대료(율)책정</Col><Col id=\"ISCHECKED\">0</Col></Row><Row><Col id=\"GBN\">임시임대료(율) 적용기간</Col><Col id=\"CONTENT\">임시 임대료(율)를 적용받는 기간</Col><Col id=\"ISCHECKED\">0</Col></Row><Row><Col id=\"GBN\">기  타</Col><Col id=\"CONTENT\">기타 부속합의가 필요한 사안</Col><Col id=\"ETC\">자율기재</Col><Col id=\"ISCHECKED\">0</Col></Row></Rows>");
            ...
            obj = new Static("Static18", "absolute", "15.74%", "231", null, "29", "0.89%", null, this);
            obj.set_taborder("48");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static79", "absolute", "15.74%", "599", null, "29", "0.89%", null, this);
            obj.set_taborder("25");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static03", "absolute", "15.74%", "627", null, "29", "0.89%", null, this);
            obj.set_taborder("28");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static05", "absolute", "15.74%", "683", null, "29", "0.89%", null, this);
            obj.set_taborder("30");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static08", "absolute", "15.74%", "739", null, "29", "0.89%", null, this);
            obj.set_taborder("33");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static09", "absolute", "15.74%", "711", null, "29", "0.89%", null, this);
            obj.set_taborder("34");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static00", "absolute", "0", "282", "59.26%", "21", null, null, this);
            obj.set_taborder("18");
            obj.set_text("부속계약서 추가내용 (최소 1개)");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static72", "absolute", "16.88%", "655", null, "29", "0.89%", null, this);
            obj.set_taborder("19");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static73", "absolute", "0", "655", null, "29", "80.96%", null, this);
            obj.set_taborder("20");
            obj.set_text("매장도면");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static65", "absolute", "16.88%", "767", null, "106", "0.89%", null, this);
            obj.set_taborder("21");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);

            obj = new Static("Static66", "absolute", "0%", "767", null, "106", "80.96%", null, this);
            obj.set_taborder("22");
            obj.set_text("특약사항");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new FileUpload("FileUpload", "absolute", "19.67%", "659", null, "24", "159", null, this);
            obj.set_taborder("6");
            ...
            obj = new TextArea("edt_ETC52", "absolute", "19.67%", "772", null, "95", "4.19%", null, this);
            obj.set_taborder("15");
            ...
            obj = new Button("btn_delPlan", "absolute", "81.22%", "659", null, "21", "11.17%", null, this);
            obj.set_taborder("7");
            obj.set_text("변경");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static01", "absolute", "0", "572", "59.26%", "21", null, null, this);
            obj.set_taborder("23");
            obj.set_text("부속계약서 약정내용");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ETC16", "absolute", "28.17%", "715", null, "21", "4.19%", null, this);
            obj.set_taborder("11");
            obj.set_lengthunit("ascii");
            ...
            obj = new Grid("grd_add", "absolute", "0", "310", null, "252", "0.89%", null, this);
            obj.set_taborder("2");
            obj.set_binddataset("ds_add");
            obj.set_autofittype("col");
            obj.style.set_border("0 solid #808080");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"1\"/><Column size=\"158\"/><Column size=\"373\"/><Column size=\"80\"/><Column size=\"144\"/></Columns><Rows><Row size=\"28\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell/><Cell col=\"1\" style=\"background:#f2f8faff;\" text=\"구  분\"/><Cell col=\"2\" style=\"background:#f2f8faff;\" text=\"관련내용\"/><Cell col=\"3\" style=\"background:#f2f8faff;\" text=\"선택여부\" autosizecol=\"none\"/><Cell col=\"4\" style=\"background:#f2f8faff;\" text=\"기  타\" autosizecol=\"none\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\" style=\"line:1 solid #ccd3d5ff ;background:#ffffffff;background2:#ffffffff;selectbackground:#ffffffff;selectline:1 solid #ccd3d5ff ;\" text=\"bind:GBN\"/><Cell col=\"2\" style=\"line:1 solid #ccd3d5ff ;background:#ffffffff;background2:#ffffffff;selectbackground:#ffffffff;selectline:1 solid #ccd3d5ff ;\" text=\"bind:CONTENT\"/><Cell col=\"3\" displaytype=\"checkbox\" style=\"line:1 solid #ccd3d5ff ;background:#ffffffff;background2:#ffffffff;selectbackground:#ffffffff;selectline:1 solid #ccd3d5ff ;\" text=\"bind:ISCHECKED\"/><Cell col=\"4\" style=\"line:1 solid #ccd3d5ff ;background:#ffffffff;background2:#ffffffff;selectbackground:#ffffffff;selectline:1 solid #ccd3d5ff ;\" text=\"bind:ETC\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Calendar("edt_ETC10", "absolute", "69.67%", "603", null, "21", "18.15%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("3");
            obj.set_dateformat("yyyy-MM-dd");

            obj = new Static("Static131", "absolute", "82.23%", "603", null, "21", "16.62%", null, this);
            obj.set_taborder("26");
            obj.set_text("~");
            this.addChild(obj.name, obj);

            obj = new Calendar("edt_ETC11", "absolute", "83.5%", "603", null, "21", "4.19%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("4");
            obj.set_dateformat("yyyy-MM-dd");

            obj = new Static("Static06", "absolute", "0", "711", null, "29", "72.46%", null, this);
            obj.set_taborder("31");
            obj.set_text("계약담당자 혹은 계약상대자의 변경");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static07", "absolute", "0", "739", null, "29", "80.96%", null, this);
            obj.set_taborder("32");
            obj.set_text("임대료(율)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static80", "absolute", "0", "599", null, "29", "80.96%", null, this);
            obj.set_taborder("24");
            obj.set_text("약정기간");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "0", "627", null, "29", "80.96%", null, this);
            obj.set_taborder("27");
            obj.set_text("목적물의 주소");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static04", "absolute", "0", "683", null, "29", "80.96%", null, this);
            obj.set_taborder("29");
            obj.set_text("매장면적(전용)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static10", "absolute", "50%", "599", null, "29", "30.96%", null, this);
            obj.set_taborder("35");
            obj.set_text("임시임대료(율) 적용기간");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Calendar("edt_stdt", "absolute", "19.67%", "603", null, "21", "68.15%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("36");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_enable("false");

            obj = new Static("Static11", "absolute", "32.23%", "603", null, "21", "66.62%", null, this);
            obj.set_taborder("37");
            obj.set_text("~");
            this.addChild(obj.name, obj);

            obj = new Calendar("edt_eddt", "absolute", "33.5%", "603", null, "21", "54.19%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("38");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_enable("false");

            obj = new Edit("edt_ETC12", "absolute", "19.67%", "631", null, "21", "4.19%", null, this);
            obj.set_taborder("5");
            obj.set_lengthunit("ascii");
            obj.set_maxlength("190");
            obj.style.set_align("left middle");
            ...
            obj = new MaskEdit("edt_ETC13", "absolute", "19.67%", "687", null, "21", "70.3%", null, this);
            obj.set_taborder("8");
            obj.set_value("0");
            obj.set_mask("9990.0");
            ...
            obj = new Static("Static60", "absolute", "29.82%", "687", null, "21", "67.39%", null, this);
            obj.set_taborder("39");
            obj.set_text("㎡");
            this.addChild(obj.name, obj);

            obj = new Static("Static14", "absolute", "62.82%", "687", null, "21", "34.39%", null, this);
            obj.set_taborder("40");
            obj.set_text("㎡");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC14", "absolute", "52.66%", "687", null, "21", "37.31%", null, this);
            obj.set_taborder("9");
            obj.set_value("0");
            obj.set_mask("9990.0");
            obj.set_limitbymask("both");
            ...
            obj = new Static("Static16", "absolute", "95.94%", "687", null, "21", "1.27%", null, this);
            obj.set_taborder("41");
            obj.set_text("㎡");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("edt_ETC15", "absolute", "85.79%", "687", null, "21", "4.19%", null, this);
            obj.set_taborder("10");
            obj.set_value("0");
            obj.set_mask("9990.0");
            obj.set_limitbymask("both");
            ...
            obj = new Static("Static12", "absolute", "32.99%", "683", null, "29", "47.97%", null, this);
            obj.set_taborder("42");
            obj.set_text("매장면적(공용)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static13", "absolute", "65.99%", "683", null, "29", "14.97%", null, this);
            obj.set_taborder("43");
            obj.set_text("매장면적(전체)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_rent", "absolute", "30.58%", "743", "93", "21", null, null, this);
            this.addChild(obj.name, obj);
            var rdo_rent_innerdataset = new Dataset("rdo_rent_innerdataset", this.rdo_rent);
            rdo_rent_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">원</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">%</Col></Row></Rows>");
            obj.set_innerdataset(rdo_rent_innerdataset);
            obj.set_taborder("13");
            ...
            obj = new MaskEdit("edt_ETC17", "absolute", "19.67%", "743", null, "21", "70.3%", null, this);
            obj.set_taborder("12");
            obj.set_value("0");
            obj.set_mask("#,###,###,###");
            obj.set_limitbymask("both");
            ...
            obj = new Static("Static15", "absolute", "0", "207", "59.26%", "21", null, null, this);
            obj.set_taborder("44");
            obj.set_text("계약사업장");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static17", "absolute", "0", "231", null, "29", "82.99%", null, this);
            obj.set_taborder("45");
            obj.set_text("계약사업장 선택");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Combo("cbo_ETC31", "absolute", "17.39%", "235", "247", "21", null, null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("46");
            ...
            obj = new Edit("edt_ETC32", "absolute", "48.98%", "235", "30", "21", null, null, this);
            obj.set_taborder("47");
            ...
            obj = new Layout("default", "", 788, 890, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("부속계약서(테넌트_단기 임대차)");
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item6","edt_ETC17","value","ds_eltCtrwDtl01","ETC17");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item12","rdo_rent","value","ds_eltCtrwDtl01","ETC18");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item19","cbo_ETC31","value","ds_eltCtrwDtl01","ETC31");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item31","edt_ETC32","value","ds_eltCtrwDtl01","ETC32");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311597.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311597.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	for (var i = 0; i < this.parent.ds_eltCtrwDtl.rowcount; i++) {
        		if (this.parent.ds_eltCtrwDtl.getColumn(i, "MN_CTRW_KDC") == "197") {
        			...
        			if (this.gfn_nullToEmpty(this.parent.ds_eltCtrwDtl.getColumn(fv_position, "ETC18")) == "") {
        				this.rdo_rent.set_value("1");
        			}
        ...
        this.OMG_DS_SC_311301_ontextchanged = function(obj,e)
        {
        	...
        	this.parent.ds_eltCtrwDtl.setColumn(fv_position, "ETC17" , this.edt_ETC17.value) ; // 임대료(율)
        	this.parent.ds_eltCtrwDtl.setColumn(fv_position, "ETC18" , this.rdo_rent.value) ; // 임대료(율) \, % 구분
        ...
        // 계약사업장 선택
        this.cbo_ETC31_onitemchanged = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.Static18.addEventHandler("onclick", this.Static42_onclick, this);
            ...
            this.Static08.addEventHandler("onclick", this.Static42_onclick, this);
            ...
            this.rdo_rent.addEventHandler("onitemchanged", this.rdo_rent_onitemchanged, this);
            this.edt_ETC17.addEventHandler("ontextchanged", this.OMG_DS_SC_311301_ontextchanged, this);
            this.cbo_ETC31.addEventHandler("onitemchanged", this.cbo_ETC31_onitemchanged, this);
            this.edt_ETC32.addEventHandler("ontextchanged", this.OMG_DS_SC_311301_ontextchanged, this);

        };

        this.loadIncludeScript("OMG_DS_SC_311597.xfdl", true);
