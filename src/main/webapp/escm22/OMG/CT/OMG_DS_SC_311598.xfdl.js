    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311398");
                this.set_titletext("부속계약서(테넌트_단기 특약매입)");
            ...
            obj = new Layout("default", "", 788, 890, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("부속계약서(테넌트_단기 특약매입)");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311598.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311598.xfdl", function(exports) {
        ...
        this.loadIncludeScript("OMG_DS_SC_311598.xfdl", true);
