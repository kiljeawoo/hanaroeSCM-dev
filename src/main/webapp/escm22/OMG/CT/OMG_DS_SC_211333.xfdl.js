    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_211333");
                this.set_titletext("특약서(매장의 철수 등)");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_211333.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_211333.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	if (fv_chk == 0) {
        		...
        		fv_position = nRow;
        		this.parent.ds_sctrwDtl.setColumn(fv_position, "SCTRW_KDC", "404");
        ...
        this.loadIncludeScript("OMG_DS_SC_211333.xfdl", true);
