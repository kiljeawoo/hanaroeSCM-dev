    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("전자계약서진행사항조회 축산");
            ...
            obj = new Layout("default", "", 993, 647, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("전자계약서진행사항조회 축산");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_2133.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_2133.xfdl", function(exports) {
        ...
        */
        ...
        this.loadIncludeScript("OMG_DS_SC_2133.xfdl", true);
