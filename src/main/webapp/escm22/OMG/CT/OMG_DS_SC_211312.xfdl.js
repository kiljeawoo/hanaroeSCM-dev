    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_211312");
                this.set_titletext("특약매입 거래계약서(축산)");
                this._setFormPosition(0,0,788,193);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_etcEltStylAmm111", this);
            ...
            obj = new Dataset("ds_eltCtrwDtl11", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj = new Static("Static59", "absolute", "30.96%", "27", null, "29", "53.55%", null, this);
            obj.set_taborder("715");
            obj.set_text("계약해지");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_ctrClo", "absolute", "47.34%", "31", null, "21", "42.39%", null, this);
            obj.set_taborder("1");
            ...
            obj.set_text("특약매입 거래계약서(축산)");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Static("Static89", "absolute", "58.12%", "31", null, "21", "35.03%", null, this);
            ...
            obj = new Edit("edt_wrsPrmPy", "absolute", "17.01%", "31", null, "21", "73.86%", null, this);
            ...
            obj = new TextArea("txa_sctrSjt", "absolute", "17.01%", "115", null, "72", "1.14%", null, this);
            ...
            obj = new Edit("edt_brand", "absolute", "17.01%", "59", null, "21", "73.86%", null, this);
            obj.set_taborder("755");
            this.addChild(obj.name, obj);

            obj = new Static("Static06", "absolute", "30.96%", "55", null, "29", "53.55%", null, this);
            obj.set_taborder("756");
            obj.set_text("마진율(도매,소매)");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_phd_feert", "absolute", "47.34%", "59", null, "21", "46.45%", null, this);
            obj.set_taborder("757");
            obj.style.set_align("right middle");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_etr_Fee", "absolute", "54.44%", "59", null, "21", "39.34%", null, this);
            obj.set_taborder("758");
            obj.style.set_align("right middle");
            this.addChild(obj.name, obj);

            obj = new Static("Static03", "absolute", "13.83%", "83", null, "29", "0%", null, this);
            obj.set_taborder("760");
            obj.set_cssclass("sta_WF_Labelbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static07", "absolute", "27.54%", "87", null, "21", "69.54%", null, this);
            obj.set_taborder("761");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_blm_grmy", "absolute", "17.01%", "87", null, "21", "73.86%", null, this);
            obj.set_taborder("762");
            this.addChild(obj.name, obj);

            obj = new Static("Static09", "absolute", "30.96%", "83", null, "29", "53.55%", null, this);
            obj.set_taborder("763");
            obj.set_text("보증금");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_grmy", "absolute", "47.34%", "87", null, "21", "42.39%", null, this);
            obj.set_taborder("764");
            obj.style.set_align("right middle");
            this.addChild(obj.name, obj);

            obj = new Static("Static00", "absolute", "0", "55", null, "29", "83.63%", null, this);
            obj.set_taborder("749");
            obj.set_text("브랜드명");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "0", "83", null, "29", "83.63%", null, this);
            obj.set_taborder("759");
            obj.set_text("하자보증보험율");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static04", "absolute", "0", "27", null, "29", "83.63%", null, this);
            obj.set_taborder("712");
            obj.set_text("상품대금 지급 ");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static93", "absolute", "0", "111", null, "80", "83.63%", null, this);
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 788, 193, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("pattern_01");
            		p.set_titletext("특약매입 거래계약서(축산)");
            ...
            obj = new BindItem("item1","edt_ctrClo","value","ds_eltCtrwDtl11","CTR_CLO");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item41","edt_wrsPrmPy","value","ds_eltCtrwDtl11","WRS_PRM_PY");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","txa_sctrSjt","value","ds_eltCtrwDtl11","SCTR_SJT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","edt_brand","value","ds_eltCtrwDtl11","BRAND_N");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","edt_phd_feert","value","ds_eltCtrwDtl11","PHD_FEERT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item5","edt_etr_Fee","value","ds_eltCtrwDtl11","ETR_FEE");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item0","edt_blm_grmy","value","ds_eltCtrwDtl11","BLM_GRMY");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item6","edt_grmy","value","ds_eltCtrwDtl11","GRMY");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_211312.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_211312.xfdl", function(exports) {
        ...
        this.OMG_DS_SC_211312_ontextchanged = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.txa_sctrSjt.addEventHandler("ontextchanged", this.OMG_DS_SC_211312_ontextchanged, this);
            ...
            this.edt_etr_Fee.addEventHandler("ontextchanged", this.OMG_DS_SC_211307_ontextchanged, this);
            this.edt_blm_grmy.addEventHandler("ontextchanged", this.OMG_DS_SC_211307_ontextchanged, this);
            this.edt_grmy.addEventHandler("ontextchanged", this.OMG_DS_SC_211307_ontextchanged, this);

        };

        this.loadIncludeScript("OMG_DS_SC_211312.xfdl", true);
