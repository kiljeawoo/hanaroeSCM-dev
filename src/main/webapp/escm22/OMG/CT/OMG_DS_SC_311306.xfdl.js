    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_311306");
                this.set_titletext("스마트유통시스템 이용신청서");
                this._setFormPosition(0,0,788,145);
            }
            ...
            obj = new Edit("edt_ETC2", "absolute", "14.34%", "30", "130", "21", null, null, this);
            obj.set_taborder("24");
            obj.set_lengthunit("ascii");
            ...
            obj = new Static("Static02", "absolute", "0", "26", null, "29", "86.04%", null, this);
            obj.set_taborder("22");
            obj.set_text("환코드");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 788, 145, this,
            	//-- Layout function
            	function(p) {
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_311306.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_311306.xfdl", function(exports) {
        ...
        this.loadIncludeScript("OMG_DS_SC_311306.xfdl", true);
