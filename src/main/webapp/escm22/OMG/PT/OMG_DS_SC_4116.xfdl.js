    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("전자계약 자료실 팝업");
            ...
            obj = new Button("btn_delete", "absolute", null, "0", "41", "21", "164", null, this);
            obj.set_taborder("8");
            obj.set_text("삭제");
            ...
            obj = new Button("btn_search", "absolute", null, "0", "58", "21", "59", null, this);
            obj.set_taborder("9");
            obj.set_cssclass("btn_WFSA_Searchbtn");
            this.addChild(obj.name, obj);

            obj = new Button("btn_write", "absolute", null, "0", "41", "21", "120", null, this);
            obj.set_taborder("10");
            obj.set_text("쓰기");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Combo("cbo_temp", "absolute", "338", "-1", "162", "23", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_close2", "absolute", null, "0", "41", "21", "16", null, this);
            obj.set_taborder("25");
            obj.set_text("닫기");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Div("Div01", "absolute", "16", "0", null, "21", "547", null, this);
            obj.set_taborder("26");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_4116.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_4116.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        		...
        		switch(svcID)
        		{
        			...
        			case "getBbldID":	
        				...
        				*/
        				...
        				//if( (this.blbdId == '201506090001' && application.gv_userType != '03' && application.gv_userType != '02') || (this.blbdId == '201506090005' && application.gv_userType != '99' ) )
        				if( (this.blbdId == '201506090001' || this.blbdId == '201506090002' || this.blbdId == '201506090005' ) && application.gv_userType != '99') 
        				//if( (this.blbdId == '201506090001' && application.gv_userType != '99') )
        				{	
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_4116.xfdl", true);
