(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Radio("radio_auth", "absolute", "155", "591", "301", "23", null, null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static29", "absolute", "301", "178", "139", "21", null, null, this);
            obj.set_taborder("48");
            obj.set_text("(※200KB 이하만 가능)");
            this.addChild(obj.name, obj);

            obj = new Button("btn_comname", "absolute", "362", "263", "22", "21", null, null, this);
            obj.set_taborder("49");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_4911.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_4911.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        this.form_onload = function(obj,e)
        {
        	...
        	if (paraMode == "I") {
        		...
        		if (dept_level!=1) {
        			this.radio_auth.set_visible(false);
        		}
        	} else if (paraMode == "U") {
        		...
        		this.ds_dep.copyData(this.parent.dsdepArg);
        		...
        		auth = this.ds_user.getColumn(0, "AUTH_TYPE_CD");
        		if (auth == null) {
        			auth = "1"; // 권한이 빠져있으면 '1'
        		}
        		if (dept_level!="1") {
        		...
        		//trace(dept_level);
        		this.radio_auth.set_value(auth);
        		this.call_pic();
        	}
        }
        /************************************************************************************************
        ...
        ************************************************************************************************/
        ...
        this.call_pic = function()
        {
        	...
        	var sURL          = "svc::rest/pt/retrievePicture";	
        	var sInDatasets   = "";
        ...
        {	
        	if (btn_save_enable) {
        		if (this.fn_validationCheck()) {
        			...
        			/*
        			if (dept_level!="1") {
        				this.ds_user.setColumn(0,"AUTH_TYPE_CD",auth);
        			} else if (dept_level=="1" && auth!="4") {
        			...
        			*/
        			...
        			if (paraMode == "I") {
        				...
        				var sURL          = "svc::rest/pt/insertUserAmn";	
        				...
        				var sURL          = "svc::rest/pt/updateUserAmn";	
        				var sInDatasets   = "ds_user=ds_user";
        				var sOutDatasets  = "";	
        				var sArgument     = sParams;
        				var sCallbackFunc = "fn_callBack";
        ...
        {
        	/*알파벳 대문자, 숫자만 입력하도록 제한*/
        	if (!this.gfn_isNumBig(this.edit_user_id.value)) {
        		alert("알파벳은 대문자만 입력 바라며, 사원번호 확인바랍니다.");
        		return false;
        	}
        	/*8자리 이상 입력했는지 확인*/
        	var edtid = this.edit_user_id.value;
        	var len = edtid.length;
        	...
        	var sURL          = "svc::rest/pt/checkUserAmnid";	
        	var sInDatasets   = "";
        ...
        {
        	var oArg = {dsdepArg:this.ds_dep, dept_sort:dept_sort, dept_level:dept_level};
        	var sOption = "autosize=true";
        	var sPopupCallBack = "fn_compopupAfter";    
        	this.gfn_openPopup("deptSearchPopup","OMG.PT::OMG_DS_SC_4911_P01.xfdl",oArg,sOption,sPopupCallBack);
        }
        ...
        this.btn_reset_onclick = function(obj,e)
        {
        	...
        	if (this.confirm("["+usrId+"] 사용자의 비밀번호를 초기화 하시겠습니까?\n초기화 후 비밀번호는 '1234'로 변경됩니다.")) {
        		var sSvcID        = "resetPwd";
        		var sURL          = "svc::rest/pt/resetHanaroTalkPwd";	
        		var sInDatasets   = "";
        		var sOutDatasets  = "";	
        ...
        this.loadIncludeScript("OMG_DS_SC_4911.xfdl", true);
