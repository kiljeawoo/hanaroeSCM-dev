    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("전자계약전용회원정보변경");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_5181.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_DS_SC_5181.xfdl", "lib::comTSToolKit.xjs");
        this.registerScript("OMG_DS_SC_5181.xfdl", function(exports) {
        ...
        ********************************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_5181.xfdl", true);
