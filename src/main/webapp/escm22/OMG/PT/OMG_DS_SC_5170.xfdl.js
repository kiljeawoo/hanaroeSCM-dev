(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_hiddenArea", "absolute", "17", "544", "484", "166", null, null, this);
            obj.set_taborder("99");
            ...
            obj.set_maxlength("3");
            this.Div05.addChild(obj.name, obj);
            obj = new Static("Static138", "absolute", "1", "489", "447", "21", null, null, this.Div05);
            obj.set_taborder("79");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_5170.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_DS_SC_5170.xfdl", "lib::comPolicy.xjs");
        this.registerScript("OMG_DS_SC_5170.xfdl", function(exports) {
        ...
        *****************************************************************************/
        this.Div05_cbo_NA_TRPL_C_onitemchanged = function(obj,e)
        {
        	...
        	if (this.gfn_isNull(usrTpc) || usrTpc == "01" || usrTpc == "04" || usrTpc == "05" || usrTpc == "81") {
        		...
        		this.alert("해당 GLN은 본부, 사업장 회원으로 가입되어 있어 농협몰 회원으로 가입하실 수 없습니다.");
        ...
        ****************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_5170.xfdl", true);
