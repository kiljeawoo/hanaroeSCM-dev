(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_5115_P01.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_5115_P01.xfdl", function(exports) {
        ...
        this.loadIncludeScript("OMG_DS_SC_5115_P01.xfdl", true);
