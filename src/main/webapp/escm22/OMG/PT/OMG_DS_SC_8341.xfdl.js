(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("cbo_pageNum", "absolute", "701", "59", "60", "21", null, null, this);
            this.addChild(obj.name, obj);
            var cbo_pageNum_innerdataset = new Dataset("cbo_pageNum_innerdataset", this.cbo_pageNum);
            cbo_pageNum_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">5</Col><Col id=\"datacolumn\">5</Col></Row><Row><Col id=\"codecolumn\">50</Col><Col id=\"datacolumn\">50</Col></Row><Row><Col id=\"codecolumn\">100</Col><Col id=\"datacolumn\">100</Col></Row></Rows>");
            ...
            obj = new Static("Static01", "absolute", "555", "59", "139", "21", null, null, this);
            obj.set_taborder("10");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"49\"/><Column size=\"164\"/><Column size=\"383\"/><Column size=\"90\"/><Column size=\"90\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"점검년월\"/><Cell col=\"2\" text=\"제목\"/><Cell col=\"3\" text=\"시작일\"/><Cell col=\"4\" text=\"종료일\"/></Band><Band id=\"body\"><Cell text=\"bind:SRV_SEQ\"/><Cell col=\"1\" text=\"bind:SUBTITLE\"/><Cell col=\"2\" text=\"bind:TITLE\"/><Cell col=\"3\" displaytype=\"date\" text=\"bind:SRV_ST_DT\"/><Cell col=\"4\" displaytype=\"date\" text=\"bind:SRV_ED_DT\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_8341.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_8341.xfdl", function() {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        {		
        	...
        	var sParam        = "TITLE=" + title + " BSN_DSC=ESCM SRV_DSC=002"; // SRV_DSC 002 : 혁신점포 공급업체 모니터링
        ...
        this.fn_insert_onclick = function(obj,e)
        {
        	...
        	this.gfn_openPopup("popId", "OMG.PT::OMG_DS_SC_8341_P01.xfdl", oArg, sOption, sPopupCallBack);
        }
        ...
        this.grd_comncList_oncellclick = function(obj,e)
        {
        	...
        	var sOption = "autosize=true";
        	var sPopupCallBack = "fn_popupAfter";  
        	this.gfn_openPopup("OMG_DS_SC_8341_P01", "OMG.PT::OMG_DS_SC_8341_P01.xfdl",oArg,sOption,sPopupCallBack);	
        }
        });
        ...
        this.loadIncludeScript("OMG_DS_SC_8341.xfdl");
