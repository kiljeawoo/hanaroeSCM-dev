    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_4114");
                this.set_titletext("게시판등록(나모)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"ORG_FILENM\" type=\"STRING\" size=\"256\"/><Column id=\"MHT_DATA\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);

            obj = new Dataset("ds_namo_modify", this);
            obj._setContents("<ColumnInfo><Column id=\"ORG_FILENM\" type=\"STRING\" size=\"256\"/><Column id=\"MHT_DATA\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_text("파일삭제");
            this.div_pop.addChild(obj.name, obj);
            obj = new Static("st_closed_yn00", "absolute", "568", "0", "71", "29", null, null, this.div_pop);
            obj.set_taborder("14");
            obj.set_text("모바일알림");
            obj.set_cssclass("sta_WF_Label");
            obj.set_visible("true");
            obj.style.set_padding("2 7 0 0");
            obj.style.set_align("center middle");
            this.div_pop.addChild(obj.name, obj);
            obj = new CheckBox("chk_mobPushYn", "absolute", "85.18%", "5", "15", "21", null, null, this.div_pop);
            obj.set_taborder("15");
            obj.set_value("0");
            obj.set_truevalue("1");
            obj.set_falsevalue("0");
            ...
            obj = new Grid("grd_file", "absolute", "17", null, null, "29", "15", "15", this);
            obj.set_taborder("157");
            obj.set_binddataset("ds_file");
            obj.set_scrollbars("autoboth");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"631\"/><Column size=\"81\"/></Columns><Rows><Row size=\"29\"/></Rows><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:ORGFNAME\" expandshow=\"hide\"/><Cell col=\"2\" style=\"align:right;\" text=\"expr:comp.parent.fn_getFileSize(FILESIZE)\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("st_boarder", "absolute", "126", "128", null, null, "17", "14", this);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_Labelbg");
            obj.style.set_background("#ffffffff");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div_namo", "absolute", "127", "129", null, null, "18", "14", this);
            obj.set_taborder("189");
            obj.set_scrollbars("none");
            this.addChild(obj.name, obj);
            obj = new WebBrowser("namoWebBrowser", "absolute", "0", "0", null, null, "0", "0", this.div_namo);
            obj.set_taborder("0");
            this.div_namo.addChild(obj.name, obj);
            ...
            //-- Default Layout
            obj = new Layout("default", "", 0, 0, this.div_namo,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("189");
            ...
            this.div_namo.addLayout(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","div_pop.chk_mobPushYn","value","ds_bbs","MOB_PUSH_YN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_4114.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_DS_SC_4114.xfdl", "lib::sz_fsp_nx.xjs");
        this.registerScript("OMG_DS_SC_4114.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ********************************************************************************/
        ...
        this.div_pop_cal_from_ondropdown = function(obj,e)
        {
        	//this.div_namo.set_visible(false);
        }

        this.div_pop_cal_from_oncloseup = function(obj,e)
        {
        	//this.div_namo.set_visible(true);
        }

        this.div_namo_namoWebBrowser_onusernotify = function(obj,e)
        {	
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_pop.cal_to.addEventHandler("oncloseup", this.div_pop_cal_from_oncloseup, this);
            this.div_pop.cal_to.addEventHandler("ondropdown", this.div_pop_cal_from_ondropdown, this);
            this.div_pop.cal_from.addEventHandler("ondropdown", this.div_pop_cal_from_ondropdown, this);
            this.div_pop.cal_from.addEventHandler("oncloseup", this.div_pop_cal_from_oncloseup, this);
            ...
            this.div_pop.chk_mobPushYn.addEventHandler("onchanged", this.chk_bbrdPupYn_onchanged, this);
            ...
            this.div_namo.namoWebBrowser.addEventHandler("onusernotify", this.div_namo_namoWebBrowser_onusernotify, this);

        };

        this.loadIncludeScript("OMG_DS_SC_4114.xfdl", true);
