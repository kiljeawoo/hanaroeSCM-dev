    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_TX_7003_WRS");
                this.set_titletext("마감간소화 전표별 상품내역");
            ...
            obj._setContents("<ColumnInfo><Column id=\"NA_TRPL_C\" type=\"string\" size=\"32\"/><Column id=\"NA_BZPLC\" type=\"string\" size=\"32\"/><Column id=\"NA_BZPLNM\" type=\"string\" size=\"32\"/><Column id=\"NA_SLPNO\" type=\"string\" size=\"32\"/><Column id=\"TR_DT\" type=\"string\" size=\"32\"/><Column id=\"NA_WRS_C\" type=\"string\" size=\"32\"/><Column id=\"WRSNM\" type=\"string\" size=\"32\"/><Column id=\"WRS_STDNM\" type=\"string\" size=\"32\"/><Column id=\"TXT_DSC\" type=\"string\" size=\"32\"/><Column id=\"NA_CRC_CAN_DSC\" type=\"string\" size=\"32\"/><Column id=\"BYNG_QT\" type=\"string\" size=\"32\"/><Column id=\"BYNG_UPR\" type=\"string\" size=\"32\"/><Column id=\"BYNG_VAT\" type=\"string\" size=\"32\"/><Column id=\"BYAM\" type=\"string\" size=\"32\"/><Column id=\"TOT_AM\" type=\"STRING\" size=\"256\"/><Column id=\"NA_TR_DSC\" type=\"STRING\" size=\"256\"/><Column id=\"DVY_STSC\" type=\"STRING\" size=\"256\"/><Column id=\"DVY_QT\" type=\"STRING\" size=\"256\"/><Column id=\"DVY_WRS_UPR\" type=\"STRING\" size=\"256\"/><Column id=\"DVY_AM\" type=\"STRING\" size=\"256\"/><Column id=\"DVY_VAT\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"70\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"115\"/><Column size=\"100\"/></Columns><Rows><Row size=\"25\" band=\"head\"/><Row size=\"35\" band=\"head\"/><Row size=\"28\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"No\"/><Cell col=\"1\" rowspan=\"2\" text=\"상품코드\"/><Cell col=\"2\" rowspan=\"2\" text=\"상품명\"/><Cell col=\"3\" rowspan=\"2\" text=\"과세&#13;&#10;구분\"/><Cell col=\"4\" colspan=\"5\" text=\"매입상세내역\"/><Cell col=\"9\" colspan=\"5\" text=\"배송예정서\"/><Cell row=\"1\" col=\"4\" text=\"매입단가\"/><Cell row=\"1\" col=\"5\" text=\"매입수량\"/><Cell row=\"1\" col=\"6\" text=\"공급금액\"/><Cell row=\"1\" col=\"7\" text=\"부가세\"/><Cell row=\"1\" col=\"8\" text=\"총공급금액\"/><Cell row=\"1\" col=\"9\" text=\"전표상태\"/><Cell row=\"1\" col=\"10\" text=\"배송상품&#13;&#10;단가\"/><Cell row=\"1\" col=\"11\" text=\"배송예정&#13;&#10;수량\"/><Cell row=\"1\" col=\"12\" text=\"배송금액\"/><Cell row=\"1\" col=\"13\" text=\"부가세\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:NA_WRS_C\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:WRSNM\"/><Cell col=\"3\" text=\"bind:TXT_DSC\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:BYNG_UPR\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:BYNG_QT\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:BYAM\"/><Cell col=\"7\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:BYNG_VAT\"/><Cell col=\"8\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:TOT_AM\"/><Cell col=\"9\" text=\"bind:DVY_STSC\"/><Cell col=\"10\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:DVY_WRS_UPR\"/><Cell col=\"11\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:DVY_QT\"/><Cell col=\"12\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:DVY_AM\"/><Cell col=\"13\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:DVY_VAT\"/></Band><Band id=\"summary\"><Cell/><Cell col=\"1\" style=\"align:center;\" text=\"합 계\"/><Cell col=\"2\" style=\"align:center;\" expr=\"expr:dataset.getRowCount() + ' 건'\"/><Cell col=\"3\" style=\"align:center;\"/><Cell col=\"4\" displaytype=\"number\"/><Cell col=\"5\" displaytype=\"number\" expr=\"expr:dataset.getSum('BYNG_QT')\"/><Cell col=\"6\" displaytype=\"number\" expr=\"expr:dataset.getSum('BYAM')\"/><Cell col=\"7\" displaytype=\"number\" expr=\"expr:dataset.getSum('BYNG_VAT')\"/><Cell col=\"8\" displaytype=\"number\" expr=\"expr:dataset.getSum('TOT_AM')\"/><Cell col=\"9\"/><Cell col=\"10\"/><Cell col=\"11\" displaytype=\"number\" expr=\"expr:dataset.getSum('DVY_QT')\"/><Cell col=\"12\" displaytype=\"number\" expr=\"expr:dataset.getSum('DVY_AM')\"/><Cell col=\"13\" displaytype=\"number\" expr=\"expr:dataset.getSum('DVY_VAT')\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static06", "absolute", "0", "0", "345", "32", null, null, this);
            obj.set_taborder("8");
            obj.set_text("마감간소화 전표별 상품내역");
            ...
            obj = new Static("sta_result", "absolute", "15", "71", "90", "21", null, null, this);
            obj.set_taborder("15");
            obj.set_text("전표번호 :");
            ...
            obj = new Static("sta_result01", "absolute", "400", "47", "180", "21", null, null, this);
            obj.set_taborder("20");
            obj.set_text("매입사업장/매입사업장명 :");
            obj.set_cssclass("sta_WFSA_Label");
            this.addChild(obj.name, obj);

            obj = new Static("sta_info3", "absolute", "170", "71", "150", "21", null, null, this);
            obj.set_taborder("21");
            obj.set_text("2021-01-01-00001");
            this.addChild(obj.name, obj);

            obj = new Static("sta_info1", "absolute", "170", "47", "300", "21", null, null, this);
            obj.set_taborder("17");
            obj.set_text("20210101012345kteba12345 (일반/과세)");
            this.addChild(obj.name, obj);

            obj = new Static("sta_info2", "absolute", "575", "47", "300", "21", null, null, this);
            obj.set_taborder("19");
            ...
            obj = new Static("sta_info4", "absolute", "575", "71", "150", "21", null, null, this);
            obj.set_taborder("24");
            obj.set_text("1000000000000010");
            this.addChild(obj.name, obj);

            obj = new Static("sta_result02", "absolute", "400", "71", "120", "21", null, null, this);
            obj.set_taborder("25");
            ...
            obj = new Layout("default", "", 1000, 500, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("마감간소화 전표별 상품내역");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_TX_7003_WRS.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_TX_7003_WRS.xfdl", function(exports) {
        ...
        this.loadIncludeScript("OMG_DS_TX_7003_WRS.xfdl", true);
