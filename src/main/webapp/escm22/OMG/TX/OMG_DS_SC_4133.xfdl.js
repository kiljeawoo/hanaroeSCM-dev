    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_4133");
                this.set_titletext("환입");
            ...
            obj = new Dataset("ds_taxDetail2", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj.set_binddataset("ds_taxDetail2");
            ...
            obj = new BindItem("item14","MaskEdit01","value","ds_tax2","TOT_AM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item15","Static27","text","ds_tax2","RCT_RQS_DSC");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item0","Div01.MaskEdit01","value","ds_tax2","SPLR_BZNO");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item16","Div01.Static01","text","ds_tax2","SPLR_MTALNM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item17","Div01.Static06","text","ds_tax2","SPLR_REPMNM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item22","Div01.Static02","text","ds_tax2","SPLR_ADR");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item23","Div01.Static05","text","ds_tax2","SPLR_BZC");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item24","Div01.Static03","text","ds_tax2","SPLR_BZTPNM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item33","Div01.Static04","text","ds_tax2","SPLR_CHRR_EMAIL");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item39","Static11","text","ds_tax2","STL_METHC1");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item40","Static12","text","ds_tax2","STL_METHC2");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item41","Static15","text","ds_tax2","STL_METHC3");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item42","Static10","text","ds_tax2","STL_METHC4");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item5","MaskEdit00","value","ds_tax2","STL_AM1");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item6","MaskEdit02","value","ds_tax2","STL_AM2");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item7","MaskEdit03","value","ds_tax2","STL_AM3");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item8","MaskEdit04","value","ds_tax2","STL_AM4");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","Div02.MaskEdit00","value","ds_tax2","BUY_BZNO");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","Div02.Edit00","value","ds_tax2","");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","Div02.Edit02","value","ds_tax2","BUY_REPMNM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","Div02.Edit01","value","ds_tax2","BUY_MTALNM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item9","Div02.Edit03","value","ds_tax2","BUY_ADR");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item10","Div02.Edit04","value","ds_tax2","BUY_BZTPNM");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item11","Div02.Edit06","value","ds_tax2","BUY_BZC");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item12","Div02.Edit05","value","ds_tax2","BUY_CHRR_EMAIL1");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item13","Div02.Edit07","value","ds_tax2","BUY_CHRR_EMAIL2");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_4133.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_DS_SC_4133.xfdl", "lib::comTSToolKit.xjs");
        this.registerScript("OMG_DS_SC_4133.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.ds_tax2_oncolumnchanged = function(obj,e)
        {
        	if(e.col == 2)
        	{
        ...
        this.ds_tax2_cancolumnchange = function(obj,e)
        {
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_4133.xfdl", true);
