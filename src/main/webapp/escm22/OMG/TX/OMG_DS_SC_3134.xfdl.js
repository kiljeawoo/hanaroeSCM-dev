    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_3137");
                this.set_titletext("계약의 해제");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_3134.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_3134.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
         	...
         	else 
         	{
        		switch(svcID)
        		{
        			case "retrieveSlTxbilForMod":
        				...
        				this.ds_tax.setColumn(0, "RMK1", "당초 작성일자 : " + this.ds_tax.getColumn(0, "CRT_DT"));
        				this.fn_reverseAmt();
        				break;
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_3134.xfdl", true);
