    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_TX_7002_WRS");
                this.set_titletext("마감간소화 상품내역");
            ...
            obj.set_summarytype("top");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"50\"/><Column size=\"90\"/><Column size=\"80\"/><Column size=\"130\"/><Column size=\"100\"/><Column size=\"130\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"36\" band=\"head\"/><Row size=\"28\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell colspan=\"10\" text=\"매입전표\"/><Cell row=\"1\" text=\"No\"/><Cell row=\"1\" col=\"1\" text=\"상품코드\"/><Cell row=\"1\" col=\"2\" text=\"상품명\"/><Cell row=\"1\" col=\"3\" text=\"규격\"/><Cell row=\"1\" col=\"4\" text=\"과세&#13;&#10;구분\"/><Cell row=\"1\" col=\"5\" text=\"매입단가\"/><Cell row=\"1\" col=\"6\" text=\"매입수량\"/><Cell row=\"1\" col=\"7\" text=\"공급금액\"/><Cell row=\"1\" col=\"8\" text=\"부가세\"/><Cell row=\"1\" col=\"9\" text=\"총공급금액\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:NA_WRS_C\"/><Cell col=\"2\" text=\"bind:WRSNM\"/><Cell col=\"3\" text=\"bind:WRS_STDNM\"/><Cell col=\"4\" text=\"bind:TXT_DSC\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;\" text=\"bind:BYNG_UPR\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:BYNG_QT\"/><Cell col=\"7\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:BYAM\"/><Cell col=\"8\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:BYNG_VAT\"/><Cell col=\"9\" displaytype=\"number\" style=\"align:right;padding:0 10 0 0;\" text=\"bind:TOT_AM\"/></Band><Band id=\"summary\"><Cell/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/><Cell col=\"4\"/><Cell col=\"5\" displaytype=\"number\"/><Cell col=\"6\" displaytype=\"number\"/><Cell col=\"7\" displaytype=\"number\" expr=\"expr:dataset.getSum('BYAM')\"/><Cell col=\"8\" displaytype=\"number\" expr=\"expr:dataset.getSum('BYNG_VAT')\"/><Cell col=\"9\" displaytype=\"number\" expr=\"expr:dataset.getSum('TOT_AM')\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_TX_7002_WRS.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_TX_7002_WRS.xfdl", function(exports) {
        ...
        {
        	excelDownHandler(this.gfn_svcUrl()+"rest/tx/simplify/excel/retrieveDetailList?type=WRS&xml=" + this.fn_makeDsToParam(false), this);
        }

        this.fn_print = function(obj,e)
        {
        	var ozParam = {
        		sId: 'OMG_DS_TX_7002_WRS',
        ...
        this.grd_detail_oncelldblclick = function(obj,e)
        {
        	...
        	this.gfn_openPopup("detailPop2", "OMG.TX::OMG_DS_TX_7003_SLP.xfdl", oArg, sOption, sPopupCallBack);
        }
        ...
        this.loadIncludeScript("OMG_DS_TX_7002_WRS.xfdl", true);
