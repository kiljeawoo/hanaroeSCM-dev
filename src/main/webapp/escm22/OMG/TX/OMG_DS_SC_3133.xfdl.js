(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_3133.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_DS_SC_3133.xfdl", "lib::comTSToolKit.xjs");
        this.registerScript("OMG_DS_SC_3133.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_3133.xfdl", true);
