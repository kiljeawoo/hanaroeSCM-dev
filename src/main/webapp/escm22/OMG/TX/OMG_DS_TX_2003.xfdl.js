(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("OMG_DS_TX_2003.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_TX_2003.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_commonAfterOnload= function()
        {
            ...
            this.ds_condition.setColumn(0, "OCU_DSC", "02");  // TX_TXBIL.OCU_DSC  '발생구분코드 : 01 경제통합, 02 하나로eSCM'
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_TX_2003.xfdl", true);
