(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"s_code\" type=\"string\" size=\"13\"/><Column id=\"s_name\" type=\"string\" size=\"13\"/></ColumnInfo><Rows><Row><Col id=\"s_code\">1</Col><Col id=\"s_name\">거래처명</Col></Row><Row><Col id=\"s_code\">2</Col><Col id=\"s_name\">사업자번호</Col></Row><Row><Col id=\"s_code\">3</Col><Col id=\"s_name\">거래처코드</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"200\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"no.\"/><Cell col=\"1\" text=\"거래처코드\"/><Cell col=\"2\" text=\"거래처명\"/><Cell col=\"3\" text=\"사업자번호\"/><Cell col=\"4\" text=\"대표자\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:NA_TRPL_C\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:CLNTNM\"/><Cell col=\"3\" text=\"bind:BIZ_NUMBER\"/><Cell col=\"4\" text=\"bind:REPMNM\" editlengthunit=\"utf8\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("POPUP_BZPLC.xfdl", "lib::comLib.xjs");
        this.registerScript("POPUP_BZPLC.xfdl", function(exports) {
        ...
        this.fn_afterFormOnload = function()
        {
        	...
        	var word;
        	try {
        		if (!this.gfn_isNull(this.parent.searchType)) {
        			this.div_search.searchType.set_value(this.parent.searchType);
        		}
        ...
        this.btn_search_onclick = function(obj,e)
        {
        	if(this.fn_validationCheck()){
        		...
        		var sSvcID        = "retrieveBZPLC";//통신아이디
        		var sURL          = "svc::rest/tx/retrieveBZPLC";// 호출할 서버 페이지 주소
        ...
        this.loadIncludeScript("POPUP_BZPLC.xfdl", true);
