(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.style.set_font("bold 15 Gulim");
            this.Div03.addChild(obj.name, obj);
            obj = new Edit("Edit00", "absolute", "313", "0", null, "57", "0", null, this.Div03);
            obj.set_taborder("77");
            obj.set_readonly("true");
            obj.style.set_background("#ffffffff");
            obj.style.set_border("1 solid #8684c3ff");
            ...
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\" band=\"left\"/><Column size=\"40\" band=\"left\"/><Column size=\"31\" band=\"left\"/><Column size=\"130\"/><Column size=\"60\"/><Column size=\"40\"/><Column size=\"70\"/><Column size=\"80\"/><Column size=\"70\"/><Column size=\"158\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"월\"/><Cell col=\"1\" colspan=\"2\" text=\"일\"/><Cell col=\"3\" text=\"품목\"/><Cell col=\"4\" text=\"규격\"/><Cell col=\"5\" text=\"수량\"/><Cell col=\"6\" text=\"단가\"/><Cell col=\"7\" text=\"공급가액\"/><Cell col=\"8\" text=\"세액\"/><Cell col=\"9\" text=\"비고\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"bind:TR_DT_MON\" editdisplay=\"edit\" combodisplay=\"display\"/><Cell col=\"1\" displaytype=\"normal\" edittype=\"none\" text=\"bind:TR_DT_DAY\" editdisplay=\"edit\" combodisplay=\"display\"/><Cell col=\"2\" displaytype=\"date\" edittype=\"date\" style=\"align:right;\" text=\"bind:TR_DT\" editdisplay=\"display\" calendardisplay=\"display\"/><Cell col=\"3\" edittype=\"text\" style=\"align:left;\" text=\"bind:LATCNM\" editdisplay=\"display\"/><Cell col=\"4\" edittype=\"text\" style=\"align:center;\" text=\"bind:STD\" editdisplay=\"display\"/><Cell col=\"5\" edittype=\"text\" editfilter=\"number\" style=\"align:center;\" text=\"bind:QT\" editdisplay=\"display\"/><Cell col=\"6\" displaytype=\"number\" edittype=\"text\" editfilter=\"number\" style=\"align:right;\" text=\"bind:UPR\" editdisplay=\"display\"/><Cell col=\"7\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:SPPR\" editdisplay=\"edit\"/><Cell col=\"8\" displaytype=\"number\" edittype=\"none\" style=\"align:right;\" text=\"bind:TXA\" editdisplay=\"edit\" combodisplay=\"display\"/><Cell col=\"9\" edittype=\"text\" style=\"align:left;\" text=\"bind:RMK\" editdisplay=\"display\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item52","Div01.Static04","text","ds_tax","SPLR_CHRR_EMAIL");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item16","Div02.Edit00","value","ds_tax","");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item43","Div03.Edit00","value","ds_taxMod","");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_3135.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_3135.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_insertTaxbil = function()
        {
        	...
        	var sURL          = "svc::rest/tx/insertTaxbil";
         	...
         	else 
         	{
        		switch(svcID)
        		{
        			case "retrieveSlTxbilForMod":
        				...
        				this.ds_tax.setColumn(0, "RMK1", "내국신용장개설일 : " );
        				
        				this.ds_taxMod.copyData(this.ds_tax);
        				this.ds_taxDetailMod.copyData(this.ds_taxDetail); 
        				
        				this.ds_taxMod.setColumn(0,"TXBIL_KD", "02" + "02");
        				
        				this.fn_reverseAmt();
        				for(var i = 0 ; i < this.ds_taxDetailMod.rowcount ; i++)
        				{
        					this.ds_taxDetailMod.setColumn(i, "TXA", 0);
        				}
        				this.ds_taxMod.setColumn(0, "TXA_TT" , 0);
        				this.ds_taxMod.setColumn(0, "TOT_AM" , this.ds_taxMod.getColumn(0,"SPRTT"));
        				break;
        ...
        ************************************************************************************************/
        ...
        this.ds_taxMod_oncolumnchanged = function(obj,e)
        {
        	if(e.col == 2)
        	{
        		if(e.newvalue == undefined)
        ...
        this.loadIncludeScript("OMG_DS_SC_3135.xfdl", true);
