(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            cbo_condition_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">사업자등록번호</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">공급자</Col></Row></Rows>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"80\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"140\"/><Column size=\"90\"/><Column size=\"70\"/><Column size=\"65\"/><Column size=\"80\"/><Column size=\"70\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"작성일자\"/><Cell col=\"2\" text=\"공급자\"/><Cell col=\"3\" text=\"공급받는자\"/><Cell col=\"4\" text=\"품목\"/><Cell col=\"5\" text=\"공급가액\"/><Cell col=\"6\" text=\"세액\"/><Cell col=\"7\" text=\"상태\"/><Cell col=\"8\" text=\"발행일자\"/><Cell col=\"9\" text=\"국세청\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:ISCHECKED\"/><Cell col=\"1\" displaytype=\"date\" text=\"bind:CRT_DT\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:SPLR_MTALNM\"/><Cell col=\"3\" style=\"align:left;\" text=\"bind:BUY_MTALNM\"/><Cell col=\"4\" style=\"align:left;\" text=\"bind:LATCNM\" tooltiptext=\"bind:LATCNM\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SPRTT\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;\" text=\"bind:TXA_TT\"/><Cell col=\"7\" displaytype=\"normal\" text=\"bind:SOAC_PBC_STSC\" combodataset=\"ds_combo\" combocodecol=\"SIMP_C\" combodatacol=\"SIMP_CNM\"/><Cell col=\"8\" displaytype=\"date\" text=\"bind:PBC_DT\"/><Cell col=\"9\" displaytype=\"normal\" text=\"expr:comp.parent.parent.gfn_isNull(NTS_TMS_SQNO)?'미신고':'신고완료'\"/></Band></Format></Formats>");
            this.div_grd.addChild(obj.name, obj);
            obj = new Button("Button00", "absolute", null, "16", "53", "21", "146", null, this.div_grd);
            obj.set_taborder("0");
            obj.set_text("리스트출력");
            this.div_grd.addChild(obj.name, obj);
            obj = new Button("btn_print", "absolute", null, "16", "113", "21", "91", null, this.div_grd);
            obj.set_taborder("5");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_3120.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_3120.xfdl", function() {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_grd.div_paging.addEventHandler("onkillfocus", this.div_grd_div_paging_onkillfocus, this);

        };

        this.loadIncludeScript("OMG_DS_SC_3120.xfdl");
