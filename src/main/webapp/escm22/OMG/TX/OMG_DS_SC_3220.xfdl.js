(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"START\" type=\"STRING\" size=\"256\"/><Column id=\"END\" type=\"STRING\" size=\"256\"/><Column id=\"SOAC_PBC_STSC_01\" type=\"STRING\" size=\"256\"/><Column id=\"SOAC_PBC_STSC_02\" type=\"STRING\" size=\"256\"/><Column id=\"SOAC_PBC_STSC_03\" type=\"STRING\" size=\"256\"/><Column id=\"SOAC_PBC_STSC_04\" type=\"STRING\" size=\"256\"/><Column id=\"SOAC_PBC_STSC_05\" type=\"STRING\" size=\"256\"/><Column id=\"SPLR_BZNO\" type=\"STRING\" size=\"256\"/><Column id=\"glnCode\" type=\"STRING\" size=\"256\"/><Column id=\"TX_TYPE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"SPLR_BZNO\"/><Col id=\"SOAC_PBC_STSC_01\">01</Col><Col id=\"SOAC_PBC_STSC_02\">02</Col><Col id=\"SOAC_PBC_STSC_03\">03</Col><Col id=\"SOAC_PBC_STSC_04\">04</Col><Col id=\"SOAC_PBC_STSC_05\">05</Col><Col id=\"TX_TYPE\">BUY</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj = new Div("div_month", "absolute", "118", "36", "221", "21", null, null, this.div_search);
            obj.set_taborder("42");
            ...
            obj = new Div("div_quarter", "absolute", "118", "36", "221", "21", null, null, this.div_search);
            obj.set_taborder("41");
            ...
            obj.set_index("0");
            obj.set_value("1");
            obj = new Div("div_date", "absolute", "118", "36", "221", "21", null, null, this.div_search);
            obj.set_taborder("43");
            obj.style.set_background("#f6f6f6ff");
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("st_date", "absolute", "15", "36", "103", "21", null, null, this.div_search);
            obj.getSetter("taborder").set("28");
            obj.set_text("일자별");
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new CheckBox("chk_all", "absolute", "118", "62", "36", "21", null, null, this.div_search);
            obj.set_taborder("29");
            obj.set_value("true");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static07", "absolute", "142", "67", "5", "11", null, null, this.div_search);
            obj.getSetter("taborder").set("30");
            obj.set_cssclass("sta_WF_Vdash");
            this.div_search.addChild(obj.name, obj);
            obj = new CheckBox("chk_01", "absolute", "155", "62", "65", "21", null, null, this.div_search);
            obj.set_taborder("31");
            obj.set_text("미개봉");
            obj.set_truevalue("01");
            this.div_search.addChild(obj.name, obj);
            obj = new CheckBox("chk_05", "absolute", "419", "62", "60", "21", null, null, this.div_search);
            obj.set_taborder("32");
            obj.set_text("반려");
            obj.set_truevalue("05");
            this.div_search.addChild(obj.name, obj);
            obj = new CheckBox("chk_04", "absolute", "340", "62", "75", "21", null, null, this.div_search);
            obj.set_taborder("33");
            obj.set_text("승인취소");
            obj.set_truevalue("04");
            this.div_search.addChild(obj.name, obj);
            obj = new CheckBox("chk_02", "absolute", "220", "62", "60", "21", null, null, this.div_search);
            obj.set_taborder("34");
            obj.set_text("개봉");
            obj.set_truevalue("02");
            this.div_search.addChild(obj.name, obj);
            obj = new CheckBox("chk_03", "absolute", "279", "62", "60", "21", null, null, this.div_search);
            obj.set_taborder("35");
            obj.set_text("승인");
            obj.set_truevalue("03");
            this.div_search.addChild(obj.name, obj);
            obj = new Radio("rdo_sort", "absolute", "118", "10", "227", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            ...
            obj = new Static("st_period", "absolute", "511", "36", "232", "21", null, null, this.div_search);
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Edit("edt_company", "absolute", "511", "10", "122", "21", null, null, this.div_search);
            obj.set_taborder("44");
            ...
            obj = new Div("div_table", "absolute", "0", "123", null, null, "15", "2", this);
            obj.set_taborder("64");
            obj.set_text("Div02");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/><Row size=\"24\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"구분\"/><Cell col=\"1\" text=\"매출처수\"/><Cell col=\"2\" text=\"건수\"/><Cell col=\"3\" text=\"공급가액\"/><Cell col=\"4\" text=\"세액\"/><Cell col=\"5\" text=\"합계금액\"/></Band><Band id=\"body\"><Cell text=\"사업자등록증발행분\"/><Cell col=\"1\" displaytype=\"number\" style=\"align:right;\" text=\"bind:COUNT_BUY_BZNO2\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SUM_BUY_BZNO2\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SPRTT2\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" text=\"bind:TXA_TT2\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;\" text=\"bind:TOT_AM2\"/><Cell row=\"1\" text=\"주민등록증발행분\"/><Cell row=\"1\" col=\"1\" displaytype=\"number\" style=\"align:right;\" text=\"bind:COUNT_BUY_BZNO\"/><Cell row=\"1\" col=\"2\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SUM_BUY_BZNO\"/><Cell row=\"1\" col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SPRTT\"/><Cell row=\"1\" col=\"4\" displaytype=\"number\" style=\"align:right;\" text=\"bind:TXA_TT\"/><Cell row=\"1\" col=\"5\" displaytype=\"number\" style=\"align:right;\" text=\"bind:TOT_AM\"/></Band><Band id=\"summary\"><Cell style=\"align:center;\" text=\"소계\"/><Cell col=\"1\" displaytype=\"number\" style=\"align:right;\" text=\"expr:dataset.getSum(&quot;nexacro.toNumber(COUNT_BUY_BZNO)+nexacro.toNumber(COUNT_BUY_BZNO2)&quot;)\"/><Cell col=\"2\" displaytype=\"number\" style=\"align:right;\" text=\"expr:dataset.getSum(&quot;nexacro.toNumber(SUM_BUY_BZNO)+nexacro.toNumber(SUM_BUY_BZNO2)&quot;)\"/><Cell col=\"3\" displaytype=\"number\" style=\"align:right;\" text=\"expr:dataset.getSum(&quot;nexacro.toNumber(SPRTT)+nexacro.toNumber(SPRTT2)&quot;)\"/><Cell col=\"4\" displaytype=\"number\" style=\"align:right;\" text=\"expr:dataset.getSum(&quot;nexacro.toNumber(TXA_TT)+nexacro.toNumber(TXA_TT2)&quot;)\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;\" text=\"expr:dataset.getSum(&quot;nexacro.toNumber(TOT_AM)+nexacro.toNumber(TOT_AM2)&quot;)\"/></Band></Format></Formats>");
            ...
            obj.getSetter("taborder").set("15");
            obj.set_text("( * 오늘 발행분과 국세청 신고문서는 다음날 합게표에 반영됩니다.)");
            obj.set_cssclass("sta_WF_DescriptionE02");
            ...
            obj = new BindItem("item0","div_search.chk_01","value","ds_condition","SOAC_PBC_STSC_01");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","div_search.chk_02","value","ds_condition","SOAC_PBC_STSC_02");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","div_search.chk_03","value","ds_condition","SOAC_PBC_STSC_03");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","div_search.chk_04","value","ds_condition","SOAC_PBC_STSC_04");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","div_search.chk_05","value","ds_condition","SOAC_PBC_STSC_05");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_3220.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_3220.xfdl", function() {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_afterFormOnload = function()
        {
           //페이지 로딩후 실행부분
            ...
            this.ds_condition.setColumn(0,"glnCode", application.gv_glnCode);
        ...
        ************************************************************************************************/
        ...
        this.div_search_chk_all_onchanged = function(obj,e)
        {
        	if(e.postvalue)
        	{
        		this.div_search.chk_01.set_value(true);
        		this.div_search.chk_02.set_value(true);
        		this.div_search.chk_03.set_value(true);
        		this.div_search.chk_04.set_value(true);
        		this.div_search.chk_05.set_value(true);
        	}
        	else
        	{
        		this.div_search.chk_01.set_value(false);
        		this.div_search.chk_02.set_value(false);
        		this.div_search.chk_03.set_value(false);
        		this.div_search.chk_04.set_value(false);
        		this.div_search.chk_05.set_value(false);
        	}
        }
        ...
        ************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.chk_all.addEventHandler("onchanged", this.div_search_chk_all_onchanged, this);
        ...
        this.loadIncludeScript("OMG_DS_SC_3220.xfdl");
