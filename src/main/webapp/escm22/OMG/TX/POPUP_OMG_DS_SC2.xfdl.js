(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"s_code\" type=\"string\" size=\"13\"/><Column id=\"s_name\" type=\"string\" size=\"13\"/></ColumnInfo><Rows><Row><Col id=\"s_name\">전체</Col><Col id=\"s_code\"/></Row><Row><Col id=\"s_code\">1</Col><Col id=\"s_name\">거래처명</Col></Row><Row><Col id=\"s_code\">2</Col><Col id=\"s_name\">사업자번호</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("POPUP_OMG_DS_SC2.xfdl", "lib::comLib.xjs");
        this.registerScript("POPUP_OMG_DS_SC2.xfdl", function(exports) {
        ...
        this.loadIncludeScript("POPUP_OMG_DS_SC2.xfdl", true);
