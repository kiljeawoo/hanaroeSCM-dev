(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.setProperty("taborder", "50");
            obj.setProperty("enable", "true");
            obj.setProperty("usepersistdata", "false");
            obj.setProperty("popupstyle", "false");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_TX_2001.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_DS_TX_2001.xfdl", "lib::comTSToolKit.xjs");
        this.registerScript("OMG_DS_TX_2001.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_TX_2001.xfdl", true);
