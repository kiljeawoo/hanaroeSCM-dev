(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_taxCopy2", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("true");
            obj.set_updatecontrol("true");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_4131.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_DS_SC_4131.xfdl", "lib::comTSToolKit.xjs");
        this.registerScript("OMG_DS_SC_4131.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_insertTaxMod2 = function()
        {
        	...
        	var sOutDatasets  = "ds_taxCopy2=ds_taxMod";	
        	var sArgument     = "";
        	var sCallbackFunc = "fn_callBack";
        	var sTranType     = "U"; // U:저장/삭제, S:조회
        	...
        	if(ErrorCode < 0) //에러
         	...
         	else 
         	{
        		switch(svcID)
        		{
        			...
        			case "insertTaxMod2":
        				/*
        				 * 사용료 세금계산서는 전자서명 배치에서 자동서명하므로 안하지만
        				 * 경제통합 정발행은 해야한다. 
        				 */
        				this.ds_taxCopy.addRow();
        				this.ds_taxCopy.copyRow(this.ds_taxCopy.rowposition, this.ds_taxCopy2, 0);
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_4131.xfdl", true);
