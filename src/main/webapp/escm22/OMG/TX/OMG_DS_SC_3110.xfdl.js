    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("매출세금계산서(역발행)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"DT\" type=\"STRING\" size=\"256\"/><Column id=\"CONDITION\" type=\"STRING\" size=\"256\"/><Column id=\"STARTDT\" type=\"STRING\" size=\"256\"/><Column id=\"ENDDT\" type=\"STRING\" size=\"256\"/><Column id=\"SEARCH\" type=\"STRING\" size=\"256\"/><Column id=\"SPLR_NA_TRPL_C\" type=\"STRING\" size=\"256\"/><Column id=\"TX_TYPE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"STARTDT\">20150503</Col><Col id=\"ENDDT\">20150716</Col></Row></Rows>");
            ...
            obj.set_taborder("6");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static05", "absolute", "15", "62", "122", "21", null, null, this.div_search);
            ...
            obj = new Combo("cbo_num", "absolute", "142", "62", "100", "21", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            ...
            obj.set_datacolumn("datacolumn");
            obj.set_index("0");
            obj.set_innerdataset("@ds_combo3");
            obj.set_value("1");
            obj.set_text("작성");
            ...
            cbo_condition_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">사업자등록번호</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">공급받는자</Col></Row></Rows>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"80\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"140\"/><Column size=\"90\"/><Column size=\"70\"/><Column size=\"65\"/><Column size=\"80\"/><Column size=\"70\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"작성일자\"/><Cell col=\"2\" text=\"공급받는자\"/><Cell col=\"3\" text=\"공급자\"/><Cell col=\"4\" text=\"품목\"/><Cell col=\"5\" text=\"공급가액\"/><Cell col=\"6\" text=\"세액\"/><Cell col=\"7\" text=\"상태\"/><Cell col=\"8\" text=\"발행일자\"/><Cell col=\"9\" text=\"국세청\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\" text=\"bind:ISCHECKED\"/><Cell col=\"1\" displaytype=\"date\" text=\"bind:CRT_DT\"/><Cell col=\"2\" style=\"align:left;\" text=\"bind:BUY_MTALNM\"/><Cell col=\"3\" style=\"align:left;\" text=\"bind:SPLR_MTALNM\" maskchar=\" \"/><Cell col=\"4\" style=\"align:left;selectfont: ;\" text=\"bind:LATCNM\" tooltiptext=\"bind:LATCNM\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;\" text=\"bind:SPRTT\"/><Cell col=\"6\" displaytype=\"number\" style=\"align:right;\" text=\"bind:TXA_TT\"/><Cell col=\"7\" displaytype=\"normal\" text=\"bind:SOAC_PBC_STSC\" combodataset=\"ds_combo\" combocodecol=\"SIMP_C\" combodatacol=\"SIMP_CNM\"/><Cell col=\"8\" displaytype=\"date\" text=\"bind:PBC_DT\"/><Cell col=\"9\" displaytype=\"normal\" text=\"expr:NTS_PRC_STSC\" combodataset=\"ds_combo2\" combocodecol=\"SIMP_C\" combodatacol=\"SIMP_CNM\"/></Band></Format></Formats>");
            this.div_grd.addChild(obj.name, obj);
            obj = new Button("Button00", "absolute", null, "16", "53", "21", "146", null, this.div_grd);
            obj.set_taborder("2");
            obj.set_text("리스트출력");
            this.div_grd.addChild(obj.name, obj);
            obj = new Button("btn_print", "absolute", null, "16", "137", "21", "91", null, this.div_grd);
            obj.set_taborder("3");
            ...
            obj.set_text("엑셀다운로드");
            this.div_grd.addChild(obj.name, obj);
            obj = new Button("btn_publish", "absolute", null, "16", "77", "21", "231", null, this.div_grd);
            obj.set_taborder("5");
            obj.set_text("발행및신고");
            this.div_grd.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","div_search.edt_suppliee","value","ds_condition","SEARCH");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","div_search.cbo_dt","value","ds_condition","DT");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","div_search.cbo_condition","value","ds_condition","CONDITION");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        this.addIncludeScript("OMG_DS_SC_3110.xfdl", "lib::comTSToolKit.xjs");
        ...
        ************************************************************************************************/
        ...
        this.fn_afterFormOnload = function()
        {
           ...
           var param = [  
         		...
         		{code:"NTS_PRC_STSC",   dsName:"ds_combo2",   selecttype:"N"}
            ];
        ...
        this.common_onclick = function(obj,e)
        {
        	switch(obj.name)
        	{
        		...
        		case "btn_publish"://발행및신고(국세청신고)
        			...
        			{
        				//선택된 행 && 국세청미신고(NTS_TMS_SQNO빈값)
        				if(this.ds_tax.getColumn(i, "ISCHECKED") == "1" && this.ds_tax.getColumn(i, "NTS_PRC_STSC") == "00")
        				{
        			...
        			for(var i = 0 ; i < this.ds_taxCopy.rowcount ; i++)
        			{
        				//선택된 행 && 국세청미신고(NTS_TMS_SQNO빈값)
        				if(this.ds_taxCopy.getColumn(i, "SOAC_PBC_STSC") == "04"
        				   || this.ds_taxCopy.getColumn(i, "SOAC_PBC_STSC") == "05")
        				{
        					this.ds_taxCopy.deleteRow(i);
        					alert("반려 또는 승인취소 단계일 때는 신고할 수 없습니다.");
        					return;
        				}
        			}
        			...
        			{
        				alert("미신고 상태의 행을 선택해주세요.");
        				for(var j = 0 ; j < this.ds_tax.rowcount ; j++)
        				{
        					if(this.ds_tax.getColumn(i, "NTS_PRC_STSC") == "00")
        					this.ds_tax.setColumn(j, "ISCHECKED", 0);
        				}
         				return;
        			}
        		...
        		case "btn_print":
        			...
        			{
        				nRow = this.ds_tax.findRow("ISCHECKED" , "1");
        				if(this.ds_tax.getColumn(nRow, "SOAC_PBC_STSC") == '06')
        				{
        					var param = {
        						PBC_SQNO:this.ds_tax.getColumn(nRow, "PBC_SQNO")
        					}
        					var ozParam = {
        					sId: 'OMG_DS_SC_3110',
        				...
        				{
        					alert("발행된 세금 계산서만 출력 가능합니다.");
        				}
        			}
        			else
        			{
        				alert("하나의 행만 선택해 주십시오.");
        			}
        			break;
        	}
        }
        ...
        ************************************************************************************************/
        ...
        this.div_grd_grd_tax_oncelldblclick = function(obj,e)
        {
        	...
        	var sOption = "autosize=true, title=true";
        	var sPopupCallBack = "fn_popupAfter";    
        	this.gfn_openPopup("OMG_DS_SC_3111","OMG.TX::OMG_DS_SC_3111.xfdl",oArg,sOption,sPopupCallBack);	
        }
        ...
        this.div_grd_grd_tax_oncellclick = function(obj,e)
        {
        	if(e.col != 0)
        	{
        		var oArg = {sqNo:this.ds_tax.getColumn(e.row, "PBC_SQNO")};
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_grd.grd_tax.addEventHandler("oncellclick", this.div_grd_grd_tax_oncellclick, this);
