    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("매출세금계산서조회(eSCM)");
            ...
            obj.set_text("리스트출력");
            this.div_grd.addChild(obj.name, obj);
            obj = new Button("Button01", "absolute", null, "16", "137", "21", "91", null, this.div_grd);
            obj.set_taborder("3");
            ...
            obj.set_text("엑셀다운로드");
            this.div_grd.addChild(obj.name, obj);
            obj = new Button("btn_publish", "absolute", null, "16", "101", "21", "231", null, this.div_grd);
            obj.set_taborder("5");
            ...
            obj = new Layout("default", "", 803, 490, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("매출세금계산서조회(eSCM)");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_3130.xfdl", "lib::comLib.xjs");
        this.addIncludeScript("OMG_DS_SC_3130.xfdl", "lib::comTSToolKit.xjs");
        this.registerScript("OMG_DS_SC_3130.xfdl", function() {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        this.fn_retrieveTaxBillList = function()
        {
        	...
        	var sURL          = "svc::rest/tx/retrieveTxbilEscmList";
        	...
        	switch(obj.name)
        	{
        		...
        		case "btn_publish"://수정세금계산서 발행및신고(국세청신고)
        			...
        			for(var i = 0 ; i < this.ds_tax.rowcount ; i++)
        			{
        				...
        				if(this.ds_tax.getColumn(i, "ISCHECKED") == "1" && this.ds_tax.getColumn(i, "SOAC_PBC_STSC") == "06")
        				{
        			...
        			{
        				//선택된 행 && 국세청미신고(NTS_TMS_SQNO빈값)
        				if(this.ds_taxCopy.getColumn(i, "SOAC_PBC_STSC") != "06" || this.ds_taxCopy.getColumn(i, "NTS_PRC_STSC") != '01')
        				{
        					this.ds_taxCopy.deleteRow(i);
        					alert("계산서 발행 및 국세청 신고 상태일때만 수정 계산서를 발행할 수 있습니다.");
        					return;
        				}
        			}
        			...
        			{
        				alert("국세청 신고상태의 행을 선택해주세요.");
        				for(var j = 0 ; j < this.ds_tax.rowcount ; j++)
        				{
        					if(this.ds_tax.getColumn(i, "NTS_PRC_STSC") != "01")
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_3130.xfdl");
