(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("POPUP_OMG_DS_SC.xfdl", "lib::comLib.xjs");
        this.registerScript("POPUP_OMG_DS_SC.xfdl", function(exports) {
        ...
        this.loadIncludeScript("POPUP_OMG_DS_SC.xfdl", true);
