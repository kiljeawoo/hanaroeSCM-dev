    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("매입세금계산서(이용료)");
            ...
            obj = new Static("Static05", "absolute", "420", "57", "186", "32", null, null, this.div_search);
            obj.set_taborder("71");
            ...
            obj = new Static("Static06", "absolute", "276", "10", "16", "21", null, null, this.div_search);
            obj.set_taborder("73");
            obj.set_text("~");
            ...
            this.div_search.addChild(obj.name, obj);
            obj = new Button("btn_buyer", "absolute", "266", "36", "21", "21", null, null, this.div_search);
            obj.set_taborder("90");
            ...
            obj = new WebBrowser("web_downExcelM", "absolute", "240", "0", null, "20", "510", null, this);
            obj.set_taborder("45");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item6","div_search.chk_02","value","ds_condition","CODE02");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item7","div_search.chk_01","value","ds_condition","CODE01");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item8","div_search.cbo_kind","value","ds_condition","TXBIL_KD");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item9","div_search.cbo_num","value","ds_condition","");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("OMG_DS_TX_2006.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_TX_2006.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.fn_commonAfterOnload= function()
        {
            ...
            this.ds_condition.setColumn(0, "TXBIL_STSC", "01,02,04,05,07,99,00");//02:미발행04:발행05:발행취소07:국세청접수99:발행오류00:국세청신고완료
            ...
            this.ds_condition.setColumn(0, "NA_BZPLC", "");//사업장코드. 경제통합 정발행 세금계산서는 사업장코드 없음
        	...
        	switch(obj.name)
        	{
        		...
        		case "btn_excel": 
        			...
        			var params = "DT_TYPE=" + this.gfn_nullToEmpty(this.ds_condition.getColumn(0,"DT_TYPE"))
        						...
        						+ "&OCU_DSC=" + this.gfn_nullToEmpty(this.ds_condition.getColumn(0,"OCU_DSC"))
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_TX_2006.xfdl", true);
