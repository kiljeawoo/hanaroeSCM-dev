(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("POPUP_BZPLC_copy.xfdl", "lib::comLib.xjs");
        this.registerScript("POPUP_BZPLC_copy.xfdl", function(exports) {
        ...
        this.loadIncludeScript("POPUP_BZPLC_copy.xfdl", true);
