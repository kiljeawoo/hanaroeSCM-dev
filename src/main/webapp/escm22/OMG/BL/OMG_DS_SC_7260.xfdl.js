    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_7260");
                this.set_titletext("오납 조회");
                this._setFormPosition(0,0,803,490);
            }

            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_mpayInq", this);
            ...
            obj._setContents("<ColumnInfo><Column id=\"RV_TRPL_C\" type=\"STRING\" size=\"13\"/><Column id=\"CLNTNM\" type=\"STRING\" size=\"50\"/><Column id=\"RV_DT\" type=\"STRING\" size=\"10\"/><Column id=\"RV_SEQ\" type=\"INT\" size=\"256\"/><Column id=\"RV_BNK\" type=\"STRING\" size=\"10\"/><Column id=\"ACNO\" type=\"STRING\" size=\"64\"/><Column id=\"TR_CNTN\" type=\"STRING\" size=\"128\"/><Column id=\"TR_REC_SJT_CNTN\" type=\"STRING\" size=\"128\"/><Column id=\"TR_STOR\" type=\"STRING\" size=\"128\"/><Column id=\"MIS_PAY_AM\" type=\"INT\" size=\"256\"/><Column id=\"MIS_PAY_C\" type=\"STRING\" size=\"256\"/><Column id=\"MIS_PAY_N\" type=\"INT\" size=\"256\"/><Column id=\"LSCHG_DTM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);

            obj = new Dataset("ds_mpayInq_1row", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj.set_taborder("2");
            obj.set_binddataset("ds_mpayInq");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"45\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"0\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"업체코드\"/><Cell col=\"2\" text=\"업체명\"/><Cell col=\"3\" text=\"레벨\"/><Cell col=\"4\" text=\"입금일\"/><Cell col=\"5\" text=\"은행\"/><Cell col=\"6\" text=\"계좌\"/><Cell col=\"7\" text=\"오납금\"/><Cell col=\"8\" text=\"거래내용\"/><Cell col=\"9\" text=\"거래기록사항\"/><Cell col=\"10\" text=\"거래점\"/><Cell col=\"11\" text=\"업무선택\"/><Cell col=\"12\" text=\"적용\"/><Cell col=\"13\" text=\"적용일\"/></Band><Band id=\"body\"><Cell displaytype=\"number\" style=\"align: ;\" expr=\"currow+1\"/><Cell col=\"1\" displaytype=\"text\" edittype=\"expr:MIS_PAY_N==0?'text':'none'\" text=\"bind:RV_TRPL_C\" tooltiptext=\"bind:RV_TRPL_C\"/><Cell col=\"2\" displaytype=\"text\" edittype=\"none\" text=\"bind:CLNTNM\" tooltiptext=\"bind:CLNTNM\"/><Cell col=\"3\" displaytype=\"number\" text=\"bind:LEV\" tooltiptext=\"bind:LEV\"/><Cell col=\"4\" displaytype=\"date\" text=\"bind:RV_DT\" mask=\"@@@@-@@-@@\" tooltiptext=\"bind:RV_DT\"/><Cell col=\"5\" displaytype=\"combo\" text=\"bind:RV_BNK\" combodataset=\"ds_bnkC\" combocodecol=\"SIMP_C\" combodatacol=\"SIMP_CNM\" tooltiptext=\"bind:RV_BNK\"/><Cell col=\"6\" displaytype=\"text\" text=\"bind:ACNO\" tooltiptext=\"bind:ACNO\"/><Cell col=\"7\" displaytype=\"number\" style=\"align:right middle;\" text=\"bind:MIS_PAY_AM\" tooltiptext=\"bind:MIS_PAY_AM\"/><Cell col=\"8\" displaytype=\"normal\" style=\"align: ;\" text=\"bind:TR_CNTN\" tooltiptext=\"bind:TR_CNTN\"/><Cell col=\"9\" displaytype=\"normal\" style=\"align: ;\" text=\"bind:TR_REC_SJT_CNTN\" tooltiptext=\"bind:TR_REC_SJT_CNTN\"/><Cell col=\"10\" displaytype=\"normal\" style=\"align: ;\" text=\"bind:TR_STOR\" tooltiptext=\"bind:TR_STOR\"/><Cell col=\"11\" displaytype=\"combo\" edittype=\"expr:MIS_PAY_N==0?'combo':'none'\" style=\"align: ;\" text=\"bind:MIS_PAY_C\" editdisplay=\"edit\" combodataset=\"ds_mipDsc\" combocodecol=\"SIMP_C\" combodatacol=\"SIMP_CNM\" combodisplay=\"expr:MIS_PAY_N==0?'display':'edit'\" tooltiptext=\"bind:MIS_PAY_C\"/><Cell col=\"12\" displaytype=\"expr:MIS_PAY_N==0?'button':'none'\" style=\"align: ;\" text=\"적용\" tooltiptext=\"적용\"/><Cell col=\"13\" displaytype=\"expr:LSCHG_DTM==null?'none':'date'\" style=\"align: ;\" text=\"bind:LSCHG_DTM\" mask=\"@@@@-@@-@@\" tooltiptext=\"bind:LSCHG_DTM\"/></Band><Band id=\"summary\"><Cell colspan=\"2\" style=\"align:center middle;\" text=\"합계\"/><Cell col=\"2\"/><Cell col=\"3\" displaytype=\"number\" expr=\"dataset.getSum(&quot;RQS_BAC&quot;)\" tooltiptext=\"expr:dataset.getSum(&quot;RQS_BAC&quot;)\"/><Cell col=\"4\"/><Cell col=\"5\"/><Cell col=\"6\"/><Cell col=\"7\" displaytype=\"number\" expr=\"dataset.getSum(&quot;MIS_PAY_AM&quot;)\" tooltiptext=\"expr:dataset.getSum(&quot;MIS_PAY_AM&quot;)\"/><Cell col=\"8\" displaytype=\"normal\"/><Cell col=\"9\" displaytype=\"normal\"/><Cell col=\"10\" displaytype=\"normal\"/><Cell col=\"11\" displaytype=\"normal\"/><Cell col=\"12\" displaytype=\"normal\"/><Cell col=\"13\" displaytype=\"normal\"/></Band></Format></Formats>");
            this.Div02.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_7260.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_7260.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.ds_mpayInq_1row.addRow();

            var param = [  
        		{code:"BNK_C"		, dsName:"ds_bnkC"		, selecttype:""},
        ...
        ************************************************************************************************/
        ...
        this.fn_callBack = function(svcID,ErrorCode,ErrorMsg)
        {
        	...
        	{
        		if(svcID == "retrieveMisPayInqList")
        		{
        		//	trace("this.ds_mpayInq:" + this.ds_mpayInq.saveXML());
        			if(this.ds_mpayInq.rowcount == 0)
        			{
        				this.Div02.Grid01.set_nodatatext(this.gfn_getTextMessage('result.message.search.no.exist.data'));
        			}
        		}
        		else if(svcID == "saveMisPayC")
        		{
        	 		if(ErrorCode == 1)
        	 		{
        	 		...
        	 		{
        	 			this.gfn_getMessage("alert", "result.message.mispay.no.exist.vndrcode");
        	 		}
        		}
        	}	
        }
        ...
        ************************************************************************************************/
        ...
        {
        //	trace("ds_mpayInq_1row:" + this.ds_mpayInq_1row.saveXML());
        	var params	      = "";
        	var sSvcID        = "saveMisPayC";					// 통신아이디
        	var sURL          = "svc::rest/bl/saveMisPayC";		// 호출할 서버 페이지 주소
        	var sInDatasets   = "in_ds=ds_mpayInq_1row:A";		// 보내는데이터셋
        	var sOutDatasets  = "";
        ...
        this.fn_excel = function(sParams)
        {
        	...
        	this.web_downExcel.set_url(application.gv_serverAdmin_url + "rest/excel/bl/downloadExcelMisPayInq?" + sParams);
        }
        ...
        ************************************************************************************************/	
        ...
        {
        	var sSvcID			= "retrieveMisPayInqList";
        	var sURL			= "svc::rest/bl/retrieveMisPayInqList";
        	var sInDatasets		= "";
        	var sOutDatasets	= "ds_mpayInq=ds_mpayInq";
        ...
        //	alert("cell:" + e.cell + " col:" + e.col + " row:" + e.row);
        	var mpay_null = this.ds_mpayInq.getColumn(e.row, "MIS_PAY_N");
        	var mpay_st = this.ds_mpayInq.getColumn(e.row, "MIS_PAY_C");
        	var vndrCode = this.gfn_nullToEmpty(this.Div02.Grid01.getCellValue(e.row, 1));
         	if (e.col == 12 && mpay_null == 0)
         	{
        	//	상태값 검증
        		if (mpay_st == 'D' || mpay_st == 'R')
        		{
        			if (vndrCode == '')
        			{
        				this.gfn_getMessage("alert", "validation.message.mispay.no.vndrcode");
        				return;
        			}
        			else this.ds_mpayInq.setColumn(e.row, "RV_TRPL_C", vndrCode);
        		}
        	//	1줄만 복사하여 서버에 넘겨준다
        		var bSucc = this.ds_mpayInq_1row.copyRow(0, this.ds_mpayInq, e.row);
        	//	trace("bSucc:" + bSucc);
        	//	trace("ds_mpayInq_1row:" + this.ds_mpayInq_1row.saveXML());
        ...
        this.loadIncludeScript("OMG_DS_SC_7260.xfdl", true);
