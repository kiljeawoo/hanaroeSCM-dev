(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edit_compname", "absolute", "301", "80", "171", "21", null, null, this);
            obj.set_taborder("12");
            ...
            obj = new Edit("edit_gln", "absolute", "130", "80", "166", "21", null, null, this);
            obj.set_taborder("11");
            obj.set_cssclass("edt_WF_Essential");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Edit("edit_compnum", "absolute", "130", "108", "166", "21", null, null, this);
            obj.set_taborder("13");
            obj.set_cssclass("edt_WF_Essential");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_comname", "absolute", "475", "80", "21", "21", null, null, this);
            obj.set_taborder("16");
            obj.set_cssclass("btn_WF_Searchbtn");
            this.addChild(obj.name, obj);

            obj = new Button("btn_comnameCheck", "absolute", "499", "80", "65", "21", null, null, this);
            obj.set_taborder("17");
            obj.set_text("중복확인");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_7121.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_7121.xfdl", function(exports) {
        /************************************************************************************************
         * 공통 라이브러리 INCLUDE 영역
        ************************************************************************************************/
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("OMG_DS_SC_7121.xfdl", true);
