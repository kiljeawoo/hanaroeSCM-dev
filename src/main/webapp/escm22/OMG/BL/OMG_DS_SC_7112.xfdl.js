(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"RATE_ST_DTM\" type=\"STRING\" size=\"14\"/><Column id=\"RATE_ED_DTM\" type=\"STRING\" size=\"14\"/><Column id=\"MM_SL_AM_STN\" type=\"STRING\" size=\"256\"/><Column id=\"MM_FDAM\" type=\"INT\" size=\"256\"/><Column id=\"MSR_RT_AM\" type=\"INT\" size=\"256\"/></ColumnInfo>");
            ...
            combo_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">0</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">10억 이상</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">5억 ~ 10억</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">3억 ~ 5억</Col></Row><Row><Col id=\"codecolumn\">4</Col><Col id=\"datacolumn\">1억 ~ 3억</Col></Row><Row><Col id=\"codecolumn\">5</Col><Col id=\"datacolumn\">0.5억 ~ 1억</Col></Row><Row><Col id=\"codecolumn\">6</Col><Col id=\"datacolumn\">0.3억 ~ 0.5억</Col></Row><Row><Col id=\"codecolumn\">7</Col><Col id=\"datacolumn\">0.3억 미만</Col></Row></Rows>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"128\"/><Column size=\"114\"/><Column size=\"107\"/><Column size=\"120\"/><Column size=\"122\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"월매출 기간\"/><Cell col=\"1\" text=\"요금적용 시작일\"/><Cell col=\"2\" text=\"요금적용 종료일\"/><Cell col=\"3\" text=\"정액제 (월정액)\"/><Cell col=\"4\" text=\"종량제 SKU(건당)\"/></Band><Band id=\"body\"><Cell text=\"bind:MM_SL_AM_STN\"/><Cell col=\"1\" text=\"bind:RATE_ST_DTM\" mask=\"####-##-##\"/><Cell col=\"2\" text=\"bind:RATE_ED_DTM\" mask=\"####-##-##\"/><Cell col=\"3\" text=\"bind:MM_FDAM\"/><Cell col=\"4\" text=\"bind:MSR_RT_AM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_7112.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_7112.xfdl", function(exports) {
        ...
        this.Button09_onclick = function(obj,e)
        {
        	if(this.gfn_isNull(this.Div00.cal_st.value)){
        		...
        		var sParams = "combo="+this.gfn_nullToEmpty(this.Div00.combo.value)
        					...
        					;
        		var sSvcID        = "retrieveAdinfHst";
        		var sURL          = "svc::rest/bl/retrieveAdinfHst";	
        		var sInDatasets   = "";
        ...
        this.loadIncludeScript("OMG_DS_SC_7112.xfdl", true);
