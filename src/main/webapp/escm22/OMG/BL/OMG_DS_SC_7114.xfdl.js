(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"RATE_ST_DTM\" type=\"STRING\" size=\"14\"/><Column id=\"RATE_ED_DTM\" type=\"STRING\" size=\"14\"/><Column id=\"MM_FDAM\" type=\"INT\" size=\"256\"/></ColumnInfo>");
            ...
            this.addChild(obj.name, obj);
            obj = new Static("Static01", "absolute", "11", "10", "119", "21", null, null, this.Div00);
            obj.set_taborder("22");
            obj.set_text("요금적용 시작일");
            obj.set_cssclass("sta_WFSA_Label");
            this.Div00.addChild(obj.name, obj);
            obj = new Calendar("cal_st", "absolute", "136", "10", "101", "21", null, null, this.Div00);
            this.Div00.addChild(obj.name, obj);
            obj.set_taborder("23");
            obj.set_dateformat("yyyy-MM-dd ddd");
            obj = new Calendar("cal_dt", "absolute", "262", "10", "99", "21", null, null, this.Div00);
            this.Div00.addChild(obj.name, obj);
            obj.set_taborder("24");
            obj.set_dateformat("yyyy-MM-dd ddd");
            obj.set_value("null");
            obj.set_editformat("yyyy-MM-dd");
            obj = new Static("Static02", "absolute", "245", "12", "13", "17", null, null, this.Div00);
            obj.set_taborder("25");
            obj.set_text("~");
            this.Div00.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"114\"/><Column size=\"107\"/><Column size=\"120\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"요금적용 시작일\"/><Cell col=\"1\" text=\"요금적용 종료일\"/><Cell col=\"2\" text=\"요금\"/></Band><Band id=\"body\"><Cell text=\"bind:RATE_ST_DTM\" mask=\"####-##-##\"/><Cell col=\"1\" text=\"bind:RATE_ED_DTM\" mask=\"####-##-##\"/><Cell col=\"2\" text=\"bind:MM_FDAM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_7114.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_7114.xfdl", function(exports) {
        ...
        this.Button09_onclick = function(obj,e)
        {
        	if(this.gfn_isNull(this.Div00.cal_st.value)){
        		...
        		var sParams = "combo=10 cal_st="+this.gfn_nullToEmpty(this.Div00.cal_st.value+"000000")
        ...
        this.loadIncludeScript("OMG_DS_SC_7114.xfdl", true);
