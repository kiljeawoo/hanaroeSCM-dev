(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"s_code\" type=\"string\" size=\"13\"/><Column id=\"s_name\" type=\"string\" size=\"13\"/></ColumnInfo><Rows><Row><Col id=\"s_code\">name</Col><Col id=\"s_name\">협력업체 명</Col></Row><Row><Col id=\"s_code\">code</Col><Col id=\"s_name\">협력업체 코드</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"144\"/><Column size=\"278\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"협력업체 코드\"/><Cell col=\"1\" text=\"협력업체 명\"/></Band><Band id=\"body\"><Cell text=\"bind:NA_TRPL_C\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:CLNTNM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_7230_P01.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_7230_P01.xfdl", function(exports) {
        ...
        this.btn_search_onclick = function(obj,e)
        {
        	...
        	if(this.fn_validationCheck()){
        		...
        		var sURL          = "svc::rest/bl/searchTRPL";// 호출할 서버 페이지 주소
        ...
        this.loadIncludeScript("OMG_DS_SC_7230_P01.xfdl", true);
