    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_8520");
                this.set_classname("OMG_DS_SC_7022");
                this.set_titletext("상품/사업장별 재고현황 조회");
            ...
            this.addChild(obj.name, obj);
            obj = new Grid("grd_detail", "absolute", "0%", "222", null, "467", "0%", null, this.div_detail);
            obj.set_taborder("8");
            obj.set_binddataset("ds_detail_store");
            obj.set_autofittype("col");
            obj.set_summarytype("top");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"180\"/><Column size=\"359\"/></Columns><Rows><Row size=\"50\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"63\"/><Row size=\"63\"/></Rows><Band id=\"head\"><Cell text=\"사업장코드\"/><Cell col=\"1\" text=\"사업장명\"/><Cell row=\"1\" text=\"재고수량\"/><Cell row=\"1\" col=\"1\" text=\"재고금액(만원)\"/></Band><Band id=\"body\"><Cell style=\"align: ;\" text=\"bind:CODE\"/><Cell col=\"1\" style=\"align:left middle;\" text=\"bind:NAME\"/><Cell row=\"1\" style=\"align:right middle;\" text=\"bind:AMOUNT\"/><Cell row=\"1\" col=\"1\" style=\"align:right middle;\" text=\"bind:AMOUNTM\"/></Band></Format></Formats>");
            this.div_detail.addChild(obj.name, obj);
            obj = new Grid("grd_detailSum", "absolute", "0%", "127", null, "95", "0%", null, this.div_detail);
            obj.set_cssclass("grd_Wf_SumData");
            obj.set_taborder("9");
            obj.set_binddataset("ds_detail_store");
            obj.set_scrollbars("none");
            ...
            this.div_detail.addChild(obj.name, obj);
            obj = new Static("Static03", "absolute", "0%", "0", null, "64", "71.67%", null, this.div_detail);
            obj.getSetter("taborder").set("10");
            obj.set_text("상품코드");
            obj.set_cssclass("sta_WF_Label");
            this.div_detail.addChild(obj.name, obj);
            obj = new Static("Static04", "absolute", "28.15%", "0", null, "64", "0%", null, this.div_detail);
            obj.getSetter("taborder").set("11");
            obj.set_cssclass("sta_WF_LabelBg");
            this.div_detail.addChild(obj.name, obj);
            obj = new Edit("edt_infoCode", "absolute", "28.89%", "5", null, "54", "2.78%", null, this.div_detail);
            obj.set_taborder("12");
            this.div_detail.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "0%", "63", null, "64", "71.67%", null, this.div_detail);
            obj.getSetter("taborder").set("13");
            obj.set_text("상품명");
            obj.set_cssclass("sta_WF_Label");
            this.div_detail.addChild(obj.name, obj);
            obj = new Static("Static01", "absolute", "28.15%", "63", null, "64", "0%", null, this.div_detail);
            obj.getSetter("taborder").set("14");
            obj.set_cssclass("sta_WF_LabelBg");
            this.div_detail.addChild(obj.name, obj);
            obj = new Edit("edt_infoName", "absolute", "28.89%", "68", null, "54", "2.78%", null, this.div_detail);
            obj.set_taborder("15");
            this.div_detail.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 540, 680, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("상품/사업장별 재고현황 조회");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_8520.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_8520.xfdl", function() {
        ...
        this.div_list_grd_list_oncellclick = function(obj,e)
        {
        	...
        	this.searchDetail();
        	this.gfn_callDetailMenu("div_detail", "상품/사업장별 재고정보 상세", "상품/사업장별 재고정보^사업장/상품별;재고정보^");
        }
        ...
        */
        ...
        this.loadIncludeScript("OMG_DS_SC_8520.xfdl");
