    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("직송분 검수실적 조회");
            ...
            obj._setContents("<ColumnInfo><Column id=\"NA_BZPLC\" type=\"string\" size=\"32\"/><Column id=\"NA_TEAM_C\" type=\"string\" size=\"32\"/><Column id=\"SLP_DT\" type=\"string\" size=\"32\"/><Column id=\"NA_SLPNO\" type=\"string\" size=\"32\"/><Column id=\"BCLNTNM\" type=\"string\" size=\"32\"/><Column id=\"NA_DVY_PLASH_SLPNO\" type=\"string\" size=\"32\"/><Column id=\"CCLNTNM\" type=\"string\" size=\"32\"/><Column id=\"DDLY_CCLNTNM\" type=\"string\" size=\"32\"/><Column id=\"CNR_DT\" type=\"string\" size=\"32\"/><Column id=\"TRSLPNO\" type=\"string\" size=\"32\"/><Column id=\"RPY_PLA_DT\" type=\"string\" size=\"32\"/><Column id=\"GAM_AM\" type=\"bigdecimal\" size=\"8\"/><Column id=\"BYNG_VAT\" type=\"bigdecimal\" size=\"8\"/><Column id=\"TOT_GAM\" type=\"bigdecimal\" size=\"8\"/><Column id=\"CHRG_TOT\" type=\"bigdecimal\" size=\"8\"/><Column id=\"VCBT_AM\" type=\"bigdecimal\" size=\"8\"/><Column id=\"VCBX_AM\" type=\"bigdecimal\" size=\"8\"/><Column id=\"CBAM\" type=\"bigdecimal\" size=\"8\"/><Column id=\"NA_TR_DSC\" type=\"string\" size=\"32\"/><Column id=\"NA_CRC_CAN_DSC\" type=\"string\" size=\"32\"/><Column id=\"ROTS_CTR_DSC\" type=\"string\" size=\"32\"/><Column id=\"MNGT_NA_TRPL_C\" type=\"string\" size=\"32\"/><Column id=\"ACTL_BUYPL_NA_TRPL_C\" type=\"string\" size=\"32\"/><Column id=\"DDLY_BUYPL_NA_TRPL_C\" type=\"string\" size=\"32\"/><Column id=\"COMP_FEE\" type=\"bigdecimal\" size=\"8\"/><Column id=\"BYNG_SSDY\" type=\"bigdecimal\" size=\"8\"/><Column id=\"ETR_AMN_FEE\" type=\"bigdecimal\" size=\"8\"/><Column id=\"ETR_AMN_VAT\" type=\"bigdecimal\" size=\"8\"/><Column id=\"SLGT_AMN_FEE\" type=\"bigdecimal\" size=\"8\"/><Column id=\"PHD_FEE\" type=\"bigdecimal\" size=\"8\"/><Column id=\"PHD_FEE_VAT\" type=\"bigdecimal\" size=\"8\"/><Column id=\"TRP_SVC_CST\" type=\"bigdecimal\" size=\"8\"/><Column id=\"TRP_SVCOS_VAT\" type=\"bigdecimal\" size=\"8\"/><Column id=\"ETC_FEE\" type=\"bigdecimal\" size=\"8\"/><Column id=\"ETC_FEE_VAT\" type=\"bigdecimal\" size=\"8\"/><Column id=\"FSRGMN_ENO\" type=\"string\" size=\"32\"/><Column id=\"EDIRG_DTM\" type=\"datetime\" size=\"17\"/><Column id=\"FS_RMS_DT\" type=\"string\" size=\"32\"/></ColumnInfo>");
            ...
            obj = new Div("div_list", "absolute", "0", "402", "540", null, null, "0", this);
            obj.set_taborder("53");
            obj.set_text("Div01");
            this.addChild(obj.name, obj);
            ...
            obj.set_datacolumn("name");
            obj.set_codecolumn("code");
            obj = new Combo("cbo_center", "absolute", "32.59%", "264", null, "54", "3.15%", null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            obj.set_taborder("98");
        ...
        this.fn_getNABizPlace = function(v_nacode){
        	...
        	var sURL          = "svc::rest/recadv/getDdlyNABizPlace";// 호출할 서버 페이지 주소
        ...
        this.search = function()
        {
        	if(this.fn_validationCheck()){	
        		...
        		var sInDatasets   = "";//보내는데이터셋
        		var sOutDatasets  = "ds_Rcv_Direct_M=ds_rcv_dir_M";	//화면에서 받는 데이터셋=보낸이름(1대1 맵핑)
        		var sArgument     = param;// 파라미터
        		var sCallbackFunc = "fn_callBack";//콜백
        		var sTranType     = "S"; // U:저장/삭제, S:조회
        ...
        this.div_list_grd_list_oncellclick = function(obj,e)
        {
        	...
        	this.searchDetail();
        	this.gfn_callDetailMenu("div_detail", "검수실적_직송분 상세", "검수실적_직송분^검수실적;전표별^반품입고;의뢰");
        }
        ...
        this.searchDetail = function()
        {
        	if(this.fn_validationCheck()){
        		...
        		*/
        		...
        		var sInDatasets   = "";//보내는데이터셋
        		var sOutDatasets  = "ds_Rcv_Direct_D=ds_rcv_dir_D";	//화면에서 받는 데이터셋=보낸이름(1대1 맵핑)
        		var sArgument     = param;// 파라미터
        		var sCallbackFunc = "fn_callBack";//콜백
        		var sTranType     = "S"; // U:저장/삭제, S:조회
        ...
        {
            this.ds_Rcv_Direct_M.addEventHandler("onrowposchanged", this.ds_Rcv_Direct_M_onrowposchanged, this);
            this.ds_Rcv_Direct_D.addEventHandler("onrowposchanged", this.ds_Rcv_Direct_D_onrowposchanged, this);
