    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_titletext("배송예정서 일반등록");
                this._setFormPosition(0,0,540,1215);
            }
            ...
            obj = new Static("Static63", "absolute", "0%", "0", null, "55", "0%", null, this);
            obj.getSetter("taborder").set("84");
            obj.set_cssclass("sta_WF_CRUDbg");
            this.addChild(obj.name, obj);

            obj = new Static("Static20", "absolute", "28.15%", "296", null, "64", "0.19%", null, this);
            obj.getSetter("taborder").set("72");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static18", "absolute", "28.33%", "800", null, "64", "0%", null, this);
            obj.getSetter("taborder").set("87");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static14", "absolute", "28.33%", "737", null, "64", "0%", null, this);
            obj.getSetter("taborder").set("90");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static10", "absolute", "28.33%", "611", null, "64", "0%", null, this);
            obj.getSetter("taborder").set("93");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static08", "absolute", "28.33%", "548", null, "64", "0%", null, this);
            obj.getSetter("taborder").set("95");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static06", "absolute", "28.33%", "485", null, "64", "0%", null, this);
            obj.getSetter("taborder").set("97");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static04", "absolute", "28.33%", "422", null, "64", "0%", null, this);
            obj.getSetter("taborder").set("100");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", "28.33%", "359", null, "64", "0%", null, this);
            obj.getSetter("taborder").set("102");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static45", "absolute", "28.33%", "175", null, "122", "0%", null, this);
            obj.getSetter("taborder").set("105");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static12", "absolute", "28.33%", "674", null, "64", "0%", null, this);
            obj.getSetter("taborder").set("111");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Static("Static17", "absolute", "28.33%", "54", null, "122", "0%", null, this);
            obj.getSetter("taborder").set("108");
            obj.set_cssclass("sta_WF_LabelBg");
            this.addChild(obj.name, obj);

            obj = new Div("div_pup_van_seq", "absolute", "548", "0", "540", "1215", null, null, this);
            obj.set_taborder("59");
            ...
            obj = new Static("Static02", "absolute", "15", "16", "122", "54", null, null, this.div_pup_van_seq.div_search);
            ...
            this.div_pup_van_seq.addChild(obj.name, obj);
            obj = new Div("div_master", "absolute", "0", "154", "540", "1061", null, null, this.div_pup_van_seq);
            obj.set_taborder("8");
            this.div_pup_van_seq.addChild(obj.name, obj);
            ...
            this.div_pup_van_seq.div_master.addChild(obj.name, obj);
            obj = new Grid("grd_master", "absolute", "0", "64", null, "997", "0", null, this.div_pup_van_seq.div_master);
            obj.set_taborder("5");
            ...
            obj = new Div("div_detail", "absolute", "1096", "0", "540", "1215", null, null, this);
            obj.set_taborder("61");
            ...
            obj = new Div("div_sche", "absolute", "1645", "0", "540", "1215", null, null, this);
            obj.set_taborder("67");
            obj.set_text("div_pup_van_seq");
            obj.style.set_background("white");
            obj.set_visible("false");
            ...
            obj.set_dateformat("yyyy-MM-dd");
            obj = new Static("Static00", "absolute", "89.81%", "134", null, "20", "-6.11%", null, this.div_sche);
            obj.getSetter("taborder").set("15");
            obj.set_visible("false");
            obj.style.set_background("#dc143c33");
            this.div_sche.addChild(obj.name, obj);
            obj = new Div("div_master02", "absolute", "0", "154", "540", "1061", null, null, this.div_sche);
            obj.set_taborder("16");
            this.div_sche.addChild(obj.name, obj);
            ...
            obj.set_cssclass("sta_WF_Gridbg");
            this.div_sche.div_master02.addChild(obj.name, obj);
            obj = new Grid("grd_sche", "absolute", "0", "64", "540", "997", null, null, this.div_sche.div_master02);
            obj.set_taborder("11");
            ...
            obj = new Edit("edt_dvyaa_na_trpl_c", "absolute", "101.48%", "1227", null, "54", "-68.52%", null, this);
            obj.set_taborder("68");
            obj.set_tabstop("false");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_dvy_plash_slpno", "absolute", "28.89%", "301", null, "54", "13.15%", null, this);
            obj.set_taborder("70");
            obj.set_tabstop("false");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Button("btn_dvy_plash_slpno", "absolute", "87.41%", "301", null, "54", "2.78%", null, this);
            obj.set_taborder("71");
            obj.set_cssclass("btn_WF_SearchBtn");
            this.addChild(obj.name, obj);

            obj = new Static("Static19", "absolute", "0%", "296", null, "64", "71.67%", null, this);
            obj.getSetter("taborder").set("73");
            obj.set_text("배송예정서\r\n번호");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Radio("rdo_dvy_vhc_dsc", "absolute", "29.07%", "490", null, "54", "17.96%", null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_pup_van_seq", "absolute", "87.41%", "117", null, "54", "2.78%", null, this);
            obj.set_taborder("75");
            obj.set_cssclass("btn_WF_SearchBtn");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_odr_slpno", "absolute", "29.07%", "117", null, "54", "13.15%", null, this);
            obj.set_taborder("77");
            obj.set_tabstop("false");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_dlv_dest", "absolute", "29.07%", "364", null, "54", "2.78%", null, this);
            obj.set_taborder("78");
            obj.set_tabstop("false");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit05", "absolute", "64.63%", "553", null, "54", "2.78%", null, this);
            obj.set_taborder("79");
            obj.set_value("배송예정");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Combo("cbo_vhcno", "absolute", "29.07%", "553", null, "54", "36.67%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("80");
            ...
            obj = new Edit("edt_shrt_bzplnm", "absolute", "29.07%", "238", null, "54", "2.78%", null, this);
            obj.set_taborder("81");
            obj.set_tabstop("false");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Calendar("cal_odr_dt", "absolute", "29.07%", "59", null, "54", "2.78%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("82");
            obj.set_tabstop("false");
            obj.set_dateformat("yyyy-MM-dd");

            obj = new Button("btn_register", "absolute", "84.26%", "4", null, "46", "2.78%", null, this);
            obj.set_taborder("83");
            obj.set_text("등록");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("mae_vcbt", "absolute", "29.07%", "805", null, "54", "2.78%", null, this);
            obj.set_taborder("85");
            obj.set_tabstop("false");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("mae_odr_am", "absolute", "29.07%", "742", null, "54", "2.78%", null, this);
            obj.set_taborder("86");
            obj.set_tabstop("false");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static15", "absolute", "0%", "800", null, "64", "71.67%", null, this);
            obj.getSetter("taborder").set("88");
            obj.set_text("공병");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("mae_odr_qt", "absolute", "29.07%", "616", null, "54", "2.78%", null, this);
            obj.set_taborder("89");
            obj.set_tabstop("false");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static13", "absolute", "0%", "737", null, "64", "71.67%", null, this);
            obj.getSetter("taborder").set("91");
            obj.set_text("수주금액");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static11", "absolute", "0%", "674", null, "64", "71.67%", null, this);
            obj.getSetter("taborder").set("92");
            obj.set_text("BOX수량");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static09", "absolute", "0%", "611", null, "64", "71.67%", null, this);
            obj.getSetter("taborder").set("94");
            obj.set_text("수주량");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static07", "absolute", "0%", "548", null, "64", "71.67%", null, this);
            obj.getSetter("taborder").set("96");
            obj.set_text("배송차량 및\r\n상태");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static05", "absolute", "0%", "485", null, "64", "71.67%", null, this);
            obj.getSetter("taborder").set("98");
            obj.set_text("배송차량구분");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Calendar("cal_dvy_pla_dt", "absolute", "29.07%", "427", null, "54", "2.78%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("99");
            obj.set_tabstop("false");
            obj.set_dateformat("yyyy-MM-dd");

            obj = new Static("Static03", "absolute", "0%", "422", null, "64", "71.67%", null, this);
            obj.getSetter("taborder").set("101");
            obj.set_text("배송예정일자");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static01", "absolute", "0%", "359", null, "64", "71.67%", null, this);
            obj.getSetter("taborder").set("103");
            obj.set_text("배송지");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_odrpl_na_trpl_c", "absolute", "29.07%", "180", null, "54", "2.78%", null, this);
            obj.set_taborder("104");
            obj.set_tabstop("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static44", "absolute", "0%", "175", null, "122", "71.67%", null, this);
            obj.getSetter("taborder").set("106");
            obj.set_text("발주처");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new Static("Static00", "absolute", "97.22%", "54", null, "93", "0%", null, this);
            obj.getSetter("taborder").set("107");
            obj.set_visible("false");
            obj.style.set_background("#00ffff33");
            this.addChild(obj.name, obj);

            obj = new Static("Static16", "absolute", "0%", "54", null, "122", "71.67%", null, this);
            obj.getSetter("taborder").set("109");
            obj.set_text("발주번호");
            obj.set_cssclass("sta_WF_Label");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("mae_boxpe_aqz", "absolute", "29.07%", "679", null, "54", "2.78%", null, this);
            obj.set_taborder("110");
            obj.set_tabstop("false");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_list", "absolute", "0", "863", "538", "352", null, null, this);
            ...
            //-- Default Layout
            obj = new Layout("default", "", 540, 1061, this.div_pup_van_seq.div_master,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("8");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 540, 1215, this.div_pup_van_seq,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("59");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 540, 1215, this.div_detail,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("61");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 540, 1061, this.div_sche.div_master02,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("16");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 540, 1215, this.div_sche,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("67");
            		p.set_text("div_pup_van_seq");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 540, 1215, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("OMG_DS_SC_7022");
            		p.set_titletext("배송예정서 일반등록");
            ...
            obj = new BindItem("item1","edt_odrpl_na_trpl_c","value","ds_dataM","ODRPL_NA_TRPL_C");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        this.btn_pup_van_seq_onclick = function(obj,e)
        {
        	...
        	//this.searchVanSeq();
        	this.gfn_callDetailMenu("div_pup_van_seq", "발주번호 조회", "배송예정서 일반등록^^배송예정서;직송등록");
        }
        ...
        this.grd_list_oncellclick = function(obj,e)
        {
        	...
        	this.gfn_callDetailMenu("div_detail", "배송예정서 일반등록 상세", "배송예정서 일반등록^^배송예정서;직송등록");
        }
        ...
        {
        	if(this.gfn_isNull(this.edt_odrpl_na_trpl_c.value)){
        		alert("발주처를 선택해 주세요");
        		return false;
        	}else{
        		var nLeft = 0;
        	...
        	this.gfn_callDetailMenu("div_sche", "배송예정서번호 조회", "배송예정서 일반등록^^배송예정서;직송등록");
        }
