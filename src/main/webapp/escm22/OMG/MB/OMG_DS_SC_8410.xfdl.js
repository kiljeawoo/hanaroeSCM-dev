    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_8410");
                this.set_classname("OMG_DS_SC_7022");
                this.set_titletext("사업장/상품별 판매정보 조회");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"BZPLC\" type=\"string\" size=\"32\"/><Column id=\"BZPLCNM\" type=\"string\" size=\"32\"/><Column id=\"SL_QT\" type=\"bigdecimal\" size=\"8\"/><Column id=\"SL_AM\" type=\"float\" size=\"8\"/><Column id=\"SRH_BY_DT_FR\" type=\"string\" size=\"32\"/><Column id=\"SRH_BY_DT_TO\" type=\"string\" size=\"32\"/><Column id=\"SRH_TRPL_C\" type=\"string\" size=\"32\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"NA_WRS_C\" type=\"string\" size=\"32\"/><Column id=\"WRSNM\" type=\"string\" size=\"32\"/><Column id=\"SL_QT\" type=\"string\" size=\"32\"/><Column id=\"TOT_SLAM\" type=\"string\" size=\"32\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_autofittype("col");
            obj.set_summarytype("top");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"180\"/><Column size=\"228\"/><Column size=\"130\"/></Columns><Rows><Row size=\"50\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"63\"/><Row size=\"63\"/></Rows><Band id=\"head\"><Cell text=\"사업장코드\"/><Cell col=\"1\" colspan=\"2\" text=\"사업장명\"/><Cell row=\"1\" text=\"수량\"/><Cell row=\"1\" col=\"1\" text=\"금액(만원)\"/><Cell row=\"1\" col=\"2\" text=\"합계대비(%)\"/></Band><Band id=\"body\"><Cell style=\"align: ;\" cssclass=\"Cellgrd_WF_txt\" text=\"bind:BZPLC\"/><Cell col=\"1\" colspan=\"2\" style=\"align:left middle;\" cssclass=\"Cellgrd_WF_txt\" text=\"bind:BZPLCNM\" wordwrap=\"char\"/><Cell row=\"1\" style=\"align:right middle;\" text=\"bind:SL_QT\"/><Cell row=\"1\" col=\"1\" style=\"align:right middle;\" text=\"bind:SL_AM\"/><Cell row=\"1\" col=\"2\" style=\"align:right middle;\" expr=\"expr:nexacro.round(SL_AM/comp.parent.parent.ds_dataTotal.getColumn(0,'TOTAL_SL_AM')*100,2)\"/></Band></Format></Formats>");
            this.div_list.addChild(obj.name, obj);
            ...
            obj.set_autofittype("col");
            obj.set_summarytype("top");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"180\"/><Column size=\"359\"/></Columns><Rows><Row size=\"50\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"63\"/><Row size=\"63\"/></Rows><Band id=\"head\"><Cell text=\"상품코드\"/><Cell col=\"1\" text=\"상품명\"/><Cell row=\"1\" text=\"수량\"/><Cell row=\"1\" col=\"1\" text=\"합계대비(%)\"/></Band><Band id=\"body\"><Cell style=\"align: ;\" cssclass=\"Cellgrd_WF_txt\" text=\"bind:NA_WRS_C\"/><Cell col=\"1\" style=\"align:left middle;\" cssclass=\"Cellgrd_WF_txt\" text=\"bind:WRSNM\"/><Cell row=\"1\" style=\"align:right middle;\" text=\"bind:SL_QT\"/><Cell row=\"1\" col=\"1\" displaytype=\"number\" style=\"align:right middle;\" expr=\"expr:nexacro.round(SL_QT/comp.parent.parent.ds_dataTotalDetail.getColumn(0,'TOTAL_SL_QT')*100,2)\"/></Band></Format></Formats>");
            ...
            this.div_detail.addChild(obj.name, obj);
            obj = new Static("Static04", "absolute", "151", "0", "387", "64", null, null, this.div_detail);
            ...
            obj.set_cssclass("sta_WF_Label");
            this.div_detail.addChild(obj.name, obj);
            obj = new Static("Static01", "absolute", "151", "63", "387", "64", null, null, this.div_detail);
            obj.getSetter("taborder").set("6");
            obj.set_cssclass("sta_WF_LabelBg");
            this.div_detail.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 540, 680, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("사업장/상품별 판매정보 조회");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_8410.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_8410.xfdl", function() {
        ...
        this.fn_search = function(){	
        	if(this.fn_validationCheck()){
        		...
        		var sSvcID        = "retrieveSalesPeriodStoreSumPgList";//통신아이디
        		var sURL          = "svc::/rest/pds/retrieveSalesPeriodStoreSumPgList";// 호출할 서버 페이지 주소
        ...
        this.fn_callBack = function(svcID,ErrorCode,ErrorMsg)
        {
        	if(ErrorCode < 0)
        	{
        		...
        		if(svcID == "retrieveSalesPeriodStoreSumPgList"){
        			var p_sum = 0;
        		...
        		}else if(svcID == "retrieveSalesPeriodStoreSumDetailPgList"){
        			var p_sum = 0;
        ...
        */
        ...
        this.div_list_grd_list_oncellclick = function(obj,e)
        {
        	...
        	this.gfn_callDetailMenu("div_detail", "사업장/상품별 판매정보 상세", "사업장/상품별 판매정보^^상품/사업장별;판매정보");
        }
        ...
        this.fn_searchDetail = function()
        {
        	...
        	this.div_detail.edt_infoCode.set_value(bzplc);
        	this.div_detail.edt_infoName.set_value(bzplcnm);
        ...
        */
        ...
        this.loadIncludeScript("OMG_DS_SC_8410.xfdl");
