    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_8411");
                this.set_classname("OMG_DS_SC_7022");
                this.set_titletext("사업장/상품별 판매정보 상세");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"180\"/><Column size=\"228\"/><Column size=\"130\"/></Columns><Rows><Row size=\"50\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"63\"/><Row size=\"63\"/></Rows><Band id=\"head\"><Cell text=\"상품코드\"/><Cell col=\"1\" colspan=\"2\" text=\"상품명\"/><Cell row=\"1\" text=\"수량\"/><Cell row=\"1\" col=\"1\" text=\"금액(만원)\"/><Cell row=\"1\" col=\"2\" text=\"합계대비(%)\"/></Band><Band id=\"body\"><Cell style=\"align: ;\" cssclass=\"Cellgrd_WF_txt\" text=\"bind:Column0\"/><Cell col=\"1\" colspan=\"2\" style=\"align:left middle;\" cssclass=\"Cellgrd_WF_txt\" text=\"bind:Column1\"/><Cell row=\"1\" style=\"align:right middle;\"/><Cell row=\"1\" col=\"1\" style=\"align:right middle;\"/><Cell row=\"1\" col=\"2\" style=\"align:right middle;\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 540, 512, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("사업장/상품별 판매정보 상세");
        ...
        this.loadIncludeScript("OMG_DS_SC_8411.xfdl");
