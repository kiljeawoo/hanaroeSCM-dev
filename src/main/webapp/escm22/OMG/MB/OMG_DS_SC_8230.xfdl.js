    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("OMG_DS_SC_8230");
                this.set_classname("OMG_DS_SC_7022");
                this.set_titletext("배송예정 거래처별 조회");
            ...
            obj = new Div("div_list", "absolute", "0", "466", null, null, "0", "-64", this);
            obj.set_taborder("52");
            this.addChild(obj.name, obj);
            obj = new Grid("grd_master", "absolute", "0", "16", null, null, "0", "0", this.div_list);
            obj.set_taborder("0");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"177\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"50\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"60\"/><Row size=\"60\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"none\" text=\"수주처\"/><Cell col=\"1\" displaytype=\"normal\" edittype=\"none\" text=\"수주처명\"/><Cell col=\"2\" colspan=\"2\" cssclass=\"Cellgrd_WF_Head\" text=\"배송예정서번호\"/><Cell row=\"1\" text=\"배송지\"/><Cell row=\"1\" col=\"1\" text=\"배송지명\"/><Cell row=\"1\" col=\"2\" cssclass=\"Cellgrd_WF_Head\" text=\"배송예정일\"/><Cell row=\"1\" col=\"3\" cssclass=\"Cellgrd_WF_Head\" text=\"배송예정금액\"/></Band><Band id=\"body\"><Cell colspan=\"2\" displaytype=\"text\" text=\"bind:NA_WRS_C\"/><Cell col=\"2\" colspan=\"2\" cssclass=\"Cellgrd_WF_txt\"/><Cell row=\"1\" colspan=\"2\" style=\"align:left middle;\" cssclass=\"Cellgrd_WF_txt\" text=\"bind:WRSNM\" wordwrap=\"char\"/><Cell row=\"1\" col=\"2\" displaytype=\"date\" style=\"align: ;\" cssclass=\"Cellgrd_WF_txt\" text=\"bind:DVY_PLA_DT\"/><Cell row=\"1\" col=\"3\" displaytype=\"number\" cssclass=\"Cellgrd_WF_txt\" wordwrap=\"char\"/></Band></Format></Formats>");
            ...
            obj = new Div("div_search", "absolute", "0", "0", "540", "466", null, null, this);
            obj.set_taborder("44");
            obj.set_cssclass("div_WFSA_Searchbg");
            this.addChild(obj.name, obj);
            obj = new Button("btn_search", "absolute", "15", "397", "510", "49", null, null, this.div_search);
            obj.set_taborder("86");
            obj.set_text("조회");
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static03", "absolute", "15", "234", "142", "54", null, null, this.div_search);
            ...
            this.div_search.addChild(obj.name, obj);
            obj = new Static("Static04", "absolute", "15", "328", "142", "54", null, null, this.div_search);
            obj.getSetter("taborder").set("100");
            obj.set_text("배송예정상태");
            obj.set_cssclass("sta_WFSA_Label");
            obj.set_wordwrap("none");
            this.div_search.addChild(obj.name, obj);
            obj = new Radio("rdo_confirm", "absolute", "157", "328", "369", "54", null, null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            var rdo_confirm_innerdataset = new Dataset("rdo_confirm_innerdataset", this.div_search.rdo_confirm);
            rdo_confirm_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">배송예정</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">매입</Col></Row></Rows>");
            ...
            obj.set_cssclass("sta_WFSA_Label");
            this.div_search.addChild(obj.name, obj);
            obj = new Radio("rdo_confirm00", "absolute", "29.07%", "78", null, "54", "2.59%", null, this.div_search);
            this.div_search.addChild(obj.name, obj);
            var rdo_confirm00_innerdataset = new Dataset("rdo_confirm00_innerdataset", this.div_search.rdo_confirm00);
            rdo_confirm00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">일반</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">직송</Col></Row></Rows>");
            obj.set_innerdataset(rdo_confirm00_innerdataset);
            ...
            obj.set_value("1");
            obj.set_direction("vertical");
            obj = new Edit("edt_dvy_plash_slpno00", "absolute", "29.07%", "264", null, "54", "2.78%", null, this.div_search);
            ...
            obj = new Div("div_detail", "absolute", "1678", "0", "540", "999", null, null, this);
            obj.set_taborder("55");
            obj.set_visible("false");
            obj.style.set_background("white");
            this.addChild(obj.name, obj);
            ...
            obj.style.set_background("#00ffff33");
            this.div_detail.addChild(obj.name, obj);
            obj = new Static("Static63", "absolute", "0%", "0", null, "55", "0%", null, this.div_detail);
            obj.getSetter("taborder").set("51");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 540, 999, this.div_detail,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("55");
            		p.set_visible("false");
        ...
        // User Script
        this.addIncludeScript("OMG_DS_SC_8230.xfdl", "lib::comLib.xjs");
        this.registerScript("OMG_DS_SC_8230.xfdl", function() {
        ...
        this.div_search_btn_search_onclick = function(obj,e)
        {
        	...
        	this.div_detail.bringToFront();
        	this.div_detail.set_visible(true);
        	this.gfn_callDetailMenu("div_detail", "배송예정 거래처별 상세", "배송예정 거래처별^배송예정서;직송등록^배송예정;상품별");
        }
        ...
        this.loadIncludeScript("OMG_DS_SC_8230.xfdl");
