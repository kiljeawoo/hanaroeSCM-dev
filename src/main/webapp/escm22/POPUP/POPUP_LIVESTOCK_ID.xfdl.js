(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CATT_NO\" type=\"STRING\" size=\"256\"/><Column id=\"BIRTH_DT\" type=\"STRING\" size=\"256\"/><Column id=\"SEX_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BUTCHERY_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BUTCHERY_DT\" type=\"STRING\" size=\"256\"/><Column id=\"INSPECT_PASS_YN\" type=\"STRING\" size=\"256\"/><Column id=\"QT_GRADE\" type=\"STRING\" size=\"256\"/><Column id=\"BRND_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MAIN_FEED_NM\" type=\"STRING\" size=\"256\"/><Column id=\"BREED_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            cbo_search_type_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">01</Col><Col id=\"datacolumn\">개체식별번호코드</Col></Row><Row><Col id=\"codecolumn\">02</Col><Col id=\"datacolumn\">개체식별번호명</Col></Row></Rows>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"100\"/><Column size=\"48\"/><Column size=\"232\"/><Column size=\"100\"/><Column size=\"158\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"개체식별번호\"/><Cell col=\"1\" text=\"출생일자\"/><Cell col=\"2\" text=\"성별\"/><Cell col=\"3\" text=\"도축장\"/><Cell col=\"4\" text=\"도축일자\"/><Cell col=\"5\" text=\"위생검사합격여부\"/></Band><Band id=\"body\"><Cell text=\"bind:NAAC_DSC_N\"/><Cell col=\"1\" text=\"bind:NA_TRPL_C\"/><Cell col=\"2\" cssclass=\"Cellgrd_WF_AlignLeft\" text=\"bind:NA_TRPL_N\"/><Cell col=\"3\" text=\"bind:BZPL_TPC\"/><Cell col=\"4\" text=\"bind:BZPL_DTI_TPC_N\"/><Cell col=\"5\" text=\"bind:BZPL_TPNM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("POPUP_LIVESTOCK_ID.xfdl", "lib::comLib.xjs");
        this.registerScript("POPUP_LIVESTOCK_ID.xfdl", function(exports) {
        ...
        */
        ...
        this.loadIncludeScript("POPUP_LIVESTOCK_ID.xfdl", true);
