(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_cancle", "absolute", "369", "305", "54", "29", null, null, this);
            obj.set_taborder("10");
            obj.set_text("취소");
            obj.set_cssclass("btn_WF_Popup");
            this.addChild(obj.name, obj);

            obj = new Button("btn_ok", "absolute", "313", "305", "54", "29", null, null, this);
            obj.set_taborder("11");
            obj.set_text("확인");
            obj.set_cssclass("btn_WF_Popup");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("Button07", "absolute", null, "47", "53", "21", "78", null, this);
            obj.set_taborder("14");
            obj.set_text("초기화");
        ...
        // User Script
        this.addIncludeScript("POPUP_BR.xfdl", "lib::comLib.xjs");
        this.registerScript("POPUP_BR.xfdl", function(exports) {
        ...
        */
        ...
        this.loadIncludeScript("POPUP_BR.xfdl", true);
