(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"s_code\" type=\"string\" size=\"13\"/><Column id=\"s_name\" type=\"string\" size=\"13\"/></ColumnInfo><Rows><Row><Col id=\"s_code\">name</Col><Col id=\"s_name\">수요처명</Col></Row><Row><Col id=\"s_code\">code</Col><Col id=\"s_name\">수요처코드</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"200\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"수요처코드\"/><Cell col=\"1\" text=\"수요처명\"/><Cell col=\"2\" text=\"팀코드\"/><Cell col=\"3\" text=\"팀명\"/></Band><Band id=\"body\"><Cell text=\"bind:NA_TRPL_C\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:CLNTNM\"/><Cell col=\"2\" text=\"bind:NA_TEAM_C\"/><Cell col=\"3\" text=\"bind:TEAMNM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("POPUP_SRC_RVOPL_TRPL.xfdl", "lib::comLib.xjs");
        this.registerScript("POPUP_SRC_RVOPL_TRPL.xfdl", function(exports) {
        ...
        {
        	this.objRtnArr[0] = this.ds_rvopl.getColumn(this.ds_rvopl.rowposition,"NA_TRPL_C");
        	this.objRtnArr[1] = this.ds_rvopl.getColumn(this.ds_rvopl.rowposition,"CLNTNM");
        ...
        this.loadIncludeScript("POPUP_SRC_RVOPL_TRPL.xfdl", true);
