(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("ds_naMnt", this);
            obj._setContents("<ColumnInfo><Column id=\"COM_ID\" type=\"STRING\" size=\"256\"/><Column id=\"STATUS\" type=\"STRING\" size=\"256\"/><Column id=\"UP_TIME\" type=\"STRING\" size=\"256\"/><Column id=\"NOWTIME\" type=\"STRING\" size=\"256\"/><Column id=\"TERM\" type=\"STRING\" size=\"256\"/><Column id=\"RESULT\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_logo", "absolute", "0", "0", "383", "65", null, null, this);
            obj.set_taborder("1");
            ...
            obj = new Static("sta_userName", "absolute", null, "1", "330", "21", "82", null, this);
            obj.set_taborder("3");
            obj.set_cssclass("sta_TF_User");
            obj.set_text("<b v='true'>김도현</b>님 접속!");
            ...
            obj = new Button("btn_userInfo", "absolute", null, "1", "48", "21", "-61", null, this);
            obj.set_taborder("6");
            obj.set_text("내정보");
            ...
            obj = new Static("Static05", "absolute", null, "8", "5", "8", "69", null, this);
            obj.set_taborder("9");
            obj.style.set_background("URL('theme://images/sta_TF_UtilLine.png')");
            this.addChild(obj.name, obj);

            obj = new Menu("mnb_topMenu", "absolute", "192", "18", null, "46", "51", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("11");
            ...
            obj = new PopupMenu("PopupMenu00", "absolute", "40.97%", "133", null, "100", "37.2%", null, this);
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01", "absolute", "2.18%", "156", null, "21", "85.91%", null, this);
            obj.set_taborder("13");
            obj.set_text("sta_ADMIN_Logo");
            obj.set_tooltiptype("default");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static02", "absolute", null, "41", "5", "8", "229", null, this);
            obj.set_taborder("14");
            obj.style.set_background("URL('theme://images/sta_TF_UtilLine.png')");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Button("btn_connect", "absolute", null, "34", "168", "21", "59", null, this);
            obj.set_taborder("15");
            obj.set_text("MCA : 연결    SFTP : 끊김");
            obj.set_cssclass("btn_TF_UtilMenu");
            obj.style.set_align("left middle");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("Static06", "absolute", null, "41", "5", "8", "152", null, this);
            obj.set_taborder("16");
            obj.style.set_background("URL('theme://images/sta_TF_UtilLine.png')");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("TopFrame_portal_admin.xfdl", "lib::comLib.xjs");
        this.registerScript("TopFrame_portal_admin.xfdl", function(exports) {
        ...
        this.loadIncludeScript("TopFrame_portal_admin.xfdl", true);
