(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("TopFrame_serviceGT.xfdl", "lib::comLib.xjs");
        this.registerScript("TopFrame_serviceGT.xfdl", function(exports) {
        if (this.executeIncludeScript) { this.executeIncludeScript("lib::comLib.xjs", null, exports); }	//include "lib::comLib.xjs";

        this.form_onload = function(obj,e)
        {
        	this.ds_topMenu.copyData(application.gds_serviceGT);
        ...
        this.mnb_topMenu_onmenuclick = function(obj,e)
        {
        	...
        	var nTopRow      = application.gds_serviceGT.findRow("MENU_ID", e.id);
        	var sLFTitleText = application.gds_serviceGT.getColumn(nTopRow, "MENU_NAME");
        ...
        this.loadIncludeScript("TopFrame_serviceGT.xfdl", true);
