(function()
{
    return function()
    {
        ...
        this.registerScript("TopFrame_serviceBT.xfdl", function(exports) {
        if (this.executeIncludeScript) { this.executeIncludeScript("lib::comLib.xjs", null, exports); }	//include "lib::comLib.xjs";

        this.form_onload = function(obj,e)
        {
        	this.ds_topMenu.copyData(application.gds_serviceBT);
        ...
        * Return :  계산된 사이즈가 저장된  Size object
        ...
        this.loadIncludeScript("TopFrame_serviceBT.xfdl", true);
