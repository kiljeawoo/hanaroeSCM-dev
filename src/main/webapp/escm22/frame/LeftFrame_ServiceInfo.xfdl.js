(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grd_menu", "absolute", "0%", "8", null, null, "4.21%", "12", this.div_menu);
        ...
        // User Script
        this.addIncludeScript("LeftFrame_ServiceInfo.xfdl", "lib::comLib.xjs");
        this.registerScript("LeftFrame_ServiceInfo.xfdl", function(exports) {
        ...
        this.loadIncludeScript("LeftFrame_ServiceInfo.xfdl", true);
