(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("LeftFrame_serviceBT.xfdl", "lib::comLib.xjs");
        this.registerScript("LeftFrame_serviceBT.xfdl", function(exports) {
        ...
        {
        	this.ds_menu.copyData(application.gds_serviceBT);
        ...
        this.loadIncludeScript("LeftFrame_serviceBT.xfdl", true);
