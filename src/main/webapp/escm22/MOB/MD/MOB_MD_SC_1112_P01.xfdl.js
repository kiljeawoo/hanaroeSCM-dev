    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("MOB_MD_SC_1112_P01");
            ...
            obj._setContents("<ColumnInfo><Column id=\"NA_WRS_C\" type=\"STRING\" size=\"256\"/><Column id=\"WRS_ABR_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"s_code\" type=\"string\" size=\"13\"/><Column id=\"s_name\" type=\"string\" size=\"13\"/></ColumnInfo><Rows><Row><Col id=\"s_code\">name</Col><Col id=\"s_name\">상품 명</Col></Row><Row><Col id=\"s_code\">code</Col><Col id=\"s_name\">상품 코드</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"144\"/><Column size=\"278\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell text=\"상품 코드\"/><Cell col=\"1\" text=\"상품 명\"/></Band><Band id=\"body\"><Cell text=\"bind:NA_WRS_C\"/><Cell col=\"1\" style=\"align:left;\" text=\"bind:WRS_ABR_NM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("MOB_MD_SC_1112_P01.xfdl", "lib::comLib.xjs");
        this.registerScript("MOB_MD_SC_1112_P01.xfdl", function(exports) {
        ...
        {
        	this.objRtnArr[0] = this.ds_codeData.getColumn(this.ds_codeData.rowposition,"NA_WRS_C");
        	this.objRtnArr[1] = this.ds_codeData.getColumn(this.ds_codeData.rowposition,"WRS_ABR_NM");
        ...
        this.btn_search_onclick = function(obj,e)
        {
        	...
        	if(this.fn_validationCheck()){
        		...
        		var sURL          = "svc::rest/mob/searchWRS";// 호출할 서버 페이지 주소
        ...
        this.loadIncludeScript("MOB_MD_SC_1112_P01.xfdl", true);
