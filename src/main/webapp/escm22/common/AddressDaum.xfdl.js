(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("AddressDaum.xfdl", "lib::comLib.xjs");
        this.registerScript("AddressDaum.xfdl", function(exports) {
        ...
        this.loadIncludeScript("AddressDaum.xfdl", true);
