    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                ...
                this.set_classname("calrendarMonth");
            ...
            obj = new Edit("edt_monthCal", "absolute", "0", "0", "140", "21", null, null, this);
            obj.set_taborder("0");
            ...
            obj = new Static("Static00", "absolute", "283", "73", "173", "21", null, null, this);
            obj.getSetter("taborder").set("2");
            obj.set_text("btn_WF_Calendarmm_S");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("calrendarMonth_org.xfdl", "lib::comLib.xjs");
        this.registerScript("calrendarMonth_org.xfdl", function() {
        /**
        ...
        {
            //현재 년월 초기값설정
            //edt_MonthCal.value = gfn_toDay().substr(0, 6);
        }
        ...
        {
        	var sVal = this.edt_monthCal.value;
        	
        	if(!this.gfn_isNull(sVal)){
        		if(sVal.length > 4){
        			if(sVal.toString().substr(4) > 12) {
        				alert("1 ~ 12월만 가능합니다.");
        				this.edt_monthCal.set_value(sVal.toString().substr(0,4));
        				this.edt_monthCal.setFocus();
        				return;
        			}
        		}
        	}
        	
        	var nX = system.clientToScreenX(this.edt_monthCal, 0) - system.clientToScreenX(application.mainframe, 0); 
        	var nY = system.clientToScreenY(this.edt_monthCal, parseInt(this.edt_monthCal.height)) - system.clientToScreenY(application.mainframe, 0); 
        ...
        this.edt_monthCal_onkeydown = function(obj,e)
        {
        	if(e.keycode == 13 ){
        ...
        {	
        	...
        	{
        		v_sBeforeValue = this.edt_monthCal.value;
        ...
        this._callBindFunction = function ()
        {
        	...
        	if (!this.gfn_isNull(gFunctionName)) 
        	{
        		try 
        		{
        			//eval(gFunctionName + "(strDateNew)");
        			 this.lookupFunc(gFunctionName + "(strDateNew)").call();
        ...
        this._setReadonly = function (isReadonly)
        {
        	...
        	if (isReadonly) 
        	{
        		this.edt_monthCal.set_readonly(true);
        		this.btn_monthCal.set_enable(false);
        	} else 
        	{
        		this.edt_monthCal.set_readonly(false);
        ...
        // 	_msgkey = strMsgKey; 2015
        	if (isRequired) 
        	{
        		this.edt_monthCal.class = "edt_WF_Essential";
        	} else 
        	{
        		this.edt_monthCal.class = "";
        	}
        }
        ...
        {
        	if(!this.gfn_isNull(this.edt_monthCal.value)){	
        		var oParamData = this.edt_monthCal.value;
        		return oParamData;	
        	}else{
        		return "";
        	}	
        ...
        {
        	this.edt_monthCal.set_value(this._checkDate(strYYMM)); 
        }

        this._clearValue = function ()
        {
        	this.edt_monthCal.set_value(""); 
        }

        this._enable = function(obj)
        {
        	if(obj){
        		this.edt_monthCal.set_enable(true); 
        		this.btn_monthCal.set_enable(true); 
        	}else{
        		this.edt_monthCal.set_enable(false); 
        		this.btn_monthCal.set_enable(false);
        	}
        }
        ...
        this._readonly = function (obj)
        {
        	if(obj){
        		...
        		this.edt_monthCal.readonly(false); 
        		this.btn_monthCal.set_enable(true); 
        	}
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.edt_monthCal.addEventHandler("onkeydown", this.edt_monthCal_onkeydown, this);
        ...
        this.loadIncludeScript("calrendarMonth_org.xfdl");
