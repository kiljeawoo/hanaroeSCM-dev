...
<%
	...
	*/
	...
	System.out.println("requset : "  + request.getClass().getName());
...
// 			items = upload.parseRequest(request);
			...
			Iterator it = ((MultipartHttpServletRequest)request).getFileNames();
			while(it.hasNext()) {
				List<MultipartFile> list = ((MultipartHttpServletRequest)request).getFiles(it.next().toString());
