...
<head>
	...
	<script type="text/javascript">
		function login() {
			...
			document.frm.gln.value = trim(gln);
			document.frm.kbn.value = trim(kbn);
			document.frm.empNo.value = trim(empNo);
			document.frm.mbPw.value = trim(mbPw);
		...
		<div class="form-panel one">
			...
			<form name="frm" method="post">
				<div class="form-group">
					<label for="username">GLN코드</label>
					<input type="text" id="gln" name="gln" maxlength="13" onkeydown="return onlyNumber(event);" onkeyup="removeChar(event);" style="ime-mode:disabled;" />
				</div>
				<div class="form-group">
					<label for="password">사업자번호</label>
					<input type="password" id="kbn" name="kbn" maxlength="10" onkeydown="return onlyNumber(event);" onkeyup="removeChar(event);" style="ime-mode:disabled;" />
				</div>
				<div class="form-group">
					<label for="password">사번</label>
					<input type="text" id="empNo" name="empNo" maxlength="10">
				</div>
				<div class="form-group">
					<label for="password">비밀번호</label>
					<input type="password" id="mbPw" name="mbPw" maxlength="15">
				</div>
				<div class="form-group">
