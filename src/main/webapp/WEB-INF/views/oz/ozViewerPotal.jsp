...
<script src="<%=CONTEXT_PATH%>/oz/ozhviewer/jquery/jquery-2.0.3.min.js"></script>
<link rel="stylesheet" href="<%=CONTEXT_PATH%>/oz/ozhviewer/jquery/jquery-ui.css" type="text/css"/>
<script src="<%=CONTEXT_PATH%>/oz/ozhviewer/jquery/jquery-ui.min.js"></script>
<link rel="stylesheet" href="<%=CONTEXT_PATH%>/oz/ozhviewer/ui.dynatree.css" type="text/css"/>
<script type="text/javascript" src="<%=CONTEXT_PATH%>/oz/ozhviewer/jquery.dynatree.js" charset="utf-8"></script>
<script type="text/javascript" src="<%=CONTEXT_PATH%>/oz/ozhviewer/OZJSViewer.js" charset="utf-8"></script>
<script>
var viewer = "HTML5";
var colDiv = "^";
var rowDiv = "//ROW//";
...
function SetOZParamters_OZViewer() {
	...
	oz.sendToActionScript("connection.servlet", "<%=OZ_PATH%>/oz80/server");
	oz.sendToActionScript("connection.reportname", "/potal/<%=sId%>.ozr");
...
function OZProgressCommand_OZViewer(step, state, reportname) {
	if (!isComp) return;
	var billSid = ['VAN_DS_SC_0110_1','VAN_DS_SC_0500_D'];
	if (step == 4 && state == 2) {
...
var ozViewerRun = function() {
	start_ozjs("OZViewer", "<%=CONTEXT_PATH%>/oz/ozhviewer/");
};
